import { ec as Oe, nq as Le, nr as vt, ns as _t, nt as Pt, nu as Dt, nv as Ot, nw as Lt, nx as Ht, ny as Mt, nz as At, nA as Ft, nB as Nt, nC as $t, nD as jt, cW as Y, a3 as ne, nE as Ut, aq as V, ic as ue, i2 as k, nF as Gt, nG as Fe, ff as zt, nH as Ne, B as r, nI as $e, ap as W, da as ye, aO as O, nJ as ae, nK as Bt, nL as je, c2 as ce, nM as Ue, iA as Ge, E as fe, nN as Ke, cA as qt, bS as gt, nO as Je, av as Ye, nP as Vt, nQ as Wt, _ as Kt, a as A, a1 as Jt, N as Yt, aQ as Zt, O as Xt, aM as Qt, g as en, nR as tn, V as nn, aU as on, nS as sn, nT as rn, bC as an, nU as xe, dc as cn, d3 as ln, nV as hn, bd as dn, nW as un, nX as fn, nY as Ze, au as mn, d as Xe, nZ as gn, Y as pn, k as Tn } from "./index-6dabdcd0.js";
import { T as yn, a as Cn, b as le, t as Sn, E as F, V as Ie, c as be, d as Ee, e as Ce, f as v, g as y, C as In, h as bn } from "./workbenchThemeService-40a4902f.js";
import { g as ze } from "./jsonErrorMessages-8ea797ae.js";
import { T as Se, p as Qe, S as et, g as En, t as pt } from "./tokenClassificationRegistry-656e70e6.js";
const He = {};
function R(s, e) {
  let t = He[s];
  t || (He[s] = t = []), t.push(e);
...
R("foreground", Le);
R("selection", vt);
R("inactiveSelection", _t);
R("selectionHighlightColor", Pt);
R("findMatchHighlight", Dt);
R("currentFindMatchHighlight", Ot);
R("hoverHighlight", Lt);
R("wordHighlight", "editor.wordHighlightBackground");
R("wordHighlightStrong", "editor.wordHighlightStrongBackground");
R("findRangeHighlight", Ht);
...
function xn(s, e, t) {
  ...
  function c(l) {
    if (t === null)
      ...
      for (; l > 0; )
        s.charCodeAt(o) === 10 ? (o++, i++, a = 0) : (o++, a++), l--;
  }
  function h(l) {
    t === null ? o = l : c(l - o);
  }
  ...
  function f(l) {
    return s.substr(o, l.length) === l ? (c(l.length), !0) : !1;
  }
  function g(l) {
    const E = s.indexOf(l, o);
    h(E !== -1 ? E + l.length : n);
  }
  function C(l) {
    const E = s.indexOf(l, o);
  ...
  function b(l) {
    throw new Error("Near offset " + o + ": " + l + " ~~~" + s.substr(o, 50) + "~~~");
  }
  const K = {
    enterDict: function() {
      if (m === null)
  ...
  function z() {
    d === 1 ? K.enterDict() : d === 2 ? N.enterDict() : (p = {}, t !== null && (p[t] = {
      filename: e,
      line: i,
      char: a
    }), I(1, p));
  ...
  function ie() {
    d === 1 ? K.enterArray() : d === 2 ? N.enterArray() : (p = [], I(2, p));
  }
  function ee() {
    if (d === 1)
...
const vn = ne.as(Ut.ColorContribution), me = En(), ot = {
...
class H {
  ...
  get tokenColors() {
    if (!this.textMateThemingRules) {
      let i = function(a) {
        a.scope && a.settings && (a.scope === "token.info-token" && (o = !0), e.push({ scope: a.scope, settings: { foreground: te(a.settings.foreground), background: te(a.settings.background), fontStyle: a.settings.fontStyle } }));
      };
      const e = [], t = this.getColor(Le) || this.getDefault(Le), n = this.getColor(Oe) || this.getDefault(Oe);
      e.push({
        settings: {
          foreground: te(t),
          background: te(n)
      ...
      let o = !1;
      this.themeTokenColors.forEach(i), this.customTokenColors.forEach(i), o || Pn[this.type].forEach(i), this.textMateThemingRules = e;
    }
    return this.textMateThemingRules;
  }
  getColor(e, t) {
    let n = this.customColorMap[e];
    return n || (n = this.colorMap[e], t !== !1 && V(n) && (n = this.getDefault(e)), n);
  }
  getTokenStyle(e, t, n, o = !0, i = {}) {
    ...
    function h(g, C, d) {
      C.foreground && c.foreground <= g && (c.foreground = g, a.foreground = C.foreground, i.foreground = d);
      for (const p of ["bold", "underline", "strikethrough", "italic"]) {
        const T = p, S = C[T];
        S !== void 0 && c[T] <= g && (c[T] = g, a[T] = S, i[T] = d);
      }
    }
    function u(g) {
      const C = g.selector.match(e, t, n);
      C >= 0 && h(C, g.style, g);
    }
    ...
    if (f)
      for (const g of me.getTokenStylingDefaultRules()) {
        const C = g.selector.match(e, t, n);
        if (C >= 0) {
          let d;
          if (g.defaults.scopesToProbe && (d = this.resolveScopes(g.defaults.scopesToProbe), d && h(C, d, g.defaults.scopesToProbe)), !d && o !== !1) {
            const p = g.defaults[this.type];
            d = this.resolveTokenStyleValue(p), d && h(C, d, p);
          }
        }
      }
    return Se.fromData(a);
  }
  ...
  getTokenColorIndex() {
    if (!this.tokenColorIndex) {
      ...
      }), this.semanticTokenRules.forEach((t) => e.add(t.style.foreground)), me.getTokenStylingDefaultRules().forEach((t) => {
  ...
  getTokenStyleMetadata(e, t, n, o = !0, i = {}) {
    const { type: a, language: c } = Qe(e, n), h = this.getTokenStyle(a, t, c, o, i);
    if (h)
      return {
  ...
  resolveScopes(e, t) {
    this.themeTokenScopeMatchers || (this.themeTokenScopeMatchers = this.themeTokenColors.map(at)), this.customTokenScopeMatchers || (this.customTokenScopeMatchers = this.customTokenColors.map(at));
    for (const n of e) {
      let f = function(g, C) {
        for (let d = 0; d < g.length; d++) {
          ...
          if (p >= 0) {
            ...
            p >= a && S.foreground && (o = S.foreground, a = p, u = T), p >= c && O(S.fontStyle) && (i = S.fontStyle, c = p, h = T);
          }
        }
      }, o, i, a = -1, c = -1, h, u;
      if (f(this.themeTokenScopeMatchers, this.themeTokenColors), f(this.customTokenScopeMatchers, this.customTokenColors), o !== void 0 || i !== void 0)
        return t && (t.foreground = u, t.bold = t.italic = t.underline = t.strikethrough = h, t.scope = n), Se.fromSettings(o, i);
    }
  }
  defines(e) {
  ...
  setCustomColors(e) {
    ...
    ue(t) && this.overwriteCustomColors(t), this.tokenColorIndex = void 0, this.textMateThemingRules = void 0, this.customTokenScopeMatchers = void 0;
  }
  overwriteCustomColors(e) {
    for (const t in e) {
      const n = e[t];
      typeof n == "string" && (this.customColorMap[t] = Y.fromHex(n));
    }
  }
  setCustomTokenColors(e) {
    ...
    const t = this.getThemeSpecificColors(e);
    ue(t) && this.addCustomTokenColors(t), this.tokenColorIndex = void 0, this.textMateThemingRules = void 0, this.customTokenScopeMatchers = void 0;
  }
  setCustomSemanticTokenColors(e) {
    if (this.customSemanticTokenRules = [], this.customSemanticHighlighting = void 0, e) {
      ...
      const t = this.getThemeSpecificColors(e);
      ue(t) && (t.enabled !== void 0 && (this.customSemanticHighlighting = t.enabled), t.rules && this.readSemanticTokenRules(t.rules));
    }
    this.tokenColorIndex = void 0, this.textMateThemingRules = void 0;
  }
  isThemeScope(e) {
    return e.charAt(0) === yn && e.charAt(e.length - 1) === Cn;
  }
  isThemeScopeMatch(e) {
  ...
  addCustomTokenColors(e) {
    for (const t in ot) {
      const n = t, o = e[n];
      if (o) {
        const i = typeof o == "string" ? { foreground: o } : o, a = ot[n];
        for (const c of a)
  ...
  toStorage(e) {
    ...
    for (const o in this.colorMap)
      t[o] = Y.Format.CSS.formatHexA(this.colorMap[o], !0);
  ...
  static createUnloadedThemeForThemeType(e, t) {
    return H.createUnloadedTheme(Gt(e), t);
  }
  static createUnloadedTheme(e, t) {
    const n = new H(e, "", "__" + e);
    if (n.isLoaded = !1, n.themeTokenColors = [], n.watch = !1, t)
      for (const o in t)
        n.colorMap[o] = Y.fromHex(t[o]);
    return n;
  }
  ...
  static fromStorageData(e) {
    ...
    if (t)
      try {
        const n = JSON.parse(t), o = new H("", "", "");
        for (const i in n)
          switch (i) {
            case "colorMap": {
              const a = n[i];
              for (const c in a)
                o.colorMap[c] = Y.fromHex(a[c]);
              break;
            }
            ...
            case "semanticTokenRules": {
              ...
              if (Array.isArray(a))
                for (const c of a) {
                  const h = et.fromJSONObject(me, c);
  ...
  static fromExtensionTheme(e, t, n) {
    const o = e.uiTheme || "vs-dark", i = _n(n.extensionId, e.path), a = `${o} ${i}`, c = e.label || Fe(e.path), h = e.id || c, u = new H(a, c, h);
    return u.description = e.description, u.watch = e._watch === !0, u.location = t, u.extensionData = n, u.isLoaded = !1, u;
  }
}
H.STORAGE_KEY = "colorThemeData";
function _n(s, e) {
...
async function yt(s, e, t) {
  if (zt(e) === ".json") {
    const n = await s.readExtensionResource(e), o = [], i = Ne(n, o);
    if (o.length > 0)
    ...
    if (i.include && await yt(s, W(ye(e), i.include), t), Array.isArray(i.settings))
    ...
    if (a) {
      ...
      for (const u in a)
        typeof a[u] == "string" && (t.colors[u] = Y.fromHex(a[u]));
    }
...
function it(s, e, t) {
  return s.readExtensionResource(e).then((n) => {
    try {
      ...
      return Array.isArray(i) ? (Tt(i, t), Promise.resolve(null)) : Promise.reject(new Error(r(
...
function Ct(s, e) {
  const t = me.parseTokenSelector(s);
  let n;
  if (typeof e == "string" ? n = Se.fromSettings(e, void 0) : On(e) && (n = Se.fromSettings(e.foreground, e.fontStyle, e.bold, e.underline, e.strikethrough, e.italic)), n)
    return { selector: t, style: n };
}
function On(s) {
  return s && (O(s.foreground) || O(s.fontStyle) || ae(s.italic) || ae(s.underline) || ae(s.strikethrough) || ae(s.bold));
}
class Ln {
  constructor() {
...
function te(s) {
  if (!s)
    return;
  typeof s != "string" && (s = Y.Format.CSS.formatHexA(s, !0));
  const e = s.length;
  if (s.charCodeAt(0) !== 35 || e !== 4 && e !== 5 && e !== 7 && e !== 9)
    return;
  const t = [35];
  for (let n = 1; n < e; n++) {
    const o = Hn(s.charCodeAt(n));
    if (!o)
      return;
...
const Be = "^([\\w_-]+)$", qe = "^(normal|italic|(oblique[ \\w\\s-]+))$", Ve = "^(normal|bold|lighter|bolder|(\\d{0-1000}))$", ct = "^([\\w .%_-]+)$", Mn = "^woff|woff2|truetype|opentype|embedded-opentype|svg$", An = "vscode://schemas/product-icon-theme", Fn = {
  type: "object",
  allowComments: !0,
...
function Nn() {
  ne.as(je.JSONContribution).registerSchema(An, Fn);
}
...
function Un() {
  ne.as(je.JSONContribution).registerSchema($n, jn);
}
class P {
  constructor(e, t, n) {
  ...
  static fromExtensionTheme(e, t, n) {
    const o = n.extensionId + "-" + e.id, i = e.label || Fe(e.path), a = e.id, c = new P(o, i, a);
    return c.description = e.description, c.location = t, c.extensionData = n, c.watch = e._watch, c.isLoaded = !1, c;
  }
  static get noIconTheme() {
    let e = P._noIconTheme;
    return e || (e = P._noIconTheme = new P("", "", null), e.hasFileIcons = !1, e.hasFolderIcons = !1, e.hidesExplorerArrows = !1, e.isLoaded = !0, e.extensionData = void 0, e.watch = !1), e;
  }
  static createUnloadedTheme(e) {
    const t = new P(e, "", "__" + e);
    return t.isLoaded = !1, t.hasFileIcons = !1, t.hasFolderIcons = !1, t.hidesExplorerArrows = !1, t.extensionData = void 0, t.watch = !1, t;
  }
  static fromStorageData(e) {
    const t = e.get(P.STORAGE_KEY, 0);
    if (t)
      try {
        const n = JSON.parse(t), o = new P("", "", null);
        for (const i in n)
          switch (i) {
            case "id":
            case "label":
  ...
  toStorage(e) {
    ...
    e.store(P.STORAGE_KEY, t, 0, 1);
  }
}
P.STORAGE_KEY = "iconThemeData";
P._noIconTheme = null;
class Gn {
  constructor(e, t) {
  ...
  loadIconThemeDocument(e) {
    return this.fileService.readExtensionResource(e).then((t) => {
      ...
      ))) : $e(o) !== "object" ? Promise.reject(new Error(r(
        "error.invalidformat",
  ...
  processIconThemeDocument(e, t, n) {
    ...
    function f(T, S) {
      ...
      if (T) {
        ...
        S && (I = S + " " + I);
        const L = ".monaco-tl-twistie.collapsible:not(.collapsed) + .monaco-tl-contents";
        T.folder && (m(`${I} .folder-icon::before`, T.folder), o.hasFolderIcons = !0), T.folderExpanded && (m(`${I} ${L} .folder-icon::before`, T.folderExpanded), o.hasFolderIcons = !0);
        const b = T.rootFolder || T.folder, K = T.rootFolderExpanded || T.folderExpanded;
        b && (m(`${I} .rootfolder-icon::before`, b), o.hasFolderIcons = !0), K && (m(`${I} ${L} .rootfolder-icon::before`, K), o.hasFolderIcons = !0), T.file && (m(`${I} .file-icon::before`, T.file), o.hasFileIcons = !0);
        const N = T.folderNames;
        if (N)
          for (const _ in N) {
            const w = [], $ = he(_.toLowerCase(), w);
            w.push(`.${q($)}-name-folder-icon`), m(`${I} ${w.join("")}.folder-icon::before`, N[_]), o.hasFolderIcons = !0;
          }
        const z = T.folderNamesExpanded;
        if (z)
          for (const _ in z) {
            const w = [], $ = he(_.toLowerCase(), w);
            w.push(`.${q($)}-name-folder-icon`), m(`${I} ${L} ${w.join("")}.folder-icon::before`, z[_]), o.hasFolderIcons = !0;
          }
        const M = T.languageIds;
        if (M) {
          !M.jsonc && M.json && (M.jsonc = M.json);
          for (const _ in M)
            m(`${I} .${q(_)}-lang-file-icon.file-icon::before`, M[_]), o.hasFileIcons = !0, i = !0, c[_] = !0;
        }
        const ie = T.fileExtensions;
        if (ie)
          for (const _ in ie) {
            const w = [], j = he(_.toLowerCase(), w).split(".");
            if (j.length) {
              for (let U = 0; U < j.length; U++)
                w.push(`.${q(j.slice(U).join("."))}-ext-file-icon`);
              w.push(".ext-file-icon");
            }
            m(`${I} ${w.join("")}.file-icon::before`, ie[_]), o.hasFileIcons = !0, i = !0;
          }
        const ee = T.fileNames;
        if (ee)
          for (const _ in ee) {
            const w = [], $ = he(_.toLowerCase(), w);
            w.push(`.${q($)}-name-file-icon`), w.push(".name-file-icon");
            const j = $.split(".");
            if (j.length) {
            ...
            m(`${I} ${w.join("")}.file-icon::before`, ee[_]), o.hasFileIcons = !0, i = !0;
          }
      }
    }
    if (f(n), f(n.light, ".vs"), f(n.highContrast, ".hc-black"), f(n.highContrast, ".hc-light"), !o.hasFileIcons && !o.hasFolderIcons)
      return o;
    const g = n.showLanguageModeIcons === !0 || i && n.showLanguageModeIcons !== !1, C = [], d = n.fonts, p = /* @__PURE__ */ new Map();
    if (Array.isArray(d)) {
      const T = d[0].size || "150%";
      d.forEach((S) => {
        const m = S.src.map((I) => `${ce(u(I.path))} format('${I.format}')`).join(", ");
        C.push(`@font-face { src: ${m}; font-family: '${S.id}'; font-weight: ${S.weight}; font-style: ${S.style}; font-display: block; }`), S.size !== void 0 && S.size !== T && p.set(S.id, S.size);
    ...
    for (const T in a) {
      ...
      if (m) {
        if (m.iconPath)
          C.push(`${S.join(", ")} { content: ' '; background-image: ${ce(u(m.iconPath))}; }`);
        else if (m.fontCharacter || m.fontColor) {
          const I = [];
          m.fontColor && I.push(`color: ${m.fontColor};`), m.fontCharacter && I.push(`content: '${m.fontCharacter}';`);
          const L = m.fontSize ?? (m.fontId ? p.get(m.fontId) : void 0);
          L && I.push(`font-size: ${L};`), m.fontId && I.push(`font-family: ${m.fontId};`), g && I.push("background-image: unset;"), C.push(`${S.join(", ")} { ${I.join(" ")} }`);
        }
      }
    }
    if (g) {
      for (const T of this.languageService.getRegisteredLanguageIds())
        if (!c[T]) {
          ...
          if (S) {
            const m = `.show-file-icons .${q(T)}-lang-file-icon.file-icon::before`;
            C.push(`${m} { content: ' '; background-image: ${ce(S.dark)}; }`), C.push(`.vs ${m} { content: ' '; background-image: ${ce(S.light)}; }`);
          }
        }
    }
...
function he(s, e) {
  ...
  if (t >= 0) {
    ...
    return e.push(`.${q(n)}-name-dir-icon`), s.substring(t + 1);
  }
  return s;
}
function q(s) {
...
const lt = [
  ...
  "variable.parameter"
], ke = "vscode://schemas/textmate-colors", zn = `${ke}#/definitions/colorGroup`, Bn = {
  type: "array",
  definitions: {
    colorGroup: {
      default: "#FF0000",
...
}, qn = "vscode://schemas/color-theme", Vn = {
  type: "object",
  allowComments: !0,
  allowTrailingCommas: !0,
  properties: {
...
function Wn() {
  const s = ne.as(je.JSONContribution);
  s.registerSchema(qn, Vn), s.registerSchema(ke, Bn);
}
function Kn() {
  return Ge.registerExtensionPoint({
    ...
    jsonSchema: {
      ...
      items: {
        type: "object",
        defaultSnippets: [{ body: { label: "${1:label}", id: "${2:id}", uiTheme: Ce, path: "./themes/${3:id}.tmTheme." } }],
        properties: {
          id: {
            description: r(
...
class Re {
  constructor(e, t, n = !1, o = void 0) {
    this.themesExtPoint = e, this.create = t, this.idRequired = n, this.builtInTheme = o, this.onDidChangeEmitter = new fe(), this.onDidChange = this.onDidChangeEmitter.event, this.extensionThemes = [], this.initialize();
  }
  initialize() {
  ...
  onThemes(e, t, n, o = [], i) {
    return Array.isArray(n) ? (n.forEach((a) => {
      ...
      if (this.idRequired && (!a.id || !O(a.id))) {
        i == null || i.error(r(
          "reqid",
...
const oe = ne.as(qt.Configuration), Z = [], X = [], Q = [];
function G(s) {
  return `\`#${s}#\``;
}
const Zn = {
  ...
  default: gt ? v.COLOR_THEME_LIGHT : v.COLOR_THEME_DARK,
  enum: Z,
  enumDescriptions: Q,
  enumItemLabels: X,
  ...
  properties: {
    [y.COLOR_THEME]: Zn,
    [y.PREFERRED_DARK_THEME]: Xn,
    [y.PREFERRED_LIGHT_THEME]: Qn,
    [y.PREFERRED_HC_DARK_THEME]: eo,
    [y.PREFERRED_HC_LIGHT_THEME]: to,
    [y.FILE_ICON_THEME]: ge,
    [y.COLOR_CUSTOMIZATIONS]: St,
    [y.PRODUCT_ICON_THEME]: pe
  }
};
oe.registerConfiguration(we);
const io = {
  id: "window",
  order: 8.1,
  type: "object",
  properties: {
    [y.DETECT_HC]: oo,
    [y.DETECT_COLOR_SCHEME]: no
  }
};
oe.registerConfiguration(io);
function J(s) {
  return {
    description: s,
    $ref: zn
...
const ve = "^\\[[^\\]]*(\\]\\s*\\[[^\\]]*)*\\]$", It = {
  type: "object",
  properties: {
    comments: J(r("editorColors.comments", "Sets the colors and styles for comments")),
    strings: J(r("editorColors.strings", "Sets the colors and styles for strings literals.")),
    keywords: J(r("editorColors.keywords", "Sets the colors and styles for keywords.")),
    numbers: J(r("editorColors.numbers", "Sets the colors and styles for number literals.")),
    types: J(r(
      "editorColors.types",
  ...
  default: {},
  allOf: [{ ...Me, patternProperties: { "^\\[": {} } }]
}, kt = {
  id: "editor",
  order: 7.2,
  type: "object",
  properties: {
    [y.TOKEN_COLOR_CUSTOMIZATIONS]: bt,
    [y.SEMANTIC_TOKEN_COLOR_CUSTOMIZATIONS]: Et
  }
};
oe.registerConfiguration(kt);
function ht(s) {
  s.sort((a, c) => a.label.localeCompare(c.label)), Z.splice(0, Z.length, ...s.map((a) => a.settingsId)), Q.splice(0, Q.length, ...s.map((a) => a.description || "")), X.splice(0, X.length, ...s.map((a) => a.label || ""));
  const e = { properties: {} }, t = { properties: {} }, n = { properties: {} }, o = { $ref: Ue, additionalProperties: !1 }, i = { properties: It.properties, additionalProperties: !1 };
  for (const a of s) {
    const c = `[${a.settingsId}]`;
    e.properties[c] = o, t.properties[c] = i, n.properties[c] = Me;
  }
  e.patternProperties = { [ve]: o }, t.patternProperties = { [ve]: i }, n.patternProperties = { [ve]: Me }, St.allOf[1] = e, bt.allOf[1] = t, Et.allOf[1] = n, oe.notifyConfigurationSchemaUpdated(we, kt);
}
function dt(s) {
  ge.enum.splice(1, Number.MAX_VALUE, ...s.map((e) => e.settingsId)), ge.enumItemLabels.splice(1, Number.MAX_VALUE, ...s.map((e) => e.label)), ge.enumDescriptions.splice(1, Number.MAX_VALUE, ...s.map((e) => e.description || "")), oe.notifyConfigurationSchemaUpdated(we);
}
function ut(s) {
  pe.enum.splice(1, Number.MAX_VALUE, ...s.map((e) => e.settingsId)), pe.enumItemLabels.splice(1, Number.MAX_VALUE, ...s.map((e) => e.label)), pe.enumDescriptions.splice(1, Number.MAX_VALUE, ...s.map((e) => e.description || "")), oe.notifyConfigurationSchemaUpdated(we);
}
class so {
  constructor(e) {
  ...
  findAutoConfigurationTarget(e) {
    ...
    if (V(t.workspaceFolderValue))
      if (V(t.workspaceValue)) {
        if (!V(t.userRemote))
          return 4;
      } else
        return 5;
...
class D {
  ...
  getIcon(e) {
    return co(e, this.iconThemeDocument);
  }
  ensureLoaded(e, t) {
  ...
  async load(e, t) {
    ...
    const o = [];
    return this.iconThemeDocument = await ro(e, n, o), this.isLoaded = !0, o.length && t.error(r(
      "error.parseicondefs",
...
`)
  ...
  static fromExtensionTheme(e, t, n) {
    const o = n.extensionId + "-" + e.id, i = e.label || Fe(e.path), a = e.id, c = new D(o, i, a);
    return c.description = e.description, c.location = t, c.extensionData = n, c.watch = e._watch, c.isLoaded = !1, c;
  }
  static createUnloadedTheme(e) {
  ...
  static get defaultTheme() {
    ...
    return e || (e = D._defaultProductIconTheme = new D(Te, r("defaultTheme", "Default"), v.PRODUCT_ICON_THEME), e.isLoaded = !0, e.extensionData = void 0, e.watch = !1), e;
  }
  static fromStorageData(e) {
    ...
    if (t)
      try {
        ...
        if (Array.isArray(i) && ue(a)) {
          const c = /* @__PURE__ */ new Map();
          for (const h of i) {
            const { id: u, fontCharacter: f, fontId: g } = h;
            if (O(u) && O(f))
              if (O(g)) {
                const C = Je.fromJSONObject(a[g]);
                C && c.set(u, { fontCharacter: f, font: { id: g, definition: C } });
              } else
  ...
  toStorage(e) {
    ...
    for (const i of this.iconThemeDocument.iconDefinitions.entries()) {
      const a = i[1].font;
      t.push({ id: i[0], fontCharacter: i[1].fontCharacter, fontId: a == null ? void 0 : a.id }), a && n[a.id] === void 0 && (n[a.id] = Je.toJSONObject(a.definition));
    }
...
function ro(s, e, t) {
  return s.readExtensionResource(e).then((n) => {
    ...
    const a = ye(e), c = /* @__PURE__ */ new Map();
    for (const f of i.fonts)
      if (O(f.id) && f.id.match(Be)) {
        const g = f.id;
        let C;
        O(f.weight) && f.weight.match(Ve) ? C = f.weight : t.push(r(
          "error.fontWeight",
          "Invalid font weight in font '{0}'. Ignoring setting.",
          f.id
        ));
        let d;
        O(f.style) && f.style.match(qe) ? d = f.style : t.push(r(
          "error.fontStyle",
        ...
        if (Array.isArray(f.src))
          for (const T of f.src)
            if (O(T.path) && O(T.format) && T.format.match(Mn)) {
              const S = W(a, T.path);
              p.push({ location: S, format: T.format });
            } else
              t.push(r(
                "error.fontSrc",
        ...
        p.length ? c.set(g, { weight: C, style: d, src: p }) : t.push(r(
          "error.noFontSrc",
    ...
    for (const f in i.iconDefinitions) {
      ...
      if (O(g.fontCharacter)) {
        const C = g.fontId ?? u, d = c.get(C);
        if (d) {
          const p = { id: `pi-${C}`, definition: d };
...
const se = "osColorScheme", re = -1, de = "vscode-theme-defaults", _e = "vscode.vscode-theme-seti-vs-seti", ft = "file-icons-enabled", lo = "contributedColorTheme", ho = "contributedFileIconTheme", uo = "contributedProductIconTheme", mt = ne.as(Wt.ThemingContribution);
function fo(s) {
  switch (s) {
    case Ee:
      return `vs ${de}-themes-light_vs-json`;
    case Ce:
      return `vs-dark ${de}-themes-dark_vs-json`;
    case be:
      return `hc-black ${de}-themes-hc_black-json`;
    case Ie:
      return `hc-light ${de}-themes-hc_light-json`;
  }
  return s;
}
const mo = Kn(), go = Jn(), po = Yn();
let Ae = class {
  constructor(e, t, n, o, i, a, c, h, u, f, g, C) {
    var z;
    this.storageService = t, this.configurationService = n, this.telemetryService = o, this.environmentService = i, this.extensionResourceLoaderService = c, this.logService = u, this.hostColorService = f, this.hasDefaultUpdated = !1, this.themeExtensionsActivated = /* @__PURE__ */ new Map(), this.container = h.container, this.settings = new so(n), this.colorThemeRegistry = new Re(mo, H.fromExtensionTheme), this.colorThemeWatcher = new Pe(a, i, this.reloadCurrentColorTheme.bind(this)), this.onColorThemeChange = new fe({ leakWarningThreshold: 400 }), this.currentColorTheme = H.createUnloadedTheme(""), this.colorThemeSequencer = new xe(), this.fileIconThemeWatcher = new Pe(
      a,
      i,
      this.reloadCurrentFileIconTheme.bind(this)
    ), this.fileIconThemeRegistry = new Re(
      go,
      P.fromExtensionTheme,
      !0,
      P.noIconTheme
    ), this.fileIconThemeLoader = new Gn(c, C), this.onFileIconThemeChange = new fe({ leakWarningThreshold: 400 }), this.currentFileIconTheme = P.createUnloadedTheme(""), this.fileIconThemeSequencer = new xe(), this.productIconThemeWatcher = new Pe(
      a,
      i,
      this.reloadCurrentProductIconTheme.bind(this)
    ), this.productIconThemeRegistry = new Re(
      po,
      D.fromExtensionTheme,
      !0,
      D.defaultTheme
    ), this.onProductIconThemeChange = new fe(), this.currentProductIconTheme = D.createUnloadedTheme(""), this.productIconThemeSequencer = new xe();
    let d = H.fromStorageData(this.storageService);
    const p = this.settings.colorTheme;
    d && p !== d.settingsId && this.settings.isDefaultColorTheme() && (this.hasDefaultUpdated = d.settingsId === v.COLOR_THEME_DARK_OLD || d.settingsId === v.COLOR_THEME_LIGHT_OLD, d = void 0);
    const T = this.getPreferredColorScheme(), S = p === v.COLOR_THEME_LIGHT ? In : p === v.COLOR_THEME_DARK ? bn : void 0;
    if (T && (d == null ? void 0 : d.type) !== T && this.storageService.get(se, re) !== T && (d = H.createUnloadedThemeForThemeType(T, void 0)), !d) {
      const M = (z = i.options) == null ? void 0 : z.initialColorTheme;
      M && (d = H.createUnloadedThemeForThemeType(M.themeType, M.colors ?? S));
    }
    d || (d = H.createUnloadedThemeForThemeType(gt ? k.LIGHT : k.DARK, S)), d.setCustomizations(this.settings), this.applyTheme(d, void 0, !0);
    const m = P.fromStorageData(this.storageService);
    m && this.applyAndSetFileIconTheme(m, !0);
    const I = D.fromStorageData(this.storageService);
    I && this.applyAndSetProductIconTheme(I, !0), Promise.all([e.whenInstalledExtensionsRegistered(), g.whenInitializationFinished()]).then((M) => {
      this.installConfigurationListener(), this.installPreferredSchemeListener(), this.installRegistryListeners(), this.initialize().catch(cn);
    });
    const L = ln();
    L.id = "codiconStyles";
    const b = hn(this);
    function K() {
      L.textContent = b.getCSS();
    }
    const N = new dn(K, 0);
  ...
  initialize() {
    const e = this.environmentService.extensionDevelopmentLocationURI, t = e && e.length === 1 ? e[0] : void 0, n = async () => {
      ...
      const c = this.currentColorTheme.type === k.LIGHT ? v.COLOR_THEME_LIGHT : v.COLOR_THEME_DARK, h = this.colorThemeRegistry.findThemeBySettingsId(this.settings.colorTheme, c), u = this.getPreferredColorScheme(), f = this.storageService.get(se, re);
      return u !== f && (this.storageService.store(se, u, re, 0), u && (h == null ? void 0 : h.type) !== u) ? this.applyPreferredColorTheme(u) : this.setColorTheme(h && h.id, void 0);
    }, o = async () => {
      ...
      return this.setFileIconTheme(c ? c.id : _e, void 0);
    }, i = async () => {
      ...
      return this.setProductIconTheme(c ? c.id : Te, void 0);
    };
  ...
  installRegistryListeners() {
    ...
    this.colorThemeRegistry.onDidChange(async (o) => {
      if (ht(o.themes), await this.restoreColorTheme())
        this.currentColorTheme.settingsId === v.COLOR_THEME_DARK && !V(e) && await this.colorThemeRegistry.findThemeById(e) ? (await this.setColorTheme(e, "auto"), e = void 0) : o.added.some((i) => i.settingsId === this.currentColorTheme.settingsId) && await this.reloadCurrentColorTheme();
  ...
  async handlePreferredSchemeUpdated() {
    const e = this.getPreferredColorScheme(), t = this.storageService.get(se, re);
    if (e !== t) {
      if (this.storageService.store(se, e, re, 1), e)
  ...
  async getMarketplaceColorThemes(e, t, n) {
    ...
    if (o)
      try {
        const i = await this.extensionResourceLoaderService.readExtensionResource(W(o, "package.json"));
  ...
  updateDynamicCSSRules(e) {
    ...
    const o = [];
    for (const i of un().getColors()) {
      const a = e.getColor(i.id, !0);
      a && o.push(`${fn(i.id)}: ${a.toString()};`);
    }
...
`), lo);
  ...
  async internalSetFileIconTheme(e, t) {
    ...
    if (n !== this.currentFileIconTheme.id || !this.currentFileIconTheme.isLoaded) {
      ...
      !i && e instanceof P && (i = e), i || (i = P.noIconTheme), await i.ensureLoaded(this.fileIconThemeLoader), this.applyAndSetFileIconTheme(i);
    }
  ...
  applyAndSetFileIconTheme(e, t = !1) {
    this.currentFileIconTheme = e, De(e.styleSheetContent, ho), e.id ? this.container.classList.add(ft) : this.container.classList.remove(ft), this.fileIconThemeWatcher.update(e), e.id && this.sendTelemetry(e.id, e.extensionData, "fileIcon"), t || this.onFileIconThemeChange.fire(this.currentFileIconTheme);
  }
  ...
  applyAndSetProductIconTheme(e, t = !1) {
    this.currentProductIconTheme = e, De(e.styleSheetContent, uo), this.productIconThemeWatcher.update(e), e.id && this.sendTelemetry(e.id, e.extensionData, "productIcon"), t || this.onProductIconThemeChange.fire(this.currentProductIconTheme);
  }
};
Ae = Kt([
  A(0, Jt),
...
class Pe {
  ...
  update(e) {
    mn(e.location, this.watchedLocation) || (this.dispose(), e.location && (e.watch || this.environmentService.isExtensionDevelopment) && (this.watchedLocation = e.location, this.watcherDisposable = this.fileService.watch(e.location), this.fileService.onDidFilesChange((t) => {
