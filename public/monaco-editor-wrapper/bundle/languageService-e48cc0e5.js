import { iA as v, B as e, _ as L, a as c, a1 as S, aQ as _, od as I, aU as E, ua as A, ap as d, kr as k, ub as C, uc as j } from "./index-6dabdcd0.js";
const l = v.registerExtensionPoint({
  ...
  activationEventsGenerator: (i, s) => {
    for (const t of i)
      t.id && t.configuration && s.push(`onLanguage:${t.id}`);
  }
});
  ...
  constructor(s, t, r, g) {
    super(r.verbose || r.isExtensionDevelopment || !r.isBuilt), this.logService = g, this._configurationService = t, this._extensionService = s, l.setHandler((a) => {
      ...
      for (let u = 0, b = a.length; u < b; u++) {
        ...
        for (let p = 0, x = o.value.length; p < x; p++) {
          const n = o.value[p];
      ...
      a.affectsConfiguration(k) && this.updateMime();
