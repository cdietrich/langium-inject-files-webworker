...
class xn extends Cu {
  ...
  constructor(e, t, i, o, s) {
    super(e, i, o), this.options = t, this.layoutService = s, this._onDidVisibilityChange = this._register(new y()), this.onDidVisibilityChange = this._onDidVisibilityChange.event, this._onDidChange = this._register(new y()), s.registerPart(this);
  }
  onThemeChange(e) {
  ...
  create(e, t) {
    this.parent = e, this.titleArea = this.createTitleArea(e, t), this.contentArea = this.createContentArea(e, t), this.partLayout = new Dn(this.options, this.contentArea), this.updateStyles();
  }
  getContainer() {
    return this.parent;
  }
  ...
  layoutContents(e, t) {
    return j(this.partLayout).layout(e, t);
  }
  get onDidChange() {
    return this._onDidChange.event;
  }
  layout(e, t, i, o) {
    this._dimension = new G(e, t);
  }
  setVisible(e) {
...
class Dn {
  ...
  layout(e, t) {
    let i;
    this.options.hasTitle ? i = new G(e, Math.min(t, Dn.TITLE_HEIGHT)) : i = G.None;
    let o = e;
    this.options && typeof this.options.borderWidth == "function" && (o -= this.options.borderWidth());
    const s = new G(o, t - i.height);
    return this.contentArea && Su(this.contentArea, s.width, s.height), { titleSize: i, contentSize: s };
  }
}
Dn.TITLE_HEIGHT = 35;
class dh extends xn {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E) {
    super(C, E, a, t, s), this.notificationService = e, this.storageService = t, this.telemetryService = i, this.contextMenuService = o, this.keybindingService = n, this.instantiationService = r, this.registry = d, this.activeCompositeSettingsKey = l, this.defaultCompositeId = u, this.nameForTelemetry = g, this.compositeCSSClass = m, this.titleForegroundColor = f, this.onDidCompositeOpen = this._register(new y()), this.onDidCompositeClose = this._register(new y()), this.mapCompositeToCompositeContainer = /* @__PURE__ */ new Map(), this.mapActionsBindingToComposite = /* @__PURE__ */ new Map(), this.instantiatedCompositeItems = /* @__PURE__ */ new Map(), this.telemetryActionsListener = this._register(new je()), this.lastActiveCompositeId = t.get(l, 1, this.defaultCompositeId);
  }
  openComposite(e, t) {
    var i;
  ...
  createComposite(e, t) {
    ...
    if (o) {
      const s = this, n = new _u(
        j(this.progressBar),
        new class extends ku {
          constructor() {
            super(o.id, !!t), this._register(s.onDidCompositeOpen.event((l) => this.onScopeOpened(l.composite.getId()))), this._register(s.onDidCompositeClose.event((l) => this.onScopeClosed(l.getId())));
          }
        }()
      ), r = this.instantiationService.createChild(new vd(
        [ga, n]
      )), a = o.instantiate(r), d = new A();
  ...
  showComposite(e) {
    ...
    if (i || (i = z(".composite"), i.classList.add(...this.compositeCSSClass.split(" ")), i.id = e.getId(), e.create(i), e.updateStyles(), this.mapCompositeToCompositeContainer.set(e.getId(), i)), !this.activeComposite || e.getId() !== this.activeComposite.getId())
      return;
    const o = this.getContentArea();
    o == null || o.appendChild(i), go(i);
    const s = j(this.toolBar);
    ...
    r || (r = this.collectCompositeActions(e), this.mapActionsBindingToComposite.set(e.getId(), r)), r(), this.telemetryActionsListener.value = s.actionRunner.onDidRun((a) => {
      a.error && !Gi(a.error) && this.notificationService.error(a.error), this.telemetryService.publicLog2("workbenchActionExecuted", { id: a.action.id, from: this.nameForTelemetry });
  ...
  updateTitle(e, t) {
    ...
    this.titleLabel.updateTitle(e, t, Bt(o == null ? void 0 : o.getLabel())), j(this.toolBar).setAriaLabel(p("ariaCompositeToolbarLabel", "{0} actions", t));
  }
  collectCompositeActions(e) {
    const t = e == null ? void 0 : e.getMenuIds(), i = (e == null ? void 0 : e.getActions().slice(0)) || [], o = (e == null ? void 0 : e.getSecondaryActions().slice(0)) || [], s = j(this.toolBar);
    return s.context = this.actionsContextProvider(), () => s.setActions(no(i), no(o), t);
  }
  getActiveComposite() {
  ...
  hideActiveComposite() {
    ...
    return e.setVisible(!1), t && (t.remove(), mo(t)), (i = this.progressBar) == null || i.stop().hide(), this.toolBar && this.collectCompositeActions()(), this.onDidCompositeClose.fire(e), e;
  }
  createTitleArea(e) {
    const t = se(e, z(".composite"));
    t.classList.add("title"), this.titleLabel = this.createTitleLabel(t);
    const i = se(t, z(".title-actions"));
    return this.toolBar = this._register(this.instantiationService.createInstance(wd, i, {
      ...
      toggleMenuTitle: p("viewsAndMoreActions", "Views and More Actions...")
    })), this.collectCompositeActions()(), t;
  }
  createTitleLabel(e) {
    const t = se(e, z(".title-label")), i = se(t, z("h2"));
    this.titleLabelElement = i;
    const o = this;
    return {
      updateTitle: (s, n, r) => {
        (!this.activeComposite || this.activeComposite.getId() === s) && (i.innerText = n, i.title = r ? p("titleTooltip", "{0} ({1})", n, r) : n);
      },
      updateStyles: () => {
  ...
  updateStyles() {
    super.updateStyles(), j(this.titleLabel).updateStyles();
  }
  actionViewItemProvider(e) {
    return this.activeComposite ? this.activeComposite.getActionViewItem(e) : un(this.instantiationService, e);
  }
  actionsContextProvider() {
    return this.activeComposite ? this.activeComposite.getActionsContext() : null;
  }
  createContentArea(e) {
    const t = se(e, z(".content"));
    return this.progressBar = this._register(new yd(t, Cd)), this.progressBar.hide(), t;
  }
  ...
  layout(e, t, i, o) {
    var s;
    super.layout(e, t, i, o), this.contentAreaSize = G.lift(super.layoutContents(e, t).contentSize), (s = this.activeComposite) == null || s.layout(this.contentAreaSize);
  }
  setBoundarySashes(e) {
    var t;
  ...
  removeComposite(e) {
    ...
    const t = this.instantiatedCompositeItems.get(e);
    return t && (t.composite.dispose(), ue(t.disposable), this.instantiatedCompositeItems.delete(e)), !0;
  }
  dispose() {
    this.mapCompositeToCompositeContainer.clear(), this.mapActionsBindingToComposite.clear(), this.instantiatedCompositeItems.forEach((e) => {
      e.composite.dispose(), ue(e.disposable);
    }), this.instantiatedCompositeItems.clear(), super.dispose();
  }
}
let Ys = class lh extends dh {
  get preferredWidth() {
  ...
  createTitleArea(e) {
    ...
    this._register(w(t, S.CONTEXT_MENU, (o) => {
      this.onTitleAreaContextMenu(new _t(o));
    })), this._register(ii.addTarget(t)), this._register(w(t, Te.Contextmenu, (o) => {
      this.onTitleAreaContextMenu(new _t(o));
    })), this.titleLabelElement.draggable = !0;
    const i = () => ({ type: "composite", id: this.getActivePaneComposite().getId() });
    return this._register(Mo.INSTANCE.registerDraggable(this.titleLabelElement, i, {})), t;
  }
  updateStyles() {
    super.updateStyles();
    const e = j(this.getContainer());
    e.style.backgroundColor = this.getColor(sr) || "", e.style.color = this.getColor(Au) || "";
    const t = this.getColor(bc) || this.getColor(ot), i = this.layoutService.getSideBarPosition() === 0;
    e.style.borderRightWidth = t && i ? "1px" : "", e.style.borderRightStyle = t && i ? "solid" : "", e.style.borderRightColor = i && t || "", e.style.borderLeftWidth = t && !i ? "1px" : "", e.style.borderLeftStyle = t && !i ? "solid" : "", e.style.borderLeftColor = i ? "" : t || "", e.style.outlineColor = this.getColor(Tu) ?? "";
  }
  layout(e, t, i, o) {
  ...
  onTitleAreaContextMenu(e) {
    ...
    if (t) {
      ...
      if (i.length) {
        const o = { x: e.posx, y: e.posy };
        this.contextMenuService.showContextMenu({
          getAnchor: () => o,
          getActions: () => i.slice(),
          getActionViewItem: (s) => this.actionViewItemProvider(s),
...
Ys.activeViewletSettingsKey = "workbench.sidebar.activeviewletid";
Ys = x([
  h(0, Be),
  h(1, Se),
  h(2, Ye),
...
const Xa = "viewsLog", hh = p("views log", "Views");
function Ja(c) {
  return No(c.windowLogsPath, "views.log");
}
te(class extends qe {
  constructor() {
    super({
      ...
      category: ve.Developer,
      f1: !0
    });
  }
  async run(c) {
    const e = c.get(ma), t = c.get(Vu), i = c.get(Ut);
    e.setVisibility(Ja(i), !0), t.showChannel(Xa);
  }
});
function uh(c) {
  return `${c}.hidden`;
}
let Er = class extends R {
  constructor(e, t, i, o, s) {
    super(), this.viewContainerName = t, this.storageService = i, this._onDidChangeStoredState = this._register(new y()), this.onDidChangeStoredState = this._onDidChangeStoredState.event, this.logger = o.createLogger(Ja(s), { id: Xa, name: hh, hidden: !0 }), this.globalViewsStateStorageId = uh(e), this.workspaceViewsStateStorageId = e, this._register(this.storageService.onDidChangeValue((n) => this.onDidStorageChange(n))), this.state = this.initialize();
  }
  set(e, t) {
    this.state.set(e, t);
  }
      ...
      for (const [s, n] of t) {
        ...
        if (r)
          ...
          this.set(s, {
            ...
            visibleWorkspace: Vi(a == null ? void 0 : a.isHidden) ? void 0 : !(a != null && a.isHidden),
  ...
  initialize() {
    ...
    for (const r of Object.keys(t)) {
      ...
      e.set(r, {
        ...
        visibleWorkspace: Vi(a.isHidden) ? void 0 : !a.isHidden,
    ...
    if (o.size > 0) {
      for (const { id: r, isHidden: a } of o.values()) {
        const d = e.get(r);
        d ? Vi(d.visibleWorkspace) && (d.visibleWorkspace = !a) : e.set(r, {
          active: !1,
          collapsed: void 0,
          visibleGlobal: void 0,
          visibleWorkspace: !a
    ...
    for (const { id: r, isHidden: a, order: d } of s.values()) {
      const l = e.get(r);
      l ? (l.visibleGlobal = !a, Vi(d) || (l.order = d)) : e.set(r, {
        active: !1,
        visibleGlobal: !a,
        order: d,
        collapsed: void 0,
...
let _r = class extends R {
  ...
  updateContainerInfo() {
    ...
    const o = e ? this.viewContainer.icon : ((l = this.visibleViewDescriptors[0]) == null ? void 0 : l.containerIcon) || Sd;
    let s = !1;
    this.isEqualIcon(o) || (this._icon = o, s = !0);
    const n = ((u = this.viewContainer.openCommandActionDescriptor) == null ? void 0 : u.id) ?? ((m = (g = this.activeViewDescriptors.find((f) => f.openCommandActionDescriptor)) == null ? void 0 : g.openCommandActionDescriptor) == null ? void 0 : m.id);
    let r = !1;
    this._keybindingId !== n && (this._keybindingId = n, r = !0), (i || s || r) && this._onDidChangeContainerInfo.fire({ title: i, icon: s, keybindingId: r });
  }
  isEqualIcon(e) {
    return P.isUri(e) ? P.isUri(this._icon) && Qt(e, this._icon) : me.isThemeIcon(e) ? me.isThemeIcon(this._icon) && me.isEqual(e, this._icon) : e === this._icon;
  }
  isVisible(e) {
  ...
  updateVisibility(e) {
    const t = et(e.filter(({ visible: s }) => !s).map(({ id: s }) => this.findAndIgnoreIfNotFound(s))), i = [];
  ...
  move(e, t) {
    ...
    Pu(this.viewDescriptorItems, i, o);
  ...
  add(e) {
    ...
    for (const s of e) {
      ...
      if (r) {
        if (n.workspace)
          r.visibleWorkspace = Ze(s.visible) ? Ze(r.visibleWorkspace) ? !n.hideByDefault : r.visibleWorkspace : s.visible;
        else {
          const a = r.visibleGlobal;
          r.visibleGlobal = Ze(s.visible) ? Ze(r.visibleGlobal) ? !n.hideByDefault : r.visibleGlobal : s.visible, r.visibleGlobal && !a && this.logger.info(`Added view ${n.id} in the container ${this.viewContainer.id} and showing it.`, `${a}`, `${n.hideByDefault}`, `${s.visible}`);
        }
        r.collapsed = Ze(s.collapsed) ? Ze(r.collapsed) ? !!n.collapsed : r.collapsed : s.collapsed;
      } else
        r = {
          active: !1,
          visibleGlobal: Ze(s.visible) ? !n.hideByDefault : s.visible,
          visibleWorkspace: Ze(s.visible) ? !n.hideByDefault : s.visible,
          collapsed: Ze(s.collapsed) ? !!n.collapsed : s.collapsed
        };
...
let $o = class qt extends R {
  ...
  migrateToViewsCustomizationsStorage() {
    if (this.storageService.get(qt.VIEWS_CUSTOMIZATIONS, 0))
      return;
    ...
    this.storageService.store(qt.VIEWS_CUSTOMIZATIONS, JSON.stringify(s), 0, 0), this.storageService.remove("views.cachedViewContainerLocations", 0), this.storageService.remove("views.cachedViewPositions", 0);
  }
  ...
  isGeneratedContainerId(e) {
    return e.startsWith(qt.COMMON_CONTAINER_ID_PREFIX);
  }
  ...
  reportMovedViews(e, t, i) {
    const o = (g) => g.id.startsWith(qt.COMMON_CONTAINER_ID_PREFIX) ? "custom" : g.extensionId ? "extension" : g.id, s = this.getViewContainerLocation(t), n = this.getViewContainerLocation(i), r = e.length, a = o(t), d = o(i), l = s === 1 ? "panel" : "sidebar", u = n === 1 ? "panel" : "sidebar";
    this.telemetryService.publicLog2("viewDescriptorService.moveViews", { viewCount: r, fromContainer: a, toContainer: d, fromLocation: l, toLocation: u });
  }
  moveViewsWithoutSaving(e, t, i, o = So.Expand) {
  ...
  cleanUpGeneratedViewContainer(e) {
    ...
    t && ((i = this.getViewContainerModel(t)) != null && i.allViewDescriptors.length) || [...this.viewDescriptorsCustomLocations.values()].includes(e) || (t && this.viewContainersRegistry.deregisterViewContainer(t), this.viewContainersCustomLocations.delete(e), this.viewContainerBadgeEnablementStates.delete(e), this.storageService.remove(uh((t == null ? void 0 : t.storageId) || td(e)), 0));
  }
  registerGeneratedViewContainer(e, t) {
    const i = t || this.generateContainerId(e), o = this.viewContainersRegistry.registerViewContainer({
      id: i,
      ctorDescriptor: new J(fa, [i, { mergeViewWithContainerWhenSingleView: !0 }]),
      title: i,
      icon: e === 0 ? Sd : void 0,
      storageId: td(i),
      hideIfEmpty: !0
  ...
  onDidStorageChange(e) {
    e.key === qt.VIEWS_CUSTOMIZATIONS && e.scope === 0 && JSON.stringify(this.viewCustomizations) !== this.getStoredViewCustomizationsValue() && this.onDidViewCustomizationsStorageChange();
  }
  ...
  getStoredViewCustomizationsValue() {
    return this.storageService.get(qt.VIEWS_CUSTOMIZATIONS, 0, "{}");
  }
  setStoredViewCustomizationsValue(e) {
    this.storageService.store(qt.VIEWS_CUSTOMIZATIONS, e, 0, 0);
  }
  ...
  registerViewsVisibilityActionsForContainer(e) {
    ...
    return e.activeViewDescriptors.forEach((i, o) => {
      i.remoteAuthority || (t.add(te(class extends yc {
        constructor() {
          super({
            id: `${i.id}.toggleVisibility`,
            viewPaneContainerId: e.viewContainer.id,
            precondition: i.canToggleVisibility && (!e.isVisible(i.id) || e.visibleViewDescriptors.length > 1) ? v.true() : v.false(),
            toggled: v.has(`${i.id}.visible`),
            title: i.name,
            menu: [{
              id: Lu,
              group: "1_toggleViews",
              when: v.and(v.equals("viewContainer", e.viewContainer.id), v.equals(
                "viewContainerLocation",
                wc(0)
              )),
              order: o
            }, {
              id: b.ViewContainerTitleContext,
              when: v.and(v.equals("viewContainer", e.viewContainer.id)),
              order: o,
              group: "1_toggleVisibility"
            }, {
              id: b.ViewTitleContext,
              when: v.and(e.visibleViewDescriptors.length > 1 ? v.or(...e.visibleViewDescriptors.map((s) => v.equals("view", s.id))) : v.false()),
              order: o,
      ...
      })), t.add(te(class extends yc {
        constructor() {
          super({
            id: `${i.id}.removeView`,
            viewPaneContainerId: e.viewContainer.id,
            title: p("hideView", "Hide '{0}'", i.name),
            precondition: i.canToggleVisibility && (!e.isVisible(i.id) || e.visibleViewDescriptors.length > 1) ? v.true() : v.false(),
            menu: [{
              id: b.ViewTitleContext,
              when: v.and(v.equals("view", i.id), v.has(`${i.id}.visible`)),
              group: "1_hide",
              order: 1
            }]
          });
    ...
    return te(class extends qe {
      constructor() {
        super({
          ...
          menu: [{
            id: b.ViewContainerTitleContext,
            when: v.or(v.and(v.equals("viewContainer", e.id), v.equals(`${e.id}.defaultViewContainerLocation`, !1)))
          }]
        });
      }
      run() {
  ...
  addViews(e, t, i = So.Default) {
    this.contextKeyService.bufferChangeEvents(() => {
      ...
      viewDescriptor: o,
      collapsed: i === So.Default ? void 0 : !1,
      visible: i === So.Default ? void 0 : !0
    })));
  }
  removeViews(e, t) {
    this.contextKeyService.bufferChangeEvents(() => {
  ...
  getOrCreateActiveViewContextKey(e) {
    ...
    return i || (i = new N(t, !1).bindTo(this.contextKeyService), this.activeViewContextKeys.set(t, i)), i;
  }
  ...
  getOrCreateMovableViewContextKey(e) {
    ...
    return i || (i = new N(t, !1).bindTo(this.contextKeyService), this.movableViewContextKeys.set(t, i)), i;
  }
  getOrCreateDefaultViewLocationContextKey(e) {
    ...
    return i || (i = new N(t, !1).bindTo(this.contextKeyService), this.defaultViewLocationContextKeys.set(t, i)), i;
  }
  getOrCreateDefaultViewContainerLocationContextKey(e) {
    ...
    return i || (i = new N(t, !1).bindTo(this.contextKeyService), this.defaultViewContainerLocationContextKeys.set(t, i)), i;
  }
};
$o.VIEWS_CUSTOMIZATIONS = "views.customizations";
$o.COMMON_CONTAINER_ID_PREFIX = "workbench.views.service";
$o = x([
  h(0, D),
  h(1, H),
  h(2, Se),
...
const Di = "workbench.action.globalActivity", Ns = "workbench.action.accountsActivity";
let kr = class extends R {
  constructor(e, t, i) {
    super(), this.viewId = e, this.viewDescriptorService = t, this.activityService = i, this.activity = void 0, this.activityDisposable = R.None, this._register(I.filter(this.viewDescriptorService.onDidChangeContainer, (o) => o.views.some((s) => s.id === e))(() => this.update())), this._register(I.filter(this.viewDescriptorService.onDidChangeLocation, (o) => o.views.some((s) => s.id === e))(() => this.update()));
  }
  setActivity(e) {
...
let xr = class {
  ...
  showViewActivity(e, t) {
    ...
    i ? i.id++ : (i = {
      id: 1,
      activity: this.instantiationService.createInstance(kr, e)
  ...
  showAccountsActivity({ badge: e, clazz: t, priority: i }) {
    return this.paneCompositeService.showActivity(Ns, 0, e, t, i);
  }
  showGlobalActivity({ badge: e, clazz: t, priority: i }) {
    return this.paneCompositeService.showActivity(Di, 0, e, t, i);
  }
};
xr = x([
  h(0, zi),
...
let jo = class ph extends Ms {
  ...
  async run(e) {
    if (e instanceof MouseEvent && e.button === 2)
      return;
    const t = Date.now();
    if (t > this.lastRun && t - this.lastRun < ph.preventDoubleClickDelay)
      return;
    this.lastRun = t;
...
jo.preventDoubleClickDelay = 300;
jo = x([
  h(2, pt),
  h(3, Ye),
  h(4, L)
], jo);
let Dr = class extends Sb {
  constructor(e, t, i, o, s, n, r, a, d, l, u) {
    super(e, i, () => !0, o, s, d, u), this.contextMenuActionsProvider = t, this.menuService = n, this.contextMenuService = r, this.contextKeyService = a, this.environmentService = l;
  }
  render(e) {
    super.render(e), this._register(w(this.container, S.MOUSE_DOWN, async (t) => {
      K.stop(t, !0), (t == null ? void 0 : t.button) !== 2 && this.run();
    })), this._register(w(this.container, S.CONTEXT_MENU, async (t) => {
      const i = new A(), o = await this.resolveContextMenuActions(i), s = new _t(t), n = {
        x: s.posx,
        y: s.posy
      };
      this.contextMenuService.showContextMenu({
    ...
    })), this._register(w(this.container, S.KEY_UP, (t) => {
      const i = new Ct(t);
      (i.equals(3) || i.equals(10)) && (K.stop(t, !0), this.run());
    })), this._register(w(this.container, Te.Tap, (t) => {
      K.stop(t, !0), this.run();
    }));
  }
...
let Xs = class extends Dr {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f) {
    super(t, i, { draggable: !1, colors: s, icon: o, hasPopup: !0, hoverOptions: n }, r, a, d, l, u, g, m, f), this.menuId = e;
  }
  async run() {
    const e = new A(), t = e.add(this.menuService.createMenu(this.menuId, this.contextKeyService)), i = await this.resolveMainMenuActions(t, e);
    this.contextMenuService.showContextMenu({
  ...
  async resolveMainMenuActions(e, t) {
    const i = [];
    return Ui(e, { renderShortTitle: !0 }, { primary: [], secondary: i }), i;
  }
};
Xs = x([
  h(6, X),
...
let Pi = class gh extends Xs {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E, V) {
    super(b.AccountsContext, e, t, !0, i, o, s, n, a, r, d, m, u, C), this.authenticationService = l, this.productService = g, this.storageService = f, this.credentialsService = E, this.logService = V, this.groupedAccounts = /* @__PURE__ */ new Map(), this.problematicProviders = /* @__PURE__ */ new Set(), this.initialized = !1, this.sessionFromEmbedder = Ob(this.credentialsService, this.productService), this.registerListeners(), this.initialize();
  }
  registerListeners() {
  ...
  async resolveMainMenuActions(e, t) {
    ...
    for (const n of i) {
      if (!this.initialized) {
        const d = t.add(new ke("noAccountsAvailable", p("loading", "Loading..."), void 0, !1));
        s.push(d);
        break;
      }
      ...
      if (!a) {
        if (this.problematicProviders.has(n)) {
          const d = t.add(new ke("providerUnavailable", p("authProviderUnavailable", "{0} is currently unavailable", r), void 0, !1));
          s.push(d);
          try {
      ...
      for (const d of a) {
        const u = [t.add(new ke(`configureSessions${d.label}`, p("manageTrustedExtensions", "Manage Trusted Extensions"), void 0, !0, () => this.authenticationService.manageTrustedExtensionsForAccount(n, d.label)))];
        if (d.canSignOut) {
          const m = t.add(new ke("signOut", p("signOut", "Sign Out"), void 0, !0, async () => {
            const C = (await this.authenticationService.getSessions(n)).filter((E) => E.account.id === d.id);
            return await this.authenticationService.removeAccountSessions(n, d.label, C);
          }));
          u.push(m);
        }
        const g = new ao(
    ...
    if (i.length && !s.length) {
      const n = t.add(new ke("noAccountsAvailable", p("noAccounts", "You are not signed in to any accounts"), void 0, !1));
      s.push(n);
    }
    return s.length && o.length && s.push(new Fe()), o.forEach((n, r) => {
      const a = n[1];
      s = s.concat(a), r !== o.length - 1 && s.push(new Fe());
    }), s;
  }
  async resolveContextMenuActions(e) {
    const t = await super.resolveContextMenuActions(e);
    return t.unshift(Ne({ id: "hideAccounts", label: p("hideAccounts", "Hide Accounts"), run: () => this.storageService.store(gh.ACCOUNTS_VISIBILITY_PREFERENCE_KEY, !1, 0, 0) }), new Fe()), t;
  }
...
Pi.ACCOUNTS_VISIBILITY_PREFERENCE_KEY = "workbench.activity.showAccounts";
Pi = x([
  h(4, X),
  h(5, gt),
  h(6, xe),
...
let Ir = class extends Xs {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m) {
    super(b.GlobalActivity, e, t, !0, i, o, n, r, a, d, l, u, g, m), this.userDataProfileService = s, this._register(I.any(this.userDataProfileService.onDidUpdateCurrentProfile, this.userDataProfileService.onDidChangeCurrentProfile)(() => this.updateProfileBadge()));
  }
  render(e) {
    super.render(e), this.profileBadge = se(e, z(".profile-badge")), this.profileBadgeContent = se(this.profileBadge, z(".profile-badge-content")), this.updateProfileBadge();
  }
  updateProfileBadge() {
    !this.profileBadge || !this.profileBadgeContent || (oi(this.profileBadgeContent), mo(this.profileBadge), !this.userDataProfileService.currentProfile.isDefault && (this.action.getBadge() || (this.profileBadgeContent.textContent = this.userDataProfileService.currentProfile.name.substring(0, 2).toUpperCase(), go(this.profileBadge))));
  }
  updateBadge() {
    super.updateBadge(), this.updateProfileBadge();
  }
  computeTitle() {
    return this.userDataProfileService.currentProfile.isDefault ? super.computeTitle() : p(
      "manage",
      "Manage {0} (Profile)",
...
class fh extends qe {
  ...
  async run(e) {
    const t = e.get(zi), i = t.getVisiblePaneCompositeIds(0), o = t.getActivePaneComposite(0);
    if (!o)
      return;
    let s;
...
te(class extends fh {
  constructor() {
    super({
      ...
      title: { value: p("previousSideBarView", "Previous Primary Side Bar View"), original: "Previous Primary Side Bar View" },
      category: ve.View,
      f1: !0
    }, -1);
  }
...
te(class extends fh {
  constructor() {
    super({
      ...
      title: { value: p("nextSideBarView", "Next Primary Side Bar View"), original: "Next Primary Side Bar View" },
      category: ve.View,
      f1: !0
    }, 1);
  }
...
te(class extends qe {
  constructor() {
    super({
      ...
      title: { value: p("focusActivityBar", "Focus Activity Bar"), original: "Focus Activity Bar" },
      category: ve.View,
      f1: !0
    });
  }
...
ba((c, e) => {
  const t = c.getColor(_d);
  t && e.addRule(`
			.monaco-workbench .activitybar > .content :not(.monaco-menu) > .monaco-action-bar .action-item.checked .active-item-indicator:before {
				border-left-color: ${t};
			}
		`);
  const i = c.getColor(Fu);
  i && e.addRule(`
...
let Js = class extends va {
  constructor(e, t, i, o, s) {
    super(), this.options = t, this.instantiationService = i, this.contextMenuService = o, this.viewDescriptorService = s, this._onDidChange = this._register(new y()), this.onDidChange = this._onDidChange.event, this.model = new Bb(e, t), this.visibleComposites = [], this.compositeSizeInBar = /* @__PURE__ */ new Map(), this.computeSizes(this.model.visibleItems);
  }
  ...
  create(e) {
    const t = e.appendChild(z(".composite-bar"));
    this.compositeSwitcherBar = this._register(new vo(t, {
      actionViewItemProvider: (o) => {
        if (o instanceof Yc)
          return this.compositeOverflowActionViewItem;
        const s = this.model.findItem(o.id);
        return s && this.instantiationService.createInstance(Eb, { draggable: !0, colors: this.options.colors, icon: this.options.icon, hoverOptions: this.options.activityHoverOptions }, o, s.pinnedAction, s.toggleBadgeAction, (n) => this.options.getContextMenuActionsForComposite(n), () => this.getContextMenuActions(), this.options.dndHandler, this);
      },
      orientation: this.options.orientation,
      ariaLabel: p("activityBarAriaLabel", "Active View Switcher"),
      ariaRole: "tablist",
      animated: !1,
      preventLoopNavigation: this.options.preventLoopNavigation,
      triggerKeys: { keyDown: !0 }
    })), this._register(w(e, S.CONTEXT_MENU, (o) => this.showContextMenu(o))), this._register(ii.addTarget(e)), this._register(w(e, Te.Contextmenu, (o) => this.showContextMenu(o)));
    let i;
    return this._register(Mo.INSTANCE.registerTarget(e, {
      onDragOver: (o) => {
        const s = this.getVisibleComposites();
        if (!s.length || o.eventData.target && Ht(o.eventData.target, t)) {
        ...
        xd(o.eventData.dataTransfer, "move", a), i = this.updateFromDragging(e, a, n, !0);
      },
      onDragLeave: (o) => {
  ...
  showActivity(e, t, i, o) {
    ...
    return this.model.addActivity(e, s), ie(() => this.model.removeActivity(e, s));
  }
  async pin(e, t) {
  ...
  updateCompositeSwitcher() {
    ...
    if (!e || !this.dimension)
      return;
    let t = this.model.visibleItems.filter((l) => l.pinned || this.model.activeItem && this.model.activeItem.id === l.id).map((l) => l.id), i = t.length;
    const o = t.length;
    let s = 0;
    const n = this.options.orientation === 1 ? this.dimension.height : this.dimension.width;
    for (let l = 0; l < t.length; l++) {
      const u = this.compositeSizeInBar.get(t[l]);
      if (s + u > n) {
        i = l;
        break;
      }
    ...
    for (o > i && (t = t.slice(0, i)), this.model.activeItem && t.every((l) => !!this.model.activeItem && l !== this.model.activeItem.id) && (s += this.compositeSizeInBar.get(this.model.activeItem.id), t.push(this.model.activeItem.id)); s > n && t.length; ) {
      const l = t.length > 1 ? t.splice(t.length - 2, 1)[0] : t.pop();
      s -= this.compositeSizeInBar.get(l);
    }
    for (o > t.length && (s += this.options.overflowActionSize); s > n && t.length; ) {
      const l = t.length > 1 && t[t.length - 1] === ((a = this.model.activeItem) == null ? void 0 : a.id) ? t.splice(t.length - 2, 1)[0] : t.pop();
      s -= this.compositeSizeInBar.get(l);
    }
    ...
    const r = [];
    this.visibleComposites.forEach((l, u) => {
      t.includes(l) || r.push(u);
    }), r.reverse().forEach((l) => {
      const u = e.viewItems[l];
      e.pull(l), u.dispose(), this.visibleComposites.splice(l, 1);
    }), t.forEach((l, u) => {
      const g = this.visibleComposites.indexOf(l);
      if (u !== g) {
        if (g !== -1) {
          const m = e.viewItems[g];
          e.pull(g), m.dispose(), this.visibleComposites.splice(g, 1);
        }
        e.push(this.model.findItem(l).activityAction, { label: !0, icon: this.options.icon, index: u }), this.visibleComposites.splice(u, 0, l);
      }
    }), o > t.length && !this.compositeOverflowAction && (this.compositeOverflowAction = this.instantiationService.createInstance(Yc, () => {
      var l;
      (l = this.compositeOverflowActionViewItem) == null || l.showMenu();
    }), this.compositeOverflowActionViewItem = this.instantiationService.createInstance(_b, this.compositeOverflowAction, () => this.getOverflowingComposites(), () => this.model.activeItem ? this.model.activeItem.id : void 0, (l) => {
      var g;
      const u = this.model.findItem(l);
      return (g = u == null ? void 0 : u.activity[0]) == null ? void 0 : g.badge;
  ...
  showContextMenu(e) {
    ...
    const t = new _t(e);
    this.contextMenuService.showContextMenu({
      getAnchor: () => ({ x: t.posx, y: t.posy }),
      getActions: () => this.getContextMenuActions(e)
    });
  }
  getContextMenuActions(e) {
    return this.model.visibleItems.map(({ id: i, name: o, activityAction: s }) => Ne({
      id: i,
...
class Bb {
  ...
  add(e, t, i, o) {
    ...
    if (s) {
      let n = !1;
      return s.name = t, Ze(i) || (n = s.order !== i, s.order = i), s.visible || (s.visible = !0, n = !0), n;
    } else {
...
class re extends R {
  constructor(e, t, i) {
    ...
    })), this._register(w(window, S.KEY_DOWN, (o) => {
  ...
  push(e) {
    ju(e).forEach((i) => {
      const o = this.menus.length, s = Cc(i.label), n = Sc.exec(i.label);
      if (n) {
        const r = n[1] ? n[1] : n[3];
      ...
      if (this.isCompact)
        ...
        const r = Ji("div.menubar-menu-button", { role: "menuitem", tabindex: -1, "aria-label": s, "aria-haspopup": !0 }), a = Ji("div.menubar-menu-title", { role: "none", "aria-hidden": !0 });
        r.appendChild(a), this.container.insertBefore(r, this.overflowMenu.buttonElement), this.updateLabels(a, r, i.label), this._register(w(r, S.KEY_UP, (d) => {
          const l = new Ct(d);
          let u = !0;
          (l.equals(18) || l.equals(3)) && !this.isOpen ? (this.focusedMenu = { index: o }, this.openedViaKeyboard = !0, this.focusState = ce.OPEN) : u = !1, u && (l.preventDefault(), l.stopPropagation());
        })), this._register(ii.addTarget(r)), this._register(w(r, Te.Tap, (d) => {
          this.isOpen && this.focusedMenu && this.focusedMenu.holder && Ht(d.initialTarget, this.focusedMenu.holder) || (this.ignoreNextMouseUp = !1, this.onMenuTriggered(o, !0), d.preventDefault(), d.stopPropagation());
        })), this._register(w(r, S.MOUSE_DOWN, (d) => {
          if (!new _t(d).leftButton) {
            d.preventDefault();
            return;
          }
  ...
  createOverflowMenu() {
    const e = this.isCompact ? p("mAppMenu", "Application Menu") : p("mMore", "More"), t = Ji("div.menubar-menu-button", { role: "menuitem", tabindex: this.isCompact ? 0 : -1, "aria-label": e, "aria-haspopup": !0 }), i = Ji("div.menubar-menu-title.toolbar-toggle-more" + me.asCSSSelector(M.menuBarMore), { role: "none", "aria-hidden": !0 });
    t.appendChild(i), this.container.appendChild(t), t.style.visibility = "hidden", this._register(w(t, S.KEY_UP, (o) => {
      const s = new Ct(o);
      let n = !0;
      const r = [3];
      this.isCompact ? (r.push(10), this.options.compactMode === Ai.Right ? r.push(17) : this.options.compactMode === Ai.Left && r.push(15)) : r.push(18), r.some((a) => s.equals(a)) && !this.isOpen ? (this.focusedMenu = { index: re.OVERFLOW_INDEX }, this.openedViaKeyboard = !0, this.focusState = ce.OPEN) : n = !1, n && (s.preventDefault(), s.stopPropagation());
    })), this._register(ii.addTarget(t)), this._register(w(t, Te.Tap, (o) => {
      this.isOpen && this.focusedMenu && this.focusedMenu.holder && Ht(o.initialTarget, this.focusedMenu.holder) || (this.ignoreNextMouseUp = !1, this.onMenuTriggered(re.OVERFLOW_INDEX, !0), o.preventDefault(), o.stopPropagation());
    })), this._register(w(t, S.MOUSE_DOWN, (o) => {
      if (!new _t(o).leftButton) {
        o.preventDefault();
        return;
      }
      this.isOpen ? this.ignoreNextMouseUp = !1 : (this.ignoreNextMouseUp = !0, this.onMenuTriggered(re.OVERFLOW_INDEX, !0)), o.preventDefault(), o.stopPropagation();
    })), this._register(w(t, S.MOUSE_UP, (o) => {
      o.defaultPrevented || (this.ignoreNextMouseUp ? this.ignoreNextMouseUp = !1 : this.isFocused && this.onMenuTriggered(re.OVERFLOW_INDEX, !0));
    })), this._register(w(t, S.MOUSE_ENTER, () => {
      this.isOpen && !this.isCurrentMenu(re.OVERFLOW_INDEX) ? (this.overflowMenu.buttonElement.focus(), this.cleanupCustomMenu(), this.showCustomMenu(re.OVERFLOW_INDEX, !1)) : this.isFocused && !this.isOpen && (this.focusedMenu = { index: re.OVERFLOW_INDEX }, t.focus());
    })), this.overflowMenu = {
      buttonElement: t,
      titleElement: i,
      label: "More",
  ...
  dispose() {
    ...
    }), this.overflowMenu.titleElement.remove(), this.overflowMenu.buttonElement.remove(), ue(this.overflowLayoutScheduled), this.overflowLayoutScheduled = void 0;
  }
  blur() {
    this.setUnfocusedState();
  }
  ...
  toggleFocus() {
    !this.isFocused && this.options.visibility !== "hidden" ? (this.mnemonicsInUse = !0, this.focusedMenu = { index: this.numMenusShown > 0 ? 0 : re.OVERFLOW_INDEX }, this.focusState = ce.FOCUSED) : this.isOpen || this.setUnfocusedState();
  }
  updateOverflowAction() {
    ...
    for (const d of n) {
      if (!o) {
        const l = d.buttonElement.offsetWidth;
        i + l > t ? o = !0 : (i += l, this.numMenusShown++, this.numMenusShown > s && (d.buttonElement.style.visibility = "visible"));
      }
    ...
    if (this.isCompact) {
      ...
      for (let l = this.numMenusShown; l < this.menus.length; l++)
        this.overflowMenu.actions.push(new ao(
          `menubar.submenu.${this.menus[l].label}`,
          this.menus[l].label,
          this.menus[l].actions || []
        ));
      const d = (a = (r = this.options).getCompactMenuActions) == null ? void 0 : a.call(r);
      d && d.length && (this.overflowMenu.actions.push(new Fe()), this.overflowMenu.actions.push(...d)), this.overflowMenu.buttonElement.style.visibility = "visible";
    } else if (o) {
  ...
  updateLabels(e, t, i) {
    ...
    if (this.options.enableMnemonics) {
      ...
      r ? (e.innerText = "", e.append(zu(a(n.substr(0, r.index)), " "), Ji("mnemonic", { "aria-hidden": "true" }, r[3]), Uu(a(n.substr(r.index + r[0].length)), " "))) : e.innerText = a(n).trim();
    } else
  ...
  update(e) {
    ...
    }), this.overflowLayoutScheduled || (this.overflowLayoutScheduled = nr(() => {
  ...
  set focusState(e) {
    var s, n;
    if (this._focusState >= ce.FOCUSED && e < ce.FOCUSED && this.updatePending && (this.menuUpdater.schedule(), this.updatePending = !1), e === this._focusState)
      return;
    ...
    switch (this._focusState = e, e) {
      case ce.HIDDEN:
        ...
        break;
      case ce.VISIBLE:
        t || this.showMenubar(), i && this.cleanupCustomMenu(), o && (this.focusedMenu && (this.focusedMenu.index === re.OVERFLOW_INDEX ? this.overflowMenu.buttonElement.blur() : (s = this.menus[this.focusedMenu.index].buttonElement) == null || s.blur()), this.focusedMenu = void 0, this.focusToReturn && (this.focusToReturn.focus(), this.focusToReturn = void 0));
        break;
      case ce.FOCUSED:
        t || this.showMenubar(), i && this.cleanupCustomMenu(), this.focusedMenu && (this.focusedMenu.index === re.OVERFLOW_INDEX ? this.overflowMenu.buttonElement.focus() : (n = this.menus[this.focusedMenu.index].buttonElement) == null || n.focus());
        break;
      case ce.OPEN:
        t || this.showMenubar(), this.focusedMenu && this.showCustomMenu(this.focusedMenu.index, this.openedViaKeyboard);
        break;
    }
    this._focusState = e, this._onFocusStateChange.fire(this.focusState >= ce.FOCUSED);
  }
  get isVisible() {
    return this.focusState >= ce.VISIBLE;
  }
  get isFocused() {
    return this.focusState >= ce.FOCUSED;
  }
  get isOpen() {
    return this.focusState >= ce.OPEN;
  }
  get hasOverflow() {
  ...
  setUnfocusedState() {
    this.options.visibility === "toggle" || this.options.visibility === "hidden" ? this.focusState = ce.HIDDEN : this.options.visibility === "classic" && Dd() ? this.focusState = ce.HIDDEN : this.focusState = ce.VISIBLE, this.ignoreNextMouseUp = !1, this.mnemonicsInUse = !1, this.updateMnemonicVisibility(!1);
  }
  focusPrevious() {
    var t;
    ...
    this.focusedMenu.index === re.OVERFLOW_INDEX ? e = this.numMenusShown - 1 : this.focusedMenu.index === 0 && this.hasOverflow && (e = re.OVERFLOW_INDEX), e !== this.focusedMenu.index && (this.isOpen ? (this.cleanupCustomMenu(), this.showCustomMenu(e)) : this.isFocused && (this.focusedMenu.index = e, e === re.OVERFLOW_INDEX ? this.overflowMenu.buttonElement.focus() : (t = this.menus[e].buttonElement) == null || t.focus()));
  }
  focusNext() {
    var t;
    if (!this.focusedMenu || this.numMenusShown === 0)
    ...
    this.focusedMenu.index === re.OVERFLOW_INDEX ? e = 0 : this.focusedMenu.index === this.numMenusShown - 1 && (e = re.OVERFLOW_INDEX), e !== this.focusedMenu.index && (this.isOpen ? (this.cleanupCustomMenu(), this.showCustomMenu(e)) : this.isFocused && (this.focusedMenu.index = e, e === re.OVERFLOW_INDEX ? this.overflowMenu.buttonElement.focus() : (t = this.menus[e].buttonElement) == null || t.focus()));
  }
  ...
  get shouldAltKeyFocus() {
    return le ? !1 : !this.options.disableAltFocus || this.options.visibility === "toggle";
  }
  ...
  onMenuTriggered(e, t) {
    this.isOpen ? this.isCurrentMenu(e) ? this.setUnfocusedState() : (this.cleanupCustomMenu(), this.showCustomMenu(e, this.openedViaKeyboard)) : (this.focusedMenu = { index: e }, this.openedViaKeyboard = !t, this.focusState = ce.OPEN);
  }
  onModifierKeyToggled(e) {
    const t = !e.altKey && !e.ctrlKey && !e.shiftKey && !e.metaKey;
    this.options.visibility !== "hidden" && (e.event && this.shouldAltKeyFocus && Ku.toEnum(e.event.code) === 159 && e.event.preventDefault(), this.isFocused && e.lastKeyPressed === "alt" && e.altKey && (this.setUnfocusedState(), this.mnemonicsInUse = !1, this.awaitingAltRelease = !0), t && e.lastKeyPressed === "alt" && e.lastKeyReleased === "alt" && (this.awaitingAltRelease || (!this.isFocused && this.shouldAltKeyFocus ? (this.mnemonicsInUse = !0, this.focusedMenu = { index: this.numMenusShown > 0 ? 0 : re.OVERFLOW_INDEX }, this.focusState = ce.FOCUSED) : this.isOpen || this.setUnfocusedState())), !e.altKey && e.lastKeyReleased === "alt" && (this.awaitingAltRelease = !1), this.options.enableMnemonics && this.menus && !this.isOpen && this.updateMnemonicVisibility(!this.awaitingAltRelease && e.altKey || this.mnemonicsInUse));
  }
  isCurrentMenu(e) {
  ...
  cleanupCustomMenu() {
    var e, t, i;
    this.focusedMenu && (this.focusedMenu.index === re.OVERFLOW_INDEX ? this.overflowMenu.buttonElement.focus() : (e = this.menus[this.focusedMenu.index].buttonElement) == null || e.focus(), this.focusedMenu.holder && ((t = this.focusedMenu.holder.parentElement) == null || t.classList.remove("open"), this.focusedMenu.holder.remove()), (i = this.focusedMenu.widget) == null || i.dispose(), this.focusedMenu = { index: this.focusedMenu.index });
  }
  showCustomMenu(e, t = !0) {
    const i = e >= this.numMenusShown ? re.OVERFLOW_INDEX : e, o = i === re.OVERFLOW_INDEX ? this.overflowMenu : this.menus[i];
    if (!o.actions || !o.buttonElement || !o.titleElement)
      return;
    const s = Ji("div.menubar-menu-items-holder", { title: "" });
    o.buttonElement.classList.add("open");
    const n = o.titleElement.getBoundingClientRect(), r = Id(o.titleElement);
    this.options.compactMode === Ai.Right ? (s.style.top = `${n.top}px`, s.style.left = `${n.left + this.container.clientWidth}px`) : this.options.compactMode === Ai.Left ? (s.style.top = `${n.top}px`, s.style.right = `${this.container.clientWidth}px`, s.style.left = "auto") : (s.style.top = `${n.bottom * r}px`, s.style.left = `${n.left * r}px`), o.buttonElement.appendChild(s);
    const a = {
      getKeyBinding: this.options.getKeybinding,
      actionRunner: this.actionRunner,
      enableMnemonics: this.options.alwaysOnMnemonics || this.mnemonicsInUse && this.options.enableMnemonics,
      ariaLabel: Bt(o.buttonElement.getAttribute("aria-label")),
      expandDirection: this.isCompact ? this.options.compactMode : Ai.Right,
      useEventAsContext: !0
    }, d = this._register(new $u(s, o.actions, a, this.menuStyle));
    this._register(d.onDidCancel(() => {
      this.focusState = ce.FOCUSED;
...
const vh = "inRecentFilesPicker";
class zb extends qe {
  constructor(e) {
    super(e), this.removeFromRecentlyOpened = {
      iconClass: me.asClassName(M.removeClose),
      tooltip: p("remove", "Remove from Recently Opened")
    }, this.dirtyRecentlyOpenedFolder = {
      iconClass: "dirty-workspace " + me.asClassName(M.closeDirty),
      tooltip: p("dirtyRecentlyOpenedFolder", "Folder With Unsaved Files"),
      alwaysVisible: !0
    }, this.dirtyRecentlyOpenedWorkspace = {
      ...this.dirtyRecentlyOpenedFolder,
      tooltip: p("dirtyRecentlyOpenedWorkspace", "Workspace With Unsaved Files")
    };
  }
  async run(e) {
    const t = e.get(wa), i = e.get(Kt), o = e.get(at), s = e.get(Ci), n = e.get(we), r = e.get(Ad), a = e.get(Yu), d = e.get(os), l = e.get(gn), u = await t.getRecentlyOpened(), g = await t.getDirtyWorkspaces();
    let m = !1;
    const f = new Zt(), C = new Zt();
    for (const W of g)
      od(W) ? f.set(W.folderUri, !0) : (C.set(W.workspace.configPath, W.workspace), m = !0);
    const E = new Zt(), V = new Zt();
    for (const W of u.workspaces)
      Vs(W) ? E.set(W.folderUri, !0) : (V.set(W.workspace.configPath, W.workspace), m = !0);
    const B = [];
    for (const W of u.workspaces) {
      const Co = Vs(W) ? f.has(W.folderUri) : C.has(W.workspace.configPath);
      B.push(this.toQuickPick(r, a, s, W, Co));
    }
    for (const W of g)
      od(W) && !E.has(W.folderUri) ? B.push(this.toQuickPick(r, a, s, W, !0)) : Gb(W) && !V.has(W.workspace.configPath) && B.push(this.toQuickPick(r, a, s, W, !0));
    const De = u.files.map(
      (W) => this.toQuickPick(r, a, s, W, !1)
    ), Me = u.workspaces[0], bt = Me && o.isCurrentWorkspace(rr(Me) ? Me.workspace : Me.folderUri);
    let Ke;
    const T = { type: "separator", label: m ? p("workspacesAndFolders", "folders & workspaces") : p("folders", "folders") }, ne = { type: "separator", label: p("files", "files") }, ye = [T, ...B, ne, ...De], li = await i.pick(ye, {
      contextKey: vh,
      activeItem: [...B, ...De][bt ? 1 : 0],
      placeHolder: le ? p(
      ...
      onDidTriggerItemButton: async (W) => {
        if (W.button === this.removeFromRecentlyOpened)
          await t.removeRecentlyOpened([W.item.resource]), W.removeItem();
        else if (W.button === this.dirtyRecentlyOpenedFolder || W.button === this.dirtyRecentlyOpenedWorkspace) {
          const Co = W.button === this.dirtyRecentlyOpenedWorkspace, { confirmed: yu } = await l.confirm({
            title: Co ? p("dirtyWorkspace", "Workspace with Unsaved Files") : p("dirtyFolder", "Folder with Unsaved Files"),
            message: Co ? p(
          ...
          yu && (d.openWindow([W.item.openable], {
            remoteAuthority: W.item.remoteAuthority || null
          }), i.cancel());
        }
      }
    });
    if (li)
      return d.openWindow([li.openable], {
        forceNewWindow: Ke == null ? void 0 : Ke.ctrlCmd,
        forceReuseWindow: Ke == null ? void 0 : Ke.alt,
        remoteAuthority: li.remoteAuthority || null
      });
  }
  toQuickPick(e, t, i, o, s) {
    let n, r, a, d, l = !1;
    Vs(o) ? (d = o.folderUri, r = Nn(e, t, d, Ve.FOLDER), n = { folderUri: d }, a = o.label || i.getWorkspaceLabel(d, { verbose: 2 })) : rr(o) ? (d = o.workspace.configPath, r = Nn(e, t, d, Ve.ROOT_FOLDER), n = { workspaceUri: d }, a = o.label || i.getWorkspaceLabel(o.workspace, { verbose: 2 }), l = !0) : (d = o.fileUri, r = Nn(e, t, d, Ve.FILE), n = { fileUri: d }, a = o.label || i.getUriLabel(d));
    const { name: u, parentPath: g } = Xu(a);
    return {
      iconClasses: r,
      label: u,
      ariaLabel: s ? l ? p(
        ...
        u
      ) : p("recentDirtyFolderAriaLabel", "{0}, folder with unsaved changes", u) : u,
      description: g,
      buttons: s ? [l ? this.dirtyRecentlyOpenedWorkspace : this.dirtyRecentlyOpenedFolder] : [this.removeFromRecentlyOpened],
      openable: n,
      resource: d,
...
class In extends zb {
  constructor() {
    super({
      id: In.ID,
      title: {
        value: p("openRecent", "Open Recent..."),
        mnemonicTitle: p({ key: "miMore", comment: ["&& denotes a mnemonic"] }, "&&More..."),
...
In.ID = "workbench.action.openRecent";
class Za extends qe {
  constructor() {
    super({
      id: Za.ID,
      title: { value: p("reloadWindow", "Reload Window"), original: "Reload Window" },
      category: ve.Developer,
      f1: !0,
      keybinding: {
        weight: 200 + 50,
  ...
  run(e) {
    return e.get(os).reload();
  }
}
Za.ID = "workbench.action.reloadWindow";
const wh = v.and(Ab, v.has(vh)), sd = "workbench.action.quickOpenNavigateNextInRecentFilesPicker";
...
const nd = "workbench.action.quickOpenNavigatePreviousInRecentFilesPicker";
k.registerCommandAndKeybindingRule({
  id: nd,
  weight: 200 + 50,
  handler: ch(nd, !1),
...
q.registerCommand("workbench.action.toggleConfirmBeforeClose", (c) => {
  const e = c.get(L), t = e.inspect("window.confirmBeforeClose").userValue;
  return e.updateValue("window.confirmBeforeClose", t === "never" ? "keyboardOnly" : "never");
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarFileMenu,
  title: {
    value: "File",
    original: "File",
    mnemonicTitle: p({ key: "mFile", comment: ["&& denotes a mnemonic"] }, "&&File")
  },
  order: 1
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarEditMenu,
  title: {
    value: "Edit",
    original: "Edit",
    mnemonicTitle: p({ key: "mEdit", comment: ["&& denotes a mnemonic"] }, "&&Edit")
  },
  order: 2
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarSelectionMenu,
  title: {
    value: "Selection",
    original: "Selection",
    mnemonicTitle: p({ key: "mSelection", comment: ["&& denotes a mnemonic"] }, "&&Selection")
  },
  order: 3
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarViewMenu,
  title: {
    value: "View",
    original: "View",
    mnemonicTitle: p({ key: "mView", comment: ["&& denotes a mnemonic"] }, "&&View")
  },
  order: 4
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarGoMenu,
  title: {
    value: "Go",
    original: "Go",
    mnemonicTitle: p({ key: "mGoto", comment: ["&& denotes a mnemonic"] }, "&&Go")
  },
  order: 5
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarTerminalMenu,
  title: {
    value: "Terminal",
    original: "Terminal",
    mnemonicTitle: p({ key: "mTerminal", comment: ["&& denotes a mnemonic"] }, "&&Terminal")
  },
  order: 7
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarHelpMenu,
  title: {
    value: "Help",
    original: "Help",
    mnemonicTitle: p({ key: "mHelp", comment: ["&& denotes a mnemonic"] }, "&&Help")
  },
  order: 8
});
_.appendMenuItem(b.MenubarMainMenu, {
  submenu: b.MenubarPreferencesMenu,
  title: {
    value: "Preferences",
    original: "Preferences",
    mnemonicTitle: p({ key: "mPreferences", comment: ["&& denotes a mnemonic"] }, "Preferences")
  },
  when: Ju,
  order: 9
});
class qo extends R {
  ...
  setupMainMenu() {
    ...
    for (const t of e)
      t instanceof ar && typeof t.item.title != "string" && (this.menus[t.item.title.original] = this.mainMenuDisposables.add(this.menuService.createMenu(t.item.submenu, this.contextKeyService, { emitEventsForSubmenuChanges: !0 })), this.topLevelTitles[t.item.title.original] = t.item.title.mnemonicTitle ?? t.item.title.value);
  }
  updateMenubar() {
  ...
  getOpenRecentActions() {
    ...
    if (e.length > 0) {
      for (let o = 0; o < qo.MAX_MENU_RECENT_ENTRIES && o < e.length; o++)
        i.push(this.createOpenRecentMenuAction(e[o]));
      i.push(new Fe());
    }
    if (t.length > 0) {
      for (let o = 0; o < qo.MAX_MENU_RECENT_ENTRIES && o < t.length; o++)
  ...
  get menubarHidden() {
    return le && ya ? !1 : Lo(this.configurationService) === "hidden";
  }
  ...
  notifyUserOfCustomMenubarAccessibility() {
    if (Qe || le)
      return;
    const e = this.storageService.getBoolean("menubar/accessibleMenubarNotified", -1, !1), t = Ib(this.configurationService) === "custom";
    ...
    this.notificationService.prompt(wt.Info, i, [
      {
        label: p("goToSetting", "Open Settings"),
...
let Ar = class extends qo {
  ...
  registerActions() {
    const e = this;
    Qe && this._register(te(class extends qe {
      constructor() {
        super({
          id: "workbench.actions.menubar.focus",
          title: { value: p("focusMenu", "Focus Application Menu"), original: "Focus Application Menu" },
          keybinding: {
            primary: 68,
            weight: 200,
            when: Do
  ...
  getUpdateAction() {
    switch (this.updateService.state.type) {
      case "uninitialized":
        return null;
      case "idle":
        return new ke("update.check", p(
          { key: "checkForUpdates", comment: ["&& denotes a mnemonic"] },
          "Check for &&Updates..."
        ), void 0, !0, () => this.updateService.checkForUpdates(!0));
      case "checking for updates":
        return new ke("update.checking", p("checkingForUpdates", "Checking for Updates..."), void 0, !1);
      case "available for download":
        return new ke("update.downloadNow", p(
          { key: "download now", comment: ["&& denotes a mnemonic"] },
          "D&&ownload Update"
        ), void 0, !0, () => this.updateService.downloadUpdate());
      case "downloading":
        return new ke("update.downloading", p("DownloadingUpdate", "Downloading Update..."), void 0, !1);
      case "downloaded":
        return new ke("update.install", p(
          { key: "installUpdate...", comment: ["&& denotes a mnemonic"] },
          "Install &&Update..."
        ), void 0, !0, () => this.updateService.applyUpdate());
      case "updating":
        return new ke("update.updating", p("installingUpdate", "Installing Update..."), void 0, !1);
      case "ready":
        return new ke("update.restart", p(
  ...
  get currentMenubarVisibility() {
    return Lo(this.configurationService);
  }
    ...
    switch (e.id) {
      ...
      case "workbench.action.showAboutDialog":
        if (!le && !Qe) {
          ...
          i && (i.label = hi(i.label), t.push(i), t.push(new Fe()));
        }
        break;
    }
  }
  get currentEnableMenuBarMnemonics() {
    ...
    return typeof e != "boolean" && (e = !0), e && (!Qe || Dd());
  }
  get currentCompactMenuMode() {
    return this.currentMenubarVisibility !== "compact" ? void 0 : this.configurationService.getValue("workbench.sideBar.location") === "right" ? Ai.Left : Ai.Right;
  }
  ...
  toActionsArray(e) {
    const t = [];
    return Gs(e, { shouldForwardArgs: !0 }, t), t;
  }
  setupCustomMenubar(e) {
    var i;
    if (!this.container)
      return;
    e ? (this.menubar && this.reinstallDisposables.clear(), this.menubar = this.reinstallDisposables.add(new re(this.container, this.getMenuBarOptions(), ip)), this.accessibilityService.alwaysUnderlineAccessKeys().then((o) => {
      var s;
    ...
    })), this.reinstallDisposables.add(this.menubar.onVisibilityChange((o) => this.onDidVisibilityChange(o))), this.reinstallDisposables.add(w(this.container, S.FOCUS_IN, () => {
      this.focusInsideMenubar = !0;
    })), this.reinstallDisposables.add(w(this.container, S.FOCUS_OUT, () => {
    ...
    const t = (o, s, n) => {
      s.splice(0);
      for (const r of o)
        if (this.insertActionsBefore(r, s), r instanceof Fe)
          s.push(r);
        else if (r instanceof ar || r instanceof Ec) {
          let a = typeof r.item.title == "string" ? r.item.title : r.item.title.mnemonicTitle ?? r.item.title.value;
          if (r instanceof ar) {
            const d = [];
            t(r.actions, d, n), d.length > 0 && s.push(new ao(r.id, hi(a), d));
          } else {
            np(r.item.toggled) && (a = r.item.toggled.mnemonicTitle ?? r.item.toggled.title ?? a);
            const d = new ke(
              r.id,
              hi(a),
              r.class,
    ...
    for (const o of Object.keys(this.topLevelTitles)) {
      ...
      e && s && (this.reinstallDisposables.add(s.onDidChange(() => {
        ...
        if (!this.focusInsideMenubar) {
          const a = [];
          t(this.toActionsArray(s), a, o), (r = this.menubar) == null || r.updateMenu({ actions: a, label: hi(this.topLevelTitles[o]) });
        }
      ...
      const n = [];
      s && t(this.toActionsArray(s), n, o), this.menubar && (e ? this.menubar.push({ actions: n, label: hi(this.topLevelTitles[o]) }) : this.menubar.updateMenu({ actions: n, label: hi(this.topLevelTitles[o]) }));
    }
  }
  ...
  getMenuBarOptions() {
    return {
      ...
      getCompactMenuActions: () => Qe ? this.getWebNavigationActions() : []
    };
  }
  onDidChangeWindowFocus(e) {
    var t;
  ...
  registerListeners() {
    super.registerListeners(), this._register(w(window, S.RESIZE, () => {
      this.menubar && !(op && sp.pointerEvents) && this.menubar.blur();
    })), Qe && (this._register(this.layoutService.onDidChangeFullscreen((e) => this.updateMenubar())), this._register(this.webNavigationMenu.onDidChange(() => this.updateMenubar())));
  }
  get onVisibilityChange() {
    return this._onVisibilityChange.event;
  }
  ...
  getMenubarItemsDimensions() {
    return this.menubar ? new G(this.menubar.getWidth(), this.menubar.getHeight()) : new G(0, 0);
  }
  create(e) {
...
let ni = class We extends xn {
  ...
  createCompositeBar() {
    ...
    return this._register(this.instantiationService.createInstance(Js, e, {
      icon: !0,
      orientation: 1,
      ...
      getOnCompositeClickAction: (t) => Ne({ id: t, label: "", run: async () => {
        var i;
      ...
      overflowActionSize: We.ACTION_HEIGHT
    }));
  }
  ...
  getContextMenuActionsForComposite(e) {
    ...
    if (o !== this.viewDescriptorService.getViewContainerLocation(i))
      t.push(Ne({ id: "resetLocationAction", label: p("resetLocation", "Reset Location"), run: () => this.viewDescriptorService.moveViewContainerToLocation(i, o) }));
    else {
      ...
      if (s.allViewDescriptors.length === 1) {
        ...
        r !== i && t.push(Ne({ id: "resetLocationAction", label: p("resetLocation", "Reset Location"), run: () => this.viewDescriptorService.moveViewsToContainer([n], r) }));
      }
    }
    return t;
  }
  registerListeners() {
    ...
    this._register(this.extensionService.onDidRegisterExtensions(() => {
      ...
      t.affectsConfiguration("window.menuBarVisibility") && (Lo(this.configurationService) === "compact" ? this.installMenubar() : this.uninstallMenubar());
    }));
  }
  ...
  showActivity(e, t, i, o) {
    return this.getViewContainer(e) ? this.compositeBar.showActivity(e, t, i, o) : e === Di ? this.showGlobalActivity(Di, t, i, o) : e === Ns ? this.showGlobalActivity(Ns, t, i, o) : R.None;
  }
  showGlobalActivity(e, t, i, o) {
    typeof o != "number" && (o = 0);
    const s = { badge: t, clazz: i, priority: o }, n = e === Di ? this.globalActivity : this.accountsActivity;
    ...
    return this.updateGlobalActivity(e), ie(() => this.removeGlobalActivity(e, s));
  }
  removeGlobalActivity(e, t) {
    const i = e === Di ? this.globalActivity : this.accountsActivity, o = i.indexOf(t);
    o !== -1 && (i.splice(o, 1), this.updateGlobalActivity(e));
  }
  updateGlobalActivity(e) {
    const t = e === Di ? this.globalActivityAction : this.accountsActivityAction;
    if (!t)
      return;
    const i = e === Di ? this.globalActivity : this.accountsActivity;
    if (i.length) {
      const [{ badge: o, clazz: s, priority: n }] = i;
      if (o instanceof Io && i.length > 1) {
  ...
  getCumulativeNumberBadge(e, t) {
    const i = e.filter((n) => n.badge instanceof Io && n.priority === t), o = i.reduce((n, r) => n + r.badge.number, 0), s = () => i.reduce((n, r, a) => (n = n + r.badge.getDescription(), a < i.length - 1 && (n = `${n}
`), n), "");
    return new Io(o, s);
  }
  uninstallMenubar() {
  ...
  installMenubar() {
    if (this.menuBar)
      return;
    this.menuBarContainer = document.createElement("div"), this.menuBarContainer.classList.add("menubar"), j(this.content).prepend(this.menuBarContainer), this.menuBar = this._register(this.instantiationService.createInstance(Ar)), this.menuBar.create(this.menuBarContainer), this.registerKeyboardNavigationListeners();
  }
  createContentArea(e) {
    return this.element = e, this.content = document.createElement("div"), this.content.classList.add("content"), e.appendChild(this.content), Lo(this.configurationService) === "compact" && this.installMenubar(), this.compositeBarContainer = this.compositeBar.create(this.content), this.globalActivitiesContainer = document.createElement("div"), this.content.appendChild(this.globalActivitiesContainer), this.registerKeyboardNavigationListeners(), this.content;
  }
  registerKeyboardNavigationListeners() {
    this.keyboardNavigationDisposables.clear(), this.menuBarContainer && this.keyboardNavigationDisposables.add(w(this.menuBarContainer, S.KEY_DOWN, (e) => {
      var i;
      const t = new Ct(e);
      (t.equals(18) || t.equals(17)) && ((i = this.compositeBar) == null || i.focus());
    })), this.compositeBarContainer && this.keyboardNavigationDisposables.add(w(this.compositeBarContainer, S.KEY_DOWN, (e) => {
      var i, o;
      const t = new Ct(e);
    ...
    })), this.globalActivitiesContainer && this.keyboardNavigationDisposables.add(w(this.globalActivitiesContainer, S.KEY_DOWN, (e) => {
      var i;
      const t = new Ct(e);
  ...
  createGlobalActivityActionBar(e) {
    this.globalActivityActionBar = this._register(new vo(e, {
      actionViewItemProvider: (t) => {
        if (t.id === "workbench.actions.manage")
          return this.instantiationService.createInstance(Ir, t, () => this.compositeBar.getContextMenuActions(), (i) => this.getActivitybarItemColors(i), this.getActivityHoverOptions());
      ...
      orientation: 1,
      ariaLabel: p("manage", "Manage"),
      animated: !1,
      preventLoopNavigation: !0
    })), this.globalActivityAction = this._register(new Ms({
      id: "workbench.actions.manage",
      name: p("manage", "Manage"),
      classNames: me.asClassNameArray(We.GEAR_ICON)
    })), this.accountsVisibilityPreference && (this.accountsActivityAction = this._register(new Ms({
      id: "workbench.actions.accounts",
      name: p("accounts", "Accounts"),
      classNames: me.asClassNameArray(We.ACCOUNTS_ICON)
    })), this.globalActivityActionBar.push(this.accountsActivityAction, { index: We.ACCOUNTS_ACTION_INDEX })), this.globalActivityActionBar.push(this.globalActivityAction);
  }
  toggleAccountsActivity() {
    !!this.accountsActivityAction !== this.accountsVisibilityPreference && (this.globalActivityActionBar && (this.accountsActivityAction ? (this.globalActivityActionBar.pull(We.ACCOUNTS_ACTION_INDEX), this.accountsActivityAction = void 0) : (this.accountsActivityAction = this._register(new Ms({
      id: "workbench.actions.accounts",
      name: p("accounts", "Accounts"),
      classNames: me.asClassNameArray(M.account)
    })), this.globalActivityActionBar.push(this.accountsActivityAction, { index: We.ACCOUNTS_ACTION_INDEX }))), this.updateGlobalActivity(Ns));
  }
  getCompositeActions(e) {
    ...
    if (!t) {
      ...
      if (i) {
        ...
        t = {
          activityAction: this.instantiationService.createInstance(jo, this.toActivity(o), this.paneCompositePart),
          pinnedAction: new qa(this.toActivity(o), this.compositeBar),
          badgeAction: new Ya(this.toActivity(o), this.compositeBar)
        };
      } else {
        const o = this.cachedViewContainers.filter((s) => s.id === e)[0];
        t = {
          activityAction: this.instantiationService.createInstance(Fb, We.toActivity(e, e, o == null ? void 0 : o.icon, void 0), this.paneCompositePart),
          pinnedAction: new id(e, this.compositeBar),
          badgeAction: new mh(e, this.compositeBar)
        };
      }
  ...
  updateActivity(e, t) {
    ...
    o.updateActivity(i), s instanceof id && s.setActivity(i), this.saveCachedViewContainers();
  }
  toActivity(e) {
    return We.toActivity(e.viewContainer.id, e.title, e.icon, e.keybindingId);
  }
  static toActivity(e, t, i, o) {
    let s, n;
    if (P.isUri(i)) {
      n = i;
      const r = Ca(i), a = new Td();
      a.update(r);
      const d = `activity-${e.replace(/\./g, "-")}-${a.digest()}`, l = `.monaco-workbench .activitybar .monaco-action-bar .action-label.${d}`;
      s = [d, "uri-icon"], Vd(l, `
      ...
      me.isThemeIcon(i) && (s = me.asClassNameArray(i));
  ...
  showOrHideViewContainer(e) {
    ...
    t || (t = this.contextKeyService.createKey(Rd(e.id), !1), this.enabledViewContainersContextKeys.set(e.id, t)), this.shouldBeHidden(e) ? (t.set(!1), this.hideComposite(e.id)) : (t.set(!0), this.addComposite(e));
  }
  shouldBeHidden(e, t) {
    var s;
    const i = Nt(e) ? this.getViewContainer(e) : e, o = Nt(e) ? e : e.id;
    if (i)
      if (i.hideIfEmpty) {
        ...
        return !1;
    if (!this.hasExtensionsRegistered && !(this.environmentService.remoteAuthority && ya)) {
      ...
      if ((s = t == null ? void 0 : t.views) != null && s.length)
        return t.views.every(({ when: n }) => !!n && !this.contextKeyService.contextMatchesRules(v.deserialize(n)));
    }
    return !0;
  }
  addComposite(e) {
  ...
  updateStyles() {
    super.updateStyles();
    const e = j(this.getContainer()), t = this.getColor(rp) || "";
    e.style.backgroundColor = t;
    const i = this.getColor(ap) || this.getColor(ot) || "";
    e.classList.toggle("bordered", !!i), e.style.borderColor = i || "";
  }
  getActivitybarItemColors(e) {
    return {
      activeForegroundColor: e.getColor(cp),
      inactiveForegroundColor: e.getColor(dp),
      activeBorderColor: e.getColor(_d),
      activeBackground: e.getColor(kd),
      badgeBackground: e.getColor(lp),
      badgeForeground: e.getColor(hp),
      dragAndDropBorder: e.getColor(up),
  ...
  layout(e, t) {
    ...
    this.menuBarContainer && (o -= this.menuBarContainer.clientHeight), this.globalActivityActionBar && (o -= this.globalActivityActionBar.viewItems.length * We.ACTION_HEIGHT), this.compositeBar.layout(new G(e, o));
  }
  getViewContainer(e) {
  ...
  onDidStorageValueChange(e) {
    if (e.key === We.PINNED_VIEW_CONTAINERS && e.scope === 0 && this.pinnedViewContainersValue !== this.getStoredPinnedViewContainersValue()) {
    ...
    for (const i of t) {
      ...
      if (o) {
        ...
        e.push({
          id: i.id,
          name: s.title,
          icon: P.isUri(s.icon) && this.environmentService.remoteAuthority ? void 0 : s.icon,
          views: n,
          pinned: i.pinned,
          order: i.order,
          visible: i.visible,
  ...
  get cachedViewContainers() {
    if (this._cachedViewContainers === void 0) {
      ...
      for (const e of this.getPlaceholderViewContainers()) {
        ...
        t && (t.name = e.name, t.icon = e.themeIcon ? e.themeIcon : e.iconUrl ? P.revive(e.iconUrl) : void 0, P.isUri(t.icon) && this.environmentService.remoteAuthority && (t.icon = void 0), t.views = e.views, t.isBuiltin = e.isBuiltin);
      }
    }
  ...
  storeCachedViewContainersState(e) {
    this.setPinnedViewContainers(e.map(({ id: t, pinned: i, visible: o, order: s }) => ({
      ...
      id: t,
      iconUrl: P.isUri(i) ? i : void 0,
      themeIcon: me.isThemeIcon(i) ? i : void 0,
      name: o,
      isBuiltin: n,
      views: s
    })));
  ...
  getStoredPinnedViewContainersValue() {
    return this.storageService.get(We.PINNED_VIEW_CONTAINERS, 0, "[]");
  }
  setStoredPinnedViewContainersValue(e) {
    this.storageService.store(We.PINNED_VIEW_CONTAINERS, e, 0, 0);
  }
  ...
  getStoredPlaceholderViewContainersValue() {
    return this.storageService.get(We.PLACEHOLDER_VIEW_CONTAINERS, 0, "[]");
  }
  setStoredPlaceholderViewContainersValue(e) {
    this.storageService.store(We.PLACEHOLDER_VIEW_CONTAINERS, e, 0, 1);
  }
...
ni.PINNED_VIEW_CONTAINERS = "workbench.activity.pinnedViewlets2";
ni.PLACEHOLDER_VIEW_CONTAINERS = "workbench.activity.placeholderViewlets";
ni.ACTION_HEIGHT = 48;
ni.ACCOUNTS_ACTION_INDEX = 0;
ni.GEAR_ICON = pe("settings-view-bar-icon", M.settingsGear, p("settingsViewBarIcon", "Settings icon in the view bar."));
ni.ACCOUNTS_ICON = pe("accounts-view-bar-icon", M.account, p("accountsViewBarIcon", "Accounts icon in the view bar."));
ni = x([
  h(1, D),
  h(2, pt),
  h(3, X),
...
let Tr = class extends va {
  ...
  constructor(e, t, i, o, s) {
    ...
    if (typeof e.content == "string")
      ...
      const u = e.content, g = this._instantiationService.createInstance(mp, { codeBlockFontFamily: this._configurationService.getValue("editor").fontFamily || fp.fontFamily }), { element: m } = g.render(u, {
        actionHandler: {
          callback: (f) => this._linkHandler(f),
    ...
    if (n.appendChild(r), this._hover.contentsDomNode.appendChild(n), e.actions && e.actions.length > 0) {
      const u = Vt("div.hover-row.status-bar"), g = Vt("div.actions");
      e.actions.forEach((m) => {
        const f = this._keybindingService.lookupKeybinding(m.commandId), C = f ? f.getLabel() : null;
        bp.render(g, {
          label: m.label,
          commandId: m.commandId,
          run: (E) => {
            m.run(E), this.dispose();
          },
    ...
    let a;
    if (e.actions && e.actions.length > 0 ? a = !1 : e.hideOnHover === void 0 ? a = typeof e.content == "string" || Ao(e.content) && !e.content.value.includes("](") && !e.content.value.includes("</a>") : a = e.hideOnHover, a && e.showHoverHint) {
      const u = Vt("div.hover-row.status-bar"), g = Vt("div.info");
      g.textContent = p("hoverhint", "Hold {0} key to mouse over", le ? "Option" : "Alt"), u.appendChild(g), this._hover.containerDomNode.appendChild(u);
    }
    const d = [...this._target.targetElements];
    a || d.push(this._hoverContainer);
    const l = this._register(new rd(d));
    if (this._register(l.onMouseOut(() => {
      this._isLocked || this.dispose();
    })), a) {
      const u = [...this._target.targetElements, this._hoverContainer];
      this._lockMouseTracker = this._register(new rd(u)), this._register(this._lockMouseTracker.onMouseOut(() => {
        this._isLocked || this.dispose();
      }));
    } else
      this._lockMouseTracker = l;
  }
  addFocusTrap() {
    ...
    if (t) {
      const i = Pd(this._hoverContainer, Vt("div")), o = se(this._hoverContainer, Vt("div"));
      i.tabIndex = 0, o.tabIndex = 0, this._register(w(o, "focus", (s) => {
  ...
  layout() {
    ...
    const e = (l) => {
      const u = Id(l), g = l.getBoundingClientRect();
      return {
        top: g.top * u,
        bottom: g.bottom * u,
        right: g.right * u,
    ...
    }, t = this._target.targetElements.map((l) => e(l)), i = Math.min(...t.map((l) => l.top)), o = Math.max(...t.map((l) => l.right)), s = Math.max(...t.map((l) => l.bottom)), n = Math.min(...t.map((l) => l.left)), r = o - n, a = s - i, d = {
      top: i,
      right: o,
      bottom: s,
      left: n,
...
class rd extends va {
  ...
  constructor(e) {
    super(), this._elements = e, this._isMouseIn = !0, this._onMouseOut = this._register(new y()), this._elements.forEach((t) => this.onmouseover(t, () => this._onTargetMouseOver())), this._elements.forEach((t) => this.onmouseleave(t, () => this._onTargetMouseLeave()));
  }
  _onTargetMouseOver() {
...
let Vr = class {
  constructor(e, t, i, o) {
    this._instantiationService = e, this._contextViewService = t, this._keybindingService = o, i.onDidShowContextMenu(() => this.hideHover());
  }
  showHover(e, t) {
    if (ad(this._currentHoverOptions) === ad(e))
      return;
    this._currentHoverOptions = e, e.trapFocus && document.activeElement ? this._lastFocusedElementBeforeOpen = document.activeElement : this._lastFocusedElementBeforeOpen = void 0;
    const i = new A(), o = this._instantiationService.createInstance(Tr, e);
    o.onDispose(() => {
      var r;
      (r = this._lastFocusedElementBeforeOpen) == null || r.focus(), this._currentHoverOptions === e && (this._currentHoverOptions = void 0), i.dispose();
    });
    const s = this._contextViewService;
    if (s.showContextView(new $b(o, t), e.container), o.onRequestLayout(() => s.layout()), "targetElements" in e.target)
      for (const r of e.target.targetElements)
        i.add(w(r, S.CLICK, () => this.hideHover()));
    else
      i.add(w(e.target, S.CLICK, () => this.hideHover()));
    const n = document.activeElement;
    if (n && (i.add(w(n, S.KEY_DOWN, (r) => this._keyDown(r, o, !!e.hideOnKeyDown))), i.add(w(document, S.KEY_DOWN, (r) => this._keyDown(r, o, !!e.hideOnKeyDown))), i.add(w(n, S.KEY_UP, (r) => this._keyUp(r, o))), i.add(w(document, S.KEY_UP, (r) => this._keyUp(r, o)))), "IntersectionObserver" in window) {
      const r = new IntersectionObserver((d) => this._intersectionChange(d, o), { threshold: 0 }), a = "targetElements" in e.target ? e.target.targetElements[0] : e.target;
      r.observe(a), i.add(ie(() => r.disconnect()));
    }
    return this._currentHover = o, o;
  }
  hideHover() {
    var e;
...
let Rr = class Ch {
  ...
  async perform(e) {
    ...
    for (const o of this._edits)
      ...
      }), i.push(new yh(o.oldUri, o.newUri, o.options)));
    return t.length === 0 ? new Yo() : (await this._workingCopyFileService.move(t, e, this._undoRedoInfo), new Ch(
      i,
      { isUndoing: !0 },
...
let Pr = class {
  ...
  async perform(e) {
    ...
    return this._instaService.createInstance(Xo, o, { isUndoing: !0 });
  }
  toString() {
  ...
  async perform(e) {
    ...
    for (const s of this._edits)
      if (!(s.options.overwrite === void 0 && s.options.ignoreIfExists && await this._fileService.exists(s.newUri))) {
        ...
        o.push(new Qa(s.newUri, s.options, !s.options.folder && !s.contents));
      }
    return t.length === 0 && i.length === 0 ? new Yo() : (await this._workingCopyFileService.createFolder(t, e, this._undoRedoInfo), await this._workingCopyFileService.create(i, e, this._undoRedoInfo), this._instaService.createInstance(Xo, o, { isUndoing: !0 }));
  }
  toString() {
...
let Xo = class {
  ...
  async perform(e) {
    ...
    for (const o of this._edits) {
      ...
      n !== void 0 && i.push(new Sh(o.oldUri, o.options, n.value));
    }
    return t.length === 0 ? new Yo() : (await this._workingCopyFileService.delete(t, e, this._undoRedoInfo), i.length === 0 ? new Yo() : this._instaService.createInstance(Zs, i, { isUndoing: !0 }));
  }
  toString() {
...
class qb {
  ...
  async _reverse() {
    for (let e = 0; e < this.operations.length; e++) {
      const i = await this.operations[e].perform(Fi.None);
      this.operations[e] = i;
    }
  }
  toString() {
...
let Lr = class {
  constructor(e, t, i, o, s, n, r, a, d, l) {
    this._label = e, this._code = t, this._undoRedoGroup = i, this._undoRedoSource = o, this._confirmBeforeUndo = s, this._progress = n, this._token = r, this._edits = a, this._instaService = d, this._undoRedoService = l;
  }
  async apply() {
    var n, r;
    const e = [], t = { undoRedoGroupId: this._undoRedoGroup.id }, i = [];
    for (const a of this._edits)
      a.newResource && a.oldResource && !((n = a.options) != null && n.copy) ? i.push(new yh(a.newResource, a.oldResource, a.options ?? {})) : a.newResource && a.oldResource && ((r = a.options) != null && r.copy) ? i.push(new jb(a.newResource, a.oldResource, a.options ?? {})) : !a.newResource && a.oldResource ? i.push(new Qa(a.oldResource, a.options ?? {}, !1)) : a.newResource && !a.oldResource && i.push(new Sh(a.newResource, a.options ?? {}, await a.options.contents));
    if (i.length === 0)
      return [];
    const o = [];
    o[0] = [i[0]];
    for (let a = 1; a < i.length; a++) {
      const d = i[a], l = Md(o);
      l[0].type === d.type ? l.push(d) : o.push([d]);
    }
    for (const a of o) {
      ...
      switch (a[0].type) {
        case "rename":
          d = this._instaService.createInstance(Rr, a, t);
          break;
        case "copy":
          d = this._instaService.createInstance(Pr, a, t);
          break;
        case "delete":
          d = this._instaService.createInstance(Xo, a, t);
          break;
        case "create":
          d = this._instaService.createInstance(Zs, a, t);
          break;
      }
      if (d) {
        const l = await d.perform(this._token);
        e.push(l);
      }
      this._progress.report(void 0);
    }
    const s = new qb(this._label, this._code, e, this._confirmBeforeUndo);
...
class Eh {
  ...
  addEdit(e) {
    ...
    const { textEdit: t } = e;
    if (typeof t.eol == "number" && (this._newEol = t.eol), !t.range && !t.text || tt.isEmpty(t.range) && !t.text)
      return;
    let i;
    t.range ? i = tt.lift(t.range) : i = this.model.getFullModelRange(), this._edits.push({ ...Cp.replaceMove(i, t.text), insertAsSnippet: t.insertAsSnippet });
  }
  validate() {
  ...
  apply() {
    this._edits.length > 0 && (this._edits = this._edits.map(this._transformSnippetStringToInsertText, this).sort((e, t) => tt.compareRangesUsingStarts(e.range, t.range)), this.model.pushEditOperations(null, this._edits, () => null)), this._newEol !== void 0 && this.model.pushEOL(this._newEol);
  }
  _transformSnippetStringToInsertText(e) {
    if (!e.insertAsSnippet || !e.text)
      return e;
    const t = Nd.asInsertText(e.text);
...
class Yb extends Eh {
  ...
  apply() {
    ...
    if (this._edits.length > 0) {
      const e = Sp.get(this._editor);
      if (e && this._edits.some((t) => t.insertAsSnippet)) {
        const t = [];
        for (const i of this._edits)
          i.range && i.text !== null && t.push({
            range: tt.lift(i.range),
            template: i.insertAsSnippet ? i.text : Nd.escape(i.text)
          });
        e.apply(t, { undoStopBefore: !1, undoStopAfter: !1 });
      } else
        this._edits = this._edits.map(this._transformSnippetStringToInsertText, this).sort((t, i) => tt.compareRangesUsingStarts(t.range, i.range)), this._editor.executeEdits("", this._edits);
    }
...
let Or = class {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g) {
    this._label = e, this._code = t, this._editor = i, this._undoRedoGroup = o, this._undoRedoSource = s, this._progress = n, this._token = r, this._editorWorker = d, this._modelService = l, this._textModelResolverService = u, this._undoRedoService = g, this._edits = new Zt();
    for (const m of a) {
      let f = this._edits.get(m.resource);
      f || (f = [], this._edits.set(m.resource, f)), f.push(m);
    }
  }
  ...
  async _createEditsTasks() {
    ...
    for (const [i, o] of this._edits) {
      const s = this._textModelResolverService.createModelReference(i).then(async (n) => {
        var d, l;
        let r, a = !1;
        ((l = (d = this._editor) == null ? void 0 : d.getModel()) == null ? void 0 : l.uri.toString()) === n.object.textEditorModel.uri.toString() ? (r = new Yb(n, this._editor), a = !0) : r = new Eh(n);
        for (const u of o)
          if (a && !u.textEdit.insertAsSnippet) {
            const g = await this._editorWorker.computeMoreMinimalEdits(u.resource, [u.textEdit]);
            if (!g)
              r.addEdit(u);
            else
              for (const m of g)
                r.addEdit(new Fo(u.resource, m, u.versionId, u.metadata));
          } else
            r.addEdit(u);
        e.push(r);
      });
  ...
  async apply() {
    ...
    try {
      ...
      if (e.length === 1) {
        const o = e[0];
        if (!o.isNoOp()) {
          const s = new _c(this._label, this._code, o.model, o.getBeforeCursorState());
          this._undoRedoService.pushElement(s, this._undoRedoGroup, this._undoRedoSource), o.apply(), s.close(), t.push(o.model.uri);
        }
        this._progress.report(void 0);
      } else {
        const o = new yp(this._label, this._code, e.map((s) => new _c(this._label, this._code, s.model, s.getBeforeCursorState())));
...
let Mr = class {
  constructor(e, t, i, o, s, n, r, a, d, l, u) {
    this._label = e, this._code = t, this._editor = i, this._progress = o, this._token = s, this._edits = n, this._undoRedoGroup = r, this._undoRedoSource = a, this._confirmBeforeUndo = d, this._instaService = l, this._logService = u;
  }
  ariaMessage() {
    const e = new Zt(), t = new Zt();
    let i = 0;
    for (const o of this._edits)
      o instanceof Fo ? (i += 1, t.set(o.resource, !0)) : o instanceof zs && e.set(o.oldResource ?? o.newResource, !0);
    return this._edits.length === 0 ? p("summary.0", "Made no edits") : e.size === 0 ? i > 1 && t.size > 1 ? p(
      "summary.nm",
      "Made {0} text edits in {1} files",
      i,
      t.size
    ) : p("summary.n0", "Made {0} text edits in one file", i) : p(
      "summary.textFiles",
  ...
  async perform() {
    ...
    for (const n of e) {
      ...
      r[0] instanceof zs ? o.push(await this._performFileEdits(r, this._undoRedoGroup, this._undoRedoSource, this._confirmBeforeUndo, i)) : r[0] instanceof Fo ? o.push(await this._performTextEdits(r, this._undoRedoGroup, this._undoRedoSource, i)) : r[0] instanceof cr ? o.push(await this._performCellEdits(r, this._undoRedoGroup, this._undoRedoSource, i)) : console.log("UNKNOWN EDIT"), s = s + n;
    }
    return o.flat();
  }
  async _performFileEdits(e, t, i, o, s) {
    return this._logService.debug("_performFileEdits", JSON.stringify(e)), await this._instaService.createInstance(Lr, this._label || p("workspaceEdit", "Workspace Edit"), this._code || "undoredo.workspaceEdit", t, i, o, s, this._token, e).apply();
  }
  async _performTextEdits(e, t, i, o) {
    return this._logService.debug("_performTextEdits", JSON.stringify(e)), await this._instaService.createInstance(Or, this._label || p("workspaceEdit", "Workspace Edit"), this._code || "undoredo.workspaceEdit", this._editor, t, i, o, this._token, e).apply();
  }
  async _performCellEdits(e, t, i, o) {
    return this._logService.debug("_performCellEdits", JSON.stringify(e)), await this._instaService.createInstance(kp, t, i, o, this._token, e).apply();
  }
};
Mr = x([
  h(9, D),
...
let Nr = class {
  constructor(e, t, i, o, s, n, r) {
    this._instaService = e, this._logService = t, this._editorService = i, this._lifecycleService = o, this._dialogService = s, this._workingCopyService = n, this._configService = r, this._activeUndoRedoGroups = new xp();
  }
  setPreviewHandler(e) {
    return this._previewHandler = e, ie(() => {
  ...
  async apply(e, t) {
    let i = Xb(Array.isArray(e) ? e : e.edits);
    if (i.length === 0)
      return { ariaSummary: p("nothing", "Made no edits"), isApplied: !1 };
    this._previewHandler && (t != null && t.showPreview || i.some((l) => {
      var u;
      return (u = l.metadata) == null ? void 0 : u.needsConfirmation;
    })) && (i = await this._previewHandler(i, t));
    let o = t == null ? void 0 : t.editor;
    if (!o) {
      const l = this._editorService.activeTextEditorControl;
      Rs(l) && (o = l);
    }
    o && o.getOption(88) && (o = void 0);
    let s, n = () => {
    };
    if (typeof (t == null ? void 0 : t.undoRedoGroupId) == "number") {
      for (const l of this._activeUndoRedoGroups)
        if (l.id === t.undoRedoGroupId) {
          s = l;
          break;
        }
    }
    s || (s = new Dp(), n = this._activeUndoRedoGroups.push(s));
    const r = (t == null ? void 0 : t.quotableLabel) || (t == null ? void 0 : t.label), a = this._instaService.createInstance(Mr, r, t == null ? void 0 : t.code, o, (t == null ? void 0 : t.progress) ?? Ip.None, (t == null ? void 0 : t.token) ?? Fi.None, i, s, t == null ? void 0 : t.undoRedoSource, !!(t != null && t.confirmBeforeUndo));
    let d;
    try {
      d = this._lifecycleService.onBeforeShutdown((u) => u.veto(this._shouldVeto(r, u.reason), "veto.blukEditService"));
      const l = await a.perform();
      return t != null && t.respectAutoSaveConfig && this._configService.getValue(_h) === !0 && l.length > 1 && await this._saveAll(l), { ariaSummary: a.ariaMessage(), isApplied: i.length > 0 };
    } catch (l) {
      throw this._logService.error(l), l;
    } finally {
      d == null || d.dispose(), n();
    }
  }
  async _saveAll(e) {
    const t = new dr(e), i = this._workingCopyService.dirtyWorkingCopies.map(async (s) => {
  ...
  async _shouldVeto(e, t) {
    ...
    switch (t) {
      case 1:
        i = p("closeTheWindow.message", "Are you sure you want to close the window?"), o = p(
      ...
      case 4:
        ...
        break;
      case 3:
        i = p("reloadTheWindow.message", "Are you sure you want to reload the window?"), o = p(
          { key: "reloadTheWindow", comment: ["&& denotes a mnemonic"] },
          "&&Reload Window"
        );
        break;
      default:
        i = p("quit.message", "Are you sure you want to quit?"), o = p({ key: "quit", comment: ["&& denotes a mnemonic"] }, "&&Quit");
        break;
    }
    return !(await this._dialogService.confirm({
      ...
      detail: p(
        ...
        "'{0}' is in progress.",
        e || p("fileOperation", "File operation")
      ),
      primaryButton: o
    })).confirmed;
  }
...
const _h = "files.refactoring.autoSave";
de.as(_p.Configuration).registerConfiguration({
  id: "files",
  properties: {
    [_h]: {
      description: p(
...
let Qs = class Fr extends dh {
  ...
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E, V, B, De, Me, bt) {
    var Ke;
    super(e, t, i, o, s, n, r, a, de.as(E), m, ((Ke = d.getDefaultViewContainer(B)) == null ? void 0 : Ke.id) || "", "panel", "panel", void 0, g, bt), this.viewDescriptorService = d, this.contextKeyService = l, this.extensionService = u, this.partId = g, this.pinnedPanelsKey = f, this.placeholdeViewContainersKey = C, this.backgroundColor = V, this.viewContainerLocation = B, this.activePanelContextKey = De, this.panelFocusContextKey = Me, this.panelOptions = bt, this.minimumWidth = 300, this.maximumWidth = Number.POSITIVE_INFINITY, this.minimumHeight = 77, this.maximumHeight = Number.POSITIVE_INFINITY, this.snap = !0, this.onDidPaneCompositeClose = this.onDidCompositeClose.event, this.compositeActions = /* @__PURE__ */ new Map(), this.panelDisposables = /* @__PURE__ */ new Map(), this.blockOpeningPanel = !1, this.extensionsRegistered = !1, this.enabledViewContainersContextKeys = /* @__PURE__ */ new Map(), this.panelRegistry = de.as(E), this.dndHandler = new bh(
      this.viewDescriptorService,
      this.viewContainerLocation,
      (T, ne) => this.openPaneComposite(T, ne).then((ye) => ye || null),
      (T, ne, ye) => this.compositeBar.move(T, ne, ye == null ? void 0 : ye.horizontallyBefore),
      () => this.compositeBar.getCompositeBarItems()
    ), this.compositeBar = this._register(this.instantiationService.createInstance(Js, this.getCachedPanels(), {
      icon: !!this.panelOptions.useIcons,
      orientation: 0,
      activityHoverOptions: this.getActivityHoverOptions(),
      openComposite: (T, ne) => this.openPaneComposite(T, !ne).then((ye) => ye || null),
      getActivityAction: (T) => this.getCompositeActions(T).activityAction,
      getCompositePinnedAction: (T) => this.getCompositeActions(T).pinnedAction,
      getCompositeBadgeAction: (T) => this.getCompositeActions(T).badgeAction,
      getOnCompositeClickAction: (T) => this.instantiationService.createInstance(Jc, j(this.getPaneComposite(T)), this.viewContainerLocation),
      fillExtraContextMenuActions: (T) => this.fillExtraContextMenuActions(T),
      getContextMenuActionsForComposite: (T) => this.getContextMenuActionsForComposite(T),
      getDefaultCompositeId: () => {
        var T;
        return (T = d.getDefaultViewContainer(this.viewContainerLocation)) == null ? void 0 : T.id;
      },
      ...
      colors: (T) => ({
        activeBackgroundColor: T.getColor(this.backgroundColor),
        inactiveBackgroundColor: T.getColor(this.backgroundColor),
        activeBorderBottomColor: T.getColor(Ap),
        activeForegroundColor: T.getColor(Tp),
        inactiveForegroundColor: T.getColor(Vp),
        badgeBackground: T.getColor(Rp),
        badgeForeground: T.getColor(Pp),
        dragAndDropBorder: T.getColor(Lp)
      })
    })), this.registerListeners(), this.onDidRegisterPanels([...this.getPaneComposites()]), this.globalActions = this._register(this.instantiationService.createInstance(Op, g === "workbench.parts.panel" ? b.PanelTitle : b.AuxiliaryBarTitle, void 0, void 0)), this._register(this.globalActions.onDidChange(() => this.updateGlobalToolbarActions()));
  }
  getContextMenuActionsForComposite(e) {
    const t = [], i = this.viewDescriptorService.getViewContainerById(e), o = this.viewDescriptorService.getDefaultViewContainerLocation(i);
    if (o !== this.viewDescriptorService.getViewContainerLocation(i))
  ...
  updateActivity(e, t) {
    ...
    s.setActivity(this.toActivity(t)), n instanceof Zc && n.setActivity(o), this.compositeBar.recomputeSizes(), this.layoutCompositeBar(), this.extensionsRegistered && this.saveCachedPanels();
  }
  toActivity(e) {
    return Fr.toActivity(e.viewContainer.id, e.title, this.panelOptions.useIcons ? e.icon : void 0, e.keybindingId);
  }
  static toActivity(e, t, i, o) {
    let s, n;
    if (P.isUri(i)) {
      ...
      s = [d, "uri-icon"];
      const l = `.monaco-workbench .basepanel .monaco-action-bar .action-label.${d}`;
      Vd(l, `
				mask: ${r} no-repeat 50% 50%;
				mask-size: 16px;
				-webkit-mask: ${r} no-repeat 50% 50%;
  ...
  showOrHideViewContainer(e, t) {
    ...
    if (i || (i = this.contextKeyService.createKey(Rd(e.id), !1), this.enabledViewContainersContextKeys.set(e.id, i)), t.activeViewDescriptors.length) {
  ...
  shouldBeHidden(e, t) {
    const i = this.getViewContainer(e);
    return !i || !i.hideIfEmpty ? !1 : t != null && t.views && t.views.length ? t.views.every(({ when: o }) => !!o && !this.contextKeyService.contextMatchesRules(v.deserialize(o))) : !1;
  }
  registerListeners() {
  ...
  createEmptyPanelMessage() {
    ...
    t.classList.add("empty-panel-message"), t.innerText = p("panel.emptyMessage", "Drag a view here to display."), this.emptyPanelMessageElement.appendChild(t), e.appendChild(this.emptyPanelMessageElement), this._register(Mo.INSTANCE.registerTarget(this.emptyPanelMessageElement, {
      onDragOver: (i) => {
        K.stop(i.eventData, !0);
        const o = this.dndHandler.onDragEnter(i.dragAndDropData, void 0, i.eventData);
        xd(i.eventData.dataTransfer, "move", o);
      },
      onDragEnter: (i) => {
        var s;
        K.stop(i.eventData, !0);
        const o = this.dndHandler.onDragEnter(i.dragAndDropData, void 0, i.eventData);
        this.emptyPanelMessageElement.style.backgroundColor = o && ((s = this.theme.getColor(fn)) == null ? void 0 : s.toString()) || "";
      },
      onDragLeave: (i) => {
        K.stop(i.eventData, !0), this.emptyPanelMessageElement.style.backgroundColor = "";
      },
      onDragEnd: (i) => {
        K.stop(i.eventData, !0), this.emptyPanelMessageElement.style.backgroundColor = "";
      },
      onDrop: (i) => {
        K.stop(i.eventData, !0), this.emptyPanelMessageElement.style.backgroundColor = "", this.dndHandler.drop(i.dragAndDropData, void 0, i.eventData);
      }
    }));
  }
  createTitleArea(e) {
    const t = super.createTitleArea(e), i = t.appendChild(z(".global-actions"));
    return this.globalToolBar = this._register(new Mp(i, this.contextMenuService, {
      actionViewItemProvider: (o) => this.actionViewItemProvider(o),
      orientation: 0,
      getKeyBinding: (o) => this.keybindingService.lookupKeybinding(o.id),
      anchorAlignmentProvider: () => this.getTitleAreaDropDownAnchorAlignment(),
      toggleMenuTitle: p("moreActions", "More Actions...")
  ...
  layout(e, t, i, o) {
    this.layoutService.isVisible(this.partId) && (this.contentDimension = new G(e, t), super.layout(this.contentDimension.width, this.contentDimension.height, i, o), this.layoutCompositeBar(), this.layoutEmptyMessage());
  }
  layoutCompositeBar() {
    if (this.contentDimension && this.dimension) {
      let e = this.contentDimension.width - 40;
      this.toolBar && (e = Math.max(Fr.MIN_COMPOSITE_BAR_WIDTH, e - this.getToolbarWidth())), this.compositeBar.layout(new G(e, this.dimension.height));
    }
  }
  layoutEmptyMessage() {
    var e;
  ...
  updateGlobalToolbarActions() {
    ...
    (i = this.globalToolBar) == null || i.setActions(no(e), no(t));
  }
  getCompositeActions(e) {
    let t = this.compositeActions.get(e);
    if (!t) {
      ...
      if (i) {
        const o = this.viewDescriptorService.getViewContainerModel(i);
        t = {
          activityAction: this.instantiationService.createInstance(Jc, this.toActivity(o), this.viewContainerLocation),
          pinnedAction: new qa(this.toActivity(o), this.compositeBar),
          badgeAction: new Ya(this.toActivity(o), this.compositeBar)
        };
      } else
        t = {
          activityAction: this.instantiationService.createInstance(kb, e, this.viewContainerLocation),
          pinnedAction: new Zc(e, this.compositeBar),
          badgeAction: new mh(e, this.compositeBar)
        };
      this.compositeActions.set(e, t);
    }
  ...
  getCachedPanels() {
    const e = this.getPaneComposites(), i = JSON.parse(this.cachedPanelsValue).map((o) => {
      ...
      return s.visible = n ? Ze(s.visible) ? !0 : s.visible : !1, s;
    });
...
let en = class kh extends Qs {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m) {
    super(e, t, i, o, s, n, r, a, d, l, u, "workbench.parts.panel", kh.activePanelSettingsKey, "workbench.panel.pinnedPanels", "workbench.panel.placeholderPanels", qs.Panels, lr, 1, Np.bindTo(l), Fp.bindTo(l), {
      useIcons: !1,
      hasTitle: !0
    }), this.commandService = g, this.menuService = m;
  }
  updateStyles() {
    super.updateStyles();
    const e = j(this.getContainer()), t = this.getColor(kc) || this.getColor(ot) || "";
    e.style.borderLeftColor = t, e.style.borderRightColor = t;
    const i = this.getTitleArea();
    i && (i.style.borderTopColor = this.getColor(kc) || this.getColor(ot) || "");
  }
  getActivityHoverOptions() {
    return {
  ...
  fillExtraContextMenuActions(e) {
    const t = this.menuService.createMenu(b.PanelPositionMenu, this.contextKeyService), i = this.menuService.createMenu(b.PanelAlignmentMenu, this.contextKeyService), o = [], s = [];
    Gs(t, { shouldForwardArgs: !0 }, { primary: [], secondary: o }), Gs(i, { shouldForwardArgs: !0 }, { primary: [], secondary: s }), i.dispose(), t.dispose(), e.push(new Fe(), new ao("workbench.action.panel.position", p("panel position", "Panel Position"), o), new ao("workbench.action.panel.align", p("align panel", "Align Panel"), s), Ne({ id: Qc.ID, label: p("hidePanel", "Hide Panel"), run: () => this.commandService.executeCommand(Qc.ID) }));
  }
  layout(e, t, i, o) {
    let s;
    this.layoutService.getPanelPosition() === 1 ? s = new G(e - 1, t) : s = new G(e, t), super.layout(s.width, s.height, i, o);
  }
  toJSON() {
    return {
...
en.activePanelSettingsKey = "workbench.panelpart.activepanelid";
en = x([
  h(0, Be),
  h(1, Se),
  h(2, Ye),
...
var Zb = ".monaco-grid-view{overflow:hidden;position:relative}.monaco-grid-branch-node,.monaco-grid-view{height:100%;width:100%}";
be(Zb, {});
const Qb = {
  separatorBorder: bi.transparent
};
function Mt(c) {
  return c === 0 ? 1 : 0;
}
...
class Z {
  ...
  set edgeSnapping(e) {
    if (this._edgeSnapping !== e) {
      ...
      for (const t of this.children)
        t instanceof Z && (t.edgeSnapping = e);
      this.updateSplitviewEdgeSnappingEnablement();
    }
  }
  constructor(e, t, i, o, s = 0, n = 0, r = !1, a) {
    if (this.orientation = e, this.layoutController = t, this.splitviewProportionalLayout = o, this.children = [], this._absoluteOffset = 0, this._absoluteOrthogonalOffset = 0, this.absoluteOrthogonalSize = 0, this._onDidChange = new y(), this.onDidChange = this._onDidChange.event, this._onDidScroll = new y(), this.onDidScrollDisposable = R.None, this.onDidScroll = this._onDidScroll.event, this.childrenChangeDisposable = R.None, this._onDidSashReset = new y(), this.onDidSashReset = this._onDidSashReset.event, this.splitviewSashResetDisposable = R.None, this.childrenSashResetDisposable = R.None, this._boundarySashes = {}, this._edgeSnapping = !1, this._styles = i, this._size = s, this._orthogonalSize = n, this.element = z(".monaco-grid-branch-node"), !a)
      this.splitview = new Bo(
        this.element,
      ...
      const l = {
        views: a.map((g) => ({
          view: g.node,
          size: g.node.size,
          visible: g.node instanceof Ee && g.visible !== void 0 ? g.visible : !0
        })),
        size: this.orthogonalSize
      }, u = { proportionalLayout: o, orientation: e, styles: i };
      this.children = a.map((g) => g.node), this.splitview = new Bo(this.element, { ...u, descriptor: l }), this.children.forEach((g, m) => {
        const f = m === 0, C = m === this.children.length;
        g.boundarySashes = {
          start: this.boundarySashes.orthogonalStart,
          end: this.boundarySashes.orthogonalEnd,
          orthogonalStart: f ? this.boundarySashes.start : this.splitview.sashes[m - 1],
          orthogonalEnd: C ? this.boundarySashes.end : this.splitview.sashes[m]
        };
      });
    }
    const d = I.map(this.splitview.onDidSashReset, (l) => [l]);
  ...
  addChild(e, t, i, o) {
    i = vt(i, this.children.length), this.splitview.addView(e, t, i, o), this._addChild(e, i), this.onDidChildrenChange();
  }
  _addChild(e, t) {
    const i = t === 0, o = t === this.children.length;
    this.children.splice(t, 0, e), e.boundarySashes = {
      start: this.boundarySashes.orthogonalStart,
      end: this.boundarySashes.orthogonalEnd,
      orthogonalStart: i ? this.boundarySashes.start : this.splitview.sashes[t - 1],
      orthogonalEnd: o ? this.boundarySashes.end : this.splitview.sashes[t]
    }, i || (this.children[t - 1].boundarySashes = {
      ...this.children[t - 1].boundarySashes,
      orthogonalEnd: this.splitview.sashes[t - 1]
    }), o || (this.children[t + 1].boundarySashes = {
      ...this.children[t + 1].boundarySashes,
      orthogonalStart: this.splitview.sashes[t]
    });
  }
  removeChild(e, t) {
    e = vt(e, this.children.length), this.splitview.removeView(e, t), this._removeChild(e), this.onDidChildrenChange();
  }
  _removeChild(e) {
    const t = e === 0, i = e === this.children.length - 1, [o] = this.children.splice(e, 1);
    return t || (this.children[e - 1].boundarySashes = {
      ...this.children[e - 1].boundarySashes,
      orthogonalEnd: this.splitview.sashes[e - 1]
    }), i || (this.children[e].boundarySashes = {
      ...this.children[e].boundarySashes,
      orthogonalStart: this.splitview.sashes[Math.max(e - 1, 0)]
    }), o;
  }
  moveChild(e, t) {
    if (e = vt(e, this.children.length), t = vt(t, this.children.length), e === t)
      return;
    e < t && t--, this.splitview.moveView(e, t);
    const i = this._removeChild(e);
    this._addChild(i, t), this.onDidChildrenChange();
  }
  swapChildren(e, t) {
    e = vt(e, this.children.length), t = vt(t, this.children.length), e !== t && (this.splitview.swapViews(e, t), [this.children[e].boundarySashes, this.children[t].boundarySashes] = [this.children[e].boundarySashes, this.children[t].boundarySashes], [this.children[e], this.children[t]] = [this.children[t], this.children[e]], this.onDidChildrenChange());
  }
  resizeChild(e, t) {
    e = vt(e, this.children.length), this.splitview.resizeView(e, t);
  }
  ...
  distributeViewSizes(e = !1) {
    if (this.splitview.distributeViewSizes(), e)
      for (const t of this.children)
        t instanceof Z && t.distributeViewSizes(!0);
  }
  getChildSize(e) {
    return e = vt(e, this.children.length), this.splitview.getViewSize(e);
  }
  isChildVisible(e) {
    return e = vt(e, this.children.length), this.splitview.isViewVisible(e);
  }
  setChildVisible(e, t) {
    e = vt(e, this.children.length), this.splitview.isViewVisible(e) !== t && this.splitview.setViewVisible(e, t);
  }
  getChildCachedVisibleSize(e) {
    return e = vt(e, this.children.length), this.splitview.getViewCachedVisibleSize(e);
  }
  onDidChildrenChange() {
    this.updateChildrenEvents(), this._onDidChange.fire(void 0);
  }
  updateChildrenEvents() {
    const e = I.map(I.any(...this.children.map((o) => o.onDidChange)), () => {
    });
    this.childrenChangeDisposable.dispose(), this.childrenChangeDisposable = e(this._onDidChange.fire, this._onDidChange);
    const t = I.any(...this.children.map((o, s) => I.map(o.onDidSashReset, (n) => [s, ...n])));
    ...
    const i = I.any(I.signal(this.splitview.onDidScroll), ...this.children.map((o) => o.onDidScroll));
  ...
  trySet2x2(e) {
    ...
    return n.linkedSash = r, r.linkedSash = n, this._onDidChange.fire(void 0), e._onDidChange.fire(void 0), ie(() => {
...
function ov(c) {
  const [e, t] = I.split(c.onDidChange, Vi);
  return I.any(t, I.map(I.latch(I.map(
    e,
...
class Ee {
  ...
  set linkedWidthNode(e) {
    this._onDidLinkedWidthNodeChange.input = e ? e._onDidViewChange : I.None, this._linkedWidthNode = e, this._onDidSetLinkedNode.fire(void 0);
  }
  get linkedHeightNode() {
    return this._linkedHeightNode;
  }
  set linkedHeightNode(e) {
    this._onDidLinkedHeightNodeChange.input = e ? e._onDidViewChange : I.None, this._linkedHeightNode = e, this._onDidSetLinkedNode.fire(void 0);
  }
  constructor(e, t, i, o, s = 0) {
    ...
    const n = ov(e);
    this._onDidViewChange = I.map(
      n,
      (r) => r && (this.orientation === 0 ? r.width : r.height),
      this.disposables
    ), this.onDidChange = I.any(this._onDidViewChange, this._onDidSetLinkedNode.event, this._onDidLinkedWidthNodeChange.event, this._onDidLinkedHeightNodeChange.event);
  }
  get width() {
    return this.orientation === 1 ? this.orthogonalSize : this.size;
  }
  ...
  set boundarySashes(e) {
    var t, i;
    this._boundarySashes = e, (i = (t = this.view).setBoundarySashes) == null || i.call(t, tv(e, this.orientation));
  }
  layout(e, t, i) {
    if (this.layoutController.isLayoutEnabled) {
      if (typeof i > "u")
...
function xh(c, e, t) {
  if (c instanceof Z) {
    ...
    for (let s = c.children.length - 1; s >= 0; s--) {
      const n = c.children[s], r = n instanceof Z ? n.orthogonalSize : n.size;
      let a = c.size === 0 ? 0 : Math.round(e * r / c.size);
      o += a, s === 0 && (a += e - o), i.addChild(xh(n, t, a), a, 0, !0);
    }
    return i;
  } else
    return new Ee(
...
class oo {
  ...
  set root(e) {
    const t = this._root;
    t && (this.element.removeChild(t.element), t.dispose()), this._root = e, this.element.appendChild(e.element), this.onDidSashResetRelay.input = e.onDidSashReset, this._onDidChange.input = I.map(e.onDidChange, () => {
  ...
  set orientation(e) {
    ...
    this.root = xh(this._root, i, t), this.root.layout(t, 0, { orthogonalSize: i, absoluteOffset: s, absoluteOrthogonalOffset: o, absoluteSize: t, absoluteOrthogonalSize: i }), this.boundarySashes = this.boundarySashes;
  }
  set boundarySashes(e) {
    this._boundarySashes = e, this.root.boundarySashes = iv(e, this.orientation);
  }
  set edgeSnapping(e) {
    this.root.edgeSnapping = e;
  }
  constructor(e = {}) {
    this.onDidSashResetRelay = new ei(), this._onDidScroll = new ei(), this._onDidChange = new ei(), this._boundarySashes = {}, this.disposable2x2 = R.None, this.onDidSashReset = this.onDidSashResetRelay.event, this.onDidScroll = this._onDidScroll.event, this.onDidChange = this._onDidChange.event, this.element = z(".monaco-grid-view"), this.styles = e.styles || Qb, this.proportionalLayout = typeof e.proportionalLayout < "u" ? !!e.proportionalLayout : !0, this.layoutController = new ev(!1), this.root = new Z(
      0,
  ...
  addView(e, t, i) {
    this.disposable2x2.dispose(), this.disposable2x2 = R.None;
    const [o, s] = ge(i), [n, r] = this.getNode(o);
    if (r instanceof Z) {
      const a = new Ee(
        e,
        Mt(r.orientation),
      ...
      const [, a] = ge(n), [, d] = ge(o);
      let l = 0;
      const u = a.getChildCachedVisibleSize(d);
      typeof u == "number" && (l = yt.Invisible(u)), a.removeChild(d);
      const g = new Z(
        r.orientation,
        r.layoutController,
        this.styles,
      ...
      a.addChild(g, r.size, d);
      const m = new Ee(r.view, a.orientation, this.layoutController, r.size);
      g.addChild(m, l, 0), typeof t != "number" && t.type === "split" && (t = yt.Split(0));
      const f = new Ee(e, a.orientation, this.layoutController, r.size);
      g.addChild(f, t, s);
    }
    this.trySet2x2();
  }
  removeView(e, t) {
    this.disposable2x2.dispose(), this.disposable2x2 = R.None;
    const [i, o] = ge(e), [s, n] = this.getNode(i);
    if (!(n instanceof Z))
    ...
    const [, a] = ge(s), [, d] = ge(i), l = n.children[0], u = n.isChildVisible(0);
    n.removeChild(0);
    const g = a.children.map((m, f) => a.getChildSize(f));
    if (a.removeChild(d, t), l instanceof Z) {
      g.splice(d, 1, ...l.children.map((m) => m.size));
      for (let m = 0; m < l.children.length; m++) {
        const f = l.children[m];
        a.addChild(f, f.size, d + m);
      }
    } else {
      const m = new Ee(
        l.view,
        ...
        this.layoutController,
        l.size
      ), f = u ? l.orthogonalSize : yt.Invisible(l.orthogonalSize);
      a.addChild(m, f, d);
    }
  ...
  swapViews(e, t) {
    const [i, o] = ge(e), [, s] = this.getNode(i);
    if (!(s instanceof Z))
      throw new Error("Invalid from location");
    const n = s.getChildSize(o), r = s.children[o];
    if (!(r instanceof Ee))
      throw new Error("Invalid from location");
    const [a, d] = ge(t), [, l] = this.getNode(a);
    if (!(l instanceof Z))
      throw new Error("Invalid to location");
    const u = l.getChildSize(d), g = l.children[d];
    if (!(g instanceof Ee))
      throw new Error("Invalid to location");
    s === l ? s.swapChildren(o, d) : (s.removeChild(o), l.removeChild(d), s.addChild(g, n, o), l.addChild(r, u, d)), this.trySet2x2();
  }
  resizeView(e, t) {
    const [i, o] = ge(e), [s, n] = this.getNode(i);
    if (!(n instanceof Z))
  ...
  getViewCachedVisibleSize(e) {
    const [t, i] = ge(e), [, o] = this.getNode(t);
    if (!(o instanceof Z))
      throw new Error("Invalid location");
  ...
  static deserialize(e, t, i = {}) {
    ...
    const o = e.orientation, s = e.height, n = new oo(i);
  ...
  _deserializeNode(e, t, i, o) {
    ...
    if (e.type === "branch") {
      const r = e.data.map((a) => ({
        node: this._deserializeNode(a, Mt(t), i, e.size),
        visible: a.visible
      }));
      s = new Z(
        t,
  ...
  _getViews(e, t, i) {
    ...
    for (let n = 0; n < e.children.length; n++) {
      ...
      s.push(this._getViews(r, Mt(t), a));
    }
  ...
  trySet2x2() {
    if (this.disposable2x2.dispose(), this.disposable2x2 = R.None, this.root.children.length !== 2)
      return;
    const [e, t] = this.root.children;
    !(e instanceof Z) || !(t instanceof Z) || (this.disposable2x2 = e.trySet2x2(t));
  }
  getViewMap(e, t) {
    t || (t = this.root), t instanceof Z ? t.children.forEach((i) => this.getViewMap(e, i)) : e.set(t.view, t.element);
  }
  dispose() {
...
function Dh(c, e) {
  ...
  if (!Ni(c))
    throw new Error("Invalid location");
  const [t, ...i] = e;
  return Dh(c.children[t], i);
}
function nv(c, e) {
  return !(c.start >= e.end || e.start >= c.end);
}
function Ih(c, e) {
  const t = ec(e), i = e === 0 ? c.top : e === 3 ? c.left + c.width : e === 1 ? c.top + c.height : c.left, o = {
...
function rv(c, e, t) {
  ...
  function o(s, n, r) {
    if (Ni(s))
      ...
      const { offset: a, range: d } = Ih(s.box, n);
      a === r.offset && nv(d, r.range) && i.push(s);
    }
  }
  return o(c, e, t), i;
}
function Br(c, e) {
  return e.length % 2 === 0 ? Mt(c) : c;
}
function ec(c) {
  return c === 0 || c === 1 ? 0 : 1;
}
function cd(c, e, t) {
  const i = Br(c, e), o = ec(t);
  if (i === o) {
    let [s, n] = ge(e);
...
function Ah(c) {
  ...
  if (/\bmonaco-grid-view\b/.test(e.className))
    return [];
  const t = av(e), i = e.parentElement.parentElement.parentElement.parentElement;
  return [...Ah(i), t];
}
var Jo;
(function(c) {
  c.Distribute = { type: "distribute" }, c.Split = { type: "split" };
  function e(t) {
...
class cv extends R {
  ...
  constructor(e, t = {}) {
    super(), this.views = /* @__PURE__ */ new Map(), this.didLayout = !1, e instanceof oo ? (this.gridview = e, this.gridview.getViewMap(this.views)) : this.gridview = new oo(t), this._register(this.gridview), this._register(this.gridview.onDidSashReset(this.onDidSashReset, this)), e instanceof oo || this._addView(e, 0, [0]), this.onDidChange = this.gridview.onDidChange, this.onDidScroll = this.gridview.onDidScroll;
  }
  style(e) {
  ...
  addView(e, t, i, o) {
    ...
    const n = this.getViewLocation(i), r = cd(this.gridview.orientation, n, o);
    let a;
    if (typeof t == "number")
      a = t;
      ...
      t.type === "distribute" ? a = yt.Distribute : a = t;
    this._addView(e, a, r);
  }
  addViewAt(e, t, i) {
    if (this.views.has(e))
      throw new Error("Can't add same view twice");
    let o;
    typeof t == "number" ? o = t : t.type === "distribute" ? o = yt.Distribute : o = t, this._addView(e, o, i);
  }
  _addView(e, t, i) {
  ...
  removeView(e, t) {
    ...
    this.gridview.removeView(i, t && t.type === "distribute" ? yt.Distribute : void 0), this.views.delete(e);
  }
  moveView(e, t, i, o) {
    const s = this.getViewLocation(e), [n, r] = ge(s), a = this.getViewLocation(i), d = cd(this.gridview.orientation, a, o), [l, u] = ge(d);
    co(n, l) ? this.gridview.moveView(n, r, u) : (this.removeView(e, typeof t == "number" ? void 0 : t), this.addView(e, t, i, o));
  }
  moveViewTo(e, t) {
    const i = this.getViewLocation(e), [o, s] = ge(i), [n, r] = ge(t);
    if (co(o, n))
      this.gridview.moveView(o, s, r);
    else {
      const a = this.getViewSize(e), d = Br(this.gridview.orientation, i), l = this.getViewCachedVisibleSize(e), u = typeof l > "u" ? d === 1 ? a.width : a.height : Jo.Invisible(l);
      this.removeView(e), this.addViewAt(e, u, t);
    }
  }
  swapViews(e, t) {
  ...
  getNeighborViews(e, t, i = !1) {
    ...
    const o = this.getViewLocation(e), s = this.getViews(), n = Dh(s, o);
    let r = Ih(n.box, t);
    return i && (t === 0 && n.box.top === 0 ? r = { offset: s.box.top + s.box.height, range: r.range } : t === 3 && n.box.left + n.box.width === s.box.width ? r = { offset: 0, range: r.range } : t === 1 && n.box.top + n.box.height === s.box.height ? r = { offset: 0, range: r.range } : t === 2 && n.box.left === 0 && (r = { offset: s.box.left + s.box.width, range: r.range })), rv(s, sv(t), r).map((a) => a.view);
  }
  getViewLocation(e) {
  ...
  onDidSashReset(e) {
    const t = (s) => {
      ...
      if (Ni(n))
        return !1;
      const r = Br(this.orientation, s), a = r === 1 ? n.view.preferredWidth : n.view.preferredHeight;
      if (typeof a != "number")
        return !1;
...
class Li extends cv {
  ...
  static serializeNode(e, t) {
    ...
    return Ni(e) ? { type: "branch", data: e.children.map((o) => Li.serializeNode(o, Mt(t))), size: i } : typeof e.cachedVisibleSize == "number" ? { type: "leaf", data: e.view.toJSON(), size: e.cachedVisibleSize, visible: !1 } : { type: "leaf", data: e.view.toJSON(), size: i };
  }
  static deserialize(e, t, i = {}) {
    if (typeof e.orientation != "number")
      throw new Error("Invalid JSON: 'orientation' property must be a number.");
    ...
    if (typeof e.height != "number")
      throw new Error("Invalid JSON: 'height' property must be a number.");
    const o = oo.deserialize(e, t, i);
    return new Li(o, i);
  }
  static from(e, t = {}) {
    return Li.deserialize(Lh(e), { fromJSON: (i) => i }, t);
  }
  serialize() {
    return {
      root: Li.serializeNode(this.getViews(), this.orientation),
...
function Vh(c, e) {
  if (!e && c.groups && c.groups.length <= 1 && (c.groups = void 0), !Th(c))
    return;
  let t = 0, i = 0;
  for (const r of c.groups)
    Vh(r, !1), r.size && (t += r.size, i++);
  const o = i > 0 ? t : 1, s = c.groups.length - i, n = o / s;
  for (const r of c.groups)
    r.size || (r.size = n);
}
function Rh(c) {
  return Th(c) ? { type: "branch", data: c.groups.map((e) => Rh(e)), size: c.size } : { type: "leaf", data: c.data, size: c.size };
}
function Ph(c, e) {
  if (c.type === "branch") {
    const t = c.data.map((i) => Ph(i, Mt(e)));
    if (e === 0) {
...
function Lh(c) {
  Vh(c, !0);
  const e = Rh(c), { width: t, height: i } = Ph(e, c.orientation);
  return {
    root: e,
...
class uv {
  constructor(e, t, i, o) {
    this._disposables = new A(), this._onDidSelectItem = new y(), this._onDidFocusItem = new y(), this._onDidChangeFocus = new y(), this.onDidSelectItem = this._onDidSelectItem.event, this.onDidFocusItem = this._onDidFocusItem.event, this.onDidChangeFocus = this._onDidChangeFocus.event, this._items = new Array(), this._nodes = new Array(), this._freeNodes = new Array(), this._enabled = !0, this._focusedItemIdx = -1, this._selectedItemIdx = -1, this._domNode = document.createElement("div"), this._domNode.className = "monaco-breadcrumbs", this._domNode.tabIndex = 0, this._domNode.setAttribute("role", "list"), this._scrollable = new Hp(this._domNode, {
      vertical: 2,
      horizontal: 1,
      horizontalScrollbarSize: t,
      useShadows: !1,
      scrollYToX: !0
    }), this._separatorIcon = i, this._disposables.add(this._scrollable), this._disposables.add(Fd(this._domNode, "click", (r) => this._onClick(r))), e.appendChild(this._scrollable.getDomNode());
    const s = Bd(this._domNode);
    this._style(s, o);
    const n = fo(this._domNode);
  ...
  layout(e) {
    var t;
    e && G.equals(e, this._dimension) || ((t = this._pendingLayout) === null || t === void 0 || t.dispose(), e ? this._pendingLayout = this._updateDimensions(e) : this._pendingLayout = this._updateScrollbar());
  }
  _updateDimensions(e) {
    const t = new A();
    return t.add(Wp(() => {
...
`), e.innerText = i;
  ...
  setItems(e) {
    let t, i = [];
    try {
      t = Gp(this._items, e, (o, s) => o.equals(s)), i = this._items.splice(t, this._items.length - t, ...e.slice(t)), this._render(t), ue(i), this._focus(-1, void 0);
    } catch (o) {
  ...
  _renderItem(e, t) {
    ...
    const i = z(me.asCSSSelector(this._separatorIcon));
    t.appendChild(i);
  }
  _onClick(e) {
    if (this._enabled)
...
var pv = ".monaco-workbench .part.editor>.content .editor-group-container .breadcrumbs-control.hidden{display:none}.monaco-workbench .part.editor>.content .editor-group-container .breadcrumbs-control .monaco-breadcrumb-item.focused .hint-more,.monaco-workbench .part.editor>.content .editor-group-container .breadcrumbs-control .monaco-breadcrumb-item.focused .monaco-icon-label,.monaco-workbench .part.editor>.content .editor-group-container .breadcrumbs-control .monaco-breadcrumb-item.selected .hint-more,.monaco-workbench .part.editor>.content .editor-group-container .breadcrumbs-control .monaco-breadcrumb-item.selected .monaco-icon-label{text-decoration-line:underline}.monaco-workbench .monaco-breadcrumb-item.shows-symbol-icon .codicon[class*=codicon-symbol-]{padding-right:6px}.monaco-workbench .monaco-breadcrumbs-picker .arrow{border-style:solid;position:absolute;width:0}.monaco-workbench .monaco-breadcrumbs-picker .picker-item{flex:1;line-height:22px}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree{display:flex;flex-direction:column;height:100%;overflow:hidden}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree>.input{box-sizing:border-box;height:36px;padding:5px 9px;position:relative}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree>.tree{height:calc(100% - 36px)}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree.inactive>.input{display:none}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree.inactive>.tree{height:100%}.monaco-workbench .monaco-breadcrumbs-picker .highlighting-tree .monaco-highlighted-label .highlight{font-weight:700}";
be(pv, {});
class tn {
  constructor(e, t) {
...
let Wr = class {
  ...
  getElements() {
    ...
    for (let i = this._cfgSymbolPath.getValue() === "last" && t.length > 0 ? t.length - 1 : 0; i < t.length; i++)
      e.push(new Hr(t[i], this._currentOutline.value));
    return t.length === 0 && !this._currentOutline.value.isEmpty && e.push(new Hr(this._currentOutline.value, this._currentOutline.value)), e;
  }
  _initFilePathInfo(e) {
    if (Up(e, Re.untitled, Re.data))
      return {
        folder: void 0,
        path: []
      };
    const t = {
      folder: Bt(this._workspaceService.getWorkspaceFolder(e)),
      path: []
    };
    let i = e;
    for (; i && i.path !== "/" && !(t.folder && Qt(t.folder.uri, i)); ) {
      t.path.unshift(new tn(i, t.path.length === 0 ? Ve.FILE : Ve.FOLDER));
      const o = i.path.length;
      if (i = Ea(i), i.path.length === o)
        break;
    }
    return t.folder && this._workspaceService.getWorkbenchState() === 3 && t.path.unshift(new tn(t.folder.uri, Ve.ROOT_FOLDER)), t;
  }
  ...
  _bindToEditor(e) {
    const t = new st();
    this._currentOutline.clear(), this._outlineDisposables.clear(), this._outlineDisposables.add(ie(() => t.dispose(!0))), this._outlineService.createOutline(e, 2, t.token).then((i) => {
...
let on = class {
  ...
  async show(e, t, i, o, s) {
    const r = this._themeService.getColorTheme().getColor(Hd);
    this._arrow = document.createElement("div"), this._arrow.className = "arrow", this._arrow.style.borderColor = `transparent transparent ${r ? r.toString() : ""}`, this._domNode.appendChild(this._arrow), this._treeContainer = document.createElement("div"), this._treeContainer.style.background = r ? r.toString() : "", this._treeContainer.style.paddingTop = "2px", this._treeContainer.style.borderRadius = "3px", this._treeContainer.style.boxShadow = `0 0 8px 2px ${this._themeService.getColorTheme().getColor($p)}`, this._treeContainer.style.border = `1px solid ${this._themeService.getColorTheme().getColor(jp)}`, this._domNode.appendChild(this._treeContainer), this._layoutInfo = { maxHeight: t, width: i, arrowSize: o, arrowOffset: s, inputHeight: 0 }, this._tree = this._createTree(this._treeContainer, e), this._disposables.add(this._tree.onDidOpen(async (a) => {
      const { element: d, editorOptions: l, sideBySide: u } = a;
      await this._revealElement(d, { ...l, preserveFocus: !1 }, u);
...
class mv {
  getId(e) {
    return P.isUri(e) ? e.toString() : hr(e) ? e.id : si(e) ? e.uri.toString() : e.resource.toString();
  }
}
let Gr = class {
  constructor(e) {
  ...
  hasChildren(e) {
    return P.isUri(e) || hr(e) || si(e) || e.isDirectory;
  }
  async getChildren(e) {
    if (hr(e))
      return e.folders;
    let t;
    return si(e) ? t = e.uri : P.isUri(e) ? t = e : t = e.resource, (await this._fileService.resolve(t)).children ?? [];
  }
};
Gr = x([
  h(0, Ue)
...
let zr = class {
  ...
  renderElement(e, t, i) {
    ...
    let n, r;
    si(s) ? (n = s.uri, r = Ve.ROOT_FOLDER) : (n = s.resource, r = s.isDirectory ? Ve.FOLDER : Ve.FILE), i.setFile(n, {
      fileKind: r,
      hidePath: !0,
      fileDecorations: o,
      matches: Wo(e.filterData),
...
let Ur = class {
  constructor(e, t) {
    this._workspaceService = e, this._cachedExpressions = /* @__PURE__ */ new Map(), this._disposables = new A();
    const i = Ft.FileExcludes.bindTo(t), o = () => {
      e.getWorkspace().folders.forEach((s) => {
        ...
        for (const a in n) {
          if (typeof n[a] != "boolean")
            continue;
          const d = a.indexOf("**/") !== 0 ? Wd.join(s.uri.path, a) : a;
          r[d] = n[a];
        }
        this._cachedExpressions.set(s.uri.toString(), Yp(r));
      });
    };
  ...
  filter(e, t) {
    ...
    return !i || !this._cachedExpressions.has(i.uri.toString()) ? !0 : !this._cachedExpressions.get(i.uri.toString())(qp(i.uri.path, e.resource.path), rs(e.resource));
  }
};
Ur = x([
  h(0, at),
...
class vv {
  compare(e, t) {
    return si(e) && si(t) ? e.index - t.index : e.isDirectory === t.isDirectory ? Xp(e.name, t.name) : e.isDirectory ? -1 : 1;
  }
}
let Kr = class extends on {
  constructor(e, t, i, o, s, n, r) {
  ...
  _createTree(e) {
    ...
    const i = this._instantiationService.createInstance(bn, _a);
    return this._disposables.add(i), this._instantiationService.createInstance(as, "BreadcrumbsFilePicker", e, new gv(), [this._instantiationService.createInstance(zr, i)], this._instantiationService.createInstance(Gr), {
      multipleSelectionSupport: !1,
      sorter: new vv(),
      filter: this._instantiationService.createInstance(Ur),
      identityProvider: new mv(),
      keyboardNavigationLabelProvider: new fv(),
      accessibilityProvider: this._instantiationService.createInstance(bv),
  ...
  async _setInput(e) {
    ...
    let o;
    i === Ve.ROOT_FOLDER ? o = this._workspaceService.getWorkspace() : o = Ea(t);
    const s = this._tree;
    await s.setInput(o);
    let n;
  ...
  async _revealElement(e, t, i) {
    return !si(e) && e.isFile ? (this._onWillPickElement.fire(), await this._editorService.openEditor({ resource: e.resource, options: t }, i ? vi : void 0), !0) : !1;
  }
};
Kr = x([
  h(2, D),
...
class wv extends on {
  _createTree(e, t) {
    ...
    return this._instantiationService.createInstance(Gd, "BreadcrumbsOutlinePicker", e, i.delegate, i.renderers, i.treeDataSource, {
      ...i.options,
      sorter: this._instantiationService.createInstance($r, i.comparator, void 0),
      collapseByDefault: !0,
...
class sn extends tc {
  constructor(e, t, i) {
    super(), this.model = e, this.element = t, this.options = i, this._disposables = new A();
  }
  dispose() {
    this._disposables.dispose();
  }
  equals(e) {
    return e instanceof sn ? this.element.element === e.element.element && this.options.showFileIcons === e.options.showFileIcons && this.options.showSymbolIcons === e.options.showSymbolIcons : !1;
  }
  render(e) {
    const { element: t, outline: i } = this.element;
    if (t === i) {
      const r = z("span", void 0, "…");
      e.appendChild(r);
      return;
    }
    ...
    s.renderElement({
      ...
      visible: !0,
      filterData: void 0
    }, 0, n, void 0), this._disposables.add(ie(() => {
      s.disposeTemplate(n);
    }));
  }
}
...
let F = class Yt {
  ...
  update() {
    ...
    const e = ee.getCanonicalUri(this._editorGroup.activeEditor, { supportSideBySide: $.PRIMARY }), t = this.isHidden();
    if (!e || !this._fileService.hasProvider(e))
      return this._ckBreadcrumbsPossible.set(!1), t ? !1 : (this.hide(), !0);
    const i = ee.getOriginalUri(this._editorGroup.activeEditor, { supportSideBySide: $.PRIMARY });
    this.domNode.classList.toggle("hidden", !1), this._ckBreadcrumbsVisible.set(!0), this._ckBreadcrumbsPossible.set(!0);
    const o = this._instantiationService.createInstance(Wr, i ?? e, this._editorGroup.activeEditorPane);
    ...
    const s = () => {
      ...
      const l = this._cfShowIcons.getValue(), u = {
        ...this._options,
        showFileIcons: this._options.showFileIcons && l,
        showSymbolIcons: this._options.showSymbolIcons && l
      }, g = o.getElements().map((m) => m instanceof tn ? new nn(o, m, u, this._labels) : new sn(o, m, u));
      g.length === 0 ? (this._widget.setEnabled(!1), this._widget.setItems([new class extends tc {
        render(m) {
          m.innerText = p("empty", "no elements");
        }
        equals(m) {
          return m === this;
        }
      }()])) : (this._widget.setEnabled(!0), this._widget.setItems(g), this._widget.reveal(g[g.length - 1]));
    }, n = o.onDidUpdate(s), r = this._cfShowIcons.onDidChange(s);
    s(), this._breadcrumbsDisposables.clear(), this._breadcrumbsDisposables.add(n), this._breadcrumbsDisposables.add(ie(() => this._model.clear())), this._breadcrumbsDisposables.add(r), this._breadcrumbsDisposables.add(ie(() => this._widget.setItems([])));
    const a = () => {
      const l = this._cfTitleScrollbarSizing.getValue() ?? "default";
      this._widget.setHorizontalScrollbarSize(Yt.SCROLLBAR_SIZES[l]);
    };
    a();
  ...
  _onSelectEvent(e) {
    ...
    if (this._cfUseQuickPick.getValue()) {
      this._widget.setFocused(void 0), this._widget.setSelection(void 0), this._quickInputService.quickAccess.show(t instanceof Hr ? "@" : "");
      return;
    }
    let o, s;
    this._contextViewService.showContextView({
      render: (n) => {
        e.item instanceof nn ? o = this._instantiationService.createInstance(Kr, n, e.item.model.resource) : e.item instanceof sn && (o = this._instantiationService.createInstance(wv, n, e.item.model.resource));
        const r = o.onWillPickElement(() => this._contextViewService.hideContextView({ source: this, didPick: !0 })), a = Jp.onDidChange(() => this._contextViewService.hideContextView({ source: this })), d = fo(n), l = d.onDidBlur(() => {
        ...
        return this._breadcrumbsPickerShowing = !0, this._updateCkBreadcrumbsActive(), ur(o, r, a, d, l);
      },
      getAnchor: () => {
        if (!s) {
          ...
          let l;
          const u = Zp(e.node.firstChild), g = u.top + u.height + d;
          g + r >= window.innerHeight && (r = window.innerHeight - g - 30);
          let m = u.left;
          if (m + a >= n && (m = n - a), e.payload instanceof _t) {
            const f = a - 2 * d;
            l = e.payload.posx - m, l > f && (m = Math.min(n - a, m + l - f), l = f);
          } else
            l = u.left + u.width * 0.3 - m;
          o.show(t, r, a, d, Math.max(0, l)), s = { x: m, y: g };
        }
        return s;
      },
      onHide: (n) => {
  ...
  async _revealInEditor(e, t, i, o = !1) {
    if (t instanceof tn)
      if (t.kind === Ve.FILE)
        ...
        this._widget.setFocused(s[n + 1]), this._widget.setSelection(s[n + 1], Yt.Payload_Pick);
      }
    else
      t.outline.reveal(t, { pinned: o }, i === vi);
  }
  _getEditorGroup(e) {
    return e === Yt.Payload_RevealAside ? vi : e === Yt.Payload_Reveal ? Qp : void 0;
  }
};
F.HEIGHT = 22;
F.SCROLLBAR_SIZES = {
...
F.Payload_Reveal = {};
F.Payload_RevealAside = {};
F.Payload_Pick = {};
F.CK_BreadcrumbsPossible = new N("breadcrumbsPossible", !1, p("breadcrumbsPossible", "Whether the editor can show breadcrumbs"));
F.CK_BreadcrumbsVisible = new N("breadcrumbsVisible", !1, p("breadcrumbsVisible", "Whether breadcrumbs are currently visible"));
F.CK_BreadcrumbsActive = new N("breadcrumbsActive", !1, p("breadcrumbsActive", "Whether breadcrumbs have focus"));
F = x([
  h(3, H),
  h(4, ss),
  h(5, D),
...
te(class extends qe {
  constructor() {
    super({
      ...
      title: {
        value: p("cmd.toggle", "Toggle Breadcrumbs"),
        mnemonicTitle: p(
      ...
      category: ve.View,
      toggled: {
        condition: v.equals("config.breadcrumbs.enabled", !0),
        title: p("cmd.toggle2", "Breadcrumbs"),
        mnemonicTitle: p(
      ...
      menu: [
        { id: b.CommandPalette },
        { id: b.MenubarAppearanceMenu, group: "4_editor", order: 2 },
        { id: b.NotebookToolbar, group: "notebookLayout", order: 2 },
        { id: b.StickyScrollContext }
      ]
    });
  }
  run(e) {
    const t = e.get(L), i = Ft.IsEnabled.bindTo(t).getValue();
    Ft.IsEnabled.bindTo(t).updateValue(!i);
  }
});
function ic(c, e) {
  const t = c.get(oe), o = c.get($t).getWidget(t.activeGroup.id);
  if (o) {
    const s = Md(o.getItems());
    o.setFocused(s), e && o.setSelection(s, F.Payload_Pick);
  }
}
te(class extends qe {
  constructor() {
    super({
      ...
      title: {
        value: p("cmd.focusAndSelect", "Focus and Select Breadcrumbs"),
...
te(class extends qe {
  constructor() {
    super({
      ...
      title: {
        value: p("cmd.focus", "Focus Breadcrumbs"),
...
k.registerCommandAndKeybindingRule({
  ...
  weight: 200,
  primary: 3161,
  when: v.not("config.breadcrumbs.enabled"),
  handler: async (c) => {
    const e = c.get(D), t = c.get(L), i = Ft.IsEnabled.bindTo(t);
    return i.getValue() || (await i.updateValue(!0), await ka(50)), e.invokeFunction(ic, !0);
  }
});
k.registerCommandAndKeybindingRule({
  ...
  handler(c) {
    const e = c.get(oe), i = c.get($t).getWidget(e.activeGroup.id);
    i && i.focusNext();
  }
});
k.registerCommandAndKeybindingRule({
...
k.registerCommandAndKeybindingRule({
  ...
  handler(c) {
    const e = c.get(oe), i = c.get($t).getWidget(e.activeGroup.id);
    i && i.setSelection(i.getFocused(), F.Payload_Pick);
  }
});
k.registerCommandAndKeybindingRule({
  ...
  handler(c) {
    const e = c.get(oe), i = c.get($t).getWidget(e.activeGroup.id);
    i && i.setSelection(i.getFocused(), F.Payload_Reveal);
  }
});
k.registerCommandAndKeybindingRule({
...
k.registerCommandAndKeybindingRule({
  ...
  handler(c) {
    const e = c.get(U), i = c.get(O).lastFocusedList;
    if (!(i instanceof Gd) && !(i instanceof as))
      return;
    const o = i.getFocus()[0];
    if (P.isUri(o == null ? void 0 : o.resource))
      return e.openEditor({
        resource: o.resource,
        options: { pinned: !0 }
      }, vi);
...
let rn = class extends vn {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m) {
    super(u), this.accessor = t, this.group = i, this.contextMenuService = o, this.instantiationService = s, this.contextKeyService = n, this.keybindingService = r, this.notificationService = a, this.menuService = d, this.quickInputService = l, this.configurationService = g, this.fileService = m, this.editorTransfer = ti.getInstance(), this.groupTransfer = ti.getInstance(), this.treeItemsTransfer = ti.getInstance(), this.breadcrumbsControl = void 0, this.editorToolBarMenuDisposables = this._register(new A()), this.resourceContext = this._register(s.createInstance(fe)), this.editorPinnedContext = Ud.bindTo(n), this.editorIsFirstContext = Kd.bindTo(n), this.editorIsLastContext = $d.bindTo(n), this.editorStickyContext = jd.bindTo(n), this.editorCanSplitInGroupContext = tg.bindTo(n), this.sideBySideEditorContext = ig.bindTo(n), this.groupLockedContext = qd.bindTo(n), this.renderDropdownAsChildElement = !1, this.create(e);
  }
  createBreadcrumbsControl(e, t) {
    const i = this._register(Ft.IsEnabled.bindTo(this.configurationService));
    this._register(i.onDidChange(() => {
      const o = i.getValue();
      !o && this.breadcrumbsControl ? (this.breadcrumbsControl.dispose(), this.breadcrumbsControl = void 0, this.handleBreadcrumbsEnablementChange()) : o && !this.breadcrumbsControl && (this.breadcrumbsControl = this.instantiationService.createInstance(F, e, t, this.group), this.breadcrumbsControl.update(), this.handleBreadcrumbsEnablementChange());
    })), i.getValue() && (this.breadcrumbsControl = this.instantiationService.createInstance(F, e, t, this.group)), this._register(this.fileService.onDidChangeFileSystemProviderRegistrations((o) => {
      var s, n;
  ...
  createEditorActionsToolBar(e) {
    ...
    this.editorActionsToolbar = this._register(this.instantiationService.createInstance(wd, e, {
      actionViewItemProvider: (i) => this.actionViewItemProvider(i),
      orientation: 0,
      ariaLabel: p("ariaLabelEditorActions", "Editor actions"),
      getKeyBinding: (i) => this.getKeybinding(i),
      actionRunner: this._register(new Oh(t)),
      ...
      i.error && !Gi(i.error) && this.notificationService.error(i.error);
    }));
  }
  actionViewItemProvider(e) {
    ...
    return un(this.instantiationService, e, { menuAsChild: this.renderDropdownAsChildElement });
  }
  updateEditorActionsToolbar() {
    const { primary: e, secondary: t } = this.prepareEditorActions(this.getEditorActions());
    j(this.editorActionsToolbar).setActions(no(e), no(t));
  }
  getEditorActions() {
    const e = [], t = [];
    if (this.editorToolBarMenuDisposables.clear(), this.contextKeyService.bufferChangeEvents(() => {
      const o = this.group.activeEditor;
      this.resourceContext.set(Ic(ee.getOriginalUri(o, { supportSideBySide: $.PRIMARY }))), this.editorPinnedContext.set(o ? this.group.isPinned(o) : !1), this.editorIsFirstContext.set(o ? this.group.isFirst(o) : !1), this.editorIsLastContext.set(o ? this.group.isLast(o) : !1), this.editorStickyContext.set(o ? this.group.isSticky(o) : !1), this.editorCanSplitInGroupContext.set(o ? o.hasCapability(32) : !1), this.sideBySideEditorContext.set((o == null ? void 0 : o.typeId) === Pt.ID), this.groupLockedContext.set(this.group.isLocked);
    }), this.group.activeEditorPane instanceof Dc) {
      const o = this.getEditorPaneAwareContextKeyService(), s = this.menuService.createMenu(b.EditorTitle, o, { emitEventsForSubmenuChanges: !0, eventDebounceDelay: 0 });
      ...
      Ui(s, { arg: this.resourceContext.get(), shouldForwardArgs: !0 }, { primary: e, secondary: t }, "navigation", n);
    }
  ...
  enableGroupDragging(e) {
    this._register(w(e, S.DRAG_START, (t) => {
      var o;
      if (t.target !== e)
        return;
      this.groupTransfer.setData([new Ge(this.group.id)], Ge.prototype), t.dataTransfer && (t.dataTransfer.effectAllowed = "copyMove");
      let i = !1;
      if (this.accessor.partOptions.showTabs ? i = this.doFillResourceDataTransfers(this.group.getEditors(1), t) : this.group.activeEditor && (i = this.doFillResourceDataTransfers([this.group.activeEditor], t)), !i && og && ((o = t.dataTransfer) == null || o.setData(to.TEXT, String(this.group.label))), this.group.activeEditor) {
        let s = this.group.activeEditor.getName();
        this.accessor.partOptions.showTabs && this.group.count > 1 && (s = p("draggedEditorGroup", "{0} (+{1})", s, this.group.count - 1)), sg(t, s, "monaco-editor-group-drag-image", this.getColor(rg), this.getColor(ng));
      }
    })), this._register(w(e, S.DRAG_END, () => {
      this.groupTransfer.clearData(Ge.prototype);
    }));
  }
  doFillResourceDataTransfers(e, t) {
    return e.length ? (this.instantiationService.invokeFunction(Yd, e.map((i) => ({ editor: i, groupId: this.group.id })), t), !0) : !1;
  }
  onContextMenu(e, t, i) {
    const o = this.resourceContext.get();
    this.resourceContext.set(Ic(ee.getOriginalUri(e, { supportSideBySide: $.PRIMARY })));
    ...
    const l = !!this.editorCanSplitInGroupContext.get();
    this.editorCanSplitInGroupContext.set(e.hasCapability(32));
    const u = !!this.sideBySideEditorContext.get();
    this.sideBySideEditorContext.set(e.typeId === Pt.ID);
    let g = i;
    ...
    this.contextMenuService.showContextMenu({
      ...
      getKeyBinding: (m) => this.getKeybinding(m),
      onHide: () => {
        this.resourceContext.set(o || null), this.editorPinnedContext.set(s), this.editorIsFirstContext.set(n), this.editorIsLastContext.set(r), this.editorStickyContext.set(a), this.groupLockedContext.set(d), this.editorCanSplitInGroupContext.set(l), this.sideBySideEditorContext.set(u), this.accessor.activeGroup.focus();
      }
    });
  }
  getKeybinding(e) {
  ...
  getKeybindingLabel(e) {
    ...
    return t ? Bt(t.getLabel()) : void 0;
  }
  dispose() {
    ue(this.breadcrumbsControl), this.breadcrumbsControl = void 0, super.dispose();
  }
};
rn = x([
  h(3, xe),
...
let ri = class $e extends rn {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E, V) {
    super(e, t, i, o, s, n, r, a, d, l, u, g, m), this.editorService = f, this.pathService = C, this.editorGroupService = E, this.treeViewsDragAndDropService = V, this.closeEditorAction = this._register(this.instantiationService.createInstance(Fn, Fn.ID, Fn.LABEL)), this.unpinEditorAction = this._register(this.instantiationService.createInstance(Bn, Bn.ID, Bn.LABEL)), this.tabResourceLabels = this._register(this.instantiationService.createInstance(bn, _a)), this.tabLabels = [], this.tabActionBars = [], this.tabDisposables = [], this.dimensions = {
      container: G.None,
      available: G.None
    }, this.layoutScheduler = this._register(new je()), this.path = wn ? mg : Wd, this.lastMouseWheelEventTime = 0, this.isMouseOverTabs = !1, this.updateEditorLabelScheduler = this._register(new pn(() => this.doUpdateEditorLabels(), 0)), (async () => this.path = await this.pathService.path)(), this._register(this.tabResourceLabels.onDidChangeDecorations(() => this.doHandleDecorationsChange()));
  }
  create(e) {
    this.titleContainer = e, this.tabsAndActionsContainer = document.createElement("div"), this.tabsAndActionsContainer.classList.add("tabs-and-actions-container"), this.titleContainer.appendChild(this.tabsAndActionsContainer), this.tabsContainer = document.createElement("div"), this.tabsContainer.setAttribute("role", "tablist"), this.tabsContainer.draggable = !0, this.tabsContainer.classList.add("tabs-container"), this._register(ii.addTarget(this.tabsContainer)), this.tabSizingFixedDisposables = this._register(new A()), this.updateTabSizing(!1), this.tabsScrollbar = this._register(this.createTabsScrollbar(this.tabsContainer)), this.tabsAndActionsContainer.appendChild(this.tabsScrollbar.getDomNode()), this.registerTabsContainerListeners(this.tabsContainer, this.tabsScrollbar), this.editorToolbarContainer = document.createElement("div"), this.editorToolbarContainer.classList.add("editor-actions"), this.tabsAndActionsContainer.appendChild(this.editorToolbarContainer), this.createEditorActionsToolBar(this.editorToolbarContainer);
    const t = document.createElement("div");
  ...
  updateTabSizing(e) {
    const [t, i] = Zi(this.tabsContainer, this.tabSizingFixedDisposables);
    i.clear();
    ...
    })), i.add(w(t, S.MOUSE_LEAVE, () => {
      this.isMouseOverTabs = !1, this.updateTabsFixedWidth(!1);
    }))) : e && (t.style.removeProperty("--tab-sizing-fixed-max-width"), this.updateTabsFixedWidth(!1));
  }
  ...
  getTabsScrollbarSizing() {
    return this.accessor.partOptions.titleScrollbarSizing !== "large" ? $e.SCROLLBAR_SIZES.default : $e.SCROLLBAR_SIZES.large;
  }
  registerTabsContainerListeners(e, t) {
    this.enableGroupDragging(e), this._register(w(e, S.SCROLL, () => {
      e.classList.contains("scroll") && t.setScrollPosition({
        scrollLeft: e.scrollLeft
      });
    }));
    for (const o of [Te.Tap, S.DBLCLICK])
      this._register(w(e, o, (s) => {
        if (o === S.DBLCLICK) {
          if (s.target !== e)
            return;
        } else if (s.tapCount !== 2 || s.initialTarget !== e)
          return;
        K.stop(s), this.editorService.openEditor({
          resource: void 0,
          options: {
            pinned: !0,
    ...
    this._register(w(e, S.MOUSE_DOWN, (o) => {
      o.button === 1 && o.preventDefault();
    })), this._register(new fr(e, {
      onDragEnter: (o) => {
        ...
        let s = !1;
        if (this.editorTransfer.hasData(Ce.prototype)) {
          s = !0;
          const n = this.editorTransfer.getData(Ce.prototype);
          if (Array.isArray(n)) {
    ...
    })), this._register(w(e, S.MOUSE_WHEEL, (o) => {
      ...
      if (this.accessor.partOptions.scrollToSwitchTabs === !0) {
        ...
        return;
      const n = Date.now();
      if (n - this.lastMouseWheelEventTime < $e.MOUSE_WHEEL_EVENT_THRESHOLD - 2 * (Math.abs(o.deltaX) + Math.abs(o.deltaY)))
        return;
      this.lastMouseWheelEventTime = n;
      let r;
      if (o.deltaX + o.deltaY < -$e.MOUSE_WHEEL_DISTANCE_THRESHOLD)
        r = -1;
      else if (o.deltaX + o.deltaY > $e.MOUSE_WHEEL_DISTANCE_THRESHOLD)
        r = 1;
      else
        return;
      const a = this.group.getEditorByIndex(this.group.getIndexOfEditor(s) + r);
      a && (this.group.openEditor(a), K.stop(o, !0));
    }));
    const i = (o) => {
      K.stop(o);
      let s = e;
    ...
    this._register(w(e, Te.Contextmenu, (o) => i(o))), this._register(w(e, S.CONTEXT_MENU, (o) => i(o)));
  }
  ...
  handleOpenedEditors() {
    var n, r;
    const [e, t] = Zi(this.tabsContainer, this.tabsScrollbar);
  ...
  handleClosedEditors() {
    ...
    if (this.group.activeEditor) {
      const i = j(this.tabsContainer);
      for (; i.children.length > this.group.count; )
        (e = i.lastChild) == null || e.remove(), ue(this.tabDisposables.pop());
      this.computeTabLabels(), this.redraw({ forceRevealActiveTab: !0 });
    } else
      this.tabsContainer && oi(this.tabsContainer), this.tabDisposables = ue(this.tabDisposables), this.tabResourceLabels.clear(), this.tabLabels = [], this.activeTabLabel = void 0, this.tabActionBars = [], this.clearEditorActionsToolbar(), (t = this.breadcrumbsControl) == null || t.update();
  }
  moveEditor(e, t, i) {
    const o = this.tabLabels[t];
    this.tabLabels.splice(t, 1), this.tabLabels.splice(i, 0, o), this.forEachTab(
      (s, n, r, a, d, l) => {
        this.redrawTab(s, n, r, a, d, l);
      },
      Math.min(t, i),
      Math.max(t, i)
  ...
  doWithTab(e, t, i) {
    const s = j(this.tabsContainer).children[e], n = this.tabResourceLabels.get(e), r = this.tabLabels[e], a = this.tabActionBars[e];
    s && n && r && i(t, e, s, n, r, a);
  }
  createTab(e, t, i) {
    const o = document.createElement("div");
    o.draggable = !0, o.setAttribute("role", "tab"), o.classList.add("tab"), this._register(ii.addTarget(o));
    ...
    const a = new Oh({ groupId: this.group.id, editorIndex: e }), d = new vo(r, { ariaLabel: p("ariaLabelTabActions", "Tab actions"), actionRunner: a });
    d.onWillRun((m) => {
      m.action.id === this.closeEditorAction.id && this.blockRevealActiveTabOnce();
    });
    const l = ur(d, ie(el(this.tabActionBars, d))), u = document.createElement("div");
    u.classList.add("tab-border-bottom-container"), o.appendChild(u);
    const g = this.registerTabListeners(o, e, t, i);
    return this.tabDisposables.push(ur(g, l, a, n)), o;
  }
  registerTabListeners(e, t, i, o) {
    const s = new A(), n = (a, d) => {
      if (e.blur(), a instanceof MouseEvent && (a.button !== 0 || le && a.ctrlKey)) {
        a.button === 1 && a.preventDefault();
        return;
      }
      if (this.originatesFromTabActionBar(a))
        return;
      const l = this.group.getEditorByIndex(t);
      l && this.group.openEditor(l, { preserveFocus: d, activation: Ri.ACTIVATE });
    }, r = (a) => {
      K.stop(a);
      const d = this.group.getEditorByIndex(t);
      d && this.onContextMenu(d, a, e);
    };
    s.add(w(e, S.MOUSE_DOWN, (a) => n(a, !1))), s.add(w(e, Te.Tap, (a) => n(a, !0))), s.add(w(e, Te.Change, (a) => {
      o.setScrollPosition({ scrollLeft: o.getScrollPosition().scrollLeft - a.translationX });
    })), s.add(w(e, S.MOUSE_UP, (a) => {
      K.stop(a), e.blur();
    })), s.add(w(e, S.AUXCLICK, (a) => {
      a.button === 1 && (K.stop(a, !0), this.blockRevealActiveTabOnce(), this.closeEditorAction.run({ groupId: this.group.id, editorIndex: t }));
    })), s.add(w(e, S.KEY_DOWN, (a) => {
      const d = new Ct(a);
      d.shiftKey && d.keyCode === 68 && r(a);
    })), s.add(w(e, Te.Contextmenu, (a) => {
      r(a);
    })), s.add(w(e, S.KEY_UP, (a) => {
      const d = new Ct(a);
      let l = !1;
      if (d.equals(3) || d.equals(10)) {
        l = !0;
        const u = this.group.getEditorByIndex(t);
        u && this.group.openEditor(u);
      } else if ([15, 17, 16, 18, 14, 13].some((u) => d.equals(u))) {
        let u;
        d.equals(15) || d.equals(16) ? u = t - 1 : d.equals(17) || d.equals(18) ? u = t + 1 : d.equals(14) ? u = 0 : u = this.group.count - 1;
        const g = this.group.getEditorByIndex(u);
        g && (l = !0, this.group.openEditor(g, { preserveFocus: !0 }), i.childNodes[u].focus());
      }
      l && K.stop(a, !0), o.setScrollPosition({
        scrollLeft: i.scrollLeft
      });
    }));
    for (const a of [Te.Tap, S.DBLCLICK])
      s.add(w(e, a, (d) => {
        if (a === S.DBLCLICK)
          K.stop(d);
          ...
          return;
        const l = this.group.getEditorByIndex(t);
        l && this.group.isPinned(l) ? this.accessor.arrangeGroups(2, this.group) : this.group.pinEditor(l);
      }));
    return s.add(w(e, S.CONTEXT_MENU, (a) => {
      K.stop(a, !0);
      const d = this.group.getEditorByIndex(t);
      d && this.onContextMenu(d, a, e);
    }, !0)), s.add(w(e, S.DRAG_START, (a) => {
      const d = this.group.getEditorByIndex(t);
      d && (this.editorTransfer.setData([new Ce({ editor: d, groupId: this.group.id })], Ce.prototype), a.dataTransfer && (a.dataTransfer.effectAllowed = "copyMove"), this.doFillResourceDataTransfers([d], a), e.classList.add("dragged"), nr(() => e.classList.remove("dragged")));
    })), s.add(new fr(e, {
      onDragEnter: (a) => {
        ...
        if (this.editorTransfer.hasData(Ce.prototype)) {
          d = !0;
          const l = this.editorTransfer.getData(Ce.prototype);
          if (Array.isArray(l)) {
            const u = l[0].identifier;
            if (u.editor === this.group.getEditorByIndex(t) && u.groupId === this.group.id) {
              a.dataTransfer && (a.dataTransfer.dropEffect = "none");
              return;
            }
          }
      ...
      onDragOver: (a, d) => {
        if (d >= $e.DRAG_OVER_OPEN_TAB_THRESHOLD) {
          const l = this.group.getEditorByIndex(t);
          l && this.group.activeEditor !== l && this.group.openEditor(l, { preserveFocus: !0 });
        }
      },
      onDragLeave: () => {
      ...
      onDragEnd: () => {
        e.classList.remove("dragged-over"), this.updateDropFeedback(e, !1, t), this.editorTransfer.clearData(Ce.prototype);
      },
      onDrop: (a) => {
  ...
  isSupportedDropTransfer(e) {
    if (this.groupTransfer.hasData(Ge.prototype)) {
      const t = this.groupTransfer.getData(Ge.prototype);
      return !(Array.isArray(t) && t[0].identifier === this.group.id);
    }
    return !!(this.editorTransfer.hasData(Ce.prototype) || e.dataTransfer && e.dataTransfer.types.length > 0);
  }
  updateDropFeedback(e, t, i) {
    const o = typeof i == "number", s = typeof i == "number" ? this.group.getEditorByIndex(i) : void 0, n = o && !!s && this.group.isActive(s), r = o ? this.getColor(n ? gr : mr) : "";
    e.style.backgroundColor = (t ? this.getColor(fn) : r) || "";
    const a = this.getColor(ro);
  ...
  computeTabLabels() {
    ...
    for (let n = 0; n < this.group.editors.length; n++) {
      ...
      o.push({
        ...
        title: r.getTitle(2),
        ariaLabel: bg(r, n, this.group, this.editorGroupService.count)
  ...
  shortenTabLabels(e) {
    ...
    for (const i of e)
      typeof i.description == "string" ? Hn(t, i.name, []).push(i) : i.description = "";
    for (const [, i] of t) {
      ...
      for (const a of i)
        Hn(o, a.description, []).push(a);
      let s = !1;
      for (const [, a] of o)
        if (!s && a.length > 1) {
          const [d, ...l] = a.map(({ editor: u }) => u.getDescription(2));
          s = l.some((u) => u !== d);
        }
      if (s) {
        o.clear();
        for (const a of i)
          a.description = a.editor.getDescription(2), Hn(o, a.description, []).push(a);
      }
      const n = [];
      for (const [a] of o)
        n.push(a);
      ...
      const r = vg(n, this.path.sep);
      n.forEach((a, d) => {
        for (const l of o.get(a) || [])
          l.description = r[d];
      });
    }
  }
  ...
  redraw(e) {
    if (this.tabsAndActionsContainer) {
      let t = this.getColor(wg);
      !t && Da(this.theme.type) && (t = this.getColor(pr) || this.getColor(ot)), t ? (this.tabsAndActionsContainer.classList.add("tabs-border-bottom"), this.tabsAndActionsContainer.style.setProperty("--tabs-border-bottom-color", t.toString())) : (this.tabsAndActionsContainer.classList.remove("tabs-border-bottom"), this.tabsAndActionsContainer.style.removeProperty("--tabs-border-bottom-color"));
    }
    this.forEachTab((t, i, o, s, n, r) => {
  ...
  redrawTab(e, t, i, o, s, n) {
    ...
    const l = r && a.pinnedTabSizing === "compact" ? "off" : a.tabCloseButton;
    for (const g of ["off", "left", "right"])
      i.classList.toggle(`tab-actions-${g}`, l === g);
    const u = r && a.pinnedTabSizing === "shrink" ? "shrink" : a.tabSizing;
    for (const g of ["fit", "shrink", "fixed"])
      i.classList.toggle(`sizing-${g}`, u === g);
    i.classList.toggle("has-icon", a.showIcons && a.hasIcons), i.classList.toggle("sticky", r);
    for (const g of ["normal", "compact", "shrink"])
      i.classList.toggle(`sticky-${g}`, r && a.pinnedTabSizing === g);
    if (!a.wrapTabs && r && a.pinnedTabSizing !== "normal") {
      let g = 0;
      switch (a.pinnedTabSizing) {
        case "compact":
          g = $e.TAB_WIDTH.compact;
          break;
        case "shrink":
          g = $e.TAB_WIDTH.shrink;
          break;
      }
      i.style.left = `${t * g}px`;
    } else
  ...
  redrawTabLabel(e, t, i, o, s) {
    ...
    let r, a = !1, d = !!((m = n.decorations) != null && m.badges), l;
    n.pinnedTabSizing === "compact" && this.group.isSticky(t) ? (r = n.showIcons && n.hasIcons ? "" : (f = s.name) == null ? void 0 : f.charAt(0).toUpperCase(), l = "", a = !0, d = !1) : (r = s.name, l = s.description || ""), s.ariaLabel && (i.setAttribute("aria-label", s.ariaLabel), i.setAttribute("aria-description", ""));
    const u = s.title || "";
    i.title = u, o.setResource({ name: r, description: l, resource: ee.getOriginalUri(e, { supportSideBySide: $.BOTH }) }, {
      title: u,
      extraClasses: et(["tab-label", d ? "tab-label-has-badge" : void 0].concat(e.getLabelExtraClasses())),
      italic: !this.group.isPinned(e),
      forceLabel: a,
      fileDecorations: {
        colors: !!((C = n.decorations) != null && C.colors),
        badges: d
      }
    });
    const g = ee.getOriginalUri(e, { supportSideBySide: $.PRIMARY });
    g ? i.setAttribute("data-resource-name", yg(g)) : i.removeAttribute("data-resource-name");
  }
  ...
  doRedrawTabActive(e, t, i, o, s) {
    if (this.group.isActive(i)) {
      o.classList.add("active"), o.setAttribute("aria-selected", "true"), o.tabIndex = 0, o.style.backgroundColor = this.getColor(e ? gr : Zd) || "";
      const n = this.getColor(e ? Cg : Sg);
      ...
      const r = t ? this.getColor(e ? Eg : _g) : void 0;
      r ? (o.classList.add("tab-border-top"), o.style.setProperty("--tab-border-top-color", r.toString())) : (o.classList.remove("tab-border-top"), o.style.removeProperty("--tab-border-top-color")), o.style.color = this.getColor(e ? tl : il) || "", s.setFocusable(!0);
    } else
      o.classList.remove("active"), o.setAttribute("aria-selected", "false"), o.tabIndex = -1, o.style.backgroundColor = this.getColor(e ? mr : Qd) || "", o.style.boxShadow = "", o.style.color = this.getColor(e ? kg : xg) || "", s.setFocusable(!1);
  }
  doRedrawTabDirty(e, t, i, o) {
    ...
    if (i.isDirty() && !i.isSaving())
      if (o.classList.add("dirty"), this.accessor.partOptions.highlightModifiedTabs) {
        let n;
        e && t ? n = this.getColor(Dg) : e && !t ? n = this.getColor(Ig) : !e && t ? n = this.getColor(Ag) : n = this.getColor(Tg), n && (s = !0, o.classList.add("dirty-border-top"), o.style.setProperty("--tab-dirty-border-top-color", n));
      } else
  ...
  redrawTabBorders(e, t) {
    const s = (this.group.isSticky(e) && this.group.stickyCount === e + 1 ? this.getColor(Vg) : void 0) || this.getColor(pr) || this.getColor(ot);
    t.style.borderRight = s ? `1px solid ${s}` : "", t.style.outlineColor = this.getColor(ro) || "";
  }
  prepareEditorActions(e) {
    return this.accessor.activeGroup === this.group ? e : {
      primary: e.primary.filter((i) => i.id === ol),
  ...
  getHeight() {
    ...
    return this.dimensions.used ? {
      ...
      offset: e ? this.dimensions.used.height - F.HEIGHT : this.dimensions.used.height
    } : this.computeHeight();
  }
  computeHeight() {
    var i;
    let e;
    this.accessor.partOptions.wrapTabs && ((i = this.tabsAndActionsContainer) != null && i.classList.contains("wrapping")) ? e = this.tabsAndActionsContainer.offsetHeight : e = $e.TAB_HEIGHT;
    const t = e;
    return this.breadcrumbsControl && !this.breadcrumbsControl.isHidden() && (e += F.HEIGHT), { total: e, offset: t };
  }
  layout(e, t) {
    ...
    }), this.dimensions.used || (this.dimensions.used = new G(e.container.width, this.computeHeight().total)), this.dimensions.used;
  }
  doLayout(e, t) {
    const i = this.group.activeEditor ? this.getTabAndIndex(this.group.activeEditor) : void 0;
    if (i && e.container !== G.None && e.available !== G.None) {
      this.doLayoutBreadcrumbs(e);
      const [n, r] = i;
      this.doLayoutTabs(n, r, e, t);
    }
    const o = this.dimensions.used, s = this.dimensions.used = new G(e.container.width, this.computeHeight().total);
  ...
  doLayoutBreadcrumbs(e) {
    this.breadcrumbsControl && !this.breadcrumbsControl.isHidden() && this.breadcrumbsControl.layout(new G(e.container.width, F.HEIGHT));
  }
  doLayoutTabs(e, t, i, o) {
    this.doLayoutTabsWrapping(i) || this.doLayoutTabsNonWrapping(e, t, o);
  }
  doLayoutTabsWrapping(e) {
    const [t, i, o, s] = Zi(this.tabsAndActionsContainer, this.tabsContainer, this.editorToolbarContainer, this.tabsScrollbar), n = t.classList.contains("wrapping");
    let r = n;
    function a(d) {
    ...
    if (this.accessor.partOptions.wrapTabs) {
      const d = i.offsetWidth, l = i.scrollWidth, u = () => {
        const g = this.getLastTab();
        return g ? !(g.offsetWidth + o.offsetWidth - e.available.width > 1) : !0;
      };
      (r || l > d && u()) && a(!0), r && (i.offsetHeight > e.available.height || l === d && i.offsetHeight === $e.TAB_HEIGHT || !u()) && a(!1);
    } else
      n && a(!1);
    if (r && !n) {
    ...
    if (r) {
      ...
      for (const g of i.children) {
        const m = g, f = m.offsetTop;
        f !== l && (l = f, u && d.set(u, !0)), u = m, d.set(m, !1);
      }
      u && d.set(u, !0);
      for (const [g, m] of d)
        g.classList.toggle("last-in-row", m);
    }
    return r;
  }
  doLayoutTabsNonWrapping(e, t, i) {
    const [o, s] = Zi(this.tabsContainer, this.tabsScrollbar), n = o.offsetWidth, r = o.scrollWidth;
    let a = 0;
    if (this.group.stickyCount > 0) {
      let De = 0;
      switch (this.accessor.partOptions.pinnedTabSizing) {
        case "compact":
          De = $e.TAB_WIDTH.compact;
          break;
        case "shrink":
          De = $e.TAB_WIDTH.shrink;
          break;
      }
      a = this.group.stickyCount * De;
    }
    let d = this.accessor.partOptions.pinnedTabSizing !== "normal" && this.group.isSticky(t), l = n - a;
    this.group.stickyCount > 0 && l < $e.TAB_WIDTH.fit ? (o.classList.add("disable-sticky-tabs"), l = n, a = 0, d = !1) : o.classList.remove("disable-sticky-tabs");
    let u, g;
    this.blockRevealActiveTab || (u = e.offsetLeft, g = e.offsetWidth);
    const { width: m, scrollWidth: f } = s.getScrollDimensions();
    s.setScrollDimensions({
      width: n,
      scrollWidth: r
    });
    const C = m !== n || f !== r;
    if (this.blockRevealActiveTab || typeof u != "number" || typeof g != "number" || d || !C && !(i != null && i.forceRevealActiveTab)) {
      this.blockRevealActiveTab = !1;
      return;
    }
    const E = s.getScrollPosition().scrollLeft, V = g <= l, B = u - a;
    V && E + l < B + g ? s.setScrollPosition({
      scrollLeft: E + (B + g - (E + l))
    }) : (E > B || !V) && s.setScrollPosition({
      scrollLeft: B
    });
  }
  getTabAndIndex(e) {
  ...
  getTabAtIndex(e) {
    if (e >= 0)
      return j(this.tabsContainer).children[e];
  }
  getLastTab() {
  ...
  originatesFromTabActionBar(e) {
    let t;
    return e instanceof MouseEvent ? t = e.target || e.srcElement : t = e.initialTarget, !!Us(t, "action-item", "tab");
  }
  async onDrop(e, t, i) {
    if (K.stop(e, !0), this.updateDropFeedback(i, !1), i.classList.remove("scroll"), this.groupTransfer.hasData(Ge.prototype)) {
      const o = this.groupTransfer.getData(Ge.prototype);
      if (Array.isArray(o)) {
        ...
        this.group.focus(), this.groupTransfer.clearData(Ge.prototype);
      }
    } else if (this.editorTransfer.hasData(Ce.prototype)) {
      const o = this.editorTransfer.getData(Ce.prototype);
      if (Array.isArray(o)) {
        const s = o[0].identifier, n = this.accessor.getGroup(s.groupId);
        n && (this.isMoveOperation(e, s.groupId, s.editor) ? n.moveEditor(s.editor, this.group, { index: t }) : n.copyEditor(s.editor, this.group, { index: t })), this.group.focus(), this.editorTransfer.clearData(Ce.prototype);
      }
    } else if (this.treeItemsTransfer.hasData(Lt.prototype)) {
      const o = this.treeItemsTransfer.getData(Lt.prototype);
      if (Array.isArray(o)) {
        const s = [];
        for (const n of o) {
      ...
      this.treeItemsTransfer.clearData(Lt.prototype);
    } else
      this.instantiationService.createInstance(nl, { allowWorkspaceOpen: !1 }).handleDrop(e, () => this.group, () => this.group.focus(), t);
  }
  isMoveOperation(e, t, i) {
    return i != null && i.hasCapability(8) ? !0 : !(e.ctrlKey && !le || e.altKey && le) || t === this.group.id;
  }
  dispose() {
    super.dispose(), this.tabDisposables = ue(this.tabDisposables);
  }
};
ri.SCROLLBAR_SIZES = {
  default: 3,
...
ri.TAB_HEIGHT = 35;
ri.DRAG_OVER_OPEN_TAB_THRESHOLD = 1500;
ri.MOUSE_WHEEL_EVENT_THRESHOLD = 150;
ri.MOUSE_WHEEL_DISTANCE_THRESHOLD = 1.5;
ri = x([
  h(3, xe),
  h(4, D),
  h(5, H),
...
ba((c, e) => {
  const t = c.getColor(pr);
  t && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container > .title > .tabs-and-actions-container.wrapping .tabs-container > .tab {
				border-bottom: 1px solid ${t};
			}
		`);
  const i = c.getColor(ro);
  i && e.addRule(`
		...
		`);
  const o = c.getColor(ot);
  o && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container > .title .editor-actions {
				outline: 1px solid ${o}
			}
		`);
  const s = c.getColor(ag);
  s && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container.active > .title .tabs-container > .tab:hover  {
				background-color: ${s} !important;
			}
		`);
  const n = c.getColor(cg);
  n && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container > .title .tabs-container > .tab:hover  {
				background-color: ${n} !important;
			}
		`);
  const r = c.getColor(dg);
  r && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container.active > .title .tabs-container > .tab:hover  {
				color: ${r} !important;
			}
		`);
  const a = c.getColor(lg);
  a && e.addRule(`
			.monaco-workbench .part.editor > .content .editor-group-container > .title .tabs-container > .tab:hover  {
				color: ${a} !important;
			}
		`);
  const d = c.getColor(hg);
  d && e.addRule(`
  ...
  if (l && e.addRule(`
		...
		`), !Da(c.type) && !pg && !i) {
    const u = gg(c), g = c.getColor(Ia), m = c.getColor(Jd), f = c.getColor(fn);
    let C;
    m && g && (C = m.flatten(g, g, u));
    let E;
    m && g && f && g && (E = m.flatten(g, f, g, u));
    const V = (T, ne, ye = !1) => `
		...
		`;
    if (s && C && E) {
      const T = s.flatten(C), ne = s.flatten(E);
      e.addRule(V(T, ne, !0));
    }
    if (n && C && E) {
      const T = n.flatten(C), ne = n.flatten(E);
      e.addRule(V(T, ne));
    }
    if (f && E) {
      const T = f.flatten(E);
    ...
    const B = (T, ne, ye, li) => `
		...
		`, De = c.getColor(gr);
    if (De && C && E) {
      const T = De.flatten(C), ne = De.flatten(E);
      e.addRule(B(T, ne, !0, !0));
    }
    const Me = c.getColor(Zd);
    if (Me && C && E) {
      const T = Me.flatten(C), ne = Me.flatten(E);
      e.addRule(B(T, ne, !1, !0));
    }
    const bt = c.getColor(mr);
    if (bt && C && E) {
      const T = bt.flatten(C), ne = bt.flatten(E);
      e.addRule(B(T, ne, !0, !1));
    }
    const Ke = c.getColor(Qd);
    if (Ke && C && E) {
      const T = Ke.flatten(C), ne = Ke.flatten(E);
      e.addRule(B(T, ne, !1, !1));
    }
  }
});
let jr = class extends R {
  get minimumWidth() {
    var e;
    return ((e = this._activeEditorPane) == null ? void 0 : e.minimumWidth) ?? Ac.width;
  }
  get minimumHeight() {
    var e;
    return ((e = this._activeEditorPane) == null ? void 0 : e.minimumHeight) ?? Ac.height;
  }
  get maximumWidth() {
    var e;
    return ((e = this._activeEditorPane) == null ? void 0 : e.maximumWidth) ?? Tc.width;
  }
  get maximumHeight() {
    var e;
    return ((e = this._activeEditorPane) == null ? void 0 : e.maximumHeight) ?? Tc.height;
  }
  get activeEditorPane() {
    return this._activeEditorPane;
  }
  constructor(e, t, i, o, s, n, r, a, d) {
    super(), this.editorGroupParent = e, this.editorPanesParent = t, this.groupView = i, this.layoutService = o, this.instantiationService = s, this.editorProgressService = n, this.workspaceTrustService = r, this.logService = a, this.dialogService = d, this._onDidFocus = this._register(new y()), this.onDidFocus = this._onDidFocus.event, this._onDidChangeSizeConstraints = this._register(new y()), this.onDidChangeSizeConstraints = this._onDidChangeSizeConstraints.event, this._activeEditorPane = null, this.editorPanes = [], this.activeEditorPaneDisposables = this._register(new A()), this.editorOperation = this._register(new Pg(this.editorProgressService)), this.editorPanesRegistry = de.as(rl.EditorPane), this.registerListeners();
  }
  registerListeners() {
  ...
  async doShowError(e, t, i, o) {
    ...
    let s = !1;
    if ((i == null ? void 0 : i.source) === al.USER && (!Vc(e) || e.allowDialog) && (s = await this.doShowErrorDialog(e, t)), s)
      return { error: e };
    const n = { ...i };
    return Gi(e) || (n.error = e), {
      ...await this.doOpenEditor(Lg.DESCRIPTOR, t, n, o),
      error: e
    };
  }
  async doShowErrorDialog(e, t) {
    let i = Ks.Error, o, s = Go(e), n;
    Vc(e) && (n = e.actions, i = e.forceSeverity ?? Ks.Error, e.forceMessage && (o = e.message, s = void 0)), o || (o = p("editorOpenErrorDialog", "Unable to open '{0}'", t.getName()));
    const r = [];
    if (n && n.length > 0)
      for (const u of n)
        r.push({
      ...
      r.push({
        label: p({ key: "ok", comment: ["&& denotes a mnemonic"] }, "&&OK"),
        run: () => {
        }
      });
    let a;
    ...
    let d = !1;
    const { result: l } = await this.dialogService.prompt({
      type: i,
      message: o,
      detail: s,
      buttons: r,
    ...
    if (l) {
      const u = l.run();
      u instanceof Promise && u.catch((g) => this.dialogService.error(Go(g))), d = !0;
    }
    return d;
  }
  ...
  shouldRestoreFocus(e) {
    ...
    return !!(!t || t === document.body || e === t || t.tagName !== "INPUT" && t.tagName !== "TEXTAREA" || Ht(t, this.editorGroupParent));
  }
  getEditorPaneDescriptor(e) {
    return e.hasCapability(16) && !this.workspaceTrustService.isWorkspaceTrusted() ? Og.DESCRIPTOR : j(this.editorPanesRegistry.getEditorPane(e));
  }
  doShowEditorPane(e) {
    ...
    const i = j(t.getContainer());
    return this.editorPanesParent.appendChild(i), go(i), t.setVisible(!0, this.groupView), this.pagePosition && t.layout(new G(this.pagePosition.width, this.pagePosition.height), { top: this.pagePosition.top, left: this.pagePosition.left }), this.boundarySashes && t.setBoundarySashes(this.boundarySashes), t;
  }
  ...
  doHideActiveEditorPane() {
    if (!this._activeEditorPane)
      return;
    this.editorOperation.stop(), this._activeEditorPane.clearInput(), this._activeEditorPane.setVisible(!1, this.groupView);
    const e = this._activeEditorPane.getContainer();
    e && (this.editorPanesParent.removeChild(e), mo(e)), this.doSetActiveEditorPane(null);
  }
  closeEditor(e) {
    var t;
  ...
  setVisible(e) {
    var t;
    (t = this._activeEditorPane) == null || t.setVisible(e, this.groupView);
  }
  layout(e) {
    var t;
    this.pagePosition = e, (t = this._activeEditorPane) == null || t.layout(new G(e.width, e.height), e);
  }
  setBoundarySashes(e) {
    var t;
    this.boundarySashes = e, (t = this._activeEditorPane) == null || t.setBoundarySashes(e);
  }
};
jr = x([
  h(3, pt),
...
class An extends rn {
  ...
  create(e) {
    ...
    t.draggable = !0, this.registerContainerListeners(t), this._register(ii.addTarget(t));
    const i = document.createElement("div");
  ...
  registerContainerListeners(e) {
    this.enableGroupDragging(e), this._register(w(e, S.DBLCLICK, (t) => this.onTitleDoubleClick(t))), this._register(w(e, S.AUXCLICK, (t) => this.onTitleAuxClick(t))), this._register(w(e, Te.Tap, (t) => this.onTitleTap(t)));
    for (const t of [S.CONTEXT_MENU, Te.Contextmenu])
      this._register(w(e, t, (i) => {
        this.group.activeEditor && this.onContextMenu(this.group.activeEditor, i, e);
      }));
  }
  onTitleLabelClick(e) {
    K.stop(e, !1), setTimeout(() => this.quickInputService.quickAccess.show());
  }
  onTitleDoubleClick(e) {
    K.stop(e), this.group.pinEditor();
  }
  onTitleAuxClick(e) {
    e.button === 1 && this.group.activeEditor && (K.stop(e, !0), this.group.closeEditor(this.group.activeEditor));
  }
  onTitleTap(e) {
    const t = e.initialTarget;
    !(t instanceof HTMLElement) || !this.editorLabel || !Ht(t, this.editorLabel.element) || setTimeout(() => this.quickInputService.quickAccess.show(), 50);
  }
  openEditor(e) {
  ...
  updateEditorDirty(e) {
    this.ifEditorIsActive(e, () => {
      const t = j(this.titleContainer);
      e.isDirty() && !e.isSaving() ? t.classList.add("dirty") : t.classList.remove("dirty");
    });
  }
  updateOptions(e, t) {
    (e.labelFormat !== t.labelFormat || !Aa(e.decorations, t.decorations)) && this.redraw();
  }
  updateStyles() {
    this.redraw();
  }
  handleBreadcrumbsEnablementChange() {
    j(this.titleContainer).classList.toggle("breadcrumbs", !!this.breadcrumbsControl), this.redraw();
  }
  ...
  redraw() {
    var r, a;
    const e = Bt(this.group.activeEditor), t = this.accessor.partOptions, i = e ? this.group.isPinned(e) : !1, o = this.accessor.activeGroup === this.group;
    ...
    const [s, n] = Zi(this.titleContainer, this.editorLabel);
    if (!e)
      ...
      let l;
      this.breadcrumbsControl && !this.breadcrumbsControl.isHidden() || d === "default" && !o ? l = "" : l = e.getDescription(this.getVerbosity(d)) || "";
      let u = e.getTitle(2);
      l === u && (u = ""), n.setResource({
        resource: ee.getOriginalUri(e, { supportSideBySide: $.BOTH }),
        name: e.getName(),
        description: l
      }, {
        title: u,
      ...
      }), o ? s.style.color = this.getColor(tl) || "" : s.style.color = this.getColor(il) || "", this.updateEditorActionsToolbar();
    }
  }
  getVerbosity(e) {
    switch (e) {
  ...
  prepareEditorActions(e) {
    return this.accessor.activeGroup === this.group ? e : {
      primary: e.primary.filter((i) => i.id === cl || i.id === ol),
      secondary: e.secondary
    };
  }
  getHeight() {
  ...
  layout(e) {
    var t;
    return (t = this.breadcrumbsControl) == null || t.layout(void 0), new G(e.container.width, this.getHeight().total);
  }
}
An.HEIGHT = 35;
const Mh = { text: p("watermark.showCommands", "Show All Commands"), id: "workbench.action.showCommands" }, Sv = { text: p("watermark.quickAccess", "Go to File"), id: "workbench.action.quickOpen" }, Ev = { text: p("watermark.openFile", "Open File"), id: "workbench.action.files.openFile", mac: !1 }, _v = { text: p("watermark.openFolder", "Open Folder"), id: "workbench.action.files.openFolder", mac: !1 }, kv = { text: p("watermark.openFileFolder", "Open File or Folder"), id: "workbench.action.files.openFileFolder", mac: !0 }, xv = { text: p("watermark.openRecent", "Open Recent"), id: "workbench.action.openRecent" }, Dv = { text: p("watermark.newUntitledFile", "New Untitled Text File"), id: "workbench.action.files.newUntitledFile" }, Iv = Object.assign({ mac: !0 }, Dv), Av = { text: p("watermark.findInFiles", "Find in Files"), id: "workbench.action.findInFiles" }, Tv = { text: p(
  { key: "watermark.toggleTerminal", comment: ["toggle is a verb here"] },
  "Toggle Terminal"
), id: "workbench.action.terminal.toggleTerminal", when: v.equals("terminalProcessSupported", !0) }, Vv = { text: p("watermark.startDebugging", "Start Debugging"), id: "workbench.action.debug.start", when: v.equals("terminalProcessSupported", !0) }, Rv = { text: p(
  { key: "watermark.toggleFullscreen", comment: ["toggle is a verb here"] },
  "Toggle Full Screen"
), id: "workbench.action.toggleFullScreen", when: v.equals("terminalProcessSupported", !0).negate() }, Pv = { text: p("watermark.showSettings", "Show Settings"), id: "workbench.action.openSettings", when: v.equals("terminalProcessSupported", !0).negate() }, dd = [
  Mh,
  Ev,
  _v,
  kv,
...
let qr = class extends R {
  constructor(e, t, i, o, s, n, r) {
    super(), this.lifecycleService = t, this.keybindingService = i, this.contextService = o, this.contextKeyService = s, this.configurationService = n, this.telemetryService = r, this.transientDisposables = this._register(new A()), this.enabled = !1;
    const a = Wn(".editor-group-watermark", [
      Wn(".letterpress"),
      Wn(".shortcuts@shortcuts")
    ]);
    se(e, a.root), this.shortcuts = a.shortcuts, this.registerListeners(), this.workbenchState = o.getWorkbenchState(), this.render();
  }
  registerListeners() {
    ...
    const e = [...dd, ...ld].filter((i) => i.when !== void 0).map((i) => i.when), t = /* @__PURE__ */ new Set();
  ...
  render() {
    ...
    if (e === this.enabled || (this.enabled = e, this.clear(), !e))
      return;
    const t = se(this.shortcuts, z(".watermark-box"));
    (this.workbenchState !== 1 ? ld : dd).filter((s) => !("when" in s) || this.contextKeyService.contextMatchesRules(s.when)).filter((s) => !("mac" in s) || s.mac === (le && !Qe)).filter((s) => !!q.getCommand(s.id));
    const o = () => {
      oi(t);
    };
  ...
  clear() {
    oi(this.shortcuts), this.transientDisposables.clear();
  }
  dispose() {
...
let Qi = class Ii extends vn {
    ...
    this._register(this.onDidModelChange((l) => {
      switch (l.kind) {
        ...
        case 5:
          ...
          break;
        case 9:
          l.editor && l.editor === this.model.activeEditor && t.set(this.model.isPinned(this.model.activeEditor));
          break;
        case 10:
          l.editor && l.editor === this.model.activeEditor && s.set(this.model.isSticky(this.model.activeEditor));
          break;
      }
      n.set(this.count);
  ...
  registerContainerListeners() {
    this._register(w(this.element, S.DBLCLICK, (e) => {
      this.isEmpty && (K.stop(e), this.editorService.openEditor({
        resource: void 0,
        options: {
          pinned: !0,
          override: Rt.id
    ...
    })), this._register(w(this.element, S.AUXCLICK, (e) => {
      this.isEmpty && e.button === 1 && (K.stop(e, !0), this.accessor.removeGroup(this));
    }));
  }
  createContainerToolbar() {
    const e = document.createElement("div");
    e.classList.add("editor-group-container-toolbar"), this.element.appendChild(e);
    const t = this._register(new vo(e, {
      ariaLabel: p("ariaLabelGroupActions", "Empty editor group actions")
    })), i = this._register(this.menuService.createMenu(b.EmptyEditorGroup, this.scopedContextKeyService)), o = () => {
      const s = { primary: [], secondary: [] };
      this.containerToolBarMenuDisposable.value = ie(() => t.clear()), Ui(i, { arg: { groupId: this.id }, shouldForwardArgs: !0 }, s, "navigation");
  ...
  createContainerContextMenu() {
    this._register(w(this.element, S.CONTEXT_MENU, (e) => this.onShowContainerContextMenu(e))), this._register(w(this.element, Te.Contextmenu, () => this.onShowContainerContextMenu()));
  }
  onShowContainerContextMenu(e) {
    ...
    this.contextMenuService.showContextMenu({
      menuId: b.EmptyEditorGroupContext,
      contextKeyService: this.contextKeyService,
      getAnchor: () => t,
      onHide: () => {
        this.focus();
  ...
  doTrackFocus() {
    const e = this._register(fo(this.element));
    ...
    const t = (i) => {
      ...
      if (i instanceof MouseEvent) {
        if (i.button !== 0 || le && i.ctrlKey)
          return;
        o = i.target;
      } else
        o = i.initialTarget;
      Us(o, "monaco-action-bar", this.titleContainer) || Us(o, "monaco-breadcrumb-item", this.titleContainer) || setTimeout(() => {
        this.focus();
      });
    };
    this._register(w(this.titleContainer, S.MOUSE_DOWN, (i) => t(i))), this._register(w(this.titleContainer, Te.Tap, (i) => t(i))), this._register(this.editorPane.onDidFocus(() => {
      this._onDidFocus.fire();
    }));
  }
  updateContainer() {
    this.isEmpty ? (this.element.classList.add("empty"), this.element.tabIndex = 0, this.element.setAttribute("aria-label", p("emptyEditorGroup", "{0} (empty)", this.label))) : (this.element.classList.remove("empty"), this.element.removeAttribute("tabIndex"), this.element.removeAttribute("aria-label")), this.updateStyles();
  }
  ...
  createTitleAreaControl() {
    return this.titleAreaControl && (this.titleAreaControl.dispose(), oi(this.titleContainer)), this.accessor.partOptions.showTabs ? this.titleAreaControl = this.scopedInstantiationService.createInstance(ri, this.titleContainer, this.accessor, this) : this.titleAreaControl = this.scopedInstantiationService.createInstance(An, this.titleContainer, this.accessor, this), this.titleAreaControl;
  }
  restoreEditors(e) {
    if (this.count === 0)
      return;
    let t;
    e instanceof Ii ? t = vr(e) : t = /* @__PURE__ */ Object.create(null);
  ...
  onDidGroupModelChange(e) {
    if (this._onDidModelChange.fire(e), !!e.editor)
      switch (e.kind) {
        case 3:
          zg(e) && this.onDidOpenEditor(e.editor, e.editorIndex);
          break;
        case 4:
          Gg(e) && this.handleOnDidCloseEditor(e.editor, e.editorIndex, e.context, e.sticky);
          break;
        case 12:
  ...
  handleOnDidCloseEditor(e, t, i, o) {
    ...
    const s = [e];
    e instanceof Pt && s.push(e.primary, e.secondary);
    for (const n of s)
  ...
  canDispose(e) {
    for (const t of this.accessor.groups)
      if (t instanceof Ii && t.model.contains(e, {
        strictEquals: !0,
        supportSideBySide: $.ANY
      }))
        return !1;
    return !0;
  }
  toEditorTelemetryDescriptor(e) {
    const t = e.getTelemetryDescriptor(), i = ee.getOriginalUri(e), o = i ? i.scheme === Re.file ? i.fsPath : i.path : void 0;
    if (i && o) {
      let s = xi(i);
      const n = s.indexOf("?");
      return s = n !== -1 ? s.substr(0, n) : s, t.resource = { mimeType: new hl(Ug(i).join(", ")), scheme: i.scheme, ext: s, path: zo(o) }, t;
    }
    return t;
  }
  ...
  handleDisposedEditors(e) {
    ...
    const i = [];
    for (const o of e)
      this.model.isActive(o) ? t = o : this.model.contains(o) && i.push(o);
    for (const o of i)
  ...
  get label() {
    return p("groupLabel", "Group {0}", this._index + 1);
  }
  get ariaLabel() {
    return p("groupAriaLabel", "Editor Group {0}", this._index + 1);
  }
  get disposed() {
  ...
  get activeEditorPane() {
    return this.editorPane ? Bt(this.editorPane.activeEditorPane) : void 0;
  }
  get activeEditor() {
  ...
  findEditors(e, t) {
    ...
    return this.getEditors(1).filter((o) => {
      if (o.resource && Qt(o.resource, i))
        return !0;
      if ((t == null ? void 0 : t.supportSideBySide) === $.PRIMARY || (t == null ? void 0 : t.supportSideBySide) === $.ANY) {
        const s = ee.getCanonicalUri(o, { supportSideBySide: $.PRIMARY });
        if (s && Qt(s, i))
          return !0;
      }
      if ((t == null ? void 0 : t.supportSideBySide) === $.SECONDARY || (t == null ? void 0 : t.supportSideBySide) === $.ANY) {
        const s = ee.getCanonicalUri(o, { supportSideBySide: $.SECONDARY });
        if (s && Qt(s, i))
          return !0;
      }
      return !1;
  ...
  async doOpenEditor(e, t, i) {
    ...
    let n = !1, r = !1;
    if ((t == null ? void 0 : t.activation) === Ri.ACTIVATE ? n = !0 : (t == null ? void 0 : t.activation) === Ri.RESTORE ? r = !0 : (t == null ? void 0 : t.activation) === Ri.PRESERVE ? (n = !1, r = !1) : s.active && (n = !t || !t.preserveFocus, r = !n), typeof s.index == "number") {
      const g = this.model.indexOf(e);
      g !== -1 && g !== s.index && this.doMoveEditorInsideGroup(e, s);
    }
    const { editor: a, isNew: d } = this.model.openEditor(e, s);
    d && this.count === 1 && this.accessor.groups.length > 1 && a.editorId && (u = this.accessor.partOptions.autoLockGroups) != null && u.has(a.editorId) && this.lock(!0);
    const l = this.doShowEditor(a, { active: !!s.active, isNew: d }, t, i);
    return n ? this.accessor.activateGroup(this) : r && this.accessor.restoreGroup(this), l;
  }
    ...
    return t.active ? s = (async () => {
      ...
      if (!a) {
        if (r && this._onDidActiveEditorChange.fire({ editor: e }), d && this._onDidOpenEditorFail.fire(e), !n && this.activeEditor === e) {
          ...
          this.doCloseEditor(e, l, { fromError: !0 });
        }
        return n;
      }
  ...
  async openEditors(e) {
    const t = et(e).filter(({ editor: r }) => !r.isDisposed()), i = Ta(t);
    if (!i)
      return;
    const o = {
      supportSideBySide: $.BOTH
    ...
    return await To.settled(s.map(({ editor: r, options: a }, d) => this.doOpenEditor(r, {
      ...a,
      inactive: !0,
      pinned: !0,
      index: n + d
      ...
      ...o,
      skipTitleUpdate: !0
    }))), this.titleAreaControl.openEditors(s.map(({ editor: r }) => r)), Bt(this.editorPane.activeEditorPane);
  }
  moveEditors(e, t) {
    const i = {
  ...
  doMoveOrCopyEditorAcrossGroups(e, t, i, o) {
    const s = o == null ? void 0 : o.keepCopy, n = vr(this, e, {
      ...i,
      pinned: !0,
    ...
    s || this._onWillMoveEditor.fire({
      ...
      editor: e,
      target: t.id
    }), t.doOpenEditor(s ? e.copy() : e, n, o), s || this.doCloseEditor(e, !1, { ...o, context: Ti.MOVE });
  }
  copyEditors(e, t) {
    const i = {
      skipTitleUpdate: this !== t
  ...
  doCloseActiveEditor(e = this.accessor.activeGroup === this, t) {
    ...
    if (n) {
      const r = !e;
      let a;
      r && this.accessor.activeGroup !== this && (a = Ri.PRESERVE);
      const d = {
        preserveFocus: r,
        activation: a,
  ...
  shouldRestoreFocus(e) {
    const t = document.activeElement;
    return t === document.body ? !0 : Ht(t, e);
  }
  ...
  async doHandleCloseConfirmation(e, t) {
    var n;
    if (!this.shouldConfirmClose(e) || e instanceof Pt && this.model.contains(e.primary) || this.accessor.groups.some((r) => {
      if (r === this)
        return !1;
      const a = r;
      return !!(a.contains(e, { supportSideBySide: $.BOTH }) || e instanceof Pt && a.contains(e.primary));
    }))
      return !1;
    let i = 2, o = 1, s = !1;
    if (!e.hasCapability(4) && !(t != null && t.skipAutoSave) && !e.closeHandler && (this.filesConfigurationService.getAutoSaveMode() === 3 ? (s = !0, i = 0, o = 3) : ya && (wn || Kg) && this.filesConfigurationService.getAutoSaveMode() === 4 && (s = !0, i = 0, o = 4)), !s)
      if ((!this.activeEditor || !this.activeEditor.matches(e)) && await this.doOpenEditor(e), typeof ((n = e.closeHandler) == null ? void 0 : n.confirm) == "function")
        ...
        let r;
        e instanceof Pt ? r = e.primary.getName() : r = e.getName(), i = await this.fileDialogService.showSaveConfirm([r]);
      }
  ...
  async replaceEditors(e) {
    ...
    for (let { editor: o, replacement: s, forceReplaceDirty: n, options: r } of e) {
      ...
      if (a >= 0) {
        ...
        const l = { editor: o, replacement: s, forceReplaceDirty: n, options: r };
        d ? t = l : i.push(l);
      }
    }
    for (const { editor: o, replacement: s, forceReplaceDirty: n, options: r } of i)
      if (await this.doOpenEditor(s, r), !o.matches(s)) {
        let a = !1;
        if (n ? (this.doCloseEditor(o, !1, { context: Ti.REPLACE }), a = !0) : a = await this.doCloseEditorWithConfirmationHandling(o, { preserveFocus: !0 }, { context: Ti.REPLACE }), !a)
          return;
      }
    if (t) {
      const o = this.doOpenEditor(t.replacement, t.options);
      t.editor.matches(t.replacement) || (t.forceReplaceDirty ? this.doCloseEditor(t.editor, !1, { context: Ti.REPLACE }) : await this.doCloseEditorWithConfirmationHandling(t.editor, { preserveFocus: !0 }, { context: Ti.REPLACE })), await o;
    }
  }
  get isLocked() {
  ...
  updateStyles() {
    ...
    e ? this.element.style.backgroundColor = this.getColor($g) || "" : this.element.style.backgroundColor = "";
    const t = this.getColor(jg) || this.getColor(ot);
    ...
    this.titleContainer.style.backgroundColor = this.getColor(i ? Jd : qg) || "", this.editorContainer.style.backgroundColor = this.getColor(Ia) || "";
  }
  get minimumWidth() {
  ...
  layout(e, t, i, o) {
    ...
    const s = this.titleAreaControl.layout({
      container: new G(e, t),
      available: new G(e, t - this.editorPane.minimumHeight)
...
let an = class Bh extends vn {
  ...
  create() {
    ...
    t.id = Bh.OVERLAY_ID, t.style.top = `${e}px`, this.groupView.element.appendChild(t), this.groupView.element.classList.add("dragged-over"), this._register(ie(() => {
      this.groupView.element.removeChild(t), this.groupView.element.classList.remove("dragged-over");
    })), this.overlay = document.createElement("div"), this.overlay.classList.add("editor-group-overlay-indicator"), t.appendChild(this.overlay), this.enableDropIntoEditor && (this.dropIntoPromptElement = Yg(p(
  ...
  updateStyles() {
    const e = j(this.overlay);
    e.style.backgroundColor = this.getColor(fn) || "";
    const t = this.getColor(ro);
    if (e.style.outlineColor = t || "", e.style.outlineOffset = t ? "-2px" : "", e.style.outlineStyle = t ? "dashed" : "", e.style.outlineWidth = t ? "2px" : "", this.dropIntoPromptElement) {
      this.dropIntoPromptElement.style.backgroundColor = this.getColor(Xg) ?? "", this.dropIntoPromptElement.style.color = this.getColor(Jg) ?? "";
      const i = this.getColor(Zg);
  ...
  registerListeners(e) {
    this._register(new fr(e, {
      ...
      onDragOver: (t) => {
        if (this.enableDropIntoEditor && Fh(t)) {
          this.dispose();
          return;
        }
        const i = this.groupTransfer.hasData(Ge.prototype), o = this.editorTransfer.hasData(Ce.prototype);
        !o && !i && t.dataTransfer && (t.dataTransfer.dropEffect = "copy");
        let s = !0;
        if (i)
          s = this.isCopyOperation(t);
        else if (o) {
          const r = this.editorTransfer.getData(Ce.prototype);
      ...
      onDrop: (t) => {
        K.stop(t, !0), this.dispose(), this.currentDropOperation && this.handleDrop(t, this.currentDropOperation.splitDirection);
      }
    })), this._register(w(e, S.MOUSE_OVER, () => {
  ...
  findSourceGroupView() {
    if (this.groupTransfer.hasData(Ge.prototype)) {
      const e = this.groupTransfer.getData(Ge.prototype);
      if (Array.isArray(e))
        return this.accessor.getGroup(e[0].identifier);
    } else if (this.editorTransfer.hasData(Ce.prototype)) {
      const e = this.editorTransfer.getData(Ce.prototype);
      if (Array.isArray(e))
  ...
  async handleDrop(e, t) {
    ...
    if (this.groupTransfer.hasData(Ge.prototype)) {
      ...
      const o = this.editorTransfer.getData(Ce.prototype);
      if (Array.isArray(o)) {
        const s = o[0].identifier, n = i(), r = this.accessor.getGroup(s.groupId);
        if (r) {
          if (r === n)
            return;
          const a = vr(r, s.editor, {
            pinned: !0,
            sticky: r.isSticky(s.editor)
          });
          this.isCopyOperation(e, s) ? r.copyEditor(s.editor, n, a) : r.moveEditor(s.editor, n, a), n.focus();
        }
        this.editorTransfer.clearData(Ce.prototype);
      }
    } else if (this.treeItemsTransfer.hasData(Lt.prototype)) {
      const o = this.treeItemsTransfer.getData(Lt.prototype);
      if (Array.isArray(o)) {
      ...
      this.instantiationService.createInstance(nl, { allowWorkspaceOpen: !Qe || Qg(this.contextService.getWorkspace()) }).handleDrop(e, () => i(), (s) => s == null ? void 0 : s.focus());
  }
  isCopyOperation(e, t) {
    return t != null && t.editor.hasCapability(8) ? !1 : e.ctrlKey && !le || e.altKey && le;
  }
  isToggleSplitOperation(e) {
    return e.altKey && !le || e.shiftKey && le;
  }
  positionOverlay(e, t, i, o) {
    ...
    const l = n * a, u = r * d, g = n / 3, m = r / 3;
    let f;
    switch (e > l && e < n - l && t > u && t < r - u ? f = void 0 : s ? e < g ? f = 2 : e > g * 2 ? f = 3 : t < r / 2 ? f = 0 : f = 1 : t < m ? f = 0 : t > m * 2 ? f = 1 : e < n / 2 ? f = 2 : f = 3, f) {
      case 0:
    ...
    const C = j(this.overlay);
    C.style.opacity = "1", setTimeout(() => C.classList.add("overlay-move-transition"), 0), this.currentDropOperation = { splitDirection: f };
  }
  doPositionOverlay(e) {
    const [t, i] = Zi(this.container, this.overlay), o = this.getOverlayOffsetHeight();
...
an.OVERLAY_ID = "monaco-workbench-editor-drop-overlay";
an = x([
  h(2, X),
  h(3, L),
  h(4, D),
...
let Yr = class extends vn {
  constructor(e, t, i, o, s, n) {
    super(o), this.accessor = e, this.container = t, this.delegate = i, this.configurationService = s, this.instantiationService = n, this.counter = 0, this.editorTransfer = ti.getInstance(), this.groupTransfer = ti.getInstance(), this.registerListeners();
  }
  get overlay() {
  ...
  registerListeners() {
    this._register(w(this.container, S.DRAG_ENTER, (e) => this.onDragEnter(e))), this._register(w(this.container, S.DRAG_LEAVE, () => this.onDragLeave())), [this.container, window].forEach((e) => this._register(w(e, S.DRAG_END, () => this.onDragEnd())));
  }
  onDragEnter(e) {
    if (Nh(this.configurationService) && Fh(e))
      return;
    if (this.counter++, !this.editorTransfer.hasData(Ce.prototype) && !this.groupTransfer.hasData(Ge.prototype) && e.dataTransfer) {
      const i = de.as(em.DragAndDropContribution).getAll(), o = Array.from(i).map((s) => s.dataFormatKey);
      if (!tm(e, to.FILES, wr.FILES, to.RESOURCES, wr.EDITORS, ...o)) {
    ...
    if (t && (this.overlay && !this.overlay.contains(t) && this.disposeOverlay(), !this.overlay)) {
      ...
      i && (this._overlay = this.instantiationService.createInstance(an, this.accessor, i));
    }
  }
  onDragLeave() {
  ...
  findTargetGroupView(e) {
    return this.accessor.groups.find((i) => {
      var o, s;
      return Ht(e, i.element) || ((s = (o = this.delegate).containsGroup) == null ? void 0 : s.call(o, i));
    });
  }
  updateContainer(e) {
...
function hd(c) {
  const e = z(".centered-layout-margin");
...
function Ov(c, e) {
  return {
    ...
    onDidChange: I.map(c.onDidChange, (t) => t && t.width),
    layout: (t, i, o) => c.layout(t, e(), (o == null ? void 0 : o.top) ?? 0, ((o == null ? void 0 : o.left) ?? 0) + i)
  };
}
class Mv {
  constructor(e, t, i = { ...Eo }) {
    this.container = e, this.view = t, this.state = i, this.lastLayoutPosition = { width: 0, height: 0, left: 0, top: 0 }, this.didLayout = !1, this.splitViewDisposables = new A(), this.centeredLayoutFixedWidth = !0, this._boundarySashes = {}, this.container.appendChild(this.view.element), this.container.style.overflow = "hidden";
  }
  get minimumWidth() {
  ...
  activate(e) {
    ...
    if (e !== this.isActive())
      if (e) {
        this.container.removeChild(this.view.element), this.splitView = new Bo(this.container, {
          ...
          this.state = { ...Eo }, this.resizeSplitViews();
        ...
        this.emptyViews = [hd(i), hd(i)], this.splitView.addView(this.emptyViews[0], Xn, 0), this.splitView.addView(Ov(this.view, () => this.lastLayoutPosition.height), Xn, 1), this.splitView.addView(this.emptyViews[1], Xn, 2), this.resizeSplitViews();
      } else
  ...
  isDefault(e) {
    return this.centeredLayoutFixedWidth ? e.targetWidth === Eo.targetWidth : e.leftMarginRatio === Eo.leftMarginRatio && e.rightMarginRatio === Eo.rightMarginRatio;
  }
  dispose() {
...
function cn(c, e, t) {
  const i = c.get(oe), o = c.get(L), s = Nv(e, t, i, o);
  let n;
  return i.activeGroup !== s && e.options && !e.options.inactive && e.options.preserveFocus && typeof e.options.activation != "number" && t !== vi && (n = Ri.ACTIVATE), [s, n];
}
function Nv(c, e, t, i) {
  let o;
  const s = Vo(c) ? c.editor : c, n = c.options;
  if (e && typeof e != "number")
    ...
    const r = Pc(i);
    let a = t.findGroup({ direction: r });
    (!a || Ts(a, s)) && (a = t.addGroup(t.activeGroup, r)), o = a;
  } else if (!n || typeof n.index != "number") {
    const r = t.getGroups(1);
    if (n != null && n.revealIfVisible) {
      for (const a of r)
        if (Fv(a, s)) {
          o = a;
          break;
    ...
    if (!o && (n != null && n.revealIfOpened || i.getValue("workbench.editor.revealIfOpen") || ae(s) && s.hasCapability(8))) {
      let a, d;
      for (const l of r)
        if (Hh(l, s) && (d || (d = l), !a && l.isActive(s) && (a = l)), d && a)
          break;
      o = a || d;
    }
  }
  if (!o) {
    let r = t.activeGroup;
    if (Ts(r, s)) {
      for (const a of t.getGroups(1))
        if (!Ts(a, s)) {
          r = a;
          break;
        }
      Ts(r, s) ? o = t.addGroup(r, Pc(i)) : o = r;
    } else
      o = r;
  }
  return o;
...
function Ts(c, e) {
  return !(!c.isLocked || Hh(c, e));
}
function Fv(c, e) {
  return c.activeEditor ? c.activeEditor.matches(e) : !1;
}
function Hh(c, e) {
...
class Bv {
  constructor() {
    this.element = z(".grid-view-container"), this._onDidChange = new ei(), this.onDidChange = this._onDidChange.event;
  }
  get minimumWidth() {
  ...
  set gridWidget(e) {
    this.element.innerText = "", e ? (this.element.appendChild(e.element), this._onDidChange.input = e.onDidChange) : this._onDidChange.input = I.None, this._gridWidget = e;
  }
  layout(e, t, i, o) {
    var s;
...
let Zo = class gi extends xn {
  constructor(e, t, i, o, s) {
    super("workbench.parts.editor", { hasTitle: !1 }, t, o, s), this.instantiationService = e, this.configurationService = i, this._onDidLayout = this._register(new y()), this.onDidLayout = this._onDidLayout.event, this._onDidChangeActiveGroup = this._register(new y()), this.onDidChangeActiveGroup = this._onDidChangeActiveGroup.event, this._onDidChangeGroupIndex = this._register(new y()), this.onDidChangeGroupIndex = this._onDidChangeGroupIndex.event, this._onDidChangeGroupLocked = this._register(new y()), this.onDidChangeGroupLocked = this._onDidChangeGroupLocked.event, this._onDidActivateGroup = this._register(new y()), this.onDidActivateGroup = this._onDidActivateGroup.event, this._onDidAddGroup = this._register(new y()), this.onDidAddGroup = this._onDidAddGroup.event, this._onDidRemoveGroup = this._register(new y()), this.onDidRemoveGroup = this._onDidRemoveGroup.event, this._onDidMoveGroup = this._register(new y()), this.onDidMoveGroup = this._onDidMoveGroup.event, this.onDidSetGridWidget = this._register(new y()), this._onDidChangeSizeConstraints = this._register(new ei()), this.onDidChangeSizeConstraints = I.any(this.onDidSetGridWidget.event, this._onDidChangeSizeConstraints.event), this._onDidScroll = this._register(new ei()), this.onDidScroll = I.any(this.onDidSetGridWidget.event, this._onDidScroll.event), this._onDidChangeEditorPartOptions = this._register(new y()), this.onDidChangeEditorPartOptions = this._onDidChangeEditorPartOptions.event, this.workspaceMemento = this.getMemento(1, 1), this.profileMemento = this.getMemento(0, 1), this.groupViews = /* @__PURE__ */ new Map(), this.mostRecentActiveGroups = [], this.gridWidgetView = this._register(new Bv()), this.enforcedPartOptions = [], this._partOptions = Lc(this.configurationService, this.themeService), this._top = 0, this._left = 0, this.sideGroup = {
      openEditor: (n, r) => {
        const [a] = this.instantiationService.invokeFunction((d) => cn(d, { editor: n, options: r }, vi));
        return a.openEditor(n, r);
      }
    }, this._isReady = !1, this.whenReadyPromise = new br(), this.whenReady = this.whenReadyPromise.p, this.whenRestoredPromise = new br(), this.whenRestored = this.whenRestoredPromise.p, this.priority = 2, this.registerListeners();
  }
  registerListeners() {
  ...
  onConfigurationUpdated(e) {
    im(e) && this.handleChangedPartOptions();
  }
  handleChangedPartOptions() {
    const e = this._partOptions, t = Lc(this.configurationService, this.themeService);
  ...
  enforcePartOptions(e) {
    return this.enforcedPartOptions.push(e), this.handleChangedPartOptions(), ie(() => {
  ...
  get hasRestorableState() {
    return !!this.workspaceMemento[gi.EDITOR_PART_UI_STATE_STORAGE_KEY];
  }
  getGroups(e = 0) {
    switch (e) {
      case 0:
        return this.groups;
      case 1: {
        const t = et(this.mostRecentActiveGroups.map((i) => this.getGroup(i)));
        return Ro([...t, ...this.groups]);
      }
      case 2: {
        const t = [];
  ...
  fillGridNodes(e, t) {
    Ni(t) ? t.children.forEach((i) => this.fillGridNodes(e, i)) : e.push(t.view);
  }
  getGroup(e) {
  ...
  applyLayout(e) {
    ...
    if (i < s.length) {
      const a = s[i - 1];
      s.forEach((d, l) => {
        l >= i && this.mergeGroup(d, a);
      }), s = this.getGroups(2);
    }
    const n = this.activeGroup, r = Lh({
      orientation: this.toGridViewOrientation(
        e.orientation,
        this.isTwoDimensionalGrid() ? this.gridWidget.orientation : Mt(this.gridWidget.orientation)
      ),
      groups: e.groups
    });
  ...
  isTwoDimensionalGrid() {
    ...
    return Ni(e) ? e.children.some((t) => Ni(t)) : !1;
  }
  addGroup(e, t, i) {
  ...
  getSplitSizingStyle() {
    return this._partOptions.splitSizing === "split" ? Jo.Split : Jo.Distribute;
  }
  doCreateGroupView(e) {
    let t;
    e instanceof Qi ? t = Qi.createCopy(e, this, this.count, this.instantiationService) : ll(e) ? t = Qi.createFromSerialized(e, this, this.count, this.instantiationService) : t = Qi.createNew(this, this.count, this.instantiationService), this.groupViews.set(t.id, t);
    const i = new A();
    ...
    })), I.once(t.onWillDispose)(() => {
      ue(i), this.groupViews.delete(t.id), this.doUpdateMostRecentActive(t);
    }), t;
  }
  doSetGroupActive(e) {
  ...
  doRemoveEmptyGroup(e) {
    ...
    this.gridWidget.removeView(e, this.getSplitSizingStyle()), e.dispose(), t && this._activeGroup.focus(), this.notifyGroupIndexChange(), this.updateContainer(), this.count === 1 && ((i = Ta(this.groups)) == null || i.lock(!1)), this._onDidRemoveGroup.fire(e);
  }
  moveGroup(e, t, i) {
  ...
  mergeGroup(e, t, i) {
    ...
    for (const a of o.editors) {
      const d = !o.isActive(a) || this._activeGroup !== o, u = { index: o.isSticky(a) ? void 0 : r, inactive: d, preserveFocus: d };
      n.push({ editor: a, options: u }), r++;
    }
  ...
  createEditorDropTarget(e, t) {
    return this.instantiationService.createInstance(Yr, this, e, t);
  }
  get minimumWidth() {
  ...
  get onDidChange() {
    return I.any(this.centeredLayoutWidget.onDidChange, this.onDidSetGridWidget.event);
  }
  get gridSeparatorBorder() {
    return this.theme.getColor(om) || this.theme.getColor(ot) || bi.transparent;
  }
  updateStyles() {
    const e = j(this.container);
    e.style.backgroundColor = this.getColor(Ia) || "";
    const t = { separatorBorder: this.gridSeparatorBorder, background: this.theme.getColor(sm) || bi.transparent };
    this.gridWidget.style(t), this.centeredLayoutWidget.styles(t);
  }
  createContentArea(e, t) {
    return this.element = e, this.container = document.createElement("div"), this.container.classList.add("content"), e.appendChild(this.container), this.doCreateGridControl(t), this.centeredLayoutWidget = this._register(new Mv(
      this.container,
      this.gridWidgetView,
      this.profileMemento[gi.EDITOR_PART_CENTERED_VIEW_STORAGE_KEY]
    )), this._register(this.onDidChangeEditorPartOptions((i) => this.centeredLayoutWidget.setFixedWidth(i.newPartOptions.centeredLayoutFixedWidth ?? !1))), this.setupDragAndDropSupport(e, this.container), this.whenReadyPromise.complete(), this._isReady = !0, To.settled(this.groups.map((i) => i.whenRestored)).finally(() => {
      this.whenRestoredPromise.complete();
    }), this.container;
  }
  setupDragAndDropSupport(e, t) {
    ...
    const i = document.createElement("div");
    i.classList.add("drop-block-overlay"), e.appendChild(i), this._register(nm(i, () => i.classList.remove("visible"))), this._register(Mo.INSTANCE.registerTarget(this.element, {
      onDragStart: (l) => i.classList.add("visible"),
      onDragEnd: (l) => i.classList.remove("visible")
    }));
    let o, s, n, r;
    const a = (l) => {
    ...
    this._register(Mo.INSTANCE.registerTarget(i, {
      onDragOver: (l) => {
        K.stop(l.eventData, !0), l.eventData.dataTransfer && (l.eventData.dataTransfer.dropEffect = "none");
        const u = i.getBoundingClientRect();
        let g, m;
        const f = 100;
        l.eventData.clientX < u.left + f && (g = 0), l.eventData.clientX > u.right - f && (g = 1), l.eventData.clientY > u.bottom - f && (m = 2), o && g !== n && (clearTimeout(o), o = void 0), s && m !== r && (clearTimeout(s), s = void 0), !o && g !== void 0 && (n = g, o = setTimeout(() => a(g), 200)), !s && m !== void 0 && (r = m, s = setTimeout(() => a(m), 200));
      },
      onDragLeave: () => d(),
      onDragEnd: () => d(),
      onDrop: () => d()
  ...
  doCreateGridControl(e) {
    ...
    if ((!e || e.restorePreviousState) && (t = !this.doCreateGridControlWithPreviousState()), !this.gridWidget || t) {
      ...
      this.doSetGridWidget(new Li(i)), this.doSetGroupActive(i);
    }
    this.updateContainer(), this.notifyGroupIndexChange();
  }
  doCreateGridControlWithPreviousState() {
    const e = this.workspaceMemento[gi.EDITOR_PART_UI_STATE_STORAGE_KEY];
  ...
  updateContainer() {
    j(this.container).classList.toggle("empty", this.isEmpty);
  }
  ...
  saveState() {
    if (this.gridWidget) {
      ...
      this.isEmpty ? delete this.workspaceMemento[gi.EDITOR_PART_UI_STATE_STORAGE_KEY] : this.workspaceMemento[gi.EDITOR_PART_UI_STATE_STORAGE_KEY] = e;
    }
    if (this.centeredLayoutWidget) {
      const e = this.centeredLayoutWidget.state;
      this.centeredLayoutWidget.isDefault(e) ? delete this.profileMemento[gi.EDITOR_PART_CENTERED_VIEW_STORAGE_KEY] : this.profileMemento[gi.EDITOR_PART_CENTERED_VIEW_STORAGE_KEY] = e;
    }
    super.saveState();
  }
  toJSON() {
...
Zo.EDITOR_PART_UI_STATE_STORAGE_KEY = "editorpart.state";
Zo.EDITOR_PART_CENTERED_VIEW_STORAGE_KEY = "editorpart.centeredview";
Zo = x([
  h(0, D),
  h(1, X),
  h(2, L),
...
k.registerCommandAndKeybindingRule({
  ...
  id: ul,
  handler: async (c, e) => {
    const t = c.get(U), i = c.get(O), o = c.get(Ue), s = c.get(ci), n = ds(e, i, t, s);
    if (n.length) {
      const r = n.filter((g) => g.scheme === Re.untitled), a = n.filter((g) => g.scheme !== Re.untitled), u = (await Promise.all(a.map(async (g) => {
        const m = s.findClosest(g);
        return m || await o.stat(g);
      }))).filter((g) => !g.isDirectory).map((g) => ({
        resource: g.resource,
        options: { pinned: !0 }
      })).concat(...r.map(
        (g) => ({ resource: g, options: { pinned: !0 } })
      ));
      await t.openEditors(u, vi);
    }
  }
});
k.registerCommandAndKeybindingRule({
  weight: 200 + 10,
  when: v.and(Je, ct.toNegated()),
  primary: 3,
  mac: {
    primary: 2066
  },
...
k.registerCommandAndKeybindingRule({
  ...
  primary: kt(2089, 34),
  handler: async (c, e) => {
    const t = c.get(D), i = c.get(ns), o = c.get(U), s = c.get(Ue);
    let n = !1;
    if (pi.length === 0) {
      n = !0;
      const a = t.createInstance(Oc);
      pi.push(a), pi.push(i.registerTextModelContentProvider(Jn, a));
    }
    const r = ls(e, c.get(O), o);
    if (r && s.hasProvider(r)) {
      const a = rs(r), d = p("modifiedLabel", "{0} (in file) ↔ {1}", a, a);
      try {
        await Oc.open(r, Jn, d, o, { pinned: !0 }), n && pi.push(o.onDidVisibleEditorsChange(() => {
          o.editors.some(
            (l) => !!ee.getCanonicalUri(l, { supportSideBySide: $.SECONDARY, filterByScheme: Jn })
          ) || (pi = ue(pi));
        }));
      } catch {
        pi = ue(pi);
...
q.registerCommand({
  ...
  handler: (c, e) => {
    const t = c.get(O);
    Xr = ls(e, t, c.get(U)), Zn || (Zn = Ra.bindTo(c.get(H))), Zn.set(!0);
  }
});
q.registerCommand({
  id: gl,
  handler: async (c, e) => {
    const t = c.get(U), i = c.get(ci), o = ds(e, c.get(O), t, i);
...
q.registerCommand({
  id: ml,
  handler: (c, e) => {
    const t = c.get(U), i = c.get(O), o = ls(e, i, t);
    Xr && o && t.openEditor({
      original: { resource: Xr },
      modified: { resource: o },
      options: { pinned: !0 }
    });
  }
});
async function oc(c, e, t, i, o) {
  if (c.length) {
    const s = wn ? `\r
` : `
`;
...
const Wh = async (c, e) => {
  const t = ds(e, c.get(O), c.get(U), c.get(ci));
  await oc(t, !1, c.get(Uo), c.get(Ci), c.get(L));
};
k.registerCommandAndKeybindingRule({
  weight: 200,
  when: hs.focus.toNegated(),
  primary: 2593,
  win: {
    primary: 1569
  },
...
const Gh = async (c, e) => {
  const t = ds(e, c.get(O), c.get(U), c.get(ci));
  await oc(t, !0, c.get(Uo), c.get(Ci), c.get(L));
};
k.registerCommandAndKeybindingRule({
  weight: 200,
  when: hs.focus.toNegated(),
...
k.registerCommandAndKeybindingRule({
  ...
  handler: async (c) => {
    const t = c.get(U).activeEditor, i = ee.getOriginalUri(t, { supportSideBySide: $.PRIMARY });
    await oc(i ? [i] : [], !1, c.get(Uo), c.get(Ci), c.get(L));
  }
});
q.registerCommand({
  id: fl,
  handler: async (c, e) => {
    const t = c.get(yn), i = c.get(at), o = c.get(ci), s = ls(e, c.get(O), c.get(U));
    if (s && i.isInsideWorkspace(s)) {
      const n = await t.openView(am, !1);
      n && (n.setExpanded(!0), await o.select(s, "force"), n.focus());
    } else {
      const n = await t.openView(cm.ID, !1);
...
q.registerCommand({
  id: bl,
  handler: async (c, e) => {
    const t = c.get(U), i = ls(e, c.get(O), c.get(U));
    if (i)
      return t.openEditor({ resource: i, options: { override: Ps.PICK, source: al.USER } });
  }
});
async function sc(c, e) {
  var a;
  const t = c.get(O), i = c.get(oe), o = c.get(gs), s = c.get(Ld);
  let n = Cl(t);
  if (!n) {
    const d = i.activeGroup;
    d.activeEditor && (n = [], d.activeEditor instanceof Pt && !(e != null && e.saveAs) && !(d.activeEditor.primary.hasCapability(4) || d.activeEditor.secondary.hasCapability(4)) ? (n.push({ groupId: d.id, editor: d.activeEditor.primary }), n.push({ groupId: d.id, editor: d.activeEditor.secondary })) : n.push({ groupId: d.id, editor: d.activeEditor }));
  }
  if (!n || n.length === 0)
    return;
  await nc(c, n, e);
  ...
  if (r instanceof Na) {
    ...
    if (d && !n.some(
      ({ editor: l }) => Qt(ee.getCanonicalUri(l, { supportSideBySide: $.PRIMARY }), d)
    )) {
      const l = s.files.get(d);
      l != null && l.isReadonly() || await s.save(d, e);
    }
  }
}
function zh(c, e, t) {
...
async function nc(c, e, t) {
  const i = c.get(U), o = c.get(Be), s = c.get(D);
  try {
    await i.save(e, t);
  } catch (n) {
    Gi(n) || o.notify({
      id: e.map(({ editor: r }) => {
        var a;
        return zo((a = r.resource) == null ? void 0 : a.toString());
      }).join(),
      severity: wt.Error,
      message: p(
      ...
      actions: {
        primary: [
          Ne({ id: "workbench.action.files.saveEditors", label: p("retry", "Retry"), run: () => s.invokeFunction((r) => nc(r, e, t)) }),
          Ne({ id: "workbench.action.files.revertEditors", label: p("discard", "Discard"), run: () => i.revert(e) })
        ]
      }
    });
  }
...
k.registerCommandAndKeybindingRule({
  ...
  primary: 2097,
  id: Pa,
  handler: (c) => sc(c, { reason: 1, force: !0 })
});
k.registerCommandAndKeybindingRule({
  when: void 0,
  weight: 200,
  primary: kt(2089, 49),
  win: { primary: kt(2089, 3121) },
  id: vl,
  handler: (c) => sc(c, { reason: 1, force: !0, skipSaveParticipants: !0 })
});
k.registerCommandAndKeybindingRule({
  id: wl,
  weight: 200,
  when: void 0,
  primary: 3121,
  handler: (c) => sc(c, { reason: 1, saveAs: !0 })
});
k.registerCommandAndKeybindingRule({
  when: void 0,
  weight: 200,
  primary: void 0,
  mac: { primary: 2609 },
  win: { primary: kt(2089, 49) },
  id: dm,
  handler: (c) => zh(c, c.get(oe).getGroups(1), { reason: 1 })
});
q.registerCommand({
  id: La,
  handler: (c, e, t) => {
    const i = c.get(oe), o = lm(t, c.get(O), c.get(oe));
    let s;
    return o.length ? s = et(o.map((n) => i.getGroup(n.groupId))) : s = i.getGroups(1), zh(c, s, { reason: 1 });
  }
});
q.registerCommand({
  id: yl,
  handler: async (c) => (await c.get(U).saveAll({ includeUntitled: !1, reason: 1 })).success
});
q.registerCommand({
  id: Oa,
  handler: async (c) => {
    const e = c.get(Be), t = c.get(O), i = c.get(oe), o = c.get(U);
    let s = Cl(t);
    if (!s) {
    ...
    if (!(!s || s.length === 0))
      try {
        ...
        e.error(p("genericRevertError", "Failed to revert '{0}': {1}", s.map(({ editor: r }) => r.getName()).join(", "), Go(n, !1)));
      }
  }
});
q.registerCommand({
  id: Sl,
  handler: (c, e) => {
    const t = c.get(hm), i = c.get(at), o = c.get(cs), s = i.getWorkspace(), n = ds(e, c.get(O), c.get(U), c.get(ci)).filter(
      (r) => s.folders.some((a) => o.extUri.isEqual(a.uri, r))
    );
    return n.length === 0 ? c.get(It).executeCommand(um.ID) : t.removeFolders(n);
  }
});
k.registerCommandAndKeybindingRule({
  weight: 200 + 10,
  ...
  id: pm,
  handler: (c) => {
    const t = c.get(zi).getActivePaneComposite(0);
    if ((t == null ? void 0 : t.getId()) !== Mi)
      return;
...
k.registerCommandAndKeybindingRule({
  weight: 200,
  when: null,
  primary: Qe ? wn ? kt(2089, 44) : 2604 : 2092,
  secondary: Qe ? [2092] : void 0,
  id: Ma,
  description: {
    description: kl,
    args: [
...
q.registerCommand({
  id: bm,
  handler: async (c, e) => {
    const t = c.get(U), i = c.get(dl), o = c.get(Ue), s = p("newFileCommand.saveLabel", "Create File"), n = No(await i.defaultFilePath(), (e == null ? void 0 : e.fileName) ?? "Untitled.txt"), r = await i.showSaveDialog({ saveLabel: s, title: s, defaultUri: n });
...
const Hv = "saveConflictResolutionContext", di = 10, Uh = "renameFile";
k.registerCommandAndKeybindingRule({
  id: Uh,
  weight: 200 + di,
  when: v.and(Je, At.toNegated(), ze),
  primary: 60,
  mac: {
    primary: 3
  },
...
const jh = "filesExplorer.copy";
k.registerCommandAndKeybindingRule({
  id: jh,
  weight: 200 + di,
  when: v.and(Je, At.toNegated()),
  primary: 2081,
  handler: Cm
});
const qh = "filesExplorer.paste";
k.registerCommandAndKeybindingRule({
  id: qh,
  weight: 200 + di,
  when: v.and(Je, ze),
...
const rc = {
  id: us,
  title: p("copyPath", "Copy Path")
}, ac = {
  id: ps,
  title: p("copyRelativePath", "Copy Relative Path")
};
cc(us, rc.title, fe.IsFileSystemResource, "1_cutcopypaste");
cc(ps, ac.title, fe.IsFileSystemResource, "1_cutcopypaste");
cc(fl, p("revealInSideBar", "Reveal in Explorer View"), fe.IsFileSystemResource, "2_files", 1);
function cc(c, e, t, i, o) {
  _.appendMenuItem(b.EditorTitleContext, {
...
Yh("workbench.files.action.acceptLocalChanges", p("acceptLocalChanges", "Use your changes and overwrite file contents"), M.check, -10);
Yh("workbench.files.action.revertLocalChanges", p("revertLocalChanges", "Discard your changes and revert to file contents"), M.discard, -9);
function Yh(c, e, t, i, o) {
  _.appendMenuItem(b.EditorTitle, {
...
function ft(c, e, t, i) {
  _.appendMenuItem(b.CommandPalette, {
    command: {
      id: c,
      title: e,
      category: t
...
ft(us, { value: p("copyPathOfActive", "Copy Path of Active File"), original: "Copy Path of Active File" }, ve.File);
ft(ps, { value: p("copyRelativePathOfActive", "Copy Relative Path of Active File"), original: "Copy Relative Path of Active File" }, ve.File);
ft(Pa, { value: Dl, original: "Save" }, ve.File);
ft(vl, { value: km, original: "Save without Formatting" }, ve.File);
ft(La, { value: p("saveAllInGroup", "Save All in Group"), original: "Save All in Group" }, ve.File);
ft(yl, { value: p("saveFiles", "Save All Files"), original: "Save All Files" }, ve.File);
ft(Oa, { value: p("revert", "Revert File"), original: "Revert File" }, ve.File);
ft(Va, { value: p("compareActiveWithSaved", "Compare Active File with Saved"), original: "Compare Active File with Saved" }, ve.File);
ft(wl, { value: xm, original: "Save As..." }, ve.File);
ft(Al, { value: Il, original: "New File" }, ve.File, Fa.notEqualsTo("0"));
ft(Vl, { value: Tl, original: "New Folder" }, ve.File, Fa.notEqualsTo("0"));
ft(Ma, { value: kl, original: "New Untitled Text File" }, ve.File);
const Vn = v.or(fe.IsFileSystemResource, fe.Scheme.isEqualTo(Re.untitled)), Xh = {
  id: ul,
  title: p("openToSide", "Open to the Side")
};
_.appendMenuItem(b.OpenEditorsContext, {
  group: "navigation",
  order: 10,
  command: Xh,
  when: Vn
...
_.appendMenuItem(b.OpenEditorsContext, {
  ...
  command: {
    id: Dm,
    title: p("reopenWith", "Reopen Editor With...")
  },
  when: Im
});
_.appendMenuItem(b.OpenEditorsContext, {
...
_.appendMenuItem(b.OpenEditorsContext, {
  ...
  when: v.or(fe.Scheme.isEqualTo(Re.untitled), v.and(ms.toNegated(), Rl.toNegated(), Ha.toNegated()))
});
_.appendMenuItem(b.OpenEditorsContext, {
  group: "2_save",
  order: 20,
  command: {
    id: Oa,
    title: p("revert", "Revert File"),
    precondition: Ba
  },
  when: v.and(ms.toNegated(), Rl.toNegated(), fe.Scheme.notEqualsTo(Re.untitled), Ha.toNegated())
});
_.appendMenuItem(b.OpenEditorsContext, {
  group: "2_save",
  order: 30,
...
_.appendMenuItem(b.OpenEditorsContext, {
  ...
  command: {
    id: Va,
    title: p("compareWithSaved", "Compare with Saved"),
    precondition: Ba
  },
  when: v.and(fe.IsFileSystemResource, Ha.toNegated(), $i.toNegated())
});
const Jh = {
  id: ml,
  title: p("compareWithSelected", "Compare with Selected")
};
_.appendMenuItem(b.OpenEditorsContext, {
  group: "3_compare",
  order: 20,
...
const Zh = {
  id: pl,
  title: p("compareSource", "Select for Compare")
};
_.appendMenuItem(b.OpenEditorsContext, {
  group: "3_compare",
  order: 30,
...
const Qh = {
  id: gl,
  title: p("compareSelected", "Compare Selected")
};
_.appendMenuItem(b.OpenEditorsContext, {
  group: "3_compare",
  order: 30,
...
_.appendMenuItem(b.OpenEditorsContext, {
  ...
  command: {
    id: Tm,
    title: p("closeOthers", "Close Others")
  },
  when: ms.toNegated()
});
_.appendMenuItem(b.OpenEditorsContext, {
  ...
  command: {
    id: Vm,
    title: p("closeSaved", "Close Saved")
  }
});
_.appendMenuItem(b.OpenEditorsContext, {
  group: "4_close",
  ...
  command: {
    id: Rm,
    title: p("closeAll", "Close All")
  }
});
_.appendMenuItem(b.ExplorerContext, {
  group: "navigation",
  order: 4,
  command: {
    id: Al,
...
_.appendMenuItem(b.ExplorerContext, {
  ...
  order: 10,
  command: Xh,
  when: v.and(ct.toNegated(), fe.HasResource)
});
_.appendMenuItem(b.ExplorerContext, {
  group: "navigation",
  order: 20,
  command: {
    id: bl,
    title: p("explorerOpenWith", "Open With...")
  },
  when: v.and(ct.toNegated(), Pm)
});
_.appendMenuItem(b.ExplorerContext, {
  group: "3_compare",
  order: 20,
  command: Jh,
  when: v.and(ct.toNegated(), fe.HasResource, Ra, $i.toNegated())
});
_.appendMenuItem(b.ExplorerContext, {
  group: "3_compare",
  order: 30,
  command: Zh,
  when: v.and(ct.toNegated(), fe.HasResource, $i.toNegated())
});
_.appendMenuItem(b.ExplorerContext, {
  group: "3_compare",
  order: 30,
  command: Qh,
  when: v.and(ct.toNegated(), fe.HasResource, $i)
});
_.appendMenuItem(b.ExplorerContext, {
...
_.appendMenuItem(b.ExplorerContext, {
  ...
  when: v.or(v.and(Do.toNegated(), fe.Scheme.notEqualsTo(Re.file)), v.and(Do, ct.toNegated(), At.toNegated()), v.and(Do, Bm))
});
_.appendMenuItem(b.ExplorerContext, {
  group: "5b_importexport",
  order: 20,
...
_.appendMenuItem(b.ExplorerContext, {
  ...
  when: v.and(At, v.or(Pl, Ll.isEqualTo("workspace")))
});
_.appendMenuItem(b.ExplorerContext, {
  group: "2_workspace",
  order: 30,
  ...
  when: v.and(At, ct, v.and(Fa.notEqualsTo("0"), v.or(Pl, Ll.isEqualTo("workspace"))))
});
_.appendMenuItem(b.ExplorerContext, {
...
_.appendMenuItem(b.ExplorerContext, {
  ...
  alt: {
    id: Tn,
    title: p("deleteFile", "Delete Permanently"),
    precondition: ze
  },
  when: v.and(At.toNegated(), Sn)
});
_.appendMenuItem(b.ExplorerContext, {
  group: "7_modification",
  order: 20,
  ...
  when: v.and(At.toNegated(), Sn.toNegated())
});
for (const c of [b.EmptyEditorGroupContext, b.EditorTabsBarContext])
  _.appendMenuItem(c, { command: { id: Ma, title: p("newFile", "New Text File") }, group: "1_file", order: 10 }), _.appendMenuItem(c, { command: { id: "workbench.action.quickOpen", title: p("openFile", "Open File...") }, group: "1_file", order: 20 });
_.appendMenuItem(b.MenubarGoMenu, {
  group: "3_global_nav",
  command: {
...
var Wv = ".monaco-workbench .call-hierarchy .message,.monaco-workbench .call-hierarchy .results{display:none}.monaco-workbench .call-hierarchy[data-state=data] .results{display:inherit;height:100%}.monaco-workbench .call-hierarchy[data-state=message] .message{align-items:center;display:flex;height:100%;justify-content:center}.monaco-workbench .call-hierarchy .editor,.monaco-workbench .call-hierarchy .tree{height:100%}.monaco-editor .call-hierarchy .tree{background-color:var(--vscode-peekViewResult-background);color:var(--vscode-peekViewResult-fileForeground)}.monaco-workbench .call-hierarchy .tree .callhierarchy-element{align-items:center;display:flex;flex:1;flex-flow:row nowrap}.monaco-workbench .call-hierarchy .tree .callhierarchy-element .monaco-icon-label{padding-left:4px}.monaco-editor .call-hierarchy .tree .monaco-list:focus .monaco-list-rows>.monaco-list-row.selected:not(.highlighted){background-color:var(--vscode-peekViewResult-selectionBackground);color:var(--vscode-peekViewResult-selectionForeground)!important}.monaco-editor .call-hierarchy .call-decoration{background-color:var(--vscode-peekViewEditor-matchHighlightBackground);border:2px solid var(--vscode-peekViewEditor-matchHighlightBorder);box-sizing:border-box}.monaco-editor .call-hierarchy .editor .monaco-editor .inputarea.ime-input,.monaco-editor .call-hierarchy .editor .monaco-editor .monaco-editor-background{background-color:var(--vscode-peekViewEditor-background)}.monaco-editor .call-hierarchy .editor .monaco-editor .margin{background-color:var(--vscode-peekViewEditorGutter-background)}";
be(Wv, {});
class Fs {
  constructor(e, t, i, o) {
  ...
  static compare(e, t) {
    let i = Nl(e.item.uri.toString(), t.item.uri.toString());
    return i === 0 && (i = tt.compareRangesUsingStarts(e.item.range, t.item.range)), i;
  }
}
let Gv = class {
  constructor(e) {
  ...
  async getChildren(e) {
    if (e instanceof Ol)
      return e.roots.map((o) => new Fs(o, void 0, e, void 0));
    const { model: t, item: i } = e;
    return this.getDirection() === "outgoingCalls" ? (await t.resolveOutgoingCalls(i, Fi.None)).map((o) => new Fs(o.to, o.fromRanges.map((s) => ({ range: s, uri: i.uri })), t, e)) : (await t.resolveIncomingCalls(i, Fi.None)).map((o) => new Fs(o.from, o.fromRanges.map((s) => ({ range: s, uri: o.from.uri })), t, e));
  }
}, zv = class {
  compare(e, t) {
    return Fs.compare(e, t);
  }
}, Uv = class {
  constructor(e) {
    this.getDirection = e;
...
class ws {
  constructor() {
    this.templateId = ws.id;
  }
  renderTemplate(e) {
    e.classList.add("callhierarchy-element");
    const t = document.createElement("div");
    e.appendChild(t);
    const i = new Wa(e, { supportHighlights: !0 });
    return new Kv(t, i);
  }
  renderElement(e, t, i) {
    var r;
    const { element: o, filterData: s } = e, n = (r = o.item.tags) == null ? void 0 : r.includes(1);
    i.icon.className = "", i.icon.classList.add("inline", ...me.asClassNameArray(Ml.toIcon(o.item.kind))), i.label.setLabel(o.item.name, o.item.detail, { labelEscapeNewLines: !0, matches: Wo(s), strikethrough: n });
  }
  disposeTemplate(e) {
    e.label.dispose();
  }
...
let $v = class {
  ...
  getWidgetAriaLabel() {
    return p("tree.aria", "Call Hierarchy");
  }
  getAriaLabel(e) {
    return this.getDirection() === "outgoingCalls" ? p("from", "calls from {0}", e.item.name) : p("to", "callers of {0}", e.item.name);
  }
}, ud = class {
  static store(e, t) {
...
let Bi = class eu extends Bl {
  constructor(e, t, i, o, s, n, r, a, d, l, u) {
    super(e, { showFrame: !0, showArrow: !0, isResizeable: !0, isAccessible: !0 }, u), this._where = t, this._direction = i, this._peekViewService = s, this._editorService = n, this._textModelService = r, this._storageService = a, this._menuService = d, this._contextKeyService = l, this._instantiationService = u, this._treeViewStates = /* @__PURE__ */ new Map(), this._previewDisposable = new A(), this.create(), this._peekViewService.addExclusiveWidget(e, this), this._applyTheme(o.getColorTheme()), this._disposables.add(o.onDidColorThemeChange(this._applyTheme, this)), this._disposables.add(this._previewDisposable);
  }
  dispose() {
    ud.store(this._layoutInfo, this._storageService), this._splitView.dispose(), this._tree.dispose(), this._editor.dispose(), super.dispose();
  }
  get direction() {
    return this._direction;
  }
  _applyTheme(e) {
    const t = e.getColor(Hl) || bi.transparent;
    this.style({
      arrowColor: t,
      frameColor: t,
      headerBackgroundColor: e.getColor(Wl) || bi.transparent,
      primaryHeadingColor: e.getColor(Gl),
      secondaryHeadingColor: e.getColor(zl)
    });
  }
  _fillHead(e) {
    super._fillHead(e, !0);
    const t = this._menuService.createMenu(eu.TitleMenu, this._contextKeyService), i = () => {
      const o = [];
      Ui(t, void 0, o), this._actionbarWidget.clear(), this._actionbarWidget.push(o, { label: !1, icon: !0 });
    };
    this._disposables.add(t), this._disposables.add(t.onDidChange(i)), i();
  }
  _fillBody(e) {
    this._layoutInfo = ud.retrieve(this._storageService), this._dim = new G(0, 0), this._parent = e, e.classList.add("call-hierarchy");
    const t = document.createElement("div");
    t.classList.add("message"), e.appendChild(t), this._message = t, this._message.tabIndex = 0;
    const i = document.createElement("div");
    i.classList.add("results"), e.appendChild(i), this._splitView = new Bo(i, { orientation: 1 });
    const o = document.createElement("div");
    ...
    this._editor = this._instantiationService.createInstance(Na, o, s, {}, this.editor);
    const n = document.createElement("div");
    n.classList.add("tree"), i.appendChild(n);
    const r = {
      sorter: new zv(),
      accessibilityProvider: new jv(() => this._direction),
      identityProvider: new Uv(() => this._direction),
      expandOnlyOnTwistieClick: !0,
      overrideStyles: {
        listBackground: ql
      }
    };
    this._tree = this._instantiationService.createInstance(qv, "CallHierarchyPeek", n, new $v(), [this._instantiationService.createInstance(ws)], this._instantiationService.createInstance(Gv, () => this._direction), r), this._splitView.addView({
      onDidChange: I.None,
      element: o,
      minimumSize: 200,
    ...
    }, yt.Distribute), this._splitView.addView({
      onDidChange: I.None,
      element: n,
      minimumSize: 100,
      maximumSize: Number.MAX_VALUE,
    ...
    }, yt.Distribute), this._disposables.add(this._splitView.onDidSashChange(() => {
      ...
      const { event: d, target: l } = a;
      if (d.detail !== 2)
        return;
      const [u] = this._tree.getFocus();
      u && (this.dispose(), this._editorService.openEditor({
        resource: u.item.uri,
        options: { selection: l.range }
      }));
    })), this._disposables.add(this._tree.onMouseDblClick((a) => {
      a.target !== Ul.Twistie && a.element && (this.dispose(), this._editorService.openEditor({
  ...
  async _updatePreview() {
    ...
    for (const d of r)
      d.uri.toString() === i.toString() && (s.push({ range: d.range, options: t }), n = n ? tt.plusRange(d.range, n) : d.range);
    if (n) {
      this._editor.revealRangeInCenter(n, 1);
      const d = this._editor.createDecorationsCollection(s);
      this._previewDisposable.add(ie(() => d.clear()));
    }
    this._previewDisposable.add(o);
    const a = this._direction === "outgoingCalls" ? p("callFrom", "Calls from '{0}'", e.model.root.name) : p("callsTo", "Callers of '{0}'", e.model.root.name);
    this.setTitle(a);
  }
  showLoading() {
    this._parent.dataset.state = "loading", this.setTitle(p("title.loading", "Loading...")), this._show();
  }
  showMessage(e) {
  ...
  _show() {
    this._isShowing || (this.editor.revealLineInCenterIfOutsideViewport(this._where.lineNumber, 0), super.show(tt.fromPositions(this._where), this._layoutInfo.height));
  }
  _onWidth(e) {
    this._dim && this._doLayoutBody(this._dim.height, e);
  }
  _doLayoutBody(e, t) {
    (this._dim.height !== e || this._dim.width !== t) && (super._doLayoutBody(e, t), this._dim = new G(t, e), this._layoutInfo.height = this._viewZone ? this._viewZone.heightInLines : this._layoutInfo.height, this._splitView.layout(t), this._splitView.resizeView(0, t * this._layoutInfo.ratio));
  }
};
Bi.TitleMenu = new b("callhierarchy/title");
Bi = x([
  h(3, X),
  h(4, Fl),
  h(5, U),
...
const Jr = new N("editorHasCallHierarchyProvider", !1, p(
  "editorHasCallHierarchyProvider",
  "Whether a call hierarchy provider is available"
)), ys = new N("callHierarchyVisible", !1, p("callHierarchyVisible", "Whether call hierarchy peek is currently showing")), Qo = new N(
  "callHierarchyDirection",
  void 0,
  { type: "string", description: p(
    "callHierarchyDirection",
...
let xt = class ko {
  ...
  constructor(e, t, i, o, s) {
    this._editor = e, this._contextKeyService = t, this._storageService = i, this._editorService = o, this._instantiationService = s, this._dispoables = new A(), this._sessionDisposables = new A(), this._ctxIsVisible = ys.bindTo(this._contextKeyService), this._ctxHasProvider = Jr.bindTo(this._contextKeyService), this._ctxDirection = Qo.bindTo(this._contextKeyService), this._dispoables.add(I.any(e.onDidChangeModel, e.onDidChangeModelLanguage, Gn.onDidChange)(() => {
      this._ctxHasProvider.set(e.hasModel() && Gn.has(e.getModel()));
  ...
  async startCallHierarchyFromEditor() {
    ...
    if (!Gn.has(e))
      return;
    const i = new st(), o = Ol.create(e, t, i.token), s = Yv(this._storageService.get(ko._StorageDirection, 0, "incomingCalls"));
  ...
  async startCallHierarchyFromCallHierarchy() {
    ...
    this._sessionDisposables.clear(), (s = ko.get(i)) == null || s._showCallHierarchyWidget(tt.lift(o.root.selectionRange).getStartPosition(), this._widget.direction, Promise.resolve(o), new st());
  }
  _showCallHierarchyWidget(e, t, i, o) {
    this._ctxIsVisible.set(!0), this._ctxDirection.set(t), I.any(this._editor.onDidChangeModel, this._editor.onDidChangeModelLanguage)(this.endCallHierarchy, this, this._sessionDisposables), this._widget = this._instantiationService.createInstance(Bi, this._editor, e, t), this._widget.showLoading(), this._sessionDisposables.add(this._widget.onDidClose(() => {
      this.endCallHierarchy(), this._storageService.store(ko._StorageDirection, this._widget.direction, 0, 0);
    })), this._sessionDisposables.add({ dispose() {
      o.dispose(!0);
    } }), this._sessionDisposables.add(this._widget), i.then((s) => {
      o.token.isCancellationRequested || (s ? (this._sessionDisposables.add(s), this._widget.showModel(s)) : this._widget.showMessage(p("no.item", "No results")));
    }).catch((s) => {
      if (Gi(s)) {
        this.endCallHierarchy();
        return;
      }
      this._widget.showMessage(p("error", "Failed to show call hierarchy"));
    });
  }
  showOutgoingCalls() {
    var e;
...
xt.Id = "callHierarchy";
xt._StorageDirection = "callHierarchy/defaultDirection";
xt = x([
  h(1, H),
  h(2, Se),
  h(3, gs),
...
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title", "Peek Call Hierarchy"), original: "Peek Call Hierarchy" },
      menu: {
        id: b.EditorContextPeek,
        group: "navigation",
        order: 1e3,
        when: v.and(Jr, $s.notInPeekEditor)
      },
      keybinding: {
        when: hs.editorTextFocus,
        weight: 200,
        primary: 1024 + 512 + 38
      },
      precondition: v.and(Jr, $s.notInPeekEditor)
    });
  }
  async runEditorCommand(c, e) {
    var t;
    return (t = xt.get(e)) == null ? void 0 : t.startCallHierarchyFromEditor();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.incoming", "Show Incoming Calls"), original: "Show Incoming Calls" },
      icon: pe("callhierarchy-incoming", M.callIncoming, p(
        "showIncomingCallsIcons",
        "Icon for incoming calls in the call hierarchy view."
      )),
      precondition: v.and(ys, Qo.isEqualTo("outgoingCalls")),
      keybinding: {
        weight: 200,
        primary: 1024 + 512 + 38
      },
      menu: {
        id: Bi.TitleMenu,
        when: Qo.isEqualTo("outgoingCalls"),
        order: 1
      }
    });
  }
  runEditorCommand(c, e) {
    var t;
    return (t = xt.get(e)) == null ? void 0 : t.showIncomingCalls();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.outgoing", "Show Outgoing Calls"), original: "Show Outgoing Calls" },
      icon: pe("callhierarchy-outgoing", M.callOutgoing, p(
        "showOutgoingCallsIcon",
        "Icon for outgoing calls in the call hierarchy view."
      )),
      precondition: v.and(ys, Qo.isEqualTo("incomingCalls")),
      keybinding: {
        weight: 200,
        primary: 1024 + 512 + 38
      },
      menu: {
        id: Bi.TitleMenu,
        when: Qo.isEqualTo("incomingCalls"),
        order: 1
      }
    });
  }
  runEditorCommand(c, e) {
    var t;
    return (t = xt.get(e)) == null ? void 0 : t.showOutgoingCalls();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.refocus", "Refocus Call Hierarchy"), original: "Refocus Call Hierarchy" },
      precondition: ys,
      keybinding: {
        weight: 200,
        primary: 1024 + 3
  ...
  async runEditorCommand(c, e) {
    var t;
    return (t = xt.get(e)) == null ? void 0 : t.startCallHierarchyFromCallHierarchy();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      keybinding: {
        weight: 200 + 10,
        primary: 9,
        when: v.not("config.editor.stablePeek")
      },
      menu: {
        id: Bi.TitleMenu,
        order: 1e3
...
class Jv {
  ...
  async getChildren(e) {
    if (e instanceof Xl)
      return e.roots.map((o) => new Bs(o, e, void 0));
    const { model: t, item: i } = e;
    return this.getDirection() === "supertypes" ? (await t.provideSupertypes(i, Fi.None)).map((o) => new Bs(o, t, e)) : (await t.provideSubtypes(i, Fi.None)).map((o) => new Bs(o, t, e));
  }
}
class Zv {
  compare(e, t) {
    return Bs.compare(e, t);
  }
}
class Qv {
  constructor(e) {
...
class Cs {
  ...
  renderElement(e, t, i) {
    var r;
    const { element: o, filterData: s } = e, n = (r = o.item.tags) == null ? void 0 : r.includes(1);
    i.icon.classList.add("inline", ...me.asClassNameArray(Ml.toIcon(o.item.kind))), i.label.setLabel(o.item.name, o.item.detail, { labelEscapeNewLines: !0, matches: Wo(s), strikethrough: n });
  }
  disposeTemplate(e) {
    e.label.dispose();
  }
...
class iw {
  ...
  getWidgetAriaLabel() {
    return p("tree.aria", "Type Hierarchy");
  }
  getAriaLabel(e) {
    return this.getDirection() === "supertypes" ? p("supertypes", "supertypes of {0}", e.item.name) : p("subtypes", "subtypes of {0}", e.item.name);
  }
}
class pd {
  static store(e, t) {
...
let Hi = class tu extends Bl {
  constructor(e, t, i, o, s, n, r, a, d, l, u) {
    super(e, { showFrame: !0, showArrow: !0, isResizeable: !0, isAccessible: !0 }, u), this._where = t, this._direction = i, this._peekViewService = s, this._editorService = n, this._textModelService = r, this._storageService = a, this._menuService = d, this._contextKeyService = l, this._instantiationService = u, this._treeViewStates = /* @__PURE__ */ new Map(), this._previewDisposable = new A(), this.create(), this._peekViewService.addExclusiveWidget(e, this), this._applyTheme(o.getColorTheme()), this._disposables.add(o.onDidColorThemeChange(this._applyTheme, this)), this._disposables.add(this._previewDisposable);
  }
  dispose() {
    pd.store(this._layoutInfo, this._storageService), this._splitView.dispose(), this._tree.dispose(), this._editor.dispose(), super.dispose();
  }
  get direction() {
    return this._direction;
  }
  ...
  _fillHead(e) {
    super._fillHead(e, !0);
    const t = this._menuService.createMenu(tu.TitleMenu, this._contextKeyService), i = () => {
      const o = [];
      Ui(t, void 0, o), this._actionbarWidget.clear(), this._actionbarWidget.push(o, { label: !1, icon: !0 });
    };
    this._disposables.add(t), this._disposables.add(t.onDidChange(i)), i();
  ...
  _fillBody(e) {
    ...
    const r = {
      sorter: new Zv(),
      accessibilityProvider: new iw(() => this._direction),
      identityProvider: new Qv(() => this._direction),
      expandOnlyOnTwistieClick: !0,
      overrideStyles: {
        listBackground: ql
      }
    };
    this._tree = this._instantiationService.createInstance(ow, "TypeHierarchyPeek", n, new tw(), [this._instantiationService.createInstance(Cs)], this._instantiationService.createInstance(Jv, () => this._direction), r), this._splitView.addView({
      onDidChange: I.None,
      element: o,
      minimumSize: 200,
      maximumSize: Number.MAX_VALUE,
  ...
  async _updatePreview() {
    ...
    if (r.uri.toString() === i.toString() && (s.push({ range: r.range, options: t }), n = n ? tt.plusRange(r.range, n) : r.range), n) {
      this._editor.revealRangeInCenter(n, 1);
      const d = this._editor.createDecorationsCollection(s);
      this._previewDisposable.add(ie(() => d.clear()));
    }
    this._previewDisposable.add(o);
    const a = this._direction === "supertypes" ? p("supertypes", "Supertypes of '{0}'", e.model.root.name) : p("subtypes", "Subtypes of '{0}'", e.model.root.name);
    this.setTitle(a);
  }
  showLoading() {
    this._parent.dataset.state = "loading", this.setTitle(p("title.loading", "Loading...")), this._show();
  ...
  async showModel(e) {
    ...
    await this._tree.setInput(e, t);
    const i = this._tree.getNode(e).children[0];
    await this._tree.expand(i.element), i.children.length === 0 ? this.showMessage(this._direction === "supertypes" ? p("empt.supertypes", "No supertypes of '{0}'", e.root.name) : p("empt.subtypes", "No subtypes of '{0}'", e.root.name)) : (this._parent.dataset.state = "data", (!t || this._tree.getFocus().length === 0) && this._tree.setFocus([i.children[0].element]), this._tree.domFocus(), this._updatePreview());
  }
  getModel() {
    return this._tree.getInput();
  }
...
Hi.TitleMenu = new b("typehierarchy/title");
Hi = x([
  h(3, X),
  h(4, Fl),
  h(5, U),
...
const Zr = new N("editorHasTypeHierarchyProvider", !1, p(
  "editorHasTypeHierarchyProvider",
  "Whether a type hierarchy provider is available"
)), Ss = new N("typeHierarchyVisible", !1, p("typeHierarchyVisible", "Whether type hierarchy peek is currently showing")), es = new N(
...
let Dt = class xo {
  static get(e) {
    return e.getContribution(xo.Id);
  }
  constructor(e, t, i, o, s) {
    this._editor = e, this._contextKeyService = t, this._storageService = i, this._editorService = o, this._instantiationService = s, this._disposables = new A(), this._sessionDisposables = new A(), this._ctxHasProvider = Zr.bindTo(this._contextKeyService), this._ctxIsVisible = Ss.bindTo(this._contextKeyService), this._ctxDirection = es.bindTo(this._contextKeyService), this._disposables.add(I.any(e.onDidChangeModel, e.onDidChangeModelLanguage, zn.onDidChange)(() => {
      this._ctxHasProvider.set(e.hasModel() && zn.has(e.getModel()));
  ...
  async startTypeHierarchyFromEditor() {
    ...
    if (!zn.has(e))
      return;
    const i = new st(), o = Xl.create(e, t, i.token), s = sw(this._storageService.get(xo._storageDirectionKey, 0, "subtypes"));
    this._showTypeHierarchyWidget(t, s, o, i);
  }
  _showTypeHierarchyWidget(e, t, i, o) {
    this._ctxIsVisible.set(!0), this._ctxDirection.set(t), I.any(this._editor.onDidChangeModel, this._editor.onDidChangeModelLanguage)(this.endTypeHierarchy, this, this._sessionDisposables), this._widget = this._instantiationService.createInstance(Hi, this._editor, e, t), this._widget.showLoading(), this._sessionDisposables.add(this._widget.onDidClose(() => {
      this.endTypeHierarchy(), this._storageService.store(xo._storageDirectionKey, this._widget.direction, 0, 0);
    })), this._sessionDisposables.add({ dispose() {
      o.dispose(!0);
    } }), this._sessionDisposables.add(this._widget), i.then((s) => {
      o.token.isCancellationRequested || (s ? (this._sessionDisposables.add(s), this._widget.showModel(s)) : this._widget.showMessage(p("no.item", "No results")));
      ...
      this._widget.showMessage(p("error", "Failed to show type hierarchy"));
    });
  }
  async startTypeHierarchyFromTypeHierarchy() {
    ...
    if (!i)
      return;
    const o = e.fork(t.item);
    this._sessionDisposables.clear(), (s = xo.get(i)) == null || s._showTypeHierarchyWidget(tt.lift(o.root.selectionRange).getStartPosition(), this._widget.direction, Promise.resolve(o), new st());
  }
  showSupertypes() {
    var e;
...
Dt.Id = "typeHierarchy";
Dt._storageDirectionKey = "typeHierarchy/defaultDirection";
Dt = x([
  h(1, H),
  h(2, Se),
  h(3, gs),
...
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title", "Peek Type Hierarchy"), original: "Peek Type Hierarchy" },
      menu: {
        id: b.EditorContextPeek,
        group: "navigation",
        order: 1e3,
        when: v.and(Zr, $s.notInPeekEditor)
      },
      precondition: v.and(Zr, $s.notInPeekEditor)
    });
  }
  async runEditorCommand(c, e) {
    var t;
    return (t = Dt.get(e)) == null ? void 0 : t.startTypeHierarchyFromEditor();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.supertypes", "Show Supertypes"), original: "Show Supertypes" },
      icon: M.typeHierarchySuper,
      precondition: v.and(Ss, es.isEqualTo("subtypes")),
      keybinding: {
        weight: 200,
        primary: 1024 + 512 + 38
      },
  ...
  runEditorCommand(c, e) {
    var t;
    return (t = Dt.get(e)) == null ? void 0 : t.showSupertypes();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.subtypes", "Show Subtypes"), original: "Show Subtypes" },
      icon: M.typeHierarchySub,
      precondition: v.and(Ss, es.isEqualTo("supertypes")),
      keybinding: {
        weight: 200,
        primary: 1024 + 512 + 38
      },
  ...
  runEditorCommand(c, e) {
    var t;
    return (t = Dt.get(e)) == null ? void 0 : t.showSubtypes();
  }
});
te(class extends jt {
  constructor() {
    super({
      ...
      title: { value: p("title.refocusTypeHierarchy", "Refocus Type Hierarchy"), original: "Refocus Type Hierarchy" },
      precondition: Ss,
      keybinding: {
        weight: 200,
        primary: 1024 + 3
  ...
  async runEditorCommand(c, e) {
    var t;
    return (t = Dt.get(e)) == null ? void 0 : t.startTypeHierarchyFromTypeHierarchy();
  }
});
te(class extends jt {
  constructor() {
  ...
  runEditorCommand(c, e) {
    var t;
    return (t = Dt.get(e)) == null ? void 0 : t.endTypeHierarchy();
  }
});
function dc(c) {
  c && c.getHTMLElement() !== document.activeElement && c.domFocus();
}
async function nw(c, e) {
  if (!Zl.getValue(c.contextKeyService))
    return e(c);
  const t = c.getFocus(), i = c.getSelection();
  await e(c);
  const o = c.getFocus();
  if (i.length > 1 || !co(t, i) || co(t, o))
    return;
...
async function Gt(c, e) {
  ...
  await nw(c, e);
  const t = c.getFocus();
  t.length && c.reveal(t[0]), c.setAnchor(t[0]), dc(c);
}
k.registerCommandAndKeybindingRule({
  id: "list.focusDown",
  weight: 200,
  ...
  handler: (c, e) => {
    Gt(c.get(O).lastFocusedList, async (t) => {
...
k.registerCommandAndKeybindingRule({
  ...
  primary: 12,
  handler: (c) => {
    Gt(c.get(O).lastFocusedList, async (e) => {
...
function iu(c, e) {
  if (c instanceof fs || c instanceof bs || c instanceof vs) {
  ...
  } else if (c instanceof Si || c instanceof Ei || c instanceof mt) {
...
k.registerCommandAndKeybindingRule({
  ...
  primary: 1042,
  handler: (c, e) => {
    const t = c.get(O).lastFocusedList;
    if (!t)
      return;
    const i = t.getFocus() ? t.getFocus()[0] : void 0, o = new KeyboardEvent("keydown");
    t.focusNext(typeof e == "number" ? e : 1, !1, o), iu(t, i);
    const s = t.getFocus();
    s.length && t.reveal(s[0]), dc(t);
  }
});
k.registerCommandAndKeybindingRule({
  ...
  handler: (c, e) => {
    ...
    if (!t)
      return;
    const i = t.getFocus() ? t.getFocus()[0] : void 0, o = new KeyboardEvent("keydown");
    t.focusPrevious(typeof e == "number" ? e : 1, !1, o), iu(t, i);
    const s = t.getFocus();
    s.length && t.reveal(s[0]), dc(t);
  }
});
k.registerCommandAndKeybindingRule({
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    if (!e || !(e instanceof Si || e instanceof Ei || e instanceof mt))
      return;
...
k.registerCommandAndKeybindingRule({
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    e && !(e instanceof fs || e instanceof bs || e instanceof vs) && e.collapseAll();
  }
});
k.registerCommandAndKeybindingRule({
  ...
  when: Y,
  handler: (c) => {
    const e = c.get(O).lastFocusedList, t = Jl("keydown", !0);
    if (e instanceof Si || e instanceof Ei || e instanceof mt) {
...
k.registerCommandAndKeybindingRule({
  id: "list.expand",
  weight: 200,
  when: v.and(Y, v.or(Ym, Xm)),
  primary: 17,
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    if (e) {
      if (e instanceof Si || e instanceof Ei) {
        const t = e.getFocus();
        if (t.length === 0)
          return;
        const i = t[0];
...
function lc(c, e) {
  const t = c.get(O).lastFocusedList, i = Jl("keydown", e);
  if (t instanceof fs || t instanceof bs || t instanceof vs) {
    const o = t;
    o.setSelection(o.getFocus(), i), o.setAnchor(o.getFocus()[0]);
  } else if (t instanceof Si || t instanceof Ei || t instanceof mt) {
...
k.registerCommandAndKeybindingRule({
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    if (e instanceof fs || e instanceof bs || e instanceof vs) {
      const t = e, i = new KeyboardEvent("keydown");
      t.setSelection(Jm(t.length), i);
    } else if (e instanceof Si || e instanceof Ei || e instanceof mt) {
      ...
      const r = [], a = (l) => {
        for (const u of l.children)
          u.visible && (r.push(u.element), u.collapsed || a(u));
      };
...
k.registerCommandAndKeybindingRule({
  ...
  handler: (c) => {
    ...
    if (t.length > 1)
      if (Zl.getValue(e.contextKeyService)) {
        const s = e.getFocus();
...
q.registerCommand({
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    if (e instanceof za || e instanceof mt) {
      const t = e;
      t.findMode = t.findMode === Un.Filter ? Un.Highlight : Un.Filter;
    }
  }
});
q.registerCommandAlias("list.toggleKeyboardNavigation", "list.triggerTypeNavigation");
q.registerCommandAlias("list.toggleFilterOnType", "list.toggleFindMode");
k.registerCommandAndKeybindingRule({
  id: "list.find",
  weight: 200,
  when: v.and(Ql, Qm),
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    e instanceof fs || e instanceof bs || e instanceof vs || (e instanceof za || e instanceof mt) && e.openFind();
  }
});
k.registerCommandAndKeybindingRule({
  id: "list.closeFind",
  ...
  handler: (c) => {
    const e = c.get(O).lastFocusedList;
    (e instanceof za || e instanceof mt) && e.closeFind();
  }
});
k.registerCommandAndKeybindingRule({
  id: "list.scrollUp",
...
class cw extends R {
  constructor() {
    super(...arguments), this._onDidChangeCheckboxState = this._register(new y()), this.onDidChangeCheckboxState = this._onDidChangeCheckboxState.event;
  }
  setCheckboxState(e) {
...
class Es extends R {
  constructor(e, t) {
    super(), this.checkboxStateHandler = t, this.isDisposed = !1, this._onDidChangeState = new y(), this.onDidChangeState = this._onDidChangeState.event, this.checkboxContainer = e;
  }
  render(e) {
    e.checkbox && (this.toggle ? (this.toggle.checked = e.checkbox.isChecked, this.toggle.setIcon(this.toggle.checked ? M.check : void 0)) : this.createCheckbox(e));
  }
  createCheckbox(e) {
    e.checkbox && (this.toggle = new tf({
      isChecked: e.checkbox.isChecked,
      title: this.createCheckboxTitle(e.checkbox),
      icon: e.checkbox.isChecked ? M.check : void 0,
      ...of
    }), this.setAccessibilityInformation(e.checkbox), this.toggle.domNode.classList.add(Es.checkboxClass), se(this.checkboxContainer, this.toggle.domNode), this.registerListener(e));
  }
  registerListener(e) {
  ...
  setCheckbox(e) {
    this.toggle && e.checkbox && (e.checkbox.isChecked = this.toggle.checked, this.toggle.setIcon(this.toggle.checked ? M.check : void 0), this.toggle.setTitle(this.createCheckboxTitle(e.checkbox)), this.setAccessibilityInformation(e.checkbox), this.checkboxStateHandler.setCheckboxState(e));
  }
  createCheckboxTitle(e) {
    return e.tooltip ? e.tooltip : e.isChecked ? p("checked", "Checked") : p("unchecked", "Unchecked");
  }
...
Es.checkboxClass = "custom-view-tree-node-item-checkbox";
let Qr = class extends En {
  constructor(e, t, i, o, s, n, r, a, d, l, u) {
    super({ ...e, titleMenuId: b.ViewTitle, donotForwardArgs: !1 }, t, i, o, s, n, r, a, d, l);
    const { treeView: g } = de.as(lt.ViewsRegistry).getView(e.id);
    this.treeView = g, this._register(this.treeView.onDidChangeActions(() => this.updateActions(), this)), this._register(this.treeView.onDidChangeTitle((m) => this.updateTitle(m))), this._register(this.treeView.onDidChangeDescription((m) => this.updateTitleDescription(m))), this._register(ie(() => {
      this._container && this.treeView.container && this._container === this.treeView.container && this.treeView.setVisibility(!1);
    })), this._register(this.onDidChangeBodyVisibility(() => this.updateTreeVisibility())), this._register(this.treeView.onDidChangeWelcomeState(() => this._onDidChangeViewWelcomeState.fire())), e.title !== this.treeView.title && this.updateTitle(this.treeView.title), e.titleDescription !== this.treeView.description && this.updateTitleDescription(this.treeView.description), this._actionRunner = new ru(u, () => this.treeView.getSelection()), this.updateTreeVisibility();
  }
  focus() {
...
class Qn {
  constructor() {
    this.label = { label: "root" }, this.handle = "0", this.parentHandle = void 0, this.collapsibleState = Ot.Expanded, this.children = void 0;
  }
}
function ou(c, e) {
  const t = q.getCommand(c.originalId ? c.originalId : c.id);
  if (t) {
    const i = _.getCommand(t.id), o = i && i.precondition;
    if (o)
...
let ea = class extends R {
  ...
  initialize() {
    this._isInitialized || (this._isInitialized = !0, this.contextKeyService.bufferChangeEvents(() => {
    ...
    }), this.treeViewDnd = this.instantiationService.createInstance(oa, this.id), this._dragAndDropController && (this.treeViewDnd.controller = this._dragAndDropController), this._register(this.configurationService.onDidChangeConfiguration((e) => {
      ...
      var o;
      e.some((s) => s.id === this.id) && ((o = this.tree) == null || o.updateOptions({ overrideStyles: { listBackground: this.viewLocation === 1 ? lr : sr } }));
  ...
  set dataProvider(e) {
    if (e) {
      ...
      this._dataProvider = new class {
        constructor() {
          this._isEmpty = !0, this._onDidChangeEmpty = new y(), this.onDidChangeEmpty = this._onDidChangeEmpty.event;
        }
        get isTreeEmpty() {
        ...
        async getChildren(i) {
          let o;
          if (i && i.children ? o = i.children : (i = i ?? t.root, i.children = await (i instanceof Qn ? e.getChildren() : e.getChildren(i)), o = i.children ?? [], o.forEach((s) => s.parent = i)), i instanceof Qn) {
            const s = this._isEmpty;
            this._isEmpty = o.length === 0, s !== this._isEmpty && this._onDidChangeEmpty.fire();
          }
          return o;
        }
  ...
  set badge(e) {
    ...
    if (!(((t = this._badge) == null ? void 0 : t.value) === (e == null ? void 0 : e.value) && ((i = this._badge) == null ? void 0 : i.tooltip) === (e == null ? void 0 : e.tooltip)) && (this._badgeActivity && (this._badgeActivity.dispose(), this._badgeActivity = void 0), this._badge = e, e)) {
      const o = {
        badge: new Io(e.value, () => e.tooltip),
        priority: 50
      };
  ...
  initializeShowCollapseAllAction(e = !1) {
    return this.collapseAllContext || (this.collapseAllContextKey = new N(`treeView.${this.id}.enableCollapseAll`, e, p(
  ...
  initializeShowRefreshAction(e = !1) {
    this.refreshContext || (this.refreshContextKey = new N(`treeView.${this.id}.enableRefresh`, e, p(
  ...
  registerActions() {
    const e = this;
    this._register(te(class extends qe {
      constructor() {
        super({
          id: `workbench.actions.treeView.${e.id}.refresh`,
          title: p("refresh", "Refresh"),
          menu: {
            id: b.ViewTitle,
            when: v.and(v.equals("view", e.id), e.refreshContextKey),
            group: "navigation",
      ...
      constructor() {
        super({
          ...
          title: p("collapseAll", "Collapse All"),
          menu: {
            id: b.ViewTitle,
            when: v.and(v.equals("view", e.id), e.collapseAllContextKey),
            group: "navigation",
      ...
      async run() {
        if (e.tree)
          return new aw(e.tree, !0).run();
      }
    }));
  }
  setVisibility(e) {
    this.initialize(), e = !!e, this.isVisible !== e && (this.isVisible = e, this.tree && (this.isVisible ? go(this.tree.getHTMLElement()) : mo(this.tree.getHTMLElement()), this.isVisible && this.elementsToRefresh.length && this.dataProvider && (this.doRefresh(this.elementsToRefresh), this.elementsToRefresh = [])), sf(() => {
  ...
  show(e) {
    this._container = e, se(e, this.domNode);
  }
  create() {
    this.domNode = z(".tree-explorer-viewlet-tree-view"), this.messageElement = se(this.domNode, z(".message")), this.updateMessage(), this.treeContainer = se(this.domNode, z(".customview-tree")), this.treeContainer.classList.add("file-icon-themable-tree", "show-file-icons");
    const e = this._register(fo(this.domNode));
  ...
  updateCheckboxes(e) {
        ...
        if (i.checkbox !== void 0) {
          let o = function(r) {
            for (const a of r.children ?? [])
              a.checkbox !== void 0 && r.checkbox !== void 0 && (a.checkbox.isChecked = r.checkbox.isChecked, t.push(a), o(a));
          }, n = function(r) {
            if (r.parent && r.parent.checkbox !== void 0 && r.parent.children) {
              ...
              s.add(r.parent);
              let a = !1, d = !1;
              for (const l of r.parent.children) {
                if (a && d)
                  break;
                l.checkbox !== void 0 && (l.checkbox.isChecked ? d = !0 : a = !0);
              }
              d && !a ? (r.parent.checkbox.isChecked = !0, t.push(r.parent), n(r.parent)) : a && !d && (r.parent.checkbox.isChecked = !1, t.push(r.parent), n(r.parent));
            }
          };
          o(i);
    ...
    e = e.concat(t), e.forEach((i) => {
      var o;
      return (o = this.tree) == null ? void 0 : o.rerender(i);
    }), this._onDidChangeCheckboxState.fire(e);
  }
  createTree() {
    const e = un.bind(void 0, this.instantiationService), t = this._register(this.instantiationService.createInstance(ta, this.id));
    this.treeLabels = this._register(this.instantiationService.createInstance(bn, this));
    const i = this.instantiationService.createInstance(pw, this, (l) => this.progressService.withProgress({ location: this.id }, () => l)), o = new gw(this.themeService), s = this._register(new cw());
    this._register(s.onDidChangeCheckboxState((l) => {
      this.updateCheckboxes(l);
    }));
    const n = this.instantiationService.createInstance(Wi, this.id, t, this.treeLabels, e, o, s), r = this._title;
    this.tree = this._register(this.instantiationService.createInstance(lw, this.id, this.treeContainer, new uw(), [n], i, {
      identityProvider: new hw(),
      accessibilityProvider: {
        getAriaLabel(l) {
          if (l.accessibilityInformation)
            return l.accessibilityInformation.label;
          if (Nt(l.tooltip))
            return l.tooltip;
          {
            if (l.resourceUri && !l.label)
              return null;
            let u = "";
            return l.label && (u += l.label.label + " "), l.description && (u += l.description), u;
          }
        },
        getRole(l) {
          var u;
          return ((u = l.accessibilityInformation) == null ? void 0 : u.role) ?? "treeitem";
        },
        getWidgetAriaLabel() {
          return r;
        }
      ...
      keyboardNavigationLabelProvider: {
        getKeyboardNavigationLabel: (l) => l.label ? l.label.label : l.resourceUri ? rs(P.revive(l.resourceUri)) : void 0
      },
      expandOnlyOnTwistieClick: (l) => !!l.command || !!l.checkbox || this.configurationService.getValue("workbench.tree.expandMode") === "doubleClick",
      collapseByDefault: (l) => l.collapsibleState !== Ot.Expanded,
      multipleSelectionSupport: this.canSelectMany,
      dnd: this.treeViewDnd,
      overrideStyles: {
        listBackground: this.viewLocation === 1 ? lr : sr
      }
    })), t.setContextKeyService(this.tree.contextKeyService), o.tree = this.tree;
    const a = new ru(this.notificationService, () => this.tree.getSelection());
    n.actionRunner = a, this.tree.contextKeyService.createKey(this.id, !0), su.bindTo(this.tree.contextKeyService).set(!0), this._register(this.tree.onContextMenu((l) => this.onContextMenu(t, l, a))), this._register(this.tree.onDidChangeSelection((l) => this._onDidChangeSelection.fire(l.elements))), this._register(this.tree.onDidChangeFocus((l) => {
      l.elements.length && this._onDidChangeFocus.fire(l.elements[0]);
    })), this._register(this.tree.onDidChangeCollapseState((l) => {
      if (!l.node.element)
        return;
      const u = Array.isArray(l.node.element.element) ? l.node.element.element[0] : l.node.element.element;
      l.node.collapsed ? this._onDidCollapseItem.fire(u) : this._onDidExpandItem.fire(u);
    })), this.tree.setInput(this.root).then(() => this.updateContentAreas()), this._register(this.tree.onDidOpen(async (l) => {
      if (!l.browserEvent || l.browserEvent.target && l.browserEvent.target.classList.contains(Es.checkboxClass))
        return;
      const u = this.tree.getSelection(), g = await this.resolveCommand(u.length === 1 ? u[0] : void 0);
      if (g && ou(g, this.contextKeyService)) {
        let m = g.arguments || [];
        (g.id === nf || g.id === rf) && (m = [...m, l]);
        try {
          await this.commandService.executeCommand(g.id, ...m);
        } catch (f) {
          this.notificationService.error(f);
        }
      }
    })), this._register(t.onDidChange((l) => {
      var u, g;
      (u = this.tree) != null && u.hasNode(l) && ((g = this.tree) == null || g.rerender(l));
    }));
  }
  async resolveCommand(e) {
    let t = e == null ? void 0 : e.command;
    return e && !t && e instanceof Ka && e.hasResolve && (await e.resolve(new st().token), t = e.command), t;
  }
  onContextMenu(e, t, i) {
    ...
    n.length && this.contextMenuService.showContextMenu({
      ...
      getActionViewItem: (r) => {
        ...
        if (a)
          return new th(r, r, { label: !0, keybinding: a.getLabel() });
      },
      onHide: (r) => {
  ...
  updateMessage() {
    this._message ? this.showMessage(this._message) : this.dataProvider ? this.hideMessage() : this.showMessage(dw), this.updateContentAreas();
  }
  showMessage(e) {
    this._messageValue = e, this.messageElement && (this.messageElement.classList.remove("hide"), this.resetMessageElement(), yr(this._message) || (this.messageElement.textContent = this._messageValue), this.layout(this._height, this._width));
  }
  hideMessage() {
    var e;
  ...
  resetMessageElement() {
    this.messageElement && oi(this.messageElement);
  }
  layout(e, t) {
    var i;
    if (e && t && this.messageElement && this.treeContainer) {
      this._height = e, this._width = t;
      const o = e - af(this.messageElement);
  ...
  async refresh(e) {
    if (this.dataProvider && this.tree) {
      this.refreshing && await I.toPromise(this._onDidCompleteRefresh.event), e || (e = [this.root], this.elementsToRefresh = []);
      for (const t of e)
        t.children = void 0;
      if (this.isVisible)
  ...
  async doRefresh(e) {
    ...
    if (t && this.visible) {
      ...
      (i.length !== o.length || i.some((s, n) => s.handle !== o[n].handle)) && this._onDidChangeSelection.fire(o), this.refreshing = !1, this._onDidCompleteRefresh.fire(), this.updateContentAreas(), this.focused && this.focus(!1), this.updateCollapseAllToggle();
    }
  }
  initializeCollapseAllToggle() {
    this.collapseAllToggleContext || (this.collapseAllToggleContextKey = new N(`treeView.${this.id}.toggleCollapseAll`, !1, p(
  ...
  updateCollapseAllToggle() {
    var e;
    this.showCollapseAllAction && (this.initializeCollapseAllToggle(), (e = this.collapseAllToggleContext) == null || e.set(!!this.root.children && this.root.children.length > 0 && this.root.children.some((t) => t.collapsibleState !== Ot.None)));
  }
  updateContentAreas() {
...
class uw {
  getHeight(e) {
    return Wi.ITEM_HEIGHT;
  }
  getTemplateId(e) {
    return Wi.TREE_TEMPLATE_ID;
  }
}
class pw {
  constructor(e, t) {
  ...
  hasChildren(e) {
    return !!this.treeView.dataProvider && e.collapsibleState !== Ot.None;
  }
  async getChildren(e) {
    let t = [];
...
let Wi = class nu extends R {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g) {
    super(), this.treeViewId = e, this.menus = t, this.labels = i, this.actionViewItemProvider = o, this.aligner = s, this.checkboxStateHandler = n, this.themeService = r, this.configurationService = a, this.labelService = d, this.hoverService = l, this.treeViewsService = u, this.contextKeyService = g, this._hasCheckbox = !1, this._renderedElements = /* @__PURE__ */ new Map(), this._hoverDelegate = {
      showHover: (m) => this.hoverService.showHover(m),
      delay: this.configurationService.getValue("workbench.hover.delay")
    }, this._register(this.themeService.onDidFileIconThemeChange(() => this.rerender())), this._register(this.themeService.onDidColorThemeChange(() => this.rerender()));
  }
  get templateId() {
    return nu.TREE_TEMPLATE_ID;
  }
  set actionRunner(e) {
  ...
  renderTemplate(e) {
    ...
    const t = se(e, z("")), i = this.labels.create(e, { supportHighlights: !0, hoverDelegate: this._hoverDelegate }), o = Pd(i.element, z(".custom-view-tree-node-item-icon")), s = se(i.element, z(".actions")), n = new vo(s, {
      actionViewItemProvider: this.actionViewItemProvider
    });
    return { resourceLabel: i, icon: o, checkboxContainer: t, actionBar: n, container: e, elementDisposable: new A() };
  }
  getHover(e, t, i) {
    return !(i instanceof Ka) || !i.hasResolve ? t && !i.tooltip ? void 0 : i.tooltip === void 0 ? e : Nt(i.tooltip) ? i.tooltip !== "" ? i.tooltip : void 0 : { markdown: i.tooltip, markdownNotSupportedFallback: t ? void 0 : df(i.tooltip) } : {
  ...
  renderElement(e, t, i) {
    var C;
    const o = e.element, s = o.resourceUri ? P.revive(o.resourceUri) : null, n = o.label ? o.label : s ? { label: rs(s) } : void 0, r = Nt(o.description) ? o.description : s && o.description === !0 ? this.labelService.getUriLabel(Ea(s), { relative: !0 }) : void 0, a = n ? n.label : void 0, d = n && n.highlights && a ? n.highlights.map(([E, V]) => {
      if (E < 0 && (E = a.length + E), V < 0 && (V = a.length + V), E >= a.length || V > a.length)
        return { start: 0, end: 0 };
      if (E > V) {
        const B = E;
        E = V, V = B;
      }
      return { start: E, end: V };
    }) : void 0, l = this.themeService.getColorTheme().type === ih.LIGHT ? o.icon : o.iconDark, u = l ? P.revive(l) : void 0, g = this.getHover(a, s, o);
    i.actionBar.clear(), i.icon.style.color = "";
    let m = !0;
    if (o.command && (m = ou(o.command, this.contextKeyService)), this.renderCheckbox(o, i), s) {
      const E = this.configurationService.getValue("explorer.decorations"), V = s || P.parse("missing:_icon_resource");
      i.resourceLabel.setResource({ name: a, description: r, resource: V }, {
        fileKind: this.getFileKind(o),
        title: g,
        hideIcon: this.shouldHideResourceLabelIcon(u, o.themeIcon),
        fileDecorations: E,
        extraClasses: ["custom-view-tree-node-item-resourceLabel"],
        matches: d || Wo(e.filterData),
    ...
    if (u)
      i.icon.className = "custom-view-tree-node-item-icon", i.icon.style.backgroundImage = Ca(u);
    else {
      let E;
      this.shouldShowThemeIcon(!!s, o.themeIcon) && (E = me.asClassName(o.themeIcon), o.themeIcon.color && (i.icon.style.color = ((C = this.themeService.getColorTheme().getColor(o.themeIcon.color.id)) == null ? void 0 : C.toString()) ?? "")), i.icon.className = E ? `custom-view-tree-node-item-icon ${E}` : "", i.icon.style.backgroundImage = "";
    }
    ...
    const f = this.menus.getResourceActions(o);
    f.menu && i.elementDisposable.add(f.menu), i.actionBar.push(f.actions, { icon: !0, label: !1 }), this._actionRunner && (i.actionBar.actionRunner = this._actionRunner), this.setAlignment(i.container, o), this.treeViewsService.addRenderedTreeItemElement(o, i.container), this._renderedElements.set(e, i);
  }
  rerender() {
    const e = new Set(this._renderedElements.keys());
    for (const t of e) {
      const i = this._renderedElements.get(t);
      i && (this.disposeElement(t, 0, i), this.renderElement(t, 0, i));
    }
  }
  renderCheckbox(e, t) {
    if (e.checkbox) {
      if (this._hasCheckbox || (this._hasCheckbox = !0, this.rerender()), !t.checkbox) {
        const i = new Es(t.checkboxContainer, this.checkboxStateHandler);
        t.checkbox = i;
      }
      t.checkbox.render(e);
    } else
  ...
  isFolderThemeIcon(e) {
    return (e == null ? void 0 : e.id) === Cr.id;
  }
  isFileKindThemeIcon(e) {
    return e ? e.id === Mc.id || this.isFolderThemeIcon(e) : !1;
  }
  getFileKind(e) {
    if (e.themeIcon)
    ...
    return e.collapsibleState === Ot.Collapsed || e.collapsibleState === Ot.Expanded ? Ve.FOLDER : Ve.FILE;
  }
  disposeElement(e, t, i) {
    var o;
    i.elementDisposable.clear(), this._renderedElements.delete(e), this.treeViewsService.removeRenderedTreeItemElement(e.element), (o = i.checkbox) == null || o.dispose(), i.checkbox = void 0;
  }
  disposeTemplate(e) {
...
Wi.ITEM_HEIGHT = 22;
Wi.TREE_TEMPLATE_ID = "treeExplorer";
Wi = x([
  h(6, X),
  h(7, L),
  h(8, Ci),
...
class gw extends R {
  ...
  alignIconWithTwisty(e) {
    if (e.collapsibleState !== Ot.None || !this.hasIcon(e))
      return !1;
    if (this._tree) {
      const t = this._tree.getParentElement(e) || this._tree.getInput();
      return this.hasIcon(t) ? !!t.children && t.children.some(
        (i) => i.collapsibleState !== Ot.None && !this.hasIcon(i)
      ) : !!t.children && t.children.every((i) => i.collapsibleState === Ot.None || !this.hasIcon(i));
    } else
      return !1;
  }
  hasIcon(e) {
    if (this.themeService.getColorTheme().type === ih.LIGHT ? e.icon : e.iconDark)
      return !0;
    if (e.resourceUri || e.themeIcon) {
      const i = this.themeService.getFileIconTheme();
      return (e.themeIcon ? e.themeIcon.id === Cr.id : e.collapsibleState !== Ot.None) ? i.hasFileIcons && i.hasFolderIcons : i.hasFileIcons;
    }
    return !1;
  }
}
...
let ta = class extends R {
  constructor(e, t) {
    super(), this.id = e, this.menuService = t, this._onDidChange = new y(), this.onDidChange = this._onDidChange.event;
  }
  getResourceActions(e) {
    const t = this.getActions(b.ViewItemContext, e, !0);
    return { menu: t.menu, actions: t.primary };
  }
  getResourceContextActions(e) {
    return this.getActions(b.ViewItemContext, e).secondary;
  }
  ...
  getActions(e, t, i = !1) {
    ...
    return Gs(s, { shouldForwardArgs: !0 }, a, "inline"), i ? this._register(s.onDidChange(() => this._onDidChange.fire(t))) : s.dispose(), a;
  }
  dispose() {
...
let ia = class extends ea {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E, V, B) {
    super(e, t, o, s, n, r, a, d, l, u, g, f, m, E, B), this.extensionId = i, this.extensionService = C, this.telemetryService = V, this.activated = !1;
  }
  activate() {
    this.activated || (this.telemetryService.publicLog2("Extension:ViewActivate", {
      extensionId: new hl(this.extensionId),
      id: this.id
    }), this.createTree(), this.progressService.withProgress({ location: this.id }, () => this.extensionService.activateByEvent(`onView:${this.id}`)).then(() => ka(2e3)).then(() => {
      this.updateMessage();
    }), this.activated = !0);
  }
};
...
let oa = class {
  constructor(e, t, i, o, s) {
    this.treeId = e, this.labelService = t, this.instantiationService = i, this.treeViewsDragAndDropService = o, this.logService = s, this.treeItemsTransfer = ti.getInstance(), this.treeMimeType = `application/vnd.code.tree.${e.toLowerCase()}`;
  }
  set controller(e) {
  ...
  addResourceInfoToTransfer(e, t) {
    if (t.length && e.dataTransfer) {
      this.instantiationService.invokeFunction((o) => Yd(o, t, e));
      const i = t.filter((o) => o.scheme === Re.file).map((o) => o.fsPath);
      i.length && e.dataTransfer.setData(wr.FILES, JSON.stringify(i));
    }
  }
  onDragStart(e, t) {
    if (t.dataTransfer) {
      ...
      i.forEach((n) => {
        s.itemHandles.push(n.handle), n.resourceUri && o.push(P.revive(n.resourceUri));
  ...
  onDragOver(e, t, i, o) {
    const s = Nc(o.dataTransfer), n = new Set(Array.from(s, (d) => d[0]));
    if (o.dataTransfer) {
      for (const d of o.dataTransfer.items)
        if (d.kind === "file" || d.type === to.RESOURCES.toLowerCase()) {
          n.add(Kn.uriList);
          break;
        }
    }
    ...
    return !r || !o.dataTransfer || r.dropMimeTypes.length === 0 ? !1 : Array.from(n).some((d, l) => d === this.treeMimeType ? !0 : r.dropMimeTypes.indexOf(d) >= 0) ? { accept: !0, bubble: 0, autoExpand: !0 } : !1;
  }
  getDragURI(e) {
    return this.dndController ? e.resourceUri ? P.revive(e.resourceUri).toString() : e.handle : null;
  }
  getDragLabel(e) {
    ...
    const t = e[0];
    return t.label ? t.label.label : t.resourceUri ? this.labelService.getUriLabel(P.revive(t.resourceUri)) : void 0;
  }
  async drop(e, t, i, o) {
    ...
    if (!o.dataTransfer || !s)
      return;
    let n, r;
    this.treeItemsTransfer.hasData(Lt.prototype) && (r = this.treeItemsTransfer.getData(Lt.prototype)[0].identifier);
    const a = Nc(o.dataTransfer, !0), d = new lf();
    for (const [u, g] of a)
      if ((u === this.treeMimeType || s.dropMimeTypes.includes(u) || g.asFile() && s.dropMimeTypes.includes(to.FILES.toLowerCase())) && (d.append(u, g), u === this.treeMimeType))
        try {
          n = JSON.parse(await g.asString());
        } catch {
        }
    const l = await this.treeViewsDragAndDropService.removeDragOperationTransfer(r);
    if (l)
      for (const [u, g] of l)
        d.append(u, g);
    return s.handleDrop(d, t, Fi.None, r, n == null ? void 0 : n.id, n == null ? void 0 : n.itemHandles);
  }
  onDragEnd(e) {
    var t, i;
...
const He = bo("remoteExplorerService"), er = "remote.tunnels.toRestore", hc = "~remote.forwardedPorts";
var he;
(function(c) {
  c.Candidate = "Candidate", c.Detected = "Detected", c.Forwarded = "Forwarded", c.Add = "Add";
})(he || (he = {}));
var St;
(function(c) {
  c.Other = "Other", c.User = "User", c.AutoForwardEnd = "AutoForwardEnd";
})(St || (St = {}));
var Pe;
(function(c) {
  c[c.None = 0] = "None", c[c.New = 1] = "New", c[c.Label = 2] = "Label", c[c.LocalPort = 3] = "LocalPort";
})(Pe || (Pe = {}));
var Jt;
(function(c) {
  c[c.User = 0] = "User", c[c.Auto = 1] = "Auto", c[c.Extension = 2] = "Extension";
})(Jt || (Jt = {}));
const tr = {
  source: Jt.User,
  description: p("tunnel.source.user", "User Forwarded")
}, mw = {
  source: Jt.Auto,
  description: p("tunnel.source.auto", "Auto Forwarded")
};
function Q(c, e) {
  return c + ":" + e;
}
function Hs(c) {
  var t;
  const e = c.match(/^([a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*:)?([0-9]+)$/);
  if (e)
    return { host: ((t = e[1]) == null ? void 0 : t.substring(0, e[1].length - 1)) || "localhost", port: Number(e[2]) };
}
function gd(c, e, t) {
  const i = c.get(Q(e, t));
  if (i)
...
function Ie(c, e, t) {
  ...
  if (i)
    return i;
  const o = kn(e) ? "localhost" : _n(e) ? "0.0.0.0" : void 0;
  if (o)
    return gd(c, o, t);
}
var dt;
(function(c) {
  c.Notify = "notify", c.OpenBrowser = "openBrowser", c.OpenBrowserOnce = "openBrowserOnce", c.OpenPreview = "openPreview", c.Silent = "silent", c.Ignore = "ignore";
})(dt || (dt = {}));
class Ae extends R {
  constructor(e) {
    super(), this.configurationService = e, this.portsAttributes = [], this._onDidChangeAttributes = new y(), this.onDidChangeAttributes = this._onDidChangeAttributes.event, this._register(e.onDidChangeConfiguration((t) => {
      (t.affectsConfiguration(Ae.SETTING) || t.affectsConfiguration(Ae.DEFAULTS)) && this.updateAttributes();
  ...
  getAttributes(e, t, i) {
    let o = this.findNextIndex(e, t, i, this.portsAttributes, 0);
    const s = {
      label: void 0,
    ...
    for (; o >= 0; ) {
      const n = this.portsAttributes[o];
      n.key === e ? (s.onAutoForward = n.onAutoForward ?? s.onAutoForward, s.elevateIfNeeded = n.elevateIfNeeded !== void 0 ? n.elevateIfNeeded : s.elevateIfNeeded, s.label = n.label ?? s.label, s.requireLocalPort = n.requireLocalPort, s.protocol = n.protocol) : (s.onAutoForward = s.onAutoForward ?? n.onAutoForward, s.elevateIfNeeded = s.elevateIfNeeded !== void 0 ? s.elevateIfNeeded : n.elevateIfNeeded, s.label = s.label ?? n.label, s.requireLocalPort = s.requireLocalPort !== void 0 ? s.requireLocalPort : void 0, s.protocol = s.protocol ?? n.protocol), o = this.findNextIndex(e, t, i, this.portsAttributes, o + 1);
    }
    return s.onAutoForward !== void 0 || s.elevateIfNeeded !== void 0 || s.label !== void 0 || s.requireLocalPort !== void 0 || s.protocol !== void 0 ? s : this.getOtherAttributes();
  }
  hasStartEnd(e) {
    return e.start !== void 0 && e.end !== void 0;
  }
  hasHostAndPort(e) {
    return e.host !== void 0 && e.port !== void 0 && Nt(e.host) && $n(e.port);
  }
  findNextIndex(e, t, i, o, s) {
    if (s >= o.length)
      return -1;
    const n = !_n(t) && !kn(t), a = o.slice(s).findIndex((d) => $n(d.key) ? n ? !1 : d.key === e : this.hasStartEnd(d.key) ? n ? !1 : e >= d.key.start && e <= d.key.end : this.hasHostAndPort(d.key) ? e === d.key.port && t === d.key.host : i ? d.key.test(i) : !1);
    return a >= 0 ? a + s : -1;
  }
  readSetting() {
    const e = this.configurationService.getValue(Ae.SETTING);
    if (!e || !Fc(e))
      return [];
    const t = [];
    for (const o in e) {
      ...
      if (Number(o))
        ...
        if (Ae.RANGE.test(o)) {
          const r = o.match(Ae.RANGE);
          n = { start: Number(r[1]), end: Number(r[2]) };
        } else if (Ae.HOST_AND_PORT.test(o)) {
          const r = o.match(Ae.HOST_AND_PORT);
          n = { host: r[1], port: Number(r[2]) };
        } else {
          let r;
          try {
            r = RegExp(o);
    ...
    const i = this.configurationService.getValue(Ae.DEFAULTS);
    return i && (this.defaultPortAttributes = {
      elevateIfNeeded: i.elevateIfNeeded,
      label: i.label,
      onAutoForward: i.onAutoForward,
      requireLocalPort: i.requireLocalPort,
      protocol: i.protocol
    }), this.sortAttributes(t);
  }
  sortAttributes(e) {
    function t(i, o) {
      return $n(i.key) ? i.key : o.hasStartEnd(i.key) ? i.key.start : o.hasHostAndPort(i.key) ? i.key.port : Number.MAX_VALUE;
    }
    return e.sort((i, o) => t(i, this) - t(o, this));
  }
  getOtherAttributes() {
    return this.defaultPortAttributes;
  }
  static providedActionToAction(e) {
    switch (e) {
      case Xi.Notify:
        return dt.Notify;
      case Xi.OpenBrowser:
        return dt.OpenBrowser;
      case Xi.OpenBrowserOnce:
        return dt.OpenBrowserOnce;
      case Xi.OpenPreview:
        return dt.OpenPreview;
      case Xi.Silent:
        return dt.Silent;
      case Xi.Ignore:
        return dt.Ignore;
  ...
  async addAttributes(e, t, i) {
    const s = this.configurationService.inspect(Ae.SETTING).userRemoteValue;
    let n;
    !s || !Fc(s) ? n = {} : n = pf(s), n[`${e}`] || (n[`${e}`] = {});
    for (const r in t)
      n[`${e}`][r] = t[r];
    return this.configurationService.updateValue(Ae.SETTING, n, i);
  }
}
Ae.SETTING = "remote.portsAttributes";
Ae.DEFAULTS = "remote.otherPortsAttributes";
Ae.RANGE = /^(\d+)\-(\d+)$/;
Ae.HOST_AND_PORT = /^([a-z0-9\-]+):(\d{1,5})$/;
const fw = 10 * 1e3;
let dn = class extends R {
  constructor(e, t, i, o, s, n, r, a) {
    super(), this.tunnelService = e, this.storageService = t, this.configurationService = i, this.environmentService = o, this.remoteAuthorityResolverService = s, this.workspaceContextService = n, this.logService = r, this.dialogService = a, this.inProgress = /* @__PURE__ */ new Map(), this._onForwardPort = new y(), this.onForwardPort = this._onForwardPort.event, this._onClosePort = new y(), this.onClosePort = this._onClosePort.event, this._onPortName = new y(), this.onPortName = this._onPortName.event, this._onCandidatesChanged = new y(), this.onCandidatesChanged = this._onCandidatesChanged.event, this._onEnvironmentTunnelsSet = new y(), this.onEnvironmentTunnelsSet = this._onEnvironmentTunnelsSet.event, this._environmentTunnelsSet = !1, this.unrestoredExtensionTunnels = /* @__PURE__ */ new Map(), this.sessionCachedProperties = /* @__PURE__ */ new Map(), this.portAttributesProviders = [], this.mismatchCooldown = /* @__PURE__ */ new Date(), this.configPortsAttributes = new Ae(i), this.tunnelRestoreValue = this.getTunnelRestoreValue(), this._register(this.configPortsAttributes.onDidChangeAttributes(this.updateAttributes, this)), this.forwarded = /* @__PURE__ */ new Map(), this.remoteTunnels = /* @__PURE__ */ new Map(), this.tunnelService.tunnels.then(async (d) => {
      var u;
      const l = await this.getAttributes(d.map((g) => ({ port: g.tunnelRemotePort, host: g.tunnelRemoteHost })));
      for (const g of d)
        if (g.localAddress) {
          const m = Q(g.tunnelRemoteHost, g.tunnelRemotePort), f = Ie(this._candidates ?? /* @__PURE__ */ new Map(), g.tunnelRemoteHost, g.tunnelRemotePort);
          this.forwarded.set(m, {
            remotePort: g.tunnelRemotePort,
            remoteHost: g.tunnelRemoteHost,
            localAddress: g.localAddress,
            protocol: ((u = l == null ? void 0 : l.get(g.tunnelRemotePort)) == null ? void 0 : u.protocol) ?? _e.Http,
            localUri: await this.makeLocalUri(g.localAddress, l == null ? void 0 : l.get(g.tunnelRemotePort)),
            localPort: g.tunnelLocalPort,
            runningProcess: f == null ? void 0 : f.detail,
            hasRunningProcess: !!f,
            pid: f == null ? void 0 : f.pid,
            privacy: g.privacy,
            source: tr
          }), this.remoteTunnels.set(m, g);
        }
    }), this.detected = /* @__PURE__ */ new Map(), this._register(this.tunnelService.onTunnelOpened(async (d) => {
      var u;
      const l = Q(d.tunnelRemoteHost, d.tunnelRemotePort);
      if (!Ie(this.forwarded, d.tunnelRemoteHost, d.tunnelRemotePort) && !Ie(this.detected, d.tunnelRemoteHost, d.tunnelRemotePort) && !Ie(this.inProgress, d.tunnelRemoteHost, d.tunnelRemotePort) && d.localAddress) {
        const g = Ie(this._candidates ?? /* @__PURE__ */ new Map(), d.tunnelRemoteHost, d.tunnelRemotePort), m = (u = await this.getAttributes([{ port: d.tunnelRemotePort, host: d.tunnelRemoteHost }])) == null ? void 0 : u.get(d.tunnelRemotePort);
        this.forwarded.set(l, {
          remoteHost: d.tunnelRemoteHost,
          remotePort: d.tunnelRemotePort,
          localAddress: d.localAddress,
          protocol: (m == null ? void 0 : m.protocol) ?? _e.Http,
          localUri: await this.makeLocalUri(d.localAddress, m),
          localPort: d.tunnelLocalPort,
          closeable: !0,
          runningProcess: g == null ? void 0 : g.detail,
          hasRunningProcess: !!g,
          pid: g == null ? void 0 : g.pid,
          privacy: d.privacy,
          source: tr
        });
      }
      await this.storeForwarded(), this.remoteTunnels.set(l, d), this._onForwardPort.fire(this.forwarded.get(l));
    })), this._register(this.tunnelService.onTunnelClosed((d) => this.onTunnelClosed(d, St.Other)));
  }
  async onTunnelClosed(e, t) {
    const i = Q(e.host, e.port);
    this.forwarded.has(i) && (this.forwarded.delete(i), await this.storeForwarded(), this._onClosePort.fire(e));
  }
  makeLocalUri(e, t) {
    if (e.startsWith("http"))
      return P.parse(e);
    const i = (t == null ? void 0 : t.protocol) ?? "http";
    return P.parse(`${i}://${e}`);
  }
  async getStorageKey() {
    const e = this.workspaceContextService.getWorkspace(), t = e.configuration ? zo(e.configuration.path) : e.folders.length > 0 ? zo(e.folders[0].uri.path) : void 0;
    if (t === void 0) {
      this.logService.debug("Could not get workspace hash for forwarded ports storage key.");
      return;
    }
    return `${er}.${this.environmentService.remoteAuthority}.${t}`;
  }
  async getTunnelRestoreValue() {
    const e = this.storageService.get(er, 1);
    if (e)
      return this.storageService.remove(er, 1), await this.storeForwarded(), e;
    const t = await this.getStorageKey();
    if (t)
      return this.storageService.get(t, 0);
  }
  async restoreForwarded() {
    if (this.configurationService.getValue("remote.restoreForwardedPorts")) {
      const e = await this.tunnelRestoreValue;
      if (e && e !== this.knownPortsRestoreValue) {
        const t = JSON.parse(e) ?? [];
        this.logService.trace(`ForwardedPorts: (TunnelModel) restoring ports ${t.map((i) => i.remotePort).join(", ")}`);
        for (const i of t) {
          const o = Ie(this.detected, i.remoteHost, i.remotePort);
          i.source.source === Jt.User && !o || i.source.source === Jt.Extension && o ? await this.forward({
            remote: { host: i.remoteHost, port: i.remotePort },
            local: i.localPort,
            name: i.name,
            privacy: i.privacy,
            elevateIfNeeded: !0
          }) : i.source.source === Jt.Extension && !o && this.unrestoredExtensionTunnels.set(Q(i.remoteHost, i.remotePort), i);
        }
      }
    }
    if (!this.restoreListener) {
      const e = await this.getStorageKey();
      this.restoreListener = this._register(this.storageService.onDidChangeValue(async (t) => {
        t.key === e && (this.tunnelRestoreValue = Promise.resolve(this.storageService.get(e, 0)), await this.restoreForwarded());
      }));
    }
  }
  async storeForwarded() {
    if (this.configurationService.getValue("remote.restoreForwardedPorts")) {
      const e = JSON.stringify(Array.from(this.forwarded.values()).filter((t) => t.source.source !== Jt.Auto));
      if (e !== this.knownPortsRestoreValue) {
        this.knownPortsRestoreValue = e;
        const t = await this.getStorageKey();
        t && this.storageService.store(t, this.knownPortsRestoreValue, 0, 0);
      }
    }
  }
  async showPortMismatchModalIfNeeded(e, t, i) {
    if (!e.tunnelLocalPort || !(i != null && i.requireLocalPort) || e.tunnelLocalPort === t)
      return;
    const o = /* @__PURE__ */ new Date();
    if (this.mismatchCooldown.getTime() + fw > o.getTime())
      return;
    this.mismatchCooldown = o;
    const s = p(
...
Port number {2} has been used instead.`,
  ...
  async forward(e, t) {
    var s;
    const i = Ie(this.forwarded, e.remote.host, e.remote.port);
    t = t ?? (t !== null ? (s = await this.getAttributes([e.remote])) == null ? void 0 : s.get(e.remote.port) : void 0);
    const o = e.local !== void 0 ? e.local : e.remote.port;
    if (i)
      return this.mergeAttributesIntoExistingTunnel(i, e, t);
    {
      const n = this.environmentService.remoteAuthority, r = n ? {
        getAddress: async () => (await this.remoteAuthorityResolverService.resolveAuthority(n)).authority
      } : void 0, a = Q(e.remote.host, e.remote.port);
      this.inProgress.set(a, !0), e = this.mergeCachedAndUnrestoredProperties(a, e);
      const d = await this.tunnelService.openTunnel(r, e.remote.host, e.remote.port, void 0, o, e.elevateIfNeeded ? e.elevateIfNeeded : t == null ? void 0 : t.elevateIfNeeded, e.privacy, t == null ? void 0 : t.protocol);
      if (d && d.localAddress) {
        const l = Ie(this._candidates ?? /* @__PURE__ */ new Map(), e.remote.host, e.remote.port), u = d.protocol ? d.protocol === _e.Https ? _e.Https : _e.Http : (t == null ? void 0 : t.protocol) ?? _e.Http, g = {
          remoteHost: d.tunnelRemoteHost,
          remotePort: d.tunnelRemotePort,
          localPort: d.tunnelLocalPort,
          name: (t == null ? void 0 : t.label) ?? e.name,
          closeable: !0,
          localAddress: d.localAddress,
          protocol: u,
          localUri: await this.makeLocalUri(d.localAddress, t),
          runningProcess: l == null ? void 0 : l.detail,
          hasRunningProcess: !!l,
          pid: l == null ? void 0 : l.pid,
          source: e.source ?? tr,
          privacy: d.privacy
        };
        return this.forwarded.set(a, g), this.remoteTunnels.set(a, d), this.inProgress.delete(a), await this.storeForwarded(), await this.showPortMismatchModalIfNeeded(d, o, t), this._onForwardPort.fire(g), d;
      }
      this.inProgress.delete(a);
    }
  }
  mergeCachedAndUnrestoredProperties(e, t) {
    const i = this.unrestoredExtensionTunnels.has(e) ? this.unrestoredExtensionTunnels : this.sessionCachedProperties.has(e) ? this.sessionCachedProperties : void 0;
    if (i) {
      const o = i.get(e);
      i.delete(e), o && (t.name = o.name ?? t.name, t.local = ("local" in o ? o.local : "localPort" in o ? o.localPort : void 0) ?? t.local, t.privacy = o.privacy ?? t.privacy);
    }
    return t;
  }
  async mergeAttributesIntoExistingTunnel(e, t, i) {
    const o = (i == null ? void 0 : i.label) ?? t.name;
    let s;
    (function(r) {
      r[r.None = 0] = "None", r[r.Fire = 1] = "Fire", r[r.Reopen = 2] = "Reopen";
    })(s || (s = {}));
    let n = s.None;
    switch (o !== e.name && (e.name = o, n = s.Fire), (i != null && i.protocol || e.protocol !== _e.Http) && (i == null ? void 0 : i.protocol) !== e.protocol && (t.source = e.source, n = s.Reopen), t.privacy && e.privacy !== t.privacy && (n = s.Reopen), n) {
      case s.Fire: {
        this._onForwardPort.fire();
        break;
      }
      case s.Reopen:
        await this.close(e.remoteHost, e.remotePort, St.User), await this.forward(t, i);
    }
    return Ie(this.remoteTunnels, t.remote.host, t.remote.port);
  }
  async name(e, t, i) {
    const o = Ie(this.forwarded, e, t), s = Q(e, t);
    if (o) {
      o.name = i, await this.storeForwarded(), this._onPortName.fire({ host: e, port: t });
      return;
    } else
      this.detected.has(s) && (this.detected.get(s).name = i, this._onPortName.fire({ host: e, port: t }));
  }
  async close(e, t, i) {
    const o = Q(e, t), s = this.forwarded.get(o);
    return i === St.AutoForwardEnd && this.sessionCachedProperties.set(o, {
      local: s.localPort,
      name: s.name,
      privacy: s.privacy
    }), await this.tunnelService.closeTunnel(e, t), this.onTunnelClosed({ host: e, port: t }, i);
  }
  address(e, t) {
    var o;
    const i = Q(e, t);
    return (o = this.forwarded.get(i) || this.detected.get(i)) == null ? void 0 : o.localAddress;
  }
  get environmentTunnelsSet() {
    return this._environmentTunnelsSet;
  }
  addEnvironmentTunnels(e) {
    if (e)
      for (const t of e) {
        const i = Ie(this._candidates ?? /* @__PURE__ */ new Map(), t.remoteAddress.host, t.remoteAddress.port), o = typeof t.localAddress == "string" ? t.localAddress : Q(t.localAddress.host, t.localAddress.port);
        this.detected.set(Q(t.remoteAddress.host, t.remoteAddress.port), {
          remoteHost: t.remoteAddress.host,
          remotePort: t.remoteAddress.port,
          localAddress: o,
          protocol: _e.Http,
          localUri: this.makeLocalUri(o),
          closeable: !1,
          runningProcess: i == null ? void 0 : i.detail,
          hasRunningProcess: !!i,
          pid: i == null ? void 0 : i.pid,
          privacy: Ko.ConstantPrivate,
          source: {
            source: Jt.Extension,
            description: p("tunnel.staticallyForwarded", "Statically Forwarded")
          }
        }), this.tunnelService.setEnvironmentTunnel(t.remoteAddress.host, t.remoteAddress.port, o, Ko.ConstantPrivate, _e.Http);
      }
    this._environmentTunnelsSet = !0, this._onEnvironmentTunnelsSet.fire(), this._onForwardPort.fire();
  }
  setCandidateFilter(e) {
    this._candidateFilter = e;
  }
  async setCandidates(e) {
    let t = e;
    this._candidateFilter && (t = await this._candidateFilter(e));
    const i = this.updateInResponseToCandidates(t);
    this.logService.trace(`ForwardedPorts: (TunnelModel) removed candidates ${Array.from(i.values()).map((o) => o.port).join(", ")}`), this._onCandidatesChanged.fire(i);
  }
  updateInResponseToCandidates(e) {
    const t = this._candidates ?? /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map();
    return this._candidates = i, e.forEach((o) => {
      const s = Q(o.host, o.port);
      i.set(s, {
        host: o.host,
        port: o.port,
        detail: o.detail,
      ...
      const n = Ie(this.forwarded, o.host, o.port);
      n && (n.runningProcess = o.detail, n.hasRunningProcess = !0, n.pid = o.pid);
    }), t.forEach((o, s) => {
      const n = Hs(s);
      if (!n)
        return;
      const r = Ie(this.forwarded, n.host, n.port);
      r && (r.runningProcess = void 0, r.hasRunningProcess = !1, r.pid = void 0);
      const a = Ie(this.detected, n.host, n.port);
      a && (a.runningProcess = void 0, a.hasRunningProcess = !1, a.pid = void 0);
    }), t;
  }
  get candidates() {
  ...
  async updateAttributes() {
    const e = Array.from(this.forwarded.values()), t = await this.getAttributes(e.map((i) => ({ port: i.remotePort, host: i.remoteHost })), !1);
    if (t)
      for (const i of e) {
        const o = t.get(i.remotePort);
        (o != null && o.protocol || i.protocol !== _e.Http) && (o == null ? void 0 : o.protocol) !== i.protocol && await this.forward({
          remote: { host: i.remoteHost, port: i.remotePort },
          local: i.localPort,
          name: i.name,
          source: i.source
        }, o), o && o.label && o.label !== i.name && await this.name(i.remoteHost, i.remotePort, o.label);
      }
  }
  async getAttributes(e, t = !0) {
    const i = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
    e.forEach((d) => {
      var u;
      const l = Ie(this._candidates ?? /* @__PURE__ */ new Map(), oh[0], d.port);
      l && (i.set(d.port, l), o.has(l.pid) || o.set(l.pid, []), (u = o.get(l.pid)) == null || u.push(d.port));
    });
    const s = /* @__PURE__ */ new Map();
    if (e.forEach((d) => {
      var u;
      const l = this.configPortsAttributes.getAttributes(d.port, d.host, (u = i.get(d.port)) == null ? void 0 : u.detail);
      l && s.set(d.port, l);
    }), this.portAttributesProviders.length === 0 || !t)
      return s.size > 0 ? s : void 0;
    const n = await Promise.all(sh(this.portAttributesProviders.map((d) => Array.from(o.entries()).map((l) => {
      const u = l[1], g = i.get(u[0]);
      return d.providePortAttributes(u, g == null ? void 0 : g.pid, g == null ? void 0 : g.detail, new st().token);
    })))), r = /* @__PURE__ */ new Map();
    if (n.forEach((d) => d.forEach((l) => {
      l && r.set(l.port, l);
    })), !s && !r)
      return;
    const a = /* @__PURE__ */ new Map();
    return e.forEach((d) => {
      const l = s.get(d.port), u = r.get(d.port);
      a.set(d.port, {
        elevateIfNeeded: l == null ? void 0 : l.elevateIfNeeded,
        label: l == null ? void 0 : l.label,
        onAutoForward: (l == null ? void 0 : l.onAutoForward) ?? Ae.providedActionToAction(u == null ? void 0 : u.autoForwardAction),
        requireLocalPort: l == null ? void 0 : l.requireLocalPort,
        protocol: l == null ? void 0 : l.protocol
      });
    }), a;
  }
  addAttributesProvider(e) {
    this.portAttributesProviders.push(e);
  }
};
dn.__decorator = x([
  hf(1e3)
], dn.prototype, "storeForwarded", null);
dn = x([
  h(0, Wt),
  h(1, Se),
  h(2, L),
...
class Tw {
  constructor() {
    this.label = p("tunnel.portColumn.label", "Port"), this.tooltip = p(
      "tunnel.portColumn.tooltip",
      "The label and remote port number of the forwarded port."
    ), this.weight = 1, this.templateId = "actionbar";
  }
  project(e) {
    const t = e.tunnelType === he.Add, i = e.label;
    let o = "";
    return e instanceof Le && !t ? o = `${e.portTooltip} ${e.tooltipPostfix}` : o = i, {
      label: i,
      tunnel: e,
      menuId: b.TunnelPortInline,
      editId: e.tunnelType === he.Add ? Pe.New : Pe.Label,
      tooltip: o
    };
  }
}
class uc {
  constructor() {
    this.label = p("tunnel.addressColumn.label", "Local Address"), this.tooltip = p(
  ...
  project(e) {
    if (e.tunnelType === he.Add)
      return _s(e);
    const t = e.localAddress ?? "";
    let i = t;
    return e instanceof Le && (i = e.tooltipPostfix), {
      label: t,
      menuId: b.TunnelLocalAddressInline,
      tunnel: e,
      editId: Pe.LocalPort,
      tooltip: i,
      markdownTooltip: t ? uc.getHoverText(t) : void 0
    };
  }
  static getHoverText(e) {
    return function(t) {
      const i = t.getValue("editor");
      let o = "";
      i.multiCursorModifier === "ctrlCmd" ? le ? o = p("portsLink.followLinkAlt.mac", "option + click") : o = p("portsLink.followLinkAlt", "alt + click") : le ? o = p("portsLink.followLinkCmd", "cmd + click") : o = p("portsLink.followLinkCtrl", "ctrl + click");
      const s = new Cf("", !0), n = e.startsWith("http") ? e : `http://${e}`;
      return s.appendLink(n, "Follow link").appendMarkdown(` (${o})`);
    };
  }
}
class Vw {
  constructor() {
    this.label = p("tunnel.processColumn.label", "Running Process"), this.tooltip = p(
      "tunnel.processColumn.tooltip",
      "The command line of the process that is using the port."
    ), this.weight = 2, this.templateId = "actionbar";
  }
  project(e) {
    return e.tunnelType === he.Add ? _s(e) : { label: e.processDescription ?? "", tunnel: e, editId: Pe.None, tooltip: e instanceof Le ? e.processTooltip : "" };
  }
}
class Rw {
  constructor() {
    this.label = p("tunnel.originColumn.label", "Origin"), this.tooltip = p(
  ...
  project(e) {
    if (e.tunnelType === he.Add)
      return _s(e);
    const t = e.source.description, i = `${e instanceof Le ? e.originTooltip : ""}. ${e instanceof Le ? e.tooltipPostfix : ""}`;
    return { label: t, menuId: b.TunnelOriginInline, tunnel: e, editId: Pe.None, tooltip: i };
  }
}
class Pw {
  constructor() {
    this.label = p("tunnel.privacyColumn.label", "Visibility"), this.tooltip = p("tunnel.privacyColumn.tooltip", "The availability of the forwarded port."), this.weight = 1, this.templateId = "actionbar";
  }
  project(e) {
    var o;
    if (e.tunnelType === he.Add)
      return _s(e);
    const t = (o = e.privacy) == null ? void 0 : o.label;
    let i = "";
    return e instanceof Le && (i = `${e.privacy.label} ${e.tooltipPostfix}`), { label: t, tunnel: e, icon: { id: e.privacy.themeIcon }, editId: Pe.None, tooltip: i };
  }
}
let sa = class extends R {
  constructor(e, t, i, o, s, n, r, a) {
    super(), this.instantiationService = e, this.contextKeyService = t, this.menuService = i, this.contextViewService = o, this.remoteExplorerService = s, this.commandService = n, this.configurationService = r, this.hoverService = a, this.templateId = "actionbar";
  }
  set actionRunner(e) {
    this._actionRunner = e;
  }
  renderTemplate(e) {
    const t = se(e, z(".ports-view-actionbar-cell")), i = se(t, z(".ports-view-actionbar-cell-icon")), o = new Wa(t, {
      supportHighlights: !0,
      hoverDelegate: {
        showHover: (r) => this.hoverService.showHover(r),
        delay: this.configurationService.getValue("workbench.hover.delay")
      }
    }), s = se(t, z(".actions")), n = new vo(s, {
      actionViewItemProvider: un.bind(void 0, this.instantiationService)
    });
    return { label: o, icon: i, actionBar: n, container: t, elementDisposable: R.None };
  }
  renderElement(e, t, i) {
    i.actionBar.clear(), i.icon.className = "ports-view-actionbar-cell-icon", i.icon.style.display = "none", i.label.setLabel(""), i.label.element.style.display = "none", i.container.style.height = "22px", i.button && (i.button.element.style.display = "none", i.button.dispose()), i.container.style.paddingLeft = "0px", i.elementDisposable.dispose();
    let o;
    e.editId === Pe.New && (o = this.remoteExplorerService.getEditableData(void 0)) ? this.renderInputBox(i.container, o) : (o = this.remoteExplorerService.getEditableData(e.tunnel, e.editId), o ? this.renderInputBox(i.container, o) : e.tunnel.tunnelType === he.Add && e.menuId === b.TunnelPortInline ? this.renderButton(e, i) : this.renderActionBarItem(e, i));
  }
  renderButton(e, t) {
    t.container.style.paddingLeft = "7px", t.container.style.height = "28px", t.button = this._register(new ff(t.container, bf)), t.button.label = e.label, t.button.element.title = e.tooltip, this._register(t.button.onDidClick(() => {
      this.commandService.executeCommand(Oe.INLINE_ID);
    }));
  }
  tunnelContext(e) {
    let t;
    return e instanceof Le && (t = e.strip()), t || (t = {
  ...
  renderActionBarItem(e, t) {
    t.label.element.style.display = "flex", t.label.setLabel(e.label, void 0, {
      title: e.markdownTooltip ? { markdown: e.markdownTooltip(this.configurationService), markdownNotSupportedFallback: e.tooltip } : e.tooltip,
      extraClasses: e.menuId === b.TunnelLocalAddressInline ? ["ports-view-actionbar-cell-localaddress"] : void 0
    }), t.actionBar.context = this.tunnelContext(e.tunnel), t.container.style.paddingLeft = "10px";
    const i = [
      ["view", hc],
      [ks.key, e.tunnel.tunnelType],
      [xs.key, e.tunnel.closeable],
      [na.key, e.tunnel.privacy.id],
      [Pn.key, e.tunnel.protocol]
    ], o = this.contextKeyService.createOverlay(i), s = new A();
    if (t.elementDisposable = s, e.menuId) {
      const n = s.add(this.menuService.createMenu(e.menuId, o));
      let r = [];
      if (Ui(n, { shouldForwardArgs: !0 }, r), r) {
        const a = r.filter((d) => d.id.toLowerCase().indexOf("label") >= 0);
        a.length > 1 && (a.sort((d, l) => d.label.length - l.label.length), a.pop(), r = r.filter((d) => a.indexOf(d) < 0)), t.actionBar.push(r, { icon: !0, label: !1 }), this._actionRunner && (t.actionBar.actionRunner = this._actionRunner);
      }
    }
    e.icon && (t.icon.className = `ports-view-actionbar-cell-icon ${me.asClassName(e.icon)}`, t.icon.title = e.tooltip, t.icon.style.display = "inline");
  }
  renderInputBox(e, t) {
    this.inputDone && (this.inputDone(!1, !1), this.inputDone = void 0), e.style.paddingLeft = "5px";
    const i = t.startingValue || "", o = new vf(e, this.contextViewService, {
      ariaLabel: p("remote.tunnelsView.input", "Press Enter to confirm or Escape to cancel."),
      validationOptions: {
        validation: (r) => {
          const a = t.validationMessage(r);
          return a ? {
            content: a.content,
            formatContent: !0,
            type: a.severity === wt.Error ? 3 : 1
          } : null;
        }
      },
    ...
    o.value = i, o.focus(), o.select({ start: 0, end: t.startingValue ? t.startingValue.length : 0 });
    const s = Sf(async (r, a) => {
      ue(n), this.inputDone && (this.inputDone = void 0), o.element.style.display = "none";
      const d = o.value;
      if (a)
        return t.onFinish(d, r);
    });
    this.inputDone = s;
    const n = [
      o,
      Fd(o.inputElement, S.KEY_DOWN, async (r) => {
        if (r.equals(3))
          return r.stopPropagation(), o.validate() !== 3 ? s(!0, !0) : s(!1, !0);
        if (r.equals(9))
          return r.preventDefault(), r.stopPropagation(), s(!1, !0);
      }),
      w(o.inputElement, S.BLUR, () => s(o.validate() !== 3, !0))
    ];
    return ie(() => {
      s(!1, !1);
    });
  }
  disposeElement(e, t, i, o) {
    i.elementDisposable.dispose();
  }
  disposeTemplate(e) {
    var t;
    e.label.dispose(), e.actionBar.dispose(), e.elementDisposable.dispose(), (t = e.button) == null || t.dispose();
  }
};
sa = x([
  h(0, D),
...
class Le {
  static createFromTunnel(e, t, i, o = he.Forwarded, s) {
    return new Le(
      o,
      i.remoteHost,
      i.remotePort,
  ...
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E) {
    this.tunnelType = e, this.remoteHost = t, this.remotePort = i, this.source = o, this.hasRunningProcess = s, this.protocol = n, this.localUri = r, this.localAddress = a, this.localPort = d, this.closeable = l, this.name = u, this.runningProcess = g, this.pid = m, this._privacy = f, this.remoteExplorerService = C, this.tunnelService = E;
  }
  get label() {
    if (this.tunnelType === he.Add && this.name)
      return this.name;
    const e = _n(this.remoteHost) || kn(this.remoteHost) ? `${this.remotePort}` : `${this.remoteHost}:${this.remotePort}`;
    return this.name ? `${this.name} (${e})` : e;
  }
  set processDescription(e) {
    this.runningProcess = e;
  }
  get processDescription() {
    var t;
    let e = "";
    return this.runningProcess ? (this.pid && ((t = this.remoteExplorerService) != null && t.namedProcesses.has(this.pid)) ? e = this.remoteExplorerService.namedProcesses.get(this.pid) : e = this.runningProcess.replace(/\0/g, " ").trim(), this.pid && (e += ` (${this.pid})`)) : this.hasRunningProcess && (e = p("tunnelView.runningProcess.inacessable", "Process information unavailable")), e;
  }
  get tooltipPostfix() {
    let e;
    return this.localAddress ? e = p(
  ...
  get iconTooltip() {
    return this.tunnelType === he.Add ? this.label : `${this.processDescription ? p("tunnel.iconColumn.running", "Port has running process.") : p("tunnel.iconColumn.notRunning", "No running process.")}`;
  }
  get portTooltip() {
    return this.tunnelType === he.Add ? "" : `${this.name ? p("remote.tunnel.tooltipName", "Port labeled {0}. ", this.name) : ""}`;
  }
  get processTooltip() {
  ...
  get privacy() {
    var e, t;
    return (e = this.tunnelService) != null && e.privacyOptions ? ((t = this.tunnelService) == null ? void 0 : t.privacyOptions.find((i) => i.id === this._privacy)) ?? {
      id: "",
      themeIcon: M.question.id,
      label: p("tunnelPrivacy.unknown", "Unknown")
    } : {
      id: Ko.Private,
      themeIcon: vw.id,
      label: p("tunnelPrivacy.private", "Private")
    };
  }
}
const ks = new N("tunnelType", he.Add, !0), xs = new N("tunnelCloseable", !1, !0), na = new N("tunnelPrivacy", void 0, !0), cu = new N("tunnelPrivacyEnabled", !1, !0), Pn = new N("tunnelProtocol", _e.Http, !0), Ln = new N(
  "tunnelViewFocus",
  !1,
  p("tunnel.focusContext", "Whether the Ports view has focus.")
), Ds = "tunnelViewSelection", Lw = new N(Ds, void 0, !0), du = "tunnelViewMultiSelection", lu = new N(du, void 0, !0), hu = new N("portChangable", !1, !0);
let lo = class uu extends En {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g, m, f, C, E, V, B) {
    super(t, i, o, n, s, a, r, d, m, C), this.viewModel = e, this.quickInputService = l, this.commandService = u, this.menuService = g, this.remoteExplorerService = f, this.tunnelService = E, this.contextViewService = V, this.hoverService = B, this.isEditing = !1, this.titleActions = [], this.lastFocus = [], this.tunnelTypeContext = ks.bindTo(s), this.tunnelCloseableContext = xs.bindTo(s), this.tunnelPrivacyContext = na.bindTo(s), this.tunnelPrivacyEnabledContext = cu.bindTo(s), this.tunnelPrivacyEnabledContext.set(E.privacyOptions.length !== 0), this.tunnelProtocolContext = Pn.bindTo(s), this.tunnelViewFocusContext = Ln.bindTo(s), this.tunnelViewSelectionContext = Lw.bindTo(s), this.tunnelViewMultiSelectionContext = lu.bindTo(s), this.portChangableContextKey = hu.bindTo(s);
    const De = this.contextKeyService.createOverlay([["view", uu.ID]]), Me = this._register(this.menuService.createMenu(b.TunnelTitle, De)), bt = () => {
      this.titleActions = [], Ui(Me, void 0, this.titleActions), this.updateActions();
    };
    this._register(Me.onDidChange(bt)), bt(), this._register(ie(() => {
      this.titleActions = [];
    })), this.registerPrivacyActions();
  }
  registerPrivacyActions() {
    for (const e of this.tunnelService.privacyOptions) {
      const t = `remote.tunnel.privacy${e.id}`;
      q.registerCommand(t, ra.handler(e.id)), _.appendMenuItem(b.TunnelPrivacy, {
        order: 0,
        command: {
          id: t,
          title: e.label,
          toggled: na.isEqualTo(e.id)
        }
      });
    }
  }
  ...
  renderBody(e) {
    super.renderBody(e);
    const t = se(e, z(".tree-explorer-viewlet-tree-view")), i = se(t, z(".customview-tree"));
    i.classList.add("ports-view"), i.classList.add("file-icon-themable-tree", "show-file-icons");
    const o = new sa(
      ...
      this.hoverService
    ), s = [new Aw(), new Tw(), new uc(), new Vw()];
    this.tunnelService.canChangePrivacy && s.push(new Pw()), s.push(new Rw()), this.table = this.instantiationService.createInstance(yf, "RemoteTunnels", i, new Iw(this.remoteExplorerService), s, [o], {
      keyboardNavigationLabelProvider: {
        getKeyboardNavigationLabel: (d) => d.label
      },
      multipleSelectionSupport: !0,
      accessibilityProvider: {
        getAriaLabel: (d) => d instanceof Le ? `${d.tooltipPostfix} ${d.portTooltip} ${d.iconTooltip} ${d.processTooltip} ${d.originTooltip} ${this.tunnelService.canChangePrivacy ? d.privacy.label : ""}` : d.label,
        getWidgetAriaLabel: () => p("tunnelView", "Tunnel View")
      },
      openOnSingleClick: !0
    });
    const n = new is();
    o.actionRunner = n, this._register(this.table.onContextMenu((d) => this.onContextMenu(d, n))), this._register(this.table.onMouseDblClick((d) => this.onMouseDblClick(d))), this._register(this.table.onDidChangeFocus((d) => this.onFocusChanged(d))), this._register(this.table.onDidChangeSelection((d) => this.onSelectionChanged(d))), this._register(this.table.onDidFocus(() => this.tunnelViewFocusContext.set(!0))), this._register(this.table.onDidBlur(() => this.tunnelViewFocusContext.set(!1)));
    const r = () => this.table.splice(0, Number.POSITIVE_INFINITY, this.viewModel.all);
    r();
    let a = this.portCount;
    this._register(I.debounce(this.viewModel.onForwardedPortsChanged, (d, l) => l, 50)(() => {
      const d = this.portCount;
      (a === 0 || d === 0) && a !== d && this._onDidChangeViewWelcomeState.fire(), a = d, r();
    })), this._register(this.table.onMouseClick((d) => {
      if (this.hasOpenLinkModifier(d.browserEvent)) {
        const l = this.table.getSelectedElements();
        (l.length === 0 || l.length === 1 && l[0] === d.element) && this.commandService.executeCommand(it.ID, d.element);
      }
    })), this._register(this.table.onDidOpen((d) => {
      var l;
      !d.element || d.element.tunnelType !== he.Forwarded || ((l = d.browserEvent) == null ? void 0 : l.type) === "dblclick" && this.commandService.executeCommand(ai.ID);
    })), this._register(this.remoteExplorerService.onDidChangeEditable((d) => {
      this.isEditing = !!this.remoteExplorerService.getEditableData(d == null ? void 0 : d.tunnel, d == null ? void 0 : d.editId), this._onDidChangeViewWelcomeState.fire(), this.isEditing || i.classList.remove("highlight"), r(), this.isEditing ? (i.classList.add("highlight"), d || this.table.reveal(this.table.indexOf(this.viewModel.input))) : (d && d.tunnel.tunnelType !== he.Add && this.table.setFocus(this.lastFocus), this.focus());
    }));
  }
  shouldShowWelcome() {
  ...
  focus() {
    super.focus(), this.table.domFocus();
  }
  onFocusChanged(e) {
    e.indexes.length > 0 && e.elements.length > 0 && (this.lastFocus = [...e.indexes]);
    const t = e.elements, i = t && t.length ? t[0] : void 0;
    i ? (this.tunnelViewSelectionContext.set(Q(i.remoteHost, i.remotePort)), this.tunnelTypeContext.set(i.tunnelType), this.tunnelCloseableContext.set(!!i.closeable), this.tunnelPrivacyContext.set(i.privacy.id), this.tunnelProtocolContext.set(i.protocol === _e.Https ? _e.Https : _e.Https), this.portChangableContextKey.set(!!i.localPort)) : (this.tunnelTypeContext.reset(), this.tunnelViewSelectionContext.reset(), this.tunnelCloseableContext.reset(), this.tunnelPrivacyContext.reset(), this.tunnelProtocolContext.reset(), this.portChangableContextKey.reset());
  }
  hasOpenLinkModifier(e) {
    const t = this.configurationService.getValue("editor");
    let i = !1;
    return t.multiCursorModifier === "ctrlCmd" ? i = e.altKey : le ? i = e.metaKey : i = e.ctrlKey, i;
  }
  onSelectionChanged(e) {
    const t = e.elements;
    t.length > 1 ? this.tunnelViewMultiSelectionContext.set(t.map((i) => Q(i.remoteHost, i.remotePort))) : this.tunnelViewMultiSelectionContext.set(void 0);
  }
  onContextMenu(e, t) {
    if (e.element !== void 0 && !(e.element instanceof Le))
      return;
    e.browserEvent.preventDefault(), e.browserEvent.stopPropagation();
    const i = e.element;
    i ? (this.table.setFocus([this.table.indexOf(i)]), this.tunnelTypeContext.set(i.tunnelType), this.tunnelCloseableContext.set(!!i.closeable), this.tunnelPrivacyContext.set(i.privacy.id), this.tunnelProtocolContext.set(i.protocol), this.portChangableContextKey.set(!!i.localPort)) : (this.tunnelTypeContext.set(he.Add), this.tunnelCloseableContext.set(!1), this.tunnelPrivacyContext.set(void 0), this.tunnelProtocolContext.set(void 0), this.portChangableContextKey.set(!1)), this.contextMenuService.showContextMenu({
      menuId: b.TunnelContext,
      menuActionOptions: { shouldForwardArgs: !0 },
      contextKeyService: this.table.contextKeyService,
      getAnchor: () => e.anchor,
      getActionViewItem: (o) => {
        const s = this.keybindingService.lookupKeybinding(o.id);
        if (s)
          return new th(o, o, { label: !0, keybinding: s.getLabel() });
      },
      onHide: (o) => {
        o && this.table.domFocus();
      },
      getActionsContext: () => i == null ? void 0 : i.strip(),
      actionRunner: t
    });
  }
  onMouseDblClick(e) {
    e.element || this.commandService.executeCommand(Oe.INLINE_ID);
  }
  layoutBody(e, t) {
    super.layoutBody(e, t), this.table.layout(e, t);
  }
};
lo.ID = hc;
lo.TITLE = p("remote.tunnel", "Ports");
lo = x([
  h(2, we),
  h(3, xe),
  h(4, H),
...
function _i(c) {
  return c && c.tunnelType && c.remoteHost && c.source;
}
var ai;
(function(c) {
  c.ID = "remote.tunnel.label", c.LABEL = p("remote.tunnel.label", "Set Port Label"), c.COMMAND_ID_KEYWORD = "label";
  function e() {
    return async (t, i) => {
      const o = t.get(He);
      let s;
      if (_i(i))
        ...
        const n = t.get(H).getContextKeyValue(Ds), r = n ? o.tunnelModel.forwarded.get(n) : void 0;
        if (r) {
          const a = t.get(Wt);
          s = Le.createFromTunnel(o, a, r);
        }
      }
      if (s) {
        const n = s;
        return new Promise((r) => {
          const a = n.name ? n.name : `${n.remotePort}`;
          o.setEditable(n, Pe.Label, {
            onFinish: async (d, l) => {
              d = d.trim(), o.setEditable(n, Pe.Label, null);
              const u = l && d !== a;
              u && await o.tunnelModel.name(n.remoteHost, n.remotePort, d), r(u ? { port: n.remotePort, label: d } : void 0);
            },
            validationMessage: () => null,
            placeholder: p("remote.tunnelsView.labelPlaceholder", "Port label"),
            startingValue: a
          });
        });
      }
...
const pu = p(
  ...
  pc
), mu = p("remote.tunnelView.inlineElevationMessage", "May Require Sudo"), Ow = p("remote.tunnelView.alreadyForwarded", "Port is already forwarded");
var Oe;
(function(c) {
  c.INLINE_ID = "remote.tunnel.forwardInline", c.COMMANDPALETTE_ID = "remote.tunnel.forwardCommandPalette", c.LABEL = { value: p("remote.tunnel.forward", "Forward a Port"), original: "Forward a Port" }, c.TREEITEM_LABEL = p("remote.tunnel.forwardItem", "Forward Port");
  const e = p(
  ...
  function t(n, r, a, d) {
    ...
    if (l) {
      if (l.port >= pc)
        return { content: gu, severity: wt.Error };
      if (d && r.isPortPrivileged(l.port))
        return { content: mu, severity: wt.Info };
      if (Ie(n.tunnelModel.forwarded, l.host, l.port))
        return { content: Ow, severity: wt.Error };
    } else
      return { content: pu, severity: wt.Error };
    return null;
  }
  function i(n, r, a, d) {
    r || n.warn(p(
  ...
  function o() {
    return async (n, r) => {
      const a = n.get(He), d = n.get(Be), l = n.get(Wt);
      a.setEditable(void 0, Pe.New, {
        onFinish: async (u, g) => {
          a.setEditable(void 0, Pe.New, null);
          let m;
          g && (m = Hs(u)) && a.forward({
            remote: { host: m.host, port: m.port },
            elevateIfNeeded: !0
          }).then((f) => i(d, f, m.host, m.port));
        },
        validationMessage: (u) => t(a, l, u, l.canElevate),
        placeholder: e
      });
    };
  }
  ...
  function s() {
    return async (n, r) => {
      const a = n.get(He), d = n.get(Be), l = n.get(yn), u = n.get(Kt), g = n.get(Wt);
      await l.openView(lo.ID, !0);
      const m = await u.input({
        prompt: e,
        validateInput: (C) => Promise.resolve(t(a, g, C, g.canElevate))
      });
      let f;
      m && (f = Hs(m)) && a.forward({
        remote: { host: f.host, port: f.port },
        elevateIfNeeded: !0
      }).then((C) => i(d, C, f.host, f.port));
    };
  }
  c.commandPaletteHandler = s;
})(Oe || (Oe = {}));
function fu(c, e, t) {
  const i = c.map((o) => {
    const s = Le.createFromTunnel(e, t, o);
    return {
      label: s.label,
      description: s.processDescription,
      tunnel: s
    };
  });
...
var ht;
(function(c) {
  c.INLINE_ID = "remote.tunnel.closeInline", c.COMMANDPALETTE_ID = "remote.tunnel.closeCommandPalette", c.LABEL = { value: p("remote.tunnel.close", "Stop Forwarding Port"), original: "Stop Forwarding Port" };
  function e() {
    return async (i, o) => {
      const s = i.get(H), n = i.get(He);
      let r = [];
      const a = s.getContextKeyValue(du);
      if (a)
        a.forEach((d) => {
          const l = n.tunnelModel.forwarded.get(d);
          l && (r == null || r.push(l));
        });
      else if (_i(o))
        r = [o];
      else {
        const d = s.getContextKeyValue(Ds), l = d ? n.tunnelModel.forwarded.get(d) : void 0;
        l && (r = [l]);
      }
      if (!(!r || r.length === 0))
        return Promise.all(r.map(
          (d) => n.close({ host: d.remoteHost, port: d.remotePort }, St.User)
        ));
    };
  }
  c.inlineHandler = e;
  function t() {
    return async (i) => {
      const o = i.get(Kt), s = i.get(He), n = i.get(Wt), r = i.get(It), a = fu(Array.from(s.tunnelModel.forwarded.values()).filter((l) => l.closeable), s, n), d = await o.pick(a, { placeHolder: p("remote.tunnel.closePlaceholder", "Choose a port to stop forwarding") });
      d && d.tunnel ? await s.close({ host: d.tunnel.remoteHost, port: d.tunnel.remotePort }, St.User) : d && await r.executeCommand(Oe.COMMANDPALETTE_ID);
    };
  }
  c.commandPaletteHandler = t;
})(ht || (ht = {}));
var it;
(function(c) {
  c.ID = "remote.tunnel.open", c.LABEL = p("remote.tunnel.open", "Open in Browser");
  function e() {
    return async (i, o) => {
      let s;
      if (_i(o) ? s = Q(o.remoteHost, o.remotePort) : o.tunnelRemoteHost && o.tunnelRemotePort && (s = Q(o.tunnelRemoteHost, o.tunnelRemotePort)), s) {
        const n = i.get(He).tunnelModel, r = i.get(Ki);
        return t(n, r, s);
      }
    };
  }
  c.handler = e;
  function t(i, o, s) {
    const n = i.forwarded.get(s) || i.detected.get(s);
    return n ? o.open(n.localUri, { allowContributedOpeners: !1 }) : Promise.resolve();
  }
  c.run = t;
})(it || (it = {}));
var Et;
(function(c) {
  c.ID = "remote.tunnel.openPreview", c.LABEL = p("remote.tunnel.openPreview", "Preview in Editor");
  function e() {
    return async (i, o) => {
      let s;
      if (_i(o) ? s = Q(o.remoteHost, o.remotePort) : o.tunnelRemoteHost && o.tunnelRemotePort && (s = Q(o.tunnelRemoteHost, o.tunnelRemotePort)), s) {
        const n = i.get(He).tunnelModel, r = i.get(Ki), a = i.get(xw);
        return t(n, r, a, s);
      }
    };
  }
  c.handler = e;
  async function t(i, o, s, n) {
    const r = i.forwarded.get(n) || i.detected.get(n);
    if (r) {
      const a = r.remoteHost.includes(":") ? `[${r.remoteHost}]` : r.remoteHost, d = P.parse(`http://${a}:${r.remotePort}`), l = await s.getOpener(r.localUri, { sourceUri: d }, new st().token);
      return l ? l.openExternalUri(r.localUri, { sourceUri: d }, new st().token) : o.open(r.localUri);
    }
...
var ho;
(function(c) {
  c.ID = "remote.tunnel.openCommandPalette", c.LABEL = p("remote.tunnel.openCommandPalette", "Open Port in Browser");
  function e() {
    return async (t, i) => {
      const o = t.get(He), s = t.get(Wt), n = o.tunnelModel, r = t.get(Kt), a = t.get(Ki), d = t.get(It), l = [...n.forwarded, ...n.detected].map((g) => {
        const m = Le.createFromTunnel(o, s, g[1]);
        return {
          label: m.label,
      ...
      l.length === 0 ? l.push({
        ...
        label: p("remote.tunnel.openCommandPaletteView", "Open the Ports view...")
      });
      const u = await r.pick(l, { placeHolder: p("remote.tunnel.openCommandPalettePick", "Choose the port to open") });
      if (u && u.tunnel)
        return it.run(n, a, Q(u.tunnel.remoteHost, u.tunnel.remotePort));
      if (u)
        return d.executeCommand(`${hc}.focus`);
    };
  }
  c.handler = e;
})(
...
var ut;
(function(c) {
  c.INLINE_ID = "remote.tunnel.copyAddressInline", c.COMMANDPALETTE_ID = "remote.tunnel.copyAddressCommandPalette", c.INLINE_LABEL = p("remote.tunnel.copyAddressInline", "Copy Local Address"), c.COMMANDPALETTE_LABEL = p("remote.tunnel.copyAddressCommandPalette", "Copy Forwarded Port Address");
  async function e(o, s, n) {
    const r = o.tunnelModel.address(n.remoteHost, n.remotePort);
    r && await s.writeText(r.toString());
  }
  function t() {
    return async (o, s) => {
      const n = o.get(He);
      ...
      if (_i(s))
        ...
        const a = o.get(H).getContextKeyValue(Ds);
        r = a ? n.tunnelModel.forwarded.get(a) : void 0;
      }
      if (r)
        return e(n, o.get(Uo), r);
    };
  }
  c.inlineHandler = t;
  function i() {
    return async (o, s) => {
      const n = o.get(Kt), r = o.get(He), a = o.get(Wt), d = o.get(It), l = o.get(Uo), u = Array.from(r.tunnelModel.forwarded.values()).concat(Array.from(r.tunnelModel.detected.values())), g = await n.pick(fu(u, r, a), { placeHolder: p("remote.tunnel.copyAddressPlaceholdter", "Choose a forwarded port") });
      g && g.tunnel ? await e(r, l, g.tunnel) : g && await d.executeCommand(Oe.COMMANDPALETTE_ID);
    };
  }
  c.commandPaletteHandler = i;
})(ut || (ut = {}));
var uo;
(function(c) {
  c.ID = "remote.tunnel.changeLocalPort", c.LABEL = p("remote.tunnel.changeLocalPort", "Change Local Address Port");
  function e(i, o, s) {
    if (o.match(/^[0-9]+$/)) {
      if (Number(o) >= pc)
        return { content: gu, severity: wt.Error };
      if (s && i.isPortPrivileged(Number(o)))
        return { content: mu, severity: wt.Info };
    } else
      return { content: pu, severity: wt.Error };
    return null;
  ...
  function t() {
    return async (i, o) => {
      const s = i.get(He), n = i.get(Be), r = i.get(Wt);
      let a;
      if (_i(o))
        a = o;
      else {
        const d = i.get(H).getContextKeyValue(Ds), l = d ? s.tunnelModel.forwarded.get(d) : void 0;
        if (l) {
          const u = i.get(Wt);
          a = Le.createFromTunnel(s, u, l);
        }
      }
      if (a) {
        const d = a;
        s.setEditable(d, Pe.LocalPort, {
          onFinish: async (l, u) => {
            if (s.setEditable(d, Pe.LocalPort, null), u) {
              await s.close({ host: d.remoteHost, port: d.remotePort }, St.Other);
              const g = Number(l), m = await s.forward({
                remote: { host: d.remoteHost, port: d.remotePort },
                local: g,
                name: d.name,
                elevateIfNeeded: !0,
                source: d.source
              });
              m && m.tunnelLocalPort !== g && n.warn(p(
                "remote.tunnel.changeLocalPortNumber",
                "The local port {0} is not available. Port number {1} has been used instead",
                l,
                m.tunnelLocalPort ?? m.localAddress
              ));
            }
          },
          validationMessage: (l) => e(r, l, r.canElevate),
          placeholder: p("remote.tunnelsView.changePort", "New local port")
        });
      }
    };
  }
...
(function(c) {
  function e(t) {
    return async (i, o) => {
      if (_i(o)) {
        const s = i.get(He);
        return await s.close({ host: o.remoteHost, port: o.remotePort }, St.Other), s.forward({
          remote: { host: o.remoteHost, port: o.remotePort },
          local: o.localPort,
          name: o.name,
          elevateIfNeeded: !0,
          privacy: t,
...
var zt;
(function(c) {
  c.ID_HTTP = "remote.tunnel.setProtocolHttp", c.ID_HTTPS = "remote.tunnel.setProtocolHttps", c.LABEL_HTTP = p("remote.tunnel.protocolHttp", "HTTP"), c.LABEL_HTTPS = p("remote.tunnel.protocolHttps", "HTTPS");
  async function e(o, s, n) {
    if (_i(o)) {
      const r = {
        protocol: s
      };
      return n.tunnelModel.configPortsAttributes.addAttributes(o.remotePort, r, 4);
    }
  }
  function t() {
    return async (o, s) => e(s, _e.Http, o.get(He));
  }
  c.handlerHttp = t;
  function i() {
    return async (o, s) => e(s, _e.Https, o.get(He));
  }
  c.handlerHttps = i;
})(zt || (zt = {}));
const gc = 10, qi = ks.isEqualTo(he.Forwarded), Yi = v.or(
  qi,
  ks.isEqualTo(he.Detected)
), ki = lu.isEqualTo(void 0);
k.registerCommandAndKeybindingRule({
  id: ai.ID,
  weight: 200 + gc,
  when: v.and(Ln, qi, ki),
...
q.registerCommand(Oe.INLINE_ID, Oe.inlineHandler());
...
k.registerCommandAndKeybindingRule({
  ...
  handler: ht.inlineHandler()
});
q.registerCommand(ht.COMMANDPALETTE_ID, ht.commandPaletteHandler());
q.registerCommand(it.ID, it.handler());
q.registerCommand(Et.ID, Et.handler());
q.registerCommand(ho.ID, ho.handler());
k.registerCommandAndKeybindingRule({
  id: ut.INLINE_ID,
  weight: 200 + gc,
  when: v.and(
  ...
  primary: 2081,
  handler: ut.inlineHandler()
});
q.registerCommand(ut.COMMANDPALETTE_ID, ut.commandPaletteHandler());
q.registerCommand(uo.ID, uo.handler());
q.registerCommand(zt.ID_HTTP, zt.handlerHttp());
q.registerCommand(zt.ID_HTTPS, zt.handlerHttps());
_.appendMenuItem(b.CommandPalette, {
  command: {
    id: ht.COMMANDPALETTE_ID,
    title: ht.LABEL
  },
  when: Rn
});
...
_.appendMenuItem(b.CommandPalette, {
  command: {
    id: ut.COMMANDPALETTE_ID,
    title: ut.COMMANDPALETTE_LABEL
  },
  when: Rn
});
_.appendMenuItem(b.CommandPalette, {
...
_.appendMenuItem(b.TunnelContext, {
  group: "._open",
  order: 0,
  command: {
    id: it.ID,
...
_.appendMenuItem(b.TunnelContext, {
  group: "2_localaddress",
  order: 2,
  submenu: b.TunnelPrivacy,
  title: p("tunnelContext.privacyMenu", "Port Visibility"),
  when: v.and(qi, cu)
});
_.appendMenuItem(b.TunnelContext, {
  group: "2_localaddress",
  order: 3,
  submenu: b.TunnelProtocol,
  title: p("tunnelContext.protocolMenu", "Change Port Protocol"),
  when: v.and(qi, ki)
});
_.appendMenuItem(b.TunnelContext, {
  group: "3_forward",
...
_.appendMenuItem(b.TunnelProtocol, {
  order: 0,
  command: {
    id: zt.ID_HTTP,
    title: zt.LABEL_HTTP,
    toggled: Pn.isEqualTo(_e.Http)
  }
});
_.appendMenuItem(b.TunnelProtocol, {
  order: 1,
  command: {
    id: zt.ID_HTTPS,
    title: zt.LABEL_HTTPS,
    toggled: Pn.isEqualTo(_e.Https)
  }
});
_.appendMenuItem(b.TunnelPortInline, {
  group: "0_manage",
  order: 0,
  command: {
    id: Oe.INLINE_ID,
    title: Oe.TREEITEM_LABEL,
    icon: ww
  },
  when: ks.isEqualTo(he.Candidate)
});
_.appendMenuItem(b.TunnelPortInline, {
  group: "0_manage",
  order: 4,
...
_.appendMenuItem(b.TunnelLocalAddressInline, {
  order: -1,
  command: {
    id: ut.INLINE_ID,
    title: ut.INLINE_LABEL,
...
mf("ports.iconRunningProcessForeground", {
  light: As,
  dark: As,
  hcDark: As,
  hcLight: As
...
const ir = "workbench.view.remote";
class mc extends R {
  constructor(e, t, i, o, s, n, r, a) {
  ...
  async doAction(e) {
    ...
    if (this.logService.trace(`ForwardedPorts: (OnAutoForwardedAction) Heuristic chose ${t == null ? void 0 : t.tunnelRemotePort}`), t) {
      ...
      switch (this.logService.trace(`ForwardedPorts: (OnAutoForwardedAction) onAutoForward action is ${n}`), n) {
        case dt.OpenBrowserOnce: {
          if (this.alreadyOpenedOnce.has(t.localAddress))
            break;
          this.alreadyOpenedOnce.add(t.localAddress);
        }
        case dt.OpenBrowser: {
          const r = Q(t.tunnelRemoteHost, t.tunnelRemotePort);
          await it.run(this.remoteExplorerService.tunnelModel, this.openerService, r);
          break;
        }
        case dt.OpenPreview: {
          const r = Q(t.tunnelRemoteHost, t.tunnelRemotePort);
          await Et.run(this.remoteExplorerService.tunnelModel, this.openerService, this.externalOpenerService, r);
          break;
        }
        case dt.Silent:
          break;
        default: {
          ...
          this.logService.trace(`ForwardedPorts: (OnAutoForwardedAction) time elapsed since last notification ${r} ms`), r > mc.NOTIFY_COOL_DOWN && await this.showNotification(t);
        }
      }
    }
  }
  ...
  async showNotification(e) {
    ...
    (!Qe || Dw.getValue(this.contextKeyService)) && i.push(this.openPreviewChoice(e)), e.tunnelLocalPort !== e.tunnelRemotePort && this.tunnelService.canElevate && this.tunnelService.isPortPrivileged(e.tunnelRemotePort) && (t += p(
      "remote.tunnelsView.elevationMessage",
      "You'll need to run as superuser to use port {0} locally.  ",
      e.tunnelRemotePort
    ), i.unshift(this.elevateChoice(e))), e.privacy === Ko.Private && Qe && this.tunnelService.canChangePrivacy && i.push(this.makePublicChoice(e)), t += this.linkMessage(), this.lastNotification = this.notificationService.prompt(Ks.Info, t, i, { neverShowAgain: { id: "remote.tunnelsView.autoForwardNeverShow", isSecondary: !0 } }), this.lastShownPort = e.tunnelRemotePort, this.lastNotifyTime = /* @__PURE__ */ new Date(), this.lastNotification.onDidClose(() => {
      this.lastNotification = void 0, this.lastShownPort = void 0;
    });
  }
  makePublicChoice(e) {
    return {
      label: p("remote.tunnelsView.makePublic", "Make Public"),
      run: async () => {
        const t = Ie(this.remoteExplorerService.tunnelModel.forwarded, e.tunnelRemoteHost, e.tunnelRemotePort);
        return await this.remoteExplorerService.close({ host: e.tunnelRemoteHost, port: e.tunnelRemotePort }, St.Other), this.remoteExplorerService.forward({
  ...
  openBrowserChoice(e) {
    const t = Q(e.tunnelRemoteHost, e.tunnelRemotePort);
    return {
      label: it.LABEL,
      run: () => it.run(this.remoteExplorerService.tunnelModel, this.openerService, t)
    };
  }
  openPreviewChoice(e) {
    const t = Q(e.tunnelRemoteHost, e.tunnelRemotePort);
    return {
      label: Et.LABEL,
      run: () => Et.run(this.remoteExplorerService.tunnelModel, this.openerService, this.externalOpenerService, t)
    };
  }
  elevateChoice(e) {
    return {
      ...
      run: async () => {
        var i;
        await this.remoteExplorerService.close({ host: e.tunnelRemoteHost, port: e.tunnelRemotePort }, St.Other);
        ...
        t && ((i = this.lastNotification) == null || i.close(), this.lastShownPort = t.tunnelRemotePort, this.lastNotification = this.notificationService.prompt(Ks.Info, this.basicMessage(t) + this.linkMessage(), [this.openBrowserChoice(t), this.openPreviewChoice(e)], { neverShowAgain: { id: "remote.tunnelsView.autoForwardNeverShow", isSecondary: !0 } }), this.lastNotification.onDidClose(() => {
          this.lastNotification = void 0, this.lastShownPort = void 0;
        }));
      }
    };
...
let aa = class bu extends En {
  ...
  saveState() {
    this._webview.value && (this.viewState[or.webviewState] = this._webview.value.state), this.memento.saveMemento(), super.saveState();
  }
  layoutBody(e, t) {
    super.layoutBody(e, t), this.layoutWebview(new G(t, e));
  }
  updateTreeVisibility() {
    var e, t;
  ...
  activate() {
    if (this._activated)
      return;
    this._activated = !0;
    const e = this.extensionId ? bu.getOriginStore(this.storageService).getOrigin(this.id, this.extensionId) : void 0, t = this.webviewService.createWebviewOverlay({
      origin: e,
    ...
    t.state = this.viewState[or.webviewState], this._webview.value = t, this._container && this.layoutWebview(), this._webviewDisposables.add(ie(() => {
      var o;
      (o = this._webview.value) == null || o.release(this);
    })), this._webviewDisposables.add(t.onDidUpdateState(() => {
      this.viewState[or.webviewState] = t.state;
    }));
    for (const o of [S.DRAG, S.DRAG_END, S.DRAG_ENTER, S.DRAG_LEAVE, S.DRAG_START])
      this._webviewDisposables.add(w(this._webview.value.container, o, (s) => {
        s.preventDefault(), s.stopImmediatePropagation(), this.dropTargetElement.dispatchEvent(new DragEvent(s.type, s));
      }));
    this._webviewDisposables.add(new Mw(() => this._webview.value));
    const i = this._webviewDisposables.add(new st());
  ...
  findRootContainer(e) {
    return Bt(Us(e, "monaco-scrollable-element"));
  }
};
aa = x([
  h(1, L),
...
const fd = {
  ...
  properties: {
    ...
    panel: {
      description: p("views.container.panel", "Contribute views containers to Panel"),
      type: "array",
      items: fd
    }
  }
...
const _o = {
  ...
  properties: {
    ...
    group: {
      description: p("vscode.extension.contributes.view.group", "Nested group in the viewlet"),
      type: "string"
    },
    remoteName: {
      description: p(
  ...
  description: p("vscode.extension.contributes.views", "Contributes views to the editor"),
  type: "object",
  properties: {
    explorer: {
      description: p(
    ...
    debug: {
      description: p("views.debug", "Contributes views to Debug container in the Activity bar"),
      type: "array",
      items: _o,
      default: []
    },
    scm: {
      description: p("views.scm", "Contributes views to SCM container in the Activity bar"),
      type: "array",
      items: _o,
      default: []
    },
    test: {
      description: p("views.test", "Contributes views to Test container in the Activity bar"),
      type: "array",
      items: _o,
      default: []
    },
  ...
  additionalProperties: {
    description: p("views.contributed", "Contributes views to contributed views container"),
    type: "array",
    items: _o,
    default: []
  }
}, vu = nh.registerExtensionPoint({
...
let ca = class {
  constructor(e, t) {
    this.instantiationService = e, this.logService = t, this.viewContainersRegistry = de.as(lt.ViewContainersRegistry), this.viewsRegistry = de.as(lt.ViewsRegistry), this.handleAndRegisterCustomViewContainers(), this.handleAndRegisterCustomViews();
    let i = new st();
    k.registerCommandAndKeybindingRule({
      id: "workbench.action.showTreeHover",
      handler: async (o, ...s) => {
        i.cancel(), i = new st();
        const n = o.get(O), r = o.get(eh), a = o.get(gt), d = n.lastFocusedList;
        if (!(d instanceof mt))
          return;
        const l = d.getFocus();
        if (!l || l.length === 0)
          return;
        const u = l[0];
        if (u instanceof Ka && await u.resolve(i.token), !u.tooltip)
          return;
        const g = r.getRenderedTreeElement(u);
        g && a.showHover({
          content: u.tooltip,
          target: g,
          hoverPosition: 2,
      ...
      weight: 200,
      primary: kt(2089, 2087),
      when: v.and(su, Y)
    });
  }
  handleAndRegisterCustomViewContainers() {
    vu.setHandler((e, { added: t, removed: i }) => {
  ...
  addCustomViewContainers(e, t) {
    const i = de.as(lt.ViewContainersRegistry);
    let o = Gw + i.all.filter((n) => !!n.extensionId && i.getViewContainerLocation(n) === 0).length, s = 5 + i.all.filter((n) => !!n.extensionId && i.getViewContainerLocation(n) === 1).length + 1;
    for (const { value: n, collector: r, description: a } of e)
      Object.entries(n).forEach(([d, l]) => {
        if (this.isValidViewsContainer(l, r))
          switch (d) {
            case "activitybar":
              o = this.registerCustomViewContainers(l, a, o, t, 0);
              break;
            case "panel":
              s = this.registerCustomViewContainers(l, a, s, t, 1);
              break;
          }
      });
  }
  removeCustomViewContainers(e) {
    const t = de.as(lt.ViewContainersRegistry), i = e.reduce((o, s) => (o.add(s.description.identifier), o), new Bc());
  ...
  isValidViewsContainer(e, t) {
    if (!Array.isArray(e))
      return t.error(p("viewcontainer requirearray", "views containers must be an array")), !1;
    for (const i of e) {
      if (typeof i.id != "string" && yr(i.id))
        return t.error(p(
          "requireidstring",
  ...
  registerCustomViewContainers(e, t, i, o, s) {
    return e.forEach((n) => {
      const a = me.fromString(n.icon) || No(t.extensionLocation, n.icon), d = `workbench.view.extension.${n.id}`, l = n.title || d, u = this.registerCustomViewContainer(d, l, a, i++, t.identifier, s);
      if (o.length) {
        const g = [];
        for (const m of o)
          u !== m && g.push(...this.viewsRegistry.getViews(m).filter((f) => f.originalContainerId === n.id));
        g.length && this.viewsRegistry.moveViews(g, u);
      }
    }), i;
  }
  registerCustomViewContainer(e, t, i, o, s, n) {
    ...
    return r || (r = this.viewContainersRegistry.registerViewContainer({
      ...
      title: t,
      extensionId: s,
      ctorDescriptor: new J(fa, [e, { mergeViewWithContainerWhenSingleView: !0 }]),
      hideIfEmpty: !0,
      order: o,
      icon: i
    }, n)), r;
  ...
  deregisterCustomViewContainer(e) {
    this.viewContainersRegistry.deregisterViewContainer(e), de.as(qs.Viewlets).deregisterPaneComposite(e.id);
  }
  handleAndRegisterCustomViews() {
    Ww.setHandler((e, { added: t, removed: i }) => {
  ...
  addViews(e) {
    ...
    for (const o of e) {
      ...
      Object.entries(s).forEach(([r, a]) => {
        ...
        const l = d || this.getDefaultViewContainer(), u = [];
        for (let m = 0; m < a.length; m++) {
          ...
          if (this.viewsRegistry.getView(f.id) !== null) {
            n.error(p("duplicateView2", "A view with id `{0}` is already registered.", f.id));
            continue;
          }
          const C = If.equals(o.description.identifier, l.extensionId) ? m + 1 : l.viewOrderDelegate ? l.viewOrderDelegate.getOrder(f.group) : void 0;
          let E;
          typeof f.icon == "string" && (E = me.fromString(f.icon) || No(o.description.extensionLocation, f.icon));
          const V = this.convertInitialVisibility(f.visibility), B = this.getViewType(f.type);
          if (!B) {
            n.error(p("unknownViewType", "Unknown view type `{0}`.", f.type));
            continue;
          }
          let De;
          typeof f.initialSize == "number" && (((g = l.extensionId) == null ? void 0 : g.value) === o.description.identifier.value ? De = f.initialSize : this.logService.warn(`${o.description.identifier.value} tried to set the view size of ${f.id} but it was ignored because the view container does not belong to it.`));
          const Me = {
            type: B,
            ctorDescriptor: B === fi.Tree ? new J(Qr) : new J(aa),
            id: f.id,
            name: f.name,
            when: v.deserialize(f.when),
            containerIcon: E || (d == null ? void 0 : d.icon),
            containerTitle: f.contextualTitle || (d == null ? void 0 : d.title),
            canToggleVisibility: !0,
            canMoveView: (d == null ? void 0 : d.id) !== ir,
            treeView: B === fi.Tree ? this.instantiationService.createInstance(ia, f.id, f.name, o.description.identifier.value) : void 0,
            collapsed: this.showCollapsed(l) || V === eo.Collapsed,
            order: C,
            extensionId: o.description.identifier,
            originalContainerId: r,
            group: f.group,
            remoteAuthority: f.remoteName || f.remoteAuthority,
            virtualWorkspace: f.virtualWorkspace,
            hideByDefault: V === eo.Hidden,
            workspace: (d == null ? void 0 : d.id) === ir ? !0 : void 0,
            weight: De
          };
          t.add(Me.id), u.push(Me);
        }
        i.push({ viewContainer: l, views: u });
      });
    }
  ...
  getDefaultViewContainer() {
    return this.viewContainersRegistry.get(Mi);
  }
  removeViews(e) {
    const t = e.reduce((i, o) => (i.add(o.description.identifier), i), new Bc());
  ...
  convertInitialVisibility(e) {
    if (Object.values(eo).includes(e))
      return e;
  }
  isValidViewDescriptors(e, t) {
    if (!Array.isArray(e))
      return t.error(p("requirearray", "views must be an array")), !1;
    for (const i of e) {
  ...
  getViewContainer(e) {
    switch (e) {
      case "explorer":
        return this.viewContainersRegistry.get(Mi);
      case "debug":
        return this.viewContainersRegistry.get(Hc);
      case "scm":
        return this.viewContainersRegistry.get(md);
      case "remote":
...
const zw = de.as(xf.Workbench);
zw.registerWorkbenchContribution(ca, 1);
const Uw = bo("editorDropService");
let ln = class Ws extends R {
  get count() {
  ...
  constructor(e, t) {
    super(), this.editorGroupsService = e, this.storageService = t, this.keyMap = /* @__PURE__ */ new Map(), this.mostRecentEditorsMap = new Af(), this.editorsPerResourceCounter = new Zt(), this._onDidMostRecentlyActiveEditorsChange = this._register(new y()), this.onDidMostRecentlyActiveEditorsChange = this._onDidMostRecentlyActiveEditorsChange.event, this.registerListeners();
  }
  registerListeners() {
  ...
  registerGroupListeners(e) {
    ...
    })), I.once(e.onWillDispose)(() => ue(t));
  }
  onDidChangeEditorPartOptions(e) {
    if (!Aa(e.newPartOptions.limit, e.oldPartOptions.limit)) {
  ...
  addMostRecentEditor(e, t, i, o) {
    const s = this.ensureKey(e, t), n = this.mostRecentEditorsMap.first;
    i || !n ? this.mostRecentEditorsMap.set(s, s, n ? 1 : void 0) : (this.mostRecentEditorsMap.set(s, s, 1), this.mostRecentEditorsMap.set(n, n, 1)), o && this.updateEditorResourcesMap(t, !0), this._onDidMostRecentlyActiveEditorsChange.fire();
  }
  updateEditorResourcesMap(e, t) {
    let i, o, s;
    if (e instanceof Pt ? (i = e.primary.resource, o = e.primary.typeId, s = e.primary.editorId) : (i = e.resource, o = e.typeId, s = e.editorId), !i)
      return;
    const n = this.toIdentifier(o, s);
    if (t) {
      let r = this.editorsPerResourceCounter.get(i);
      r || (r = /* @__PURE__ */ new Map(), this.editorsPerResourceCounter.set(i, r)), r.set(n, (r.get(n) ?? 0) + 1);
    } else {
      const r = this.editorsPerResourceCounter.get(i);
      if (r) {
        const a = r.get(n) ?? 0;
        a > 1 ? r.set(n, a - 1) : (r.delete(n), r.size === 0 && this.editorsPerResourceCounter.delete(i));
      }
    }
  }
  removeMostRecentEditor(e, t) {
    ...
    if (i) {
      ...
      const o = this.keyMap.get(e.id);
      o && o.delete(i.editor) && o.size === 0 && this.keyMap.delete(e.id), this._onDidMostRecentlyActiveEditorsChange.fire();
    }
  }
  findKey(e, t) {
  ...
  ensureKey(e, t) {
    ...
    let o = i.get(t);
    return o || (o = { groupId: e.id, editor: t }, i.set(t, o)), o;
  }
  async ensureOpenedEditorsLimit(e, t) {
    var o, s;
    if (!((o = this.editorGroupsService.partOptions.limit) != null && o.enabled) || typeof this.editorGroupsService.partOptions.limit.value != "number" || this.editorGroupsService.partOptions.limit.value <= 0)
      return;
    const i = this.editorGroupsService.partOptions.limit.value;
    if ((s = this.editorGroupsService.partOptions.limit) != null && s.perEditorGroup)
      if (typeof t == "number") {
        const n = this.editorGroupsService.getGroup(t);
        n && await this.doEnsureOpenedEditorsLimit(i, n.getEditors(0).map((r) => ({ editor: r, groupId: t })), e);
      } else
        for (const n of this.editorGroupsService.groups)
          await this.ensureOpenedEditorsLimit(e, n.id);
    else
  ...
  async doEnsureOpenedEditorsLimit(e, t, i) {
    var a;
    let o;
    if ((a = this.editorGroupsService.partOptions.limit) != null && a.excludeDirty ? o = t.filter(({ editor: d }) => !(d.isDirty() && !d.isSaving() || d.hasCapability(512))) : o = t, e >= o.length)
      return;
    const s = o.reverse().filter(({ editor: d, groupId: l }) => {
      var u;
      return !(d.isDirty() && !d.isSaving() || d.hasCapability(512) || i && d === i.editor && l === i.groupId || (u = this.editorGroupsService.getGroup(l)) != null && u.isSticky(d));
    });
    let n = o.length - e;
    const r = /* @__PURE__ */ new Map();
    for (const { groupId: d, editor: l } of s) {
      let u = r.get(d);
      if (u || (u = [], r.set(d, u)), u.push(l), n--, n === 0)
        break;
    }
    for (const [d, l] of r) {
      const u = this.editorGroupsService.getGroup(d);
      u && await u.closeEditors(l, { preserveFocus: !0 });
    }
  }
  saveState() {
    this.mostRecentEditorsMap.isEmpty() ? this.storageService.remove(Ws.STORAGE_KEY, 1) : this.storageService.store(Ws.STORAGE_KEY, JSON.stringify(this.serialize()), 1, 1);
  }
  serialize() {
    const e = de.as(rl.EditorFactory), t = [...this.mostRecentEditorsMap.values()], i = /* @__PURE__ */ new Map();
    return {
      entries: et(t.map(({ editor: o, groupId: s }) => {
        const n = this.editorGroupsService.getGroup(s);
        if (!n)
          return;
        let r = i.get(n);
        r || (r = n.getEditors(1).filter((d) => {
          const l = e.getEditorSerializer(d);
          return l == null ? void 0 : l.canSerialize(d);
        }), i.set(n, r));
        const a = r.indexOf(o);
        if (a !== -1)
  ...
  loadState() {
    const e = this.storageService.get(Ws.STORAGE_KEY, 1);
    if (e)
      this.deserialize(JSON.parse(e));
    else {
      const t = this.editorGroupsService.getGroups(1);
      for (let i = t.length - 1; i >= 0; i--) {
        const o = t[i], s = o.getEditors(0);
        for (let n = s.length - 1; n >= 0; n--)
          this.addMostRecentEditor(o, s[n], !0, !0);
      }
    }
  ...
  deserialize(e) {
    const t = [];
    for (const { groupId: i, index: o } of e.entries) {
      const s = this.editorGroupsService.getGroup(i);
      if (!s)
        continue;
      const n = s.getEditorByIndex(o);
      if (!n)
        continue;
      const r = this.ensureKey(s, n);
      t.push([r, r]), this.updateEditorResourcesMap(n, !0);
    }
    this.mostRecentEditorsMap.fromJSON(t);
  }
};
ln.STORAGE_KEY = "editors.mru";
ln = x([
  h(0, oe),
  h(1, Se)
], ln);
let da = class extends R {
  constructor(e, t, i, o, s, n, r, a, d, l) {
  ...
  doHandleActiveEditorChangeEvent() {
    ...
    this.lastActiveEditor = Bt(e.activeEditor), this._onDidActiveEditorChange.fire();
  }
  registerGroupListeners(e) {
    const t = new A();
    t.add(e.onDidModelChange((i) => {
  ...
  handleVisibleEditorsChange() {
    ...
    for (const t of this.visibleEditors) {
      const i = Ro(et([
        ee.getCanonicalUri(t, { supportSideBySide: $.PRIMARY }),
        ee.getCanonicalUri(t, { supportSideBySide: $.SECONDARY })
      ]), (o) => o.toString());
      for (const o of i)
        this.fileService.hasProvider(o) && !this.contextService.isInsideWorkspace(o) && e.add(o);
    }
    for (const t of this.activeOutOfWorkspaceWatchers.keys())
      e.has(t) || (ue(this.activeOutOfWorkspaceWatchers.get(t)), this.activeOutOfWorkspaceWatchers.delete(t));
    ...
    for (const i of this.editorGroupService.groups) {
      ...
      for (const s of i.editors) {
        ...
        if (this.uriIdentityService.extUri.isEqual(e, n))
          ...
          const l = Tf(n.path, e.path, this.uriIdentityService.extUri.ignorePathCasing(n));
          r = No(t, n.path.substr(l + e.path.length + 1));
        }
        const a = await s.rename(i.id, r);
        if (!a)
          return;
        const d = {
          preserveFocus: !0,
      ...
      o.length && this.replaceEditors(o, i);
    }
  }
  onConfigurationUpdated(e) {
    var i, o;
    ...
    typeof ((o = (i = t.workbench) == null ? void 0 : i.editor) == null ? void 0 : o.closeOnFileDelete) == "boolean" ? this.closeOnFileDelete = t.workbench.editor.closeOnFileDelete : this.closeOnFileDelete = !1;
  }
  handleDeletedFile(e, t, i) {
    for (const o of this.getAllNonDirtyEditors({ includeUntitled: !1, supportSideBySide: !0 }))
      (async () => {
        const s = o.resource;
        if (s && (this.closeOnFileDelete || !t)) {
          if (i && this.uriIdentityService.extUri.isEqualOrParent(s, i))
            return;
          let n = !1;
          if (e instanceof io ? n = e.contains(s, 2) : n = this.uriIdentityService.extUri.isEqualOrParent(s, e), !n)
            return;
          let r = !1;
          t && this.fileService.hasProvider(s) && (await ka(100), r = await this.fileService.exists(s)), !r && !o.isDisposed() && o.dispose();
        }
      })();
  }
  getAllNonDirtyEditors(e) {
    const t = [];
    function i(o) {
      o.hasCapability(4) && !e.includeUntitled || o.isDirty() || t.push(o);
    }
    for (const o of this.editors)
      e.supportSideBySide && o instanceof Pt ? (i(o.primary), i(o.secondary)) : i(o);
    return t;
  }
  get activeEditorPane() {
    var e;
  ...
  get activeTextEditorLanguageId() {
    ...
    return jn(t) ? e = t.getModifiedEditor() : e = t, (i = e == null ? void 0 : e.getModel()) == null ? void 0 : i.getLanguageId();
  }
  get count() {
  ...
  getEditors(e, t) {
    switch (e) {
      case 0:
        return t != null && t.excludeSticky ? this.editorsObserver.editors.filter(({ groupId: i, editor: o }) => {
          var s;
          return !((s = this.editorGroupService.getGroup(i)) != null && s.isSticky(o));
        }) : this.editorsObserver.editors;
      case 1: {
        const i = [];
        for (const o of this.editorGroupService.getGroups(2))
          i.push(...o.getEditors(1, t).map((s) => ({ editor: s, groupId: o.id })));
        return i;
      }
    }
  }
  get activeEditor() {
    const e = this.editorGroupService.activeGroup;
    return e ? Bt(e.activeEditor) : void 0;
  }
  get visibleEditorPanes() {
    return et(this.editorGroupService.groups.map((e) => e.activeEditorPane));
  }
  ...
  get visibleEditors() {
    return et(this.editorGroupService.groups.map((e) => e.activeEditor));
  }
  async openEditor(e, t, i) {
    let o, s = ae(e) ? t : e.options, n;
    if (Rf(t) && (i = t), !ae(e)) {
      const r = await this.editorResolverService.resolveEditor(e, i);
      if (r === 1)
        return;
      Po(r) && (o = r.editor, s = r.options, n = r.group);
    }
    if (o || (o = ae(e) ? e : await this.textEditorService.resolveTextEditor(e)), !n) {
      let r;
      [n, r] = this.instantiationService.invokeFunction(cn, { editor: o, options: s }, i), r && (s = { ...s, activation: r });
    }
    return n.openEditor(o, s);
  }
  async openEditors(e, t, i) {
    ...
    for (const n of e) {
      let r, a;
      if (!Vo(n)) {
        const l = await this.editorResolverService.resolveEditor(n, t);
        if (l === 1)
          continue;
        Po(l) && (r = l, a = l.group);
      }
      r || (r = Vo(n) ? n : { editor: await this.textEditorService.resolveTextEditor(n), options: n.options }), a || ([a] = this.instantiationService.invokeFunction(cn, r, t));
      let d = o.get(a);
      d || (d = [], o.set(a, d)), d.push(r);
    }
    const s = [];
    for (const [n, r] of o)
      s.push(n.openEditors(r));
    return et(await To.settled(s));
  }
  async handleWorkspaceTrust(e) {
    const { resources: t, diffMode: i, mergeMode: o } = this.extractEditorResources(e);
    switch (await this.workspaceTrustRequestService.requestOpenFilesTrust(t)) {
      case 1:
        return !0;
      case 2:
        return await this.hostService.openWindow(t.map((n) => ({ fileUri: n })), { forceNewWindow: !0, diffMode: i, mergeMode: o }), !1;
      case 3:
        return !1;
    }
  }
  extractEditorResources(e) {
    ...
    for (const s of e)
      if (Vo(s)) {
        const n = ee.getOriginalUri(s.editor, { supportSideBySide: $.BOTH });
        P.isUri(n) ? t.add(n) : n && (n.primary && t.add(n.primary), n.secondary && t.add(n.secondary), i = s.editor instanceof Pf);
      } else
        ah(s) && (P.isUri(s.input1) && t.add(s.input1.resource), P.isUri(s.input2) && t.add(s.input2.resource), P.isUri(s.base) && t.add(s.base.resource), P.isUri(s.result) && t.add(s.result.resource), o = !0), Ls(s) ? (P.isUri(s.original.resource) && t.add(s.original.resource), P.isUri(s.modified.resource) && t.add(s.modified.resource), i = !0) : js(s) && t.add(s.resource);
    return {
  ...
  async closeEditor({ editor: e, groupId: t }, i) {
    const o = this.editorGroupService.getGroup(t);
    await (o == null ? void 0 : o.closeEditor(e, i));
  }
  async closeEditors(e, t) {
    const i = /* @__PURE__ */ new Map();
    for (const { editor: o, groupId: s } of e) {
      const n = this.editorGroupService.getGroup(s);
      if (!n)
        continue;
      let r = i.get(n);
      r || (r = [], i.set(n, r)), r.push(o);
    }
    for (const [o, s] of i)
      await o.closeEditors(s, t);
  }
  findEditors(e, t, i) {
    const o = P.isUri(e) ? e : e.resource, s = P.isUri(e) ? void 0 : e.typeId;
    if ((t == null ? void 0 : t.supportSideBySide) !== $.ANY && (t == null ? void 0 : t.supportSideBySide) !== $.SECONDARY && !this.editorsObserver.hasEditors(o))
      return P.isUri(e) || Vi(i) ? [] : void 0;
    if (Vi(i)) {
      const n = [];
      for (const r of this.editorGroupService.getGroups(1)) {
        const a = [];
        if (P.isUri(e))
          a.push(...this.findEditors(e, t, r));
        else {
          const d = this.findEditors(e, t, r);
          d && a.push(d);
        }
        n.push(...a.map((d) => ({ editor: d, groupId: r.id })));
      }
      return n;
    } else {
      const n = typeof i == "number" ? this.editorGroupService.getGroup(i) : i;
      if (P.isUri(e))
        return n ? n.findEditors(o, t) : [];
      {
        if (!n)
          return;
        const r = n.findEditors(o, t);
        for (const a of r)
          if (a.typeId === s)
            return a;
        return;
  ...
  async replaceEditors(e, t) {
    const i = typeof t == "number" ? this.editorGroupService.getGroup(t) : t, o = [];
    for (const s of e) {
      let n;
      if (!ae(s.replacement)) {
        const r = await this.editorResolverService.resolveEditor(s.replacement, i);
        if (r === 1)
          continue;
        Po(r) && (n = {
          editor: s.editor,
      ...
      n || (n = {
        editor: s.editor,
        replacement: Wc(s) ? s.replacement : await this.textEditorService.resolveTextEditor(s.replacement),
        options: Wc(s) ? s.options : s.replacement.options,
        forceReplaceDirty: s.forceReplaceDirty
      }), o.push(n);
    }
    return i == null ? void 0 : i.replaceEditors(o);
  }
  async save(e, t) {
    Array.isArray(e) || (e = [e]);
    const i = this.getUniqueEditors(e), o = [], s = [];
    if (t != null && t.saveAs)
      s.push(...i);
    else
      for (const { groupId: r, editor: a } of i)
        a.hasCapability(4) ? s.push({ groupId: r, editor: a }) : o.push({ groupId: r, editor: a });
    const n = await To.settled(o.map(({ groupId: r, editor: a }) => {
      var d;
      return (t == null ? void 0 : t.reason) === 1 && ((d = this.editorGroupService.getGroup(r)) == null || d.pinEditor(a)), a.save(r, t);
    }));
    for (const { groupId: r, editor: a } of s) {
      if (a.isDisposed())
        continue;
      const d = await this.openEditor(a, r), l = {
        pinned: !0,
        viewState: d == null ? void 0 : d.getViewState()
      }, u = t != null && t.saveAs ? await a.saveAs(r, t) : await a.save(r, t);
      if (n.push(u), !u)
        break;
      if (!a.matches(u)) {
        const g = a.hasCapability(4) ? this.editorGroupService.groups.map((m) => m.id) : [r];
        for (const m of g)
          u instanceof Lf ? await this.replaceEditors([{ editor: a, replacement: u, options: l }], m) : await this.replaceEditors([{ editor: a, replacement: { ...u, options: l } }], m);
      }
    }
    return {
      success: n.every((r) => !!r),
  ...
  saveAll(e) {
    return this.save(this.getAllDirtyEditors(e), e);
  }
  async revert(e, t) {
    Array.isArray(e) || (e = [e]);
    const i = this.getUniqueEditors(e);
    return await To.settled(i.map(async ({ groupId: o, editor: s }) => {
      var n;
      return (n = this.editorGroupService.getGroup(o)) == null || n.pinEditor(s), s.revert(o, t);
    })), !i.some(({ editor: o }) => o.isDirty());
  }
  async revertAll(e) {
    return this.revert(this.getAllDirtyEditors(e), e);
  }
  getAllDirtyEditors(e) {
    const t = [];
    for (const i of this.editorGroupService.getGroups(1))
      for (const o of i.getEditors(0))
        o.isDirty() && (!(e != null && e.includeUntitled) && o.hasCapability(4) || e != null && e.excludeSticky && i.isSticky(o) || t.push({ groupId: i.id, editor: o }));
    return t;
  }
  getUniqueEditors(e) {
    const t = [];
    for (const { editor: i, groupId: o } of e)
      t.some((s) => s.editor.matches(i)) || t.push({ editor: i, groupId: o });
    return t;
  }
  dispose() {
    super.dispose(), this.activeOutOfWorkspaceWatchers.forEach((e) => ue(e)), this.activeOutOfWorkspaceWatchers.clear();
  }
};
da = x([
  h(0, oe),
...
let po = class mi extends R {
  constructor(e, t, i, o, s, n, r, a, d) {
    super(), this.editorGroupService = e, this.instantiationService = t, this.configurationService = i, this.quickInputService = o, this.notificationService = s, this.telemetryService = n, this.storageService = r, this.extensionService = a, this.logService = d, this._onDidChangeEditorRegistrations = this._register(new Of()), this.onDidChangeEditorRegistrations = this._onDidChangeEditorRegistrations.event, this._editors = /* @__PURE__ */ new Map(), this._flattenedEditors = /* @__PURE__ */ new Map(), this._shouldReFlattenEditors = !0, this.cache = new Set(
      JSON.parse(this.storageService.get(mi.cacheStorageID, 0, JSON.stringify([])))
    ), this.storageService.remove(mi.cacheStorageID, 0), this._register(this.storageService.onWillSaveState(() => {
      this.cacheEditors();
  ...
  resolveUntypedInputAndGroup(e, t) {
    const i = e, [o, s] = this.instantiationService.invokeFunction(cn, i, t);
    return [i, o, s];
  }
  async resolveEditor(e, t) {
    var u, g, m, f;
    if (this._flattenedEditors = this._flattenEditorsMap(), Gc(e))
    ...
    let r = ee.getCanonicalUri(o, { supportSideBySide: $.PRIMARY });
    if (this.cache && r && this.resourceMatchesCache(r) && await this.extensionService.whenInstalledExtensionsRegistered(), r === void 0)
      r = P.from({ scheme: Re.untitled });
    else if (r.scheme === void 0 || r === null)
      return 2;
    if (((u = o.options) == null ? void 0 : u.override) === Ps.PICK) {
      const C = await this.doPickEditor(o);
      if (!C)
        return 1;
      o.options = C;
    }
    let { editor: a, conflictingDefault: d } = this.getEditor(r, (g = o.options) == null ? void 0 : g.override);
    if (!a && ((m = o.options) != null && m.override || Vo(e)))
      return 2;
    if (!a) {
      const C = this.getEditor(r, Rt.id);
      if (a = C == null ? void 0 : C.editor, d = C == null ? void 0 : C.conflictingDefault, !a)
        return 2;
    }
    if (Ls(o) && ((f = o.options) == null ? void 0 : f.override) === void 0) {
      let C = ee.getCanonicalUri(o, { supportSideBySide: $.SECONDARY });
      C || (C = P.from({ scheme: Re.untitled }));
      const { editor: E } = this.getEditor(C, void 0);
      if (!E || a.editorInfo.id !== E.editorInfo.id) {
        const { editor: V, conflictingDefault: B } = this.getEditor(r, Rt.id);
        a = V, d = B;
      }
      if (!a)
        return 2;
    }
    if (o.options = { override: a.editorInfo.id, ...o.options }, a.editorFactoryObject.createDiffEditorInput === void 0 && Ls(o))
      return 2;
    const l = await this.doResolveEditor(o, s, a);
    return d && l && await this.doHandleConflictingDefaults(r, a.editorInfo.label, o, l.editor, s), l ? (this.sendEditorResolutionTelemetry(l.editor), l.editor.editorId !== a.editorInfo.id && this.logService.warn(`Editor ID Mismatch: ${l.editor.editorId} !== ${a.editorInfo.id}. This will cause bugs. Please ensure editorInput.editorId matches the registered id`), { ...l, group: s }) : 1;
  }
  async doResolveSideBySideEditor(e, t) {
    ...
    return Po(o) ? {
      ...
      editor: this.instantiationService.createInstance(Pt, e.label, e.description, o.editor, i.editor),
      options: e.options
    } : 2;
  }
  ...
  registerEditor(e, t, i, o) {
    ...
    return s.set(t.id, n), this._shouldReFlattenEditors = !0, this._onDidChangeEditorRegistrations.fire(), ie(() => {
  ...
  getAllUserAssociations() {
    const e = this.configurationService.inspect(zc) || {}, t = e.workspaceValue ?? {}, i = e.userValue ?? {}, o = { ...t };
  ...
  get _registeredEditors() {
    return sh(Array.from(this._flattenedEditors.values()));
  }
  updateUserAssociations(e, t) {
    ...
    this.configurationService.updateValue(zc, s);
  }
  findMatchingEditors(e) {
    const t = this.getAssociationsForResource(e), i = [];
    for (const [o, s] of this._flattenedEditors)
      for (const n of s)
        (t.find((a) => a.viewType === n.editorInfo.id) && n.editorInfo.priority !== Tt.exclusive || qn(o, e)) && i.push(n);
    return i.sort((o, s) => ui(s.editorInfo.priority) === ui(o.editorInfo.priority) && typeof s.globPattern == "string" && typeof o.globPattern == "string" ? s.globPattern.length - o.globPattern.length : ui(s.editorInfo.priority) - ui(o.editorInfo.priority));
  }
  getEditors(e) {
    if (this._flattenedEditors = this._flattenEditorsMap(), P.isUri(e)) {
      const t = this.findMatchingEditors(e);
      return t.find((i) => i.editorInfo.priority === Tt.exclusive) ? [] : t.map((i) => i.editorInfo);
    }
    return Ro(this._registeredEditors.map((t) => t.editorInfo), (t) => t.id);
  }
  getEditor(e, t) {
    var l;
    const i = (u, g) => u.find((m) => m.options && m.options.canSupportResource !== void 0 ? m.editorInfo.id === g && m.options.canSupportResource(e) : m.editorInfo.id === g);
    if (t && t !== Ps.EXCLUSIVE_ONLY) {
    ...
    const o = this.findMatchingEditors(e), s = this.getAssociationsForResource(e), n = t === Ps.EXCLUSIVE_ONLY ? Tt.exclusive : Tt.builtin;
    let r = o.filter((u) => ui(u.editorInfo.priority) >= ui(n) && u.editorInfo.id !== Rt.id);
    if (r.length === 0)
      return {
        editor: s[0] && n !== Tt.exclusive ? i(o, s[0].viewType) : void 0,
        conflictingDefault: !1
      };
    const a = r[0].editorInfo.priority === Tt.exclusive ? r[0].editorInfo.id : ((l = s[0]) == null ? void 0 : l.viewType) || r[0].editorInfo.id;
    let d = !1;
    return r = r.filter((u) => u.editorInfo.priority !== Tt.exclusive), s.length === 0 && r.length > 1 && (d = !0), {
      editor: i(o, a),
  ...
  async doResolveEditor(e, t, i) {
    var d, l;
    let o = e.options;
    const s = ee.getCanonicalUri(e, { supportSideBySide: $.PRIMARY });
    if (o && typeof o.activation > "u" && (o = { ...o, activation: o.preserveFocus ? Ri.RESTORE : void 0 }), ah(e)) {
      if (!i.editorFactoryObject.createMergeEditorInput)
        return;
      const u = await i.editorFactoryObject.createMergeEditorInput(e, t);
      return { editor: u.editor, options: u.options ?? o };
    }
    if (Ls(e)) {
      if (!i.editorFactoryObject.createDiffEditorInput)
        return;
      const u = await i.editorFactoryObject.createDiffEditorInput(e, t);
      return { editor: u.editor, options: u.options ?? o };
    }
    if (Gc(e))
    ...
    if (Mf(e)) {
      if (!i.editorFactoryObject.createUntitledEditorInput)
        return;
      const u = await i.editorFactoryObject.createUntitledEditorInput(e, t);
      return { editor: u.editor, options: u.options ?? o };
    }
    if (s === void 0)
      throw new Error("Undefined resource on non untitled editor input.");
    if (typeof ((d = i.options) == null ? void 0 : d.singlePerResource) == "function" ? i.options.singlePerResource() : (l = i.options) == null ? void 0 : l.singlePerResource) {
      const u = await this.moveExistingEditorForResource(s, i.editorInfo.id, t);
      if (u)
        return { editor: u, options: o };
    }
  ...
  findExistingEditorsForResource(e, t) {
    ...
    for (const s of o)
      for (const n of s.editors)
        Qt(n.resource, e) && n.editorId === t && i.push({ editor: n, group: s });
    return i;
  }
  async doHandleConflictingDefaults(e, t, i, o, s) {
    const n = this.findMatchingEditors(e), r = JSON.parse(this.storageService.get(mi.conflictingDefaultsStorageID, 0, "{}")), a = `*${xi(e)}`, d = () => {
      r[a] = [], n.forEach((g) => r[a].push(g.editorInfo.id)), this.storageService.store(mi.conflictingDefaultsStorageID, JSON.stringify(r), 0, 1);
    };
    if (r[a] && r[a].find((g) => g === o.editorId))
      return;
    const u = this.notificationService.prompt(wt.Warning, p(
      "editorResolver.conflictingDefaults",
      "There are multiple default editors available for the resource."
    ), [
      {
        label: p("editorResolver.configureDefault", "Configure Default"),
        run: async () => {
          const g = await this.doPickEditor(i, !0);
          if (!g)
            return;
          i.options = g;
      ...
      {
        label: p("editorResolver.keepDefault", "Keep {0}", t),
        run: d
      }
    ]).onDidClose(() => {
      d(), u.dispose();
  ...
  mapEditorsToQuickPickEntry(e, t) {
    var u, g, m;
    const i = Ta(this.editorGroupService.activeGroup.findEditors(e));
    let o = e.scheme === Re.untitled ? this._registeredEditors.filter((f) => f.editorInfo.priority !== Tt.exclusive) : this.findMatchingEditors(e);
    o = Ro(o, (f) => f.editorInfo.id);
    const s = (u = this.getAssociationsForResource(e)[0]) == null ? void 0 : u.viewType;
    o = o.sort((f, C) => f.editorInfo.id === Rt.id ? -1 : C.editorInfo.id === Rt.id ? 1 : ui(C.editorInfo.priority) - ui(f.editorInfo.priority));
    const n = [], r = p("promptOpenWith.currentlyActive", "Active"), a = p("promptOpenWith.currentDefault", "Default"), d = p("promptOpenWith.currentDefaultAndActive", "Active and Default");
    let l = s;
    if (!l && o.length > 2 && ((g = o[1]) == null ? void 0 : g.editorInfo.priority) !== Tt.option && (l = (m = o[1]) == null ? void 0 : m.editorInfo.id), l || (l = Rt.id), o.forEach((f) => {
      const C = (i == null ? void 0 : i.editorId) ?? Rt.id, E = i ? f.editorInfo.id === C : !1, V = f.editorInfo.id === l, B = {
        id: f.editorInfo.id,
        label: f.editorInfo.label,
        description: E && V ? d : E ? r : V ? a : void 0,
        detail: f.editorInfo.detail ?? f.editorInfo.priority
      };
      n.push(B);
    }), !t && xi(e) !== "") {
      const f = { type: "separator" };
      n.push(f);
      const C = {
        id: mi.configureDefaultID,
        label: p(
  ...
  async doPickEditor(e, t) {
    var d;
    let i = ee.getOriginalUri(e, { supportSideBySide: $.PRIMARY });
    i === void 0 && (i = P.from({ scheme: Re.untitled }));
    const o = this.mapEditorsToQuickPickEntry(i, t), s = this.quickInputService.createQuickPick(), n = t ? p(
    ...
    const r = s.items.find((l) => l.type === "item");
    r && (s.selectedItems = [r]);
    const a = await new Promise((l) => {
      s.onDidAccept((u) => {
        let g;
        s.selectedItems.length === 1 && (g = {
          item: s.selectedItems[0],
          keyMods: s.keyMods,
          openInBackground: u.inBackground
        }), i && t && (g != null && g.item.id) && this.updateUserAssociations(`*${xi(i)}`, g.item.id), l(g);
      }), s.onDidHide(() => l(void 0)), s.onDidTriggerItemButton((u) => {
        l({ item: u.item, openInBackground: !1 }), i && u.item && u.item.id && this.updateUserAssociations(`*${xi(i)}`, u.item.id);
      }), s.show();
    });
    if (s.dispose(), a)
      return a.item.id === mi.configureDefaultID ? this.doPickEditor(e, !0) : {
        ...e.options,
        override: a.item.id,
  ...
  cacheEditors() {
    ...
    for (const [i, o] of this._flattenedEditors)
      o.find((n) => n.editorInfo.priority !== Tt.option && n.editorInfo.id !== Rt.id) && (Nf(i) ? e.add(`${i.pattern}`) : e.add(i));
    const t = this.getAllUserAssociations();
    for (const i of t)
      i.filenamePattern && e.add(i.filenamePattern);
    this.storageService.store(mi.cacheStorageID, JSON.stringify(Array.from(e)), 0, 1);
  }
...
po.configureDefaultID = "promptOpenWith.configureDefault";
po.cacheStorageID = "editorOverrideService.cache";
po.conflictingDefaultsStorageID = "editorOverrideService.conflictingDefaults";
po = x([
  h(0, oe),
  h(1, D),
  h(2, L),
...
class jw extends ke {
  constructor(e, t, i) {
    super(e, p("hide", "Hide '{0}'", t), void 0, !0), this.model = i;
  }
  async run() {
...
class qw extends qe {
  constructor() {
    super({
      ...
      title: { value: p("focusStatusBar", "Focus Status Bar"), original: "Focus Status Bar" },
      category: ve.View,
      f1: !0
    });
  }
  async run(e) {
    e.get(pt).focusPart("workbench.parts.statusbar");
  }
}
te(qw);
class Oi extends R {
  ...
  constructor(e) {
    super(), this.storageService = e, this._onDidChangeEntryVisibility = this._register(new y()), this.onDidChangeEntryVisibility = this._onDidChangeEntryVisibility.event, this._entries = [], this.hidden = /* @__PURE__ */ new Set(), this.restoreState(), this.registerListeners();
  }
  restoreState() {
    const e = this.storageService.get(Oi.HIDDEN_ENTRIES_KEY, 0);
    if (e)
      try {
        const t = JSON.parse(e);
  ...
  onDidStorageValueChange(e) {
    if (e.key === Oi.HIDDEN_ENTRIES_KEY && e.scope === 0) {
  ...
  remove(e) {
    ...
    t >= 0 && (this._entries.splice(t, 1), this._entries.some(
      (i) => Os(i.priority.primary) && i.priority.primary.id === e.id
  ...
  getFocusedEntry() {
    return this._entries.find((e) => Ht(document.activeElement, e.container));
  }
  focusEntry(e, t) {
    const i = (n) => {
  ...
  updateVisibility(e, t) {
    if (typeof e == "string") {
      ...
      o ? mo(i.container) : go(i.container), t && this._onDidChangeEntryVisibility.fire({ id: i.id, visible: !o }), this.markFirstLastVisibleEntry();
    }
  }
  saveState() {
    this.hidden.size > 0 ? this.storageService.store(Oi.HIDDEN_ENTRIES_KEY, JSON.stringify(Array.from(this.hidden.values())), 0, 0) : this.storageService.remove(Oi.HIDDEN_ENTRIES_KEY, 0);
  }
  sort() {
    ...
    if (t.size > 0) {
      ...
      for (const s of i) {
        const n = t.get(s.id);
        n && o.push(...n.filter((r) => Os(r.priority.primary) && r.priority.primary.alignment === 0)), o.push(s), n && o.push(...n.filter((r) => Os(r.priority.primary) && r.priority.primary.alignment === 1)), t.delete(s.id);
      }
      for (const [, s] of t)
        o.push(...s);
    } else
...
Oi.HIDDEN_ENTRIES_KEY = "workbench.statusbar.hidden";
let la = class extends R {
  get name() {
    return j(this.entry).name;
  }
  get hasCommand() {
    var e;
  ...
  constructor(e, t, i, o, s, n, r) {
    super(), this.container = e, this.hoverDelegate = i, this.commandService = o, this.notificationService = s, this.telemetryService = n, this.themeService = r, this.entry = void 0, this.foregroundListener = this._register(new je()), this.backgroundListener = this._register(new je()), this.commandMouseListener = this._register(new je()), this.commandTouchListener = this._register(new je()), this.commandKeyboardListener = this._register(new je()), this.hover = void 0, this.labelContainer = document.createElement("a"), this.labelContainer.tabIndex = -1, this.labelContainer.setAttribute("role", "button"), this.labelContainer.className = "statusbar-item-label", this._register(ii.addTarget(this.labelContainer)), this.label = new Yw(this.labelContainer), this.container.appendChild(this.labelContainer), this.beakContainer = document.createElement("div"), this.beakContainer.className = "status-bar-item-beak-container", this.container.appendChild(this.beakContainer), this.update(t);
  }
  update(e) {
    if (this.label.showProgress = e.showProgress ?? !1, (!this.entry || e.text !== this.entry.text) && (this.label.text = e.text, e.text ? go(this.labelContainer) : mo(this.labelContainer)), (!this.entry || e.ariaLabel !== this.entry.ariaLabel) && (this.container.setAttribute("aria-label", e.ariaLabel), this.labelContainer.setAttribute("aria-label", e.ariaLabel)), (!this.entry || e.role !== this.entry.role) && this.labelContainer.setAttribute("role", e.role || "button"), !this.entry || !this.isEqualTooltip(this.entry, e)) {
      const t = Ao(e.tooltip) ? { markdown: e.tooltip, markdownNotSupportedFallback: void 0 } : e.tooltip;
      this.hover ? this.hover.update(t) : this.hover = this._register(Ff(this.hoverDelegate, this.container, t));
    }
    if (!this.entry || e.command !== this.entry.command) {
      ...
      const t = e.command;
      t && (t !== Uc || this.hover) ? (this.commandMouseListener.value = w(this.labelContainer, S.CLICK, () => this.executeCommand(t)), this.commandTouchListener.value = w(this.labelContainer, Te.Tap, () => this.executeCommand(t)), this.commandKeyboardListener.value = w(this.labelContainer, S.KEY_DOWN, (i) => {
        const o = new Ct(i);
        (o.equals(10) || o.equals(3)) && (K.stop(i), this.executeCommand(t));
  ...
  isEqualTooltip({ tooltip: e }, { tooltip: t }) {
    return e === void 0 ? t === void 0 : Ao(e) ? Ao(t) && Bf(e, t) : e === t;
  }
...
class Yw extends Wf {
  constructor(e) {
    super(e), this.container = e, this.progressCodicon = Kc($c), this.currentText = "", this.currentShowProgress = !1;
  }
  set showProgress(e) {
    this.currentShowProgress !== e && (this.currentShowProgress = e, this.progressCodicon = Kc(e === "loading" ? Gf : $c), this.text = this.currentText);
  }
  set text(e) {
    if (this.currentShowProgress) {
      ...
      let t = e ?? "";
      t && (t = ` ${t}`), se(this.container, ...zf(t));
    } else
      super.text = e;
  }
}
let ha = class extends xn {
  constructor(e, t, i, o, s, n, r, a, d) {
    super("workbench.parts.statusbar", { hasTitle: !1 }, t, o, s), this.instantiationService = e, this.contextService = i, this.storageService = o, this.contextMenuService = n, this.contextKeyService = r, this.hoverService = a, this.configurationService = d, this.minimumWidth = 0, this.maximumWidth = Number.POSITIVE_INFINITY, this.minimumHeight = 22, this.maximumHeight = 22, this.pendingEntries = [], this.viewModel = this._register(new Oi(this.storageService)), this.onDidChangeEntryVisibility = this.viewModel.onDidChangeEntryVisibility, this.hoverDelegate = new class {
      ...
      constructor(l, u) {
        this.configurationService = l, this.hoverService = u, this.lastHoverHideTime = 0, this.placement = "element";
      }
      showHover(l, u) {
    ...
    }(this.configurationService, this.hoverService), this.compactEntriesDisposable = this._register(new je()), this.styleOverrides = /* @__PURE__ */ new Set(), this.registerListeners();
  }
  registerListeners() {
  ...
  doAddEntry(e, t, i, o) {
    const s = this.doCreateStatusItem(t, i, ...et([e.showBeak ? "has-beak" : void 0])), n = this.instantiationService.createInstance(la, s, e, this.hoverDelegate), r = new class {
      constructor() {
    ...
    return a ? this.appendStatusbarEntries() : this.appendStatusbarEntry(r), {
      ...
      dispose: () => {
        ...
        d ? this.appendStatusbarEntries() : s.remove(), ue(n);
      }
    };
  }
  ...
  doAddOrRemoveModelEntry(e, t) {
    ...
    return t ? i.splice(o.indexOf(e), 0, e) : i.splice(i.indexOf(e), 1), { needsFullRefresh: !co(i, o) };
  }
  isEntryVisible(e) {
  ...
  createContentArea(e) {
    ...
    return wo.bindTo(t).set(!0), this.leftItemsContainer = document.createElement("div"), this.leftItemsContainer.classList.add("left-items", "items-container"), this.element.appendChild(this.leftItemsContainer), this.element.tabIndex = 0, this.rightItemsContainer = document.createElement("div"), this.rightItemsContainer.classList.add("right-items", "items-container"), this.element.appendChild(this.rightItemsContainer), this._register(w(e, S.CONTEXT_MENU, (i) => this.showContextMenu(i))), this._register(ii.addTarget(e)), this._register(w(e, Te.Contextmenu, (i) => this.showContextMenu(i))), this.createInitialStatusbarEntries(), this.element;
  }
  ...
  appendStatusbarEntries() {
    const e = j(this.leftItemsContainer), t = j(this.rightItemsContainer);
    oi(e), oi(t);
    for (const i of [
  ...
  appendStatusbarEntry(e) {
    ...
    const i = j(e.alignment === 0 ? this.leftItemsContainer : this.rightItemsContainer), o = t.indexOf(e);
  ...
  updateCompactEntries() {
    ...
    for (const n of t.values())
      if (Os(n.priority.primary) && n.priority.primary.compact) {
    ...
    const o = this.getColor(Kf), s = this.getColor($f);
    if (this.compactEntriesDisposable.value = new A(), o && s && !Da(this.theme.type))
      for (const [, n] of i)
        for (const r of n)
          r.hasCommand && (this.compactEntriesDisposable.value.add(w(r.labelContainer, S.MOUSE_OVER, () => {
            n.forEach((a) => a.labelContainer.style.backgroundColor = o), r.labelContainer.style.backgroundColor = s;
          })), this.compactEntriesDisposable.value.add(w(r.labelContainer, S.MOUSE_OUT, () => {
  ...
  getContextMenuActions(e) {
    const t = [];
    t.push(Ne({ id: ed.ID, label: p("hideStatusBar", "Hide Status Bar"), run: () => this.instantiationService.invokeFunction((s) => new ed().run(s)) })), t.push(new Fe());
    const i = /* @__PURE__ */ new Set();
    for (const s of this.viewModel.entries)
      i.has(s.id) || (t.push(new $w(s.id, s.name, this.viewModel)), i.add(s.id));
    let o;
    ...
    return o && (t.push(new Fe()), t.push(new jw(o.id, o.name, this.viewModel))), t;
  }
  updateStyles() {
    super.updateStyles();
    const e = j(this.getContainer()), t = [...this.styleOverrides].sort((a, d) => a.priority - d.priority)[0], i = this.getColor((t == null ? void 0 : t.background) ?? (this.contextService.getWorkbenchState() !== 1 ? qf : Yf)) || "";
    e.style.backgroundColor = i;
    const o = this.getColor((t == null ? void 0 : t.foreground) ?? (this.contextService.getWorkbenchState() !== 1 ? Xf : Jf)) || "";
    e.style.color = o;
    const s = this.getColor(Zf), n = this.getColor((t == null ? void 0 : t.border) ?? (this.contextService.getWorkbenchState() !== 1 ? Qf : eb)) || this.getColor(ot);
    ...
    const r = this.getColor(tb);
    this.styleElement || (this.styleElement = Bd(e)), this.styleElement.textContent = `
  ...
  overrideStyle(e) {
    return this.styleOverrides.add(e), this.updateStyles(), ie(() => {
...
let wi = class Xt extends R {
  constructor(e, t, i, o, s, n, r, a, d, l) {
    super(), this.editorService = e, this.editorGroupService = t, this.contextService = i, this.storageService = o, this.configurationService = s, this.fileService = n, this.workspacesService = r, this.instantiationService = a, this.layoutService = d, this.contextKeyService = l, this.activeEditorListeners = this._register(new A()), this.lastActiveEditor = void 0, this.editorHelper = this.instantiationService.createInstance(hn), this.canNavigateBackContextKey = new N("canNavigateBack", !1, p(
      "canNavigateBack",
      "Whether it is possible to navigate back in editor history"
    )).bindTo(this.contextKeyService), this.canNavigateForwardContextKey = new N("canNavigateForward", !1, p(
      "canNavigateForward",
      "Whether it is possible to navigate forward in editor history"
    )).bindTo(this.contextKeyService), this.canNavigateBackInNavigationsContextKey = new N("canNavigateBackInNavigationLocations", !1, p(
      "canNavigateBackInNavigationLocations",
      "Whether it is possible to navigate back in editor navigation locations history"
    )).bindTo(this.contextKeyService), this.canNavigateForwardInNavigationsContextKey = new N("canNavigateForwardInNavigationLocations", !1, p(
      "canNavigateForwardInNavigationLocations",
      "Whether it is possible to navigate forward in editor navigation locations history"
    )).bindTo(this.contextKeyService), this.canNavigateToLastNavigationLocationContextKey = new N("canNavigateToLastNavigationLocation", !1, p(
      "canNavigateToLastNavigationLocation",
      "Whether it is possible to navigate to the last editor navigation location"
    )).bindTo(this.contextKeyService), this.canNavigateBackInEditsContextKey = new N("canNavigateBackInEditLocations", !1, p(
      "canNavigateBackInEditLocations",
      "Whether it is possible to navigate back in editor edit locations history"
    )).bindTo(this.contextKeyService), this.canNavigateForwardInEditsContextKey = new N("canNavigateForwardInEditLocations", !1, p(
      "canNavigateForwardInEditLocations",
      "Whether it is possible to navigate forward in editor edit locations history"
    )).bindTo(this.contextKeyService), this.canNavigateToLastEditLocationContextKey = new N("canNavigateToLastEditLocation", !1, p(
      "canNavigateToLastEditLocation",
      "Whether it is possible to navigate to the last editor edit location"
    )).bindTo(this.contextKeyService), this.canReopenClosedEditorContextKey = new N("canReopenClosedEditor", !1, p(
      "canReopenClosedEditor",
      "Whether it is possible to reopen the last closed editor"
    )).bindTo(this.contextKeyService), this._onDidChangeEditorNavigationStack = this._register(new y()), this.onDidChangeEditorNavigationStack = this._onDidChangeEditorNavigationStack.event, this.defaultScopedEditorNavigationStack = void 0, this.editorGroupScopedNavigationStacks = /* @__PURE__ */ new Map(), this.editorScopedNavigationStacks = /* @__PURE__ */ new Map(), this.editorNavigationScope = 0, this.recentlyUsedEditorsStack = void 0, this.recentlyUsedEditorsStackIndex = 0, this.recentlyUsedEditorsInGroupStack = void 0, this.recentlyUsedEditorsInGroupStackIndex = 0, this.navigatingInRecentlyUsedEditorsStack = !1, this.navigatingInRecentlyUsedEditorsInGroupStack = !1, this.recentlyClosedEditors = [], this.ignoreEditorCloseEvent = !1, this.history = void 0, this.editorHistoryListeners = /* @__PURE__ */ new Map(), this.resourceExcludeMatcher = this._register(new ib(() => {
      const u = this._register(this.instantiationService.createInstance(ob, (g) => sb(g ? this.configurationService.getValue({ resource: g }) : this.configurationService.getValue()) || /* @__PURE__ */ Object.create(null), (g) => g.affectsConfiguration(nb) || g.affectsConfiguration(rb)));
      return this._register(u.onExpressionChange(() => this.removeExcludedFromHistory())), u;
  ...
  registerMouseNavigationListener() {
    const e = this._register(new A()), t = () => {
      e.clear(), this.configurationService.getValue(Xt.MOUSE_NAVIGATION_SETTING) && (e.add(w(this.layoutService.container, S.MOUSE_DOWN, (i) => this.onMouseDownOrUp(i, !0))), e.add(w(this.layoutService.container, S.MOUSE_UP, (i) => this.onMouseDownOrUp(i, !1))));
    };
    this._register(this.configurationService.onDidChangeConfiguration((i) => {
      i.affectsConfiguration(Xt.MOUSE_NAVIGATION_SETTING) && t();
    })), t();
  }
  onMouseDownOrUp(e, t) {
    switch (e.button) {
      case 3:
        K.stop(e), t && this.goBack();
        break;
      case 4:
        K.stop(e), t && this.goForward();
        break;
    }
  }
  onDidRemoveGroup(e) {
  ...
  onDidActiveEditorChange() {
    ...
    this.lastActiveEditor && this.editorHelper.matchesEditorIdentifier(this.lastActiveEditor, t) || (this.lastActiveEditor = t != null && t.input && t.group ? { editor: t.input, groupId: t.group.id } : void 0, this.activeEditorListeners.clear(), this.handleActiveEditorChange(e, t), Sr(t) && this.activeEditorListeners.add(t.onDidChangeSelection((i) => this.handleActiveEditorSelectionChangeEvent(e, t, i))), this.updateContextKeys());
  }
  onDidFilesChange(e) {
    e instanceof io ? e.gotDeleted() && this.remove(e) : e.isOperation(1) ? this.remove(e) : e.isOperation(2) && e.target.isFile && this.move(e);
  }
  ...
  removeFromRecentlyOpened(e) {
    let t;
    ae(e) ? t = ee.getOriginalUri(e) : e instanceof io || (t = e.resource), t && this.workspacesService.removeRecentlyOpened([t]);
  }
  clear() {
  ...
  registerEditorNavigationScopeChangeListener() {
    const e = () => {
      ...
      const t = this.configurationService.getValue(Xt.NAVIGATION_SCOPE_SETTING);
      t === "editorGroup" ? this.editorNavigationScope = 1 : t === "editor" ? this.editorNavigationScope = 2 : this.editorNavigationScope = 0;
    };
    this._register(this.configurationService.onDidChangeConfiguration((t) => {
      t.affectsConfiguration(Xt.NAVIGATION_SCOPE_SETTING) && e();
    })), e();
  }
  getStack(e = this.editorGroupService.activeGroup, t = e.activeEditor) {
    ...
    switch (this.editorNavigationScope) {
      case 2: {
        ...
        if (!n) {
          const r = new A();
          n = r.add(this.instantiationService.createInstance(Oo, 2)), r.add(n.onDidChange(() => this._onDidChangeEditorNavigationStack.fire())), s.set(t, { stack: n, disposable: r });
        }
        return n;
      }
      case 1: {
        ...
        if (!s) {
          const n = new A();
          s = n.add(this.instantiationService.createInstance(Oo, 1)), n.add(s.onDidChange(() => this._onDidChangeEditorNavigationStack.fire())), this.editorGroupScopedNavigationStacks.set(e.id, { stack: s, disposable: n });
        }
        return s;
      }
      case 0:
        return this.defaultScopedEditorNavigationStack || (this.defaultScopedEditorNavigationStack = this._register(this.instantiationService.createInstance(Oo, 0)), this._register(this.defaultScopedEditorNavigationStack.onDidChange(() => this._onDidChangeEditorNavigationStack.fire()))), this.defaultScopedEditorNavigationStack;
    }
  }
  goForward(e) {
  ...
  handleEditorCloseEventInReopen(e) {
    ...
    if (i === Ti.REPLACE || i === Ti.MOVE)
      return;
    const o = t.toUntyped();
    if (!o)
      return;
    const s = [], n = ee.getOriginalUri(t, { supportSideBySide: $.BOTH });
    P.isUri(n) ? s.push(n) : n && s.push(...et([n.primary, n.secondary])), this.removeFromRecentlyClosedEditors(t), this.recentlyClosedEditors.push({
      editorId: t.editorId,
      editor: o,
      resource: ee.getOriginalUri(t),
      associatedResources: s,
      index: e.index,
      sticky: e.sticky
    }), this.recentlyClosedEditors.length > Xt.MAX_RECENTLY_CLOSED_EDITORS && this.recentlyClosedEditors.shift(), this.canReopenClosedEditorContextKey.set(!0);
  }
  ...
  async doReopenLastClosedEditor(e) {
    ...
    i || (ab(this.recentlyClosedEditors, e), this.reopenLastClosedEditor());
  }
  removeFromRecentlyClosedEditors(e) {
    this.recentlyClosedEditors = this.recentlyClosedEditors.filter((t) => ae(e) && t.editorId !== e.editorId ? !0 : !(t.resource && this.editorHelper.matchesFile(t.resource, e) || t.associatedResources.some(
  ...
  addToHistory(e, t = !0) {
    ...
    i && (t ? this.history.unshift(i) : this.history.push(i), this.history.length > Xt.MAX_HISTORY_ITEMS && this.editorHelper.clearOnEditorDispose(this.history.pop(), this.editorHistoryListeners), ae(i) && this.editorHelper.onEditorDispose(i, () => this.updateHistoryOnEditorDispose(i), this.editorHistoryListeners));
  }
  ...
  includeInHistory(e) {
    return ae(e) ? !0 : !this.resourceExcludeMatcher.value.matches(e.resource);
  }
  ...
  loadHistoryFromStorage() {
    const e = [], t = this.storageService.get(Xt.HISTORY_STORAGE_KEY, 1);
    if (t)
      try {
        const i = JSON.parse(t);
        for (const o of i)
          if (!(!o.editor || !o.editor.resource))
            try {
              e.push({
                ...o.editor,
                resource: typeof o.editor.resource == "string" ? P.parse(o.editor.resource) : P.from(o.editor.resource)
              });
            } catch (s) {
              Ho(s);
            }
  ...
  saveState() {
    ...
    this.storageService.store(Xt.HISTORY_STORAGE_KEY, JSON.stringify(e), 1, 1);
  }
  ...
  getLastActiveFile(e) {
    for (const t of this.getHistory()) {
      let i;
      if (ae(t) ? i = ee.getOriginalUri(t, { filterByScheme: e }) : i = t.resource, (i == null ? void 0 : i.scheme) === e)
        return i;
    }
  }
};
wi.MOUSE_NAVIGATION_SETTING = "workbench.editor.mouseBackForwardToNavigate";
wi.NAVIGATION_SCOPE_SETTING = "workbench.editor.navigationScope";
wi.MAX_RECENTLY_CLOSED_EDITORS = 20;
wi.MAX_HISTORY_ITEMS = 200;
wi.HISTORY_STORAGE_KEY = "history.entries";
wi = x([
  h(0, U),
  h(1, oe),
  h(2, at),
...
let Oo = class extends R {
  constructor(e, t) {
    super(), this.scope = e, this.instantiationService = t, this.selectionsStack = this._register(this.instantiationService.createInstance(so, 0, this.scope)), this.editsStack = this._register(this.instantiationService.createInstance(so, 1, this.scope)), this.navigationsStack = this._register(this.instantiationService.createInstance(so, 2, this.scope)), this.stacks = [
      this.selectionsStack,
      this.editsStack,
      this.navigationsStack
    ], this.onDidChange = I.any(this.selectionsStack.onDidChange, this.editsStack.onDidChange, this.navigationsStack.onDidChange);
  }
  canGoForward(e) {
...
let so = class wu extends R {
  ...
  constructor(e, t, i, o, s, n) {
    super(), this.filter = e, this.scope = t, this.instantiationService = i, this.editorService = o, this.editorGroupService = s, this.logService = n, this._onDidChange = this._register(new y()), this.onDidChange = this._onDidChange.event, this.mapEditorToDisposable = /* @__PURE__ */ new Map(), this.mapGroupToDisposable = /* @__PURE__ */ new Map(), this.editorHelper = this.instantiationService.createInstance(hn), this.stack = [], this.index = -1, this.previousIndex = -1, this.navigating = !1, this.currentSelectionState = void 0, this.registerListeners();
  }
  registerListeners() {
  ...
  traceStack() {
    var t, i, o;
    if (this.logService.getLevel() !== jc.Trace)
      return;
    const e = [];
...
`)}
  ...
  notifyNavigation(e, t) {
    ...
    const i = Sr(e), o = (e == null ? void 0 : e.group) && e.input && !e.input.isDisposed();
    this.navigating ? (this.trace("notifyNavigation() ignoring (navigating)", e == null ? void 0 : e.input, t), i && o ? (this.trace("notifyNavigation() updating current selection state", e == null ? void 0 : e.input, t), this.currentSelectionState = new bd(
  ...
  onSelectionAwareEditorNavigation(e, t, i, o) {
    ...
    const s = new bd({ groupId: e, editor: t }, i, o == null ? void 0 : o.reason);
  ...
  addOrReplace(e, t, i, o) {
    ...
    if (s)
      ...
      this.stack.splice(this.index + 1, 0, r), this.stack.length > wu.MAX_STACK_SIZE ? (a.push(this.stack.shift()), this.previousIndex >= 0 && this.previousIndex--) : this.setIndex(this.index + 1, !0);
    }
    for (const d of a)
      this.editorHelper.clearOnEditorDispose(d.editor, this.mapEditorToDisposable);
    ae(n) && this.editorHelper.onEditorDispose(n, () => this.remove(n), this.mapEditorToDisposable), this._onDidChange.fire();
  }
  ...
  isCurrentSelectionActive() {
    ...
    if (!Sr(e) || ((o = e.group) == null ? void 0 : o.id) !== this.current.groupId || !e.input || !this.editorHelper.matchesEditor(e.input, this.current.editor))
      return !1;
  ...
  doNavigate(e) {
    ...
    return e.selection && (t = e.selection.restore(t)), ae(e.editor) ? this.editorService.openEditor(e.editor, t, e.groupId) : this.editorService.openEditor({
      ...e.editor,
      options: {
        ...e.editor.options,
        ...t
...
let hn = class {
  ...
  preferResourceEditorInput(e) {
    const t = ee.getOriginalUri(e);
    if ((t == null ? void 0 : t.scheme) === Re.file || (t == null ? void 0 : t.scheme) === Re.vscodeRemote || (t == null ? void 0 : t.scheme) === Re.vscodeUserData || (t == null ? void 0 : t.scheme) === this.pathService.defaultUriScheme) {
      if (ae(e)) {
        const o = e.toUntyped();
        if (js(o))
          return o;
  ...
  matchesEditor(e, t) {
    return e instanceof io || e instanceof qc ? ae(t) ? !1 : e instanceof io ? e.contains(t.resource, 2) : this.matchesFile(t.resource, e) : ae(e) ? ae(t) ? e.matches(t) : this.matchesFile(t.resource, e) : ae(t) ? this.matchesFile(e.resource, t) : e && t && this.uriIdentityService.extUri.isEqual(e.resource, t.resource);
  }
  matchesFile(e, t) {
    if (t instanceof io)
  ...
  onEditorDispose(e, t, i) {
    const o = I.once(e.onWillDispose)(() => t());
    let s = i.get(e);
    s || (s = new A(), i.set(e, s)), s.add(o);
  }
...
const On = /* @__PURE__ */ new Map(), fc = /* @__PURE__ */ new Map();
class Jw {
  constructor() {
    this.onDidPaneCompositeOpen = I.None, this.onDidPaneCompositeClose = I.None;
  }
  async openPaneComposite(e, t, i) {
    var o;
    return (o = this.getPartByLocation(t)) == null ? void 0 : o.openPaneComposite(e, i);
  }
  getActivePaneComposite(e) {
    var t;
    return (t = this.getPartByLocation(e)) == null ? void 0 : t.getActivePaneComposite();
  }
  getPaneComposite(e, t) {
    var i;
    return (i = this.getPartByLocation(t)) == null ? void 0 : i.getPaneComposite(e);
  }
  getPaneComposites(e) {
    var t;
    return ((t = this.getPartByLocation(e)) == null ? void 0 : t.getPaneComposites()) ?? [];
  }
  getPinnedPaneCompositeIds(e) {
    var t;
    return ((t = this.getSelectorPartByLocation(e)) == null ? void 0 : t.getPinnedPaneCompositeIds()) ?? [];
  }
  getVisiblePaneCompositeIds(e) {
    var t;
    return ((t = this.getSelectorPartByLocation(e)) == null ? void 0 : t.getVisiblePaneCompositeIds()) ?? [];
  }
  getProgressIndicator(e, t) {
    var i;
    return (i = this.getPartByLocation(t)) == null ? void 0 : i.getProgressIndicator(e);
  }
  hideActivePaneComposite(e) {
    var t;
    (t = this.getPartByLocation(e)) == null || t.hideActivePaneComposite();
  }
...
function Is(c, e, t) {
  const i = document.createElement("div");
  e.append(i), i.classList.add(...t), i.oncontextmenu = () => !1, c.create(i);
  function o() {
    c.layout(Math.max(c.minimumWidth, Math.min(c.maximumWidth, e.offsetWidth)), Math.max(c.minimumHeight, Math.min(c.maximumHeight, e.offsetHeight)), 0, 0);
  }
  c.onDidVisibilityChange((n) => {
    n && o();
  }), o();
...
function aC(c) {
  const e = yo.get(D).createInstance(ni, On.get(0));
  return fc.set(0, e), e._register(Is(e, c, ["part", "activitybar", "left"])), e;
}
function cC(c) {
  const e = yo.get(D).createInstance(Ys);
  return On.set(0, e), e._register(Is(e, c, ["part", "sidebar", "left"])), e.getPaneComposites().length > 0 && e.openPaneComposite(e.getPaneComposites()[0].id), e;
}
function dC(c) {
  const e = yo.get(D).createInstance(en);
  return fc.set(1, e), On.set(1, e), e._register(Is(e, c, ["part", "panel", "basepanel"])), e.getPaneComposites().length > 0 && e.openPaneComposite(e.getPaneComposites()[0].id), e;
}
function lC(c) {
  const e = yo.get(oe);
  return Is(e, c, ["part", "editor"]);
}
function hC(c) {
  const e = yo.get(ji);
  return Is(e, c, ["part", "statusbar"]);
}
function uC(c) {
  const e = c.icon != null ? P.parse(c.icon) : void 0, t = de.as(lt.ViewContainersRegistry).registerViewContainer({
    id: c.id,
    title: c.name,
    order: c.order,
    ctorDescriptor: new J(fa, [c.id, { mergeViewWithContainerWhenSingleView: !0 }]),
    hideIfEmpty: !0,
    icon: e
  }, c.location), i = [{
    id: c.id,
    ...
    ctorDescriptor: new J(class extends En {
      renderBody(s) {
        super.renderBody(s), this.content = z(".view-pane-content"), this.content.style.display = "flex", this.content.style.alignItems = "stretch", se(s, this.content), this._register(c.renderBody(this.content));
      }
      getActionViewItem(s, n) {
        const r = (c.actions ?? []).find((a) => a.id === s.id);
        return (r == null ? void 0 : r.render) != null ? new class extends db {
          constructor() {
  ...
  de.as(lt.ViewsRegistry).registerViews(i, t);
  const o = new A();
  o.add({
    dispose() {
      de.as(lt.ViewsRegistry).deregisterViews(i, t), de.as(lt.ViewContainersRegistry).deregisterViewContainer(t);
    }
  });
  for (const s of c.actions ?? [])
    o.add(te(class extends qe {
      constructor() {
        super({
          id: s.id,
          ...
          tooltip: s.tooltip,
          icon: s.icon != null ? M[s.icon] : void 0
...
let pa = class extends da {
  constructor(e, t, i, o, s, n, r, a, d, l, u, g) {
    super(t, i, o, s, n, r, a, d, l, u), this._editorGroupService = t, this.openEditor = Db(g, this.openEditor.bind(this), e);
  }
  get activeTextEditorControl() {
    return super.activeTextEditorControl ?? yo.get(gs).getFocusedCodeEditor() ?? void 0;
  }
  async openEditor(e, t, i) {
    var s;
    if (((s = this._editorGroupService.getContainer()) == null ? void 0 : s.isConnected) ?? !1)
...
function mC(c) {
  return {
    ...lb(),
    [yn.toString()]: new J(Cb),
    [nt.toString()]: new J($o),
    [ts.toString()]: new J(xr),
    [zi.toString()]: new J(Jw),
    [gt.toString()]: new J(Vr),
    [ci.toString()]: new J(hb),
    [ub.toString()]: new J(Nr),
    [gs.toString()]: new J(xb),
    [ja.toString()]: new J(pb),
    [oe.toString()]: new J(Zo),
    [ji.toString()]: new J(ha),
    [Uw.toString()]: new J(ua),
    [U.toString()]: new J(pa, [c]),
    [$a.toString()]: new J(po),
    [$t.toString()]: new J(gb),
    [ss.toString()]: new J(mb),
    [fb.toString()]: new J(bb),
    [vb.toString()]: new J(wb),
    [yb.toString()]: new J(wi)
  };
}
export {
  vC as ViewContainerLocation,
  mC as default,
  uC as registerCustomView,
  aC as renderActivitybarPar,
  lC as renderEditorPart,
  dC as renderPanelPart,
  cC as renderSidebarPart,
