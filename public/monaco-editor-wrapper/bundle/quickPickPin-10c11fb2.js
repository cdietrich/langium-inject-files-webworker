import { c0 as t, B as e, bj as s, av as g } from "./index-6dabdcd0.js";
...
async function $(o, i, n, l) {
  const a = n.items;
  let c = w(i, n, o, void 0, l);
  n.onDidTriggerItemButton(async (r) => {
    r.button.iconClass && y.includes(r.button.iconClass) && (n.items = a, c = w(i, n, o, r.item, l), n.items = n.value ? a : c);
  }), n.onDidChangeValue(async (r) => {
    n.items === c && r ? n.items = a : n.items === a && !r && (n.items = c);
  }), n.items = n.value ? a : c, n.show();
}
function w(o, i, n, l, a) {
  const c = [];
  let r;
  ...
  for (const h of r) {
    ...
    if (I) {
      ...
      (!a || !f.has(m)) && (f.add(m), u(p, !1), c.push(p));
    }
  }
