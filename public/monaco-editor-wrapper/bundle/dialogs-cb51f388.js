import { D as O, $ as S, G as xe, B as d, is as Fe, mF as Pe, aa as L, ac as De, b7 as Be, mG as Ce, mH as Ae, mI as Ee, b0 as B, b1 as ee, ba as te, av as x, bj as F, b9 as Ie, b3 as We, x as Te, bg as Ue, fm as Le, ek as de, _ as W, a as c, aU as _, mJ as ue, X as Y, e as Z, aT as fe, fY as me, mK as Re, ch as Ne, eZ as I, w as Oe, ir as _e, mL as Me, it as qe, mM as He, mN as Ke, bD as G, a3 as Ve, iB as je, E as q, f6 as $e, ao as J, aI as ze, g as ge, bz as Qe, bB as pe, bA as Se, L as Xe, f3 as T, I as Ye, bC as ve, mO as Ze, e0 as be, a0 as Ge, bN as Je, S as g, cx as ye, dl as k, ap as D, ie as et, U as ie, mP as tt, ff as E, da as v, kj as it, mQ as y, mR as A, mS as st, mT as se, mU as P, mV as ae, au as oe, mW as M, mX as at, mY as ot, mZ as nt, bH as ne, bI as rt, d as lt, bx as ht, jM as ct, aQ as dt, cd as ut, by as ft, bO as mt, gq as gt, m_ as pt, fu as St, m$ as vt, eW as re, n0 as bt, aw as le, fD as yt, n1 as R, n2 as kt, k as he, jC as wt, jO as xt } from "./index-6dabdcd0.js";
import { i as Ft, b as Pt } from "./window-06771a54.js";
var ce = globalThis && globalThis.__awaiter || function(f, e, t, i) {
  function s(a) {
...
class Dt extends O {
  constructor(e, t, i, s) {
    ...
    if (this.options.inputs ? this.inputs = this.options.inputs.map((n) => {
      var u;
      const r = this.messageContainer.appendChild(S(".dialog-message-input")), h = this._register(new Fe(r, void 0, {
      ...
      const n = this.messageContainer.appendChild(S(".dialog-checkbox-row")), u = this.checkbox = this._register(new Pe(this.options.checkboxLabel, !!this.options.checkboxChecked, s.checkboxStyles));
      n.appendChild(u.domNode);
      const r = n.appendChild(S(".dialog-checkbox-message"));
      r.innerText = this.options.checkboxLabel, this._register(L(r, De.CLICK, () => u.checked = !u.checked));
    }
  ...
  show() {
    return ce(this, void 0, void 0, function* () {
      return this.focusToReturn = document.activeElement, new Promise((e) => {
        Be(this.buttonsContainer);
        const t = this.buttonBar = this._register(new Ce(this.buttonsContainer)), i = this.rearrangeButtons(this.buttons, this.options.cancelId);
        i.forEach((a, o) => {
          ...
          n.label = Ae(i[o].label, !0), n instanceof Ee && (n.description = this.options.buttonDetails[i[o].index]), this._register(n.onDidClick((u) => {
            u && B.stop(u), e({
              button: i[o].index,
        ...
        }), this._register(L(window, "keydown", (a) => {
          var o, l;
          const n = new ee(a);
          if (n.equals(
            512
        ...
        }, !0)), this._register(L(window, "keyup", (a) => {
          B.stop(a, !0);
          const o = new ee(a);
        ...
        }, !0)), this._register(L(this.element, "focusout", (a) => {
          a.relatedTarget && this.element && (te(a.relatedTarget, this.element) || (this.focusToReturn = a.relatedTarget, a.target && (a.target.focus(), B.stop(a, !0))));
        }, !1));
        ...
        if (!this.options.disableCloseAction) {
          const a = this._register(new Ie(this.toolbarContainer, {})), o = this._register(new We("dialog.close", d("dialogClose", "Close Dialog"), x.asClassName(F.dialogClose), !0, () => ce(this, void 0, void 0, function* () {
            e({
              button: this.options.cancelId || 0,
              checkboxChecked: this.checkbox ? this.checkbox.checked : void 0
            });
        ...
        this.applyStyles(), this.element.setAttribute("aria-modal", "true"), this.element.setAttribute("aria-labelledby", "monaco-dialog-icon monaco-dialog-message-text"), this.element.setAttribute("aria-describedby", "monaco-dialog-icon monaco-dialog-message-text monaco-dialog-message-detail monaco-dialog-message-body"), Te(this.element), this.inputs.length > 0 ? (this.inputs[0].focus(), this.inputs[0].select()) : i.forEach((a, o) => {
  ...
  dispose() {
    super.dispose(), this.modalElement && (this.modalElement.remove(), this.modalElement = void 0), this.focusToReturn && te(this.focusToReturn, document.body) && (this.focusToReturn.focus(), this.focusToReturn = void 0);
  }
  rearrangeButtons(e, t) {
    ...
    if (Ue || Le) {
      ...
      i.reverse();
    } else if (de && typeof t == "number" && i[t]) {
      const s = i.splice(t, 1)[0];
      i.push(s);
    }
    return i;
...
let N = class ke extends Re {
  constructor(e, t, i, s, a, o) {
    super(), this.logService = e, this.layoutService = t, this.keybindingService = i, this.instantiationService = s, this.productService = a, this.clipboardService = o, this.markdownRenderer = this.instantiationService.createInstance(Ne, {});
  }
  async prompt(e) {
...
Browser: {3}`,
      ...
      navigator.userAgent
    ), t = e(!0), i = e(!1), { button: s } = await this.doShow(I.Info, this.productService.nameLong, [
  ...
  async doShow(e, t, i, s, a, o, l, n) {
    const u = new Oe(), r = n ? (p) => {
      var w;
      p.classList.add(...n.classes || []), (w = n.markdownDetails) == null || w.forEach((U) => {
        const C = this.markdownRenderer.render(U.markdown);
        p.appendChild(C.element), C.element.classList.add(...U.classes || []), u.add(C);
      });
    } : void 0, h = new Dt(this.layoutService.container, t, i, {
      detail: s,
      cancelId: a,
      type: this.getDialogType(e),
      keyEventProcessor: (p) => {
        const w = this.keybindingService.softDispatch(p, this.layoutService.container);
        w.kind === 2 && w.commandId && ke.ALLOWABLE_COMMANDS.indexOf(w.commandId) === -1 && B.stop(p, !0);
      },
      renderBody: r,
...
let H = class extends O {
  constructor(e, t, i, s, a, o, l) {
    super(), this.dialogService = e, this.impl = new N(
      t,
      i,
      s,
      a,
...
const Bt = Ve.as(je.Workbench);
Bt.registerWorkbenchContribution(H, 1);
class Ct extends O {
  constructor() {
    super(...arguments), this.dialogs = [], this._onWillShowDialog = this._register(new q()), this.onWillShowDialog = this._onWillShowDialog.event, this._onDidShowDialog = this._register(new q()), this.onDidShowDialog = this._onDidShowDialog.event;
  }
  show(e) {
    const t = new $e(), i = {
      args: e,
...
let K = class extends O {
  constructor(e, t) {
    super(), this.environmentService = e, this.logService = t, this.model = this._register(new Ct()), this.onWillShowDialog = this.model.onWillShowDialog, this.onDidShowDialog = this.model.onDidShowDialog;
  }
  skipDialogs() {
  ...
  async info(e, t) {
    await this.prompt({ type: I.Info, message: e, detail: t });
  }
  async warn(e, t) {
    await this.prompt({ type: I.Warning, message: e, detail: t });
  }
  async error(e, t) {
    await this.prompt({ type: I.Error, message: e, detail: t });
  }
  async about() {
    if (this.skipDialogs())
...
(function(f) {
  ...
  function e() {
    return (t) => t.get(T).pickFileAndOpen({ forceNewWindow: !1, availableFileSystems: [g.file] });
  }
  f.handler = e;
})(V || (V = {}));
var j;
(function(f) {
  ...
  function e() {
    return (t) => {
      const i = t.get(ye), s = i.activeEditorPane;
...
(function(f) {
  ...
  function e() {
    return (t) => t.get(T).pickFolderAndOpen({ forceNewWindow: !1, availableFileSystems: [g.file] });
  }
  f.handler = e;
})($ || ($ = {}));
var z;
(function(f) {
  ...
  function e() {
    return (t) => t.get(T).pickFileFolderAndOpen({ forceNewWindow: !1, availableFileSystems: [g.file] });
  }
  f.handler = e;
})(z || (z = {}));
var b;
...
const At = new ze("remoteFileDialogVisible", !1);
let Q = class {
  constructor(e, t, i, s, a, o, l, n, u, r, h, m, p, w) {
    this.fileService = e, this.quickInputService = t, this.labelService = i, this.workspaceContextService = s, this.notificationService = a, this.fileDialogService = o, this.modelService = l, this.languageService = n, this.environmentService = u, this.remoteAgentService = r, this.pathService = h, this.keybindingService = m, this.accessibilityService = w, this.hidden = !1, this.allowFileSelection = !0, this.allowFolderSelection = !1, this.requiresTrailing = !1, this.userEnteredPathSegment = "", this.autoCompletePathSegment = "", this.isWindows = !1, this.separator = "/", this.onBusyChangeEmitter = new q(), this.disposables = [
      this.onBusyChangeEmitter
    ], this.remoteAuthority = this.environmentService.remoteAuthority, this.contextKey = At.bindTo(p), this.scheme = this.pathService.defaultUriScheme;
  }
  set busy(e) {
  ...
  async showOpenDialog(e = {}) {
    this.scheme = this.getScheme(e.availableFileSystems, e.defaultUri), this.userHome = await this.getUserHome();
    const t = this.getOptions(e);
    return t ? (this.options = t, this.pickResource()) : Promise.resolve(void 0);
  }
  async showSaveDialog(e) {
    this.scheme = this.getScheme(e.availableFileSystems, e.defaultUri), this.userHome = await this.getUserHome(), this.requiresTrailing = !0;
  ...
  getOptions(e, t = !1) {
    let i, s;
    if (e.defaultUri && (i = this.scheme === e.defaultUri.scheme ? e.defaultUri : void 0, s = t ? k(e.defaultUri) : void 0), i || (i = this.userHome, s && (i = D(i, s))), this.scheme !== g.file && !this.fileService.hasProvider(i)) {
  ...
  remoteUriFrom(e, t) {
    ...
    const i = this.scheme === g.file ? ie.file(e) : ie.from(
  ...
  getUserHome() {
    return this.pathService.userHome({ preferLocal: this.scheme === g.file });
  }
  async pickResource(e = !1) {
    ...
    if (this.options.defaultUri) {
      ...
      (!i || !i.isDirectory) && (t = v(this.options.defaultUri), this.trailing = k(this.options.defaultUri));
    }
    return new Promise((a) => {
      if (this.filePickBox = this.quickInputService.createQuickPick(), this.busy = !0, this.filePickBox.matchOnLabel = !1, this.filePickBox.sortByLabel = !1, this.filePickBox.autoFocusOnList = !1, this.filePickBox.ignoreFocusOut = !0, this.filePickBox.ok = !0, this.scheme !== g.file && this.options && this.options.availableFileSystems && this.options.availableFileSystems.length > 1 && this.options.availableFileSystems.indexOf(g.file) > -1) {
        ...
        let r;
        e ? r = j : r = this.allowFileSelection ? this.allowFolderSelection ? z : V : $;
      ...
      function n(r, h) {
        h && (h = P(h, r.separator), h = M(h)), a(h), r.contextKey.set(!1), r.filePickBox.dispose(), lt(r.disposables);
      }
      ...
      this.filePickBox.onDidAccept((r) => {
        ...
        if (l = !1, r.length === 1 && this.isSelectionChangeFromUser()) {
          ...
          y(this.filePickBox.value.substring(0, h.length), h) || (this.filePickBox.valueSelection = [0, this.filePickBox.value.length], this.insertText(h, h)), this.setAutoComplete(h, this.userEnteredPathSegment, r[0], !0);
        }
  ...
  async handleValueChange(e) {
    try {
      if (this.isValueChangeFromUser())
        if (!y(e, this.constructFullUserPath()) && !this.isBadSubpath(e)) {
          this.filePickBox.validationMessage = void 0;
          const t = this.filePickBoxValue();
          let i = b.NotUpdated;
          A.isEqual(this.currentFolder, t) || (i = await this.tryUpdateItems(e, t)), (i === b.NotUpdated || i === b.UpdatedWithTrailing) && this.setActiveItems(e);
        } else
  ...
  isBadSubpath(e) {
    return this.badPath && e.length > this.badPath.length && y(e.substring(0, this.badPath.length), this.badPath);
  }
  isValueChangeFromUser() {
    return !y(this.filePickBox.value, this.pathAppend(this.currentFolder, this.userEnteredPathSegment + this.autoCompletePathSegment));
  }
  ...
  constructFullUserPath() {
    ...
    return y(this.filePickBox.value.substr(0, this.userEnteredPathSegment.length), this.userEnteredPathSegment) ? y(this.filePickBox.value.substr(0, e.length), e) ? e : this.userEnteredPathSegment : this.pathAppend(this.currentFolder, this.userEnteredPathSegment);
  }
  filePickBoxValue() {
    const e = this.remoteUriFrom(this.filePickBox.value.trimRight(), this.currentFolder), t = this.pathFromUri(this.currentFolder);
    if (y(this.filePickBox.value, t))
      return this.currentFolder;
    const i = this.remoteUriFrom(t, this.currentFolder), s = st(i, e), a = this.filePickBox.value.length > 1 && t.length > 1 ? y(this.filePickBox.value.substr(0, 2), t.substr(0, 2)) : !1;
    if (s && a) {
      let o = D(this.currentFolder, s);
      const l = k(e);
      return (l === "." || l === "..") && (o = this.remoteUriFrom(this.pathAppend(o, l), this.currentFolder)), se(e) ? P(o) : o;
    } else
      return e;
  }
  async onDidAccept() {
    if (this.busy = !0, this.filePickBox.activeItems.length === 1) {
      ...
      if (t.isFolder) {
        if (this.trailing)
          ...
          ae(i, this.filePickBox.value) && y(t.label, k(t.uri)) ? (this.filePickBox.valueSelection = [this.pathFromUri(this.currentFolder).length, this.filePickBox.value.length], this.insertText(i, this.basenameWithTrailingSlash(t.uri))) : t.label === ".." && ae(this.filePickBox.value, i) ? (this.filePickBox.valueSelection = [i.length, this.filePickBox.value.length], this.insertText(i, "")) : await this.updateItems(t.uri, !0);
        }
        this.filePickBox.busy = !1;
        return;
      }
    } else if (await this.tryUpdateItems(this.filePickBox.value, this.filePickBoxValue()) !== b.NotUpdated) {
      this.filePickBox.busy = !1;
      return;
    }
    let e;
  ...
  async tryUpdateItems(e, t) {
    if (e.length > 0 && e[0] === "~") {
      ...
      return await this.updateItems(i, !0) ? b.UpdatedWithTrailing : b.Updated;
    } else {
      if (e === "\\")
        return t = this.root(this.currentFolder), e = this.pathFromUri(t), await this.updateItems(t, !0) ? b.UpdatedWithTrailing : b.Updated;
      if (!A.isEqual(this.currentFolder, t) && (this.endsWithSlash(e) || !A.isEqual(this.currentFolder, v(t)) && A.isEqualOrParent(this.currentFolder, v(t)))) {
        let i;
        try {
          i = await this.fileService.stat(t);
        } catch {
        }
        if (i && i.isDirectory && k(t) !== "." && this.endsWithSlash(e))
          return t = this.tryAddTrailingSeparatorToDirectory(t, i), await this.updateItems(t) ? b.UpdatedWithTrailing : b.Updated;
        if (this.endsWithSlash(e))
          return this.filePickBox.validationMessage = d("remoteFileDialog.badPath", "The path does not exist."), this.badPath = e, b.InvalidPath;
        {
          let s = v(t);
          const a = M(P(this.currentFolder)), o = M(P(s));
          if (!A.isEqual(a, o) && (!/^[a-zA-Z]:$/.test(this.filePickBox.value) || !y(this.pathFromUri(this.currentFolder).substring(0, this.filePickBox.value.length), this.filePickBox.value))) {
            let l;
            try {
            ...
            if (l && l.isDirectory)
              return this.badPath = void 0, s = this.tryAddTrailingSeparatorToDirectory(s, l), await this.updateItems(s, !1, k(t)) ? b.UpdatedWithTrailing : b.Updated;
          }
        }
      }
    }
    return this.badPath = void 0, b.NotUpdated;
  }
  tryUpdateTrailing(e) {
    const t = E(e);
    this.trailing && t && (this.trailing = k(e));
  }
  setActiveItems(e) {
    e = this.pathFromUri(this.tildaReplace(e));
    const t = this.remoteUriFrom(e), i = k(t), s = this.constructFullUserPath();
    if (y(s, e.substring(0, s.length)) || y(e, s.substring(0, e.length))) {
      let o = !1;
  ...
  setAutoComplete(e, t, i, s = !1) {
    ...
    const a = i.label;
    return a === ".." ? (this.userEnteredPathSegment = "", this.autoCompletePathSegment = "", this.activeItem = i, s && document.execCommand("insertText", !1, ""), !1) : !s && a.length >= t.length && y(a.substr(0, t.length), t) ? (this.userEnteredPathSegment = t, this.activeItem = i, this.autoCompletePathSegment = "", i.isFolder || !this.trailing ? this.filePickBox.activeItems = [i] : this.filePickBox.activeItems = [], !0) : s && !y(this.basenameWithTrailingSlash(i.uri), this.userEnteredPathSegment + this.autoCompletePathSegment) ? (this.userEnteredPathSegment = "", this.accessibilityService.isScreenReaderOptimized() || (this.autoCompletePathSegment = this.trimTrailingSlash(a)), this.activeItem = i, this.accessibilityService.isScreenReaderOptimized() || (this.filePickBox.valueSelection = [this.pathFromUri(this.currentFolder, !0).length, this.filePickBox.value.length], this.insertText(this.pathAppend(this.currentFolder, this.autoCompletePathSegment), this.autoCompletePathSegment), this.filePickBox.valueSelection = [this.filePickBox.value.length - this.autoCompletePathSegment.length, this.filePickBox.value.length]), !0) : (this.userEnteredPathSegment = t, this.autoCompletePathSegment = "", !1);
  }
  insertText(e, t) {
  ...
  addPostfix(e) {
    let t = e;
    if (this.requiresTrailing && this.options.filters && this.options.filters.length > 0 && !se(e)) {
      let i = !1;
      const s = E(e).substr(1);
      ...
      i || (t = D(v(e), k(e) + "." + this.options.filters[0].extensions[0]));
    }
    return t;
  }
  trimTrailingSlash(e) {
  ...
  async updateItems(e, t = !1, i) {
    ...
    const o = ot(async (l) => {
      let n;
      try {
        n = await this.fileService.resolve(e), n.isDirectory || (i = k(e), e = v(e), n = void 0, a = !0);
      } catch {
      }
      const u = i ? this.pathAppend(e, i) : this.pathFromUri(e, !0);
      return this.currentFolder = this.endsWithSlash(e.path) ? e : P(e, this.separator), this.userEnteredPathSegment = i || "", this.createItems(n, this.currentFolder, l).then((r) => l.isCancellationRequested ? (this.busy = !1, !1) : (this.filePickBox.items = r, this.filePickBox.activeItems = [this.filePickBox.items[0]], this.filePickBox.activeItems = [], !y(this.filePickBox.value, u) && t && (this.filePickBox.valueSelection = [0, this.filePickBox.value.length], this.insertText(u, u)), t && i && s ? this.filePickBox.valueSelection = [this.filePickBox.value.length - i.length, this.filePickBox.value.length - i.length] : i || (this.filePickBox.valueSelection = [this.filePickBox.value.length, this.filePickBox.value.length]), this.busy = !1, this.updatingPromise = void 0, a));
    });
  ...
  async createItem(e, t, i) {
    ...
    if (e.isDirectory) {
      const a = k(s);
      return s = P(s, this.separator), { label: a, uri: s, isFolder: !0, iconClasses: ne(this.modelService, this.languageService, s || void 0, rt.FOLDER) };
    } else if (!e.isDirectory && this.allowFileSelection && this.filterFile(s))
      return { label: e.name, uri: s, isFolder: !1, iconClasses: ne(this.modelService, this.languageService, s || void 0) };
  }
};
Q = W([
  c(0, ge),
...
let X = class {
  constructor(e, t, i, s, a, o, l, n, u, r, h, m, p, w, U, C, we) {
    this.hostService = e, this.contextService = t, this.historyService = i, this.environmentService = s, this.instantiationService = a, this.configurationService = o, this.fileService = l, this.openerService = n, this.dialogService = u, this.languageService = r, this.workspacesService = h, this.labelService = m, this.pathService = p, this.commandService = w, this.editorService = U, this.codeEditorService = C, this.logService = we;
  }
  async defaultFilePath(e = this.getSchemeFilterForWindow()) {
    let t = this.historyService.getLastActiveFile(e);
    return t ? t = v(t) : t = this.historyService.getLastActiveWorkspaceRoot(e), t || (t = await this.pathService.userHome({ preferLocal: e === g.file })), t;
  }
  async defaultFolderPath(e = this.getSchemeFilterForWindow()) {
    let t = this.historyService.getLastActiveWorkspaceRoot(e);
    return t || (t = this.historyService.getLastActiveFile(e)), t ? v(t) : this.pathService.userHome({ preferLocal: e === g.file });
  }
  async defaultWorkspacePath(e = this.getSchemeFilterForWindow()) {
    ...
    if (this.contextService.getWorkbenchState() === 3) {
      ...
      (i == null ? void 0 : i.scheme) === e && pt(i, this.environmentService) && !St(i) && (t = v(i));
    }
...
` + i);
  ...
  async pickFileFolderAndOpenSimplified(e, t, i) {
    ...
    if (o) {
      ...
      !Ft(n) && Pt(n) && this.addFileToRecentlyOpened(n.fileUri), l.isDirectory || t.forceNewWindow || i ? await this.hostService.openWindow([n], { forceNewWindow: t.forceNewWindow, remoteAuthority: t.remoteAuthority }) : await this.editorService.openEditors([{ resource: o, options: { source: re.USER, pinned: !0 } }], void 0, { validateTrust: !0 });
    }
  }
  async pickFileAndOpenSimplified(e, t, i) {
    ...
    o && (this.addFileToRecentlyOpened(o), t.forceNewWindow || i ? await this.hostService.openWindow([{ fileUri: o }], { forceNewWindow: t.forceNewWindow, remoteAuthority: t.remoteAuthority }) : await this.editorService.openEditors([{ resource: o, options: { source: re.USER, pinned: !0 } }], void 0, { validateTrust: !0 }));
  }
  ...
  async pickWorkspaceAndOpenSimplified(e, t) {
    const i = d("openWorkspace.title", "Open Workspace from File"), s = [{ name: d("filterName.workspace", "Workspace"), extensions: [bt] }], a = this.addFileSchemaIfNeeded(e, !0), o = await this.pickResource({ canSelectFiles: !0, canSelectFolders: !1, canSelectMany: !1, defaultUri: t.defaultUri, title: i, filters: s, availableFileSystems: a });
    if (o)
  ...
  getSimpleFileDialog() {
    return this.instantiationService.createInstance(Q);
  }
  pickResource(e) {
  ...
  getPickFileToSaveDialogOptions(e, t) {
    ...
    let a;
    const o = this.languageService.getSortedRegisteredLanguageNames(), l = le(o.map(({ languageName: n, languageId: u }) => {
      const r = this.languageService.getExtensions(u);
      if (!r.length)
        return null;
      const h = { name: n, extensions: yt(r).slice(0, 10).map((p) => R(p, ".")) }, m = s || kt;
      if (!a && r.includes(m)) {
        a = h;
        const p = R(m, ".");
    ...
    return !a && s && (a = { name: R(s, ".").toUpperCase(), extensions: [R(s, ".")] }), i.filters = le([
...
class Et extends X {
  constructor() {
    super(...arguments), this.pickWorkspaceAndOpen = xt;
  }
...
function Nt(f) {
  return {
    [G.toString()]: new he(K, void 0, !0),
    [T.toString()]: new he(Et, void 0, !0),
    ...wt(f)
  };
}
export {
