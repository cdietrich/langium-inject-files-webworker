import { _ as x, a, O as k, N as B, e as E, Y as F, Q as K, a1 as R, bA as O, a3 as y, wz as Z, wA as J, bP as ee, aG as ie, b5 as te, wB as ne, wC as se, aQ as oe, V as I, Z as m, aB as re, aK as ae, a0 as Y, D as ce, E as N, t as U, wD as z, wE as de, aI as le, w as P, al as M, aj as b, ak as S, B as p, aF as C, c5 as G, dx as H, f_ as A, aN as q, aH as D, aO as we, U as he, a2 as ue } from "./index-6dabdcd0.js";
let _ = class extends Z {
  ...
  getActions() {
    ...
    if ((i = this.viewPaneContainer) != null && i.menuActions && (e.push(...this.viewPaneContainer.menuActions.getPrimaryActions()), this.viewPaneContainer.isViewMergedWithContainer())) {
      ...
      t.shouldShowFilterInHeader() && e.push(J), e.push(...t.menuActions.getPrimaryActions());
    }
    return e;
  }
  getSecondaryActions() {
...
let j = class extends ce {
  ...
  async closeViewContainer(e) {
    ...
    if (i) {
      ...
      if (t !== null)
        return n ? this.layoutService.setPartHidden(!0, X(t)) : void 0;
    }
  }
  isViewVisible(e) {
  ...
  registerOpenViewAction(e) {
    ...
    if (e.openCommandActionDescriptor) {
      ...
      if (i.add(b(class extends S {
        ...
        async run(r) {
          const c = r.get(H), d = r.get(m), l = r.get(I), h = r.get(A), u = r.get(Y);
          if (z.getValue(u) === e.id) {
            const w = d.getViewLocationById(e.id);
            d.getViewLocationById(e.id) === 0 ? c.activeGroup.focus() : w !== null && l.setPartHidden(!0, X(w));
          } else
            h.openView(e.id, !0);
        }
  ...
  registerPaneComposite(e, i) {
    ...
    n = x([
      ...
      a(5, K),
      a(6, R)
    ], n), y.as(Q(i)).registerPaneComposite(W.create(n, e.id, typeof e.title == "string" ? e.title : e.title.value, we(e.icon) ? e.icon : void 0, e.order, e.requestedIndex, e.icon instanceof he ? e.icon : void 0));
  }
  deregisterPaneComposite(e, i) {
    y.as(Q(i)).deregisterPaneComposite(e.id);
  }
