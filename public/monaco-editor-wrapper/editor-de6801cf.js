...
let Ee = class It extends To {
  ...
  updateStyles() {
    ...
    if (this.badgeContent) {
      const o = t.badgeForeground, n = t.badgeBackground, r = e.getColor(Do);
      this.badgeContent.style.color = o ? o.toString() : "", this.badgeContent.style.backgroundColor = n ? n.toString() : "", this.badgeContent.style.borderStyle = r ? "solid" : "", this.badgeContent.style.borderWidth = r ? "1px" : "", this.badgeContent.style.borderColor = r ? r.toString() : "";
    }
  }
  render(e) {
    super.render(e), this.container = e, this.options.icon && this.container.classList.add("icon"), this.options.hasPopup ? (this.container.setAttribute("role", "button"), this.container.setAttribute("aria-haspopup", "true")) : this.container.setAttribute("role", "tab"), this._register(pe(this.container, me.MOUSE_DOWN, () => {
      this.container.classList.add("clicked");
    })), this._register(pe(this.container, me.MOUSE_UP, () => {
    ...
    })), this.label = De(e, _e("a")), this.badge = De(e, _e(".badge")), this.badgeContent = De(this.badge, _e(".badge-content")), De(e, _e(".active-item-indicator")), Yt(this.badge), this.updateActivity(), this.updateStyles(), this.updateHover();
  }
  onThemeChange(e) {
    this.updateStyles();
  }
  ...
  updateBadge() {
    const e = this.action;
    if (!this.badge || !this.badgeContent || !(e instanceof Kt))
      return;
    const t = e.getBadge(), o = e.getClass();
    this.badgeDisposable.clear(), _o(this.badgeContent), Yt(this.badge);
    ...
    if (t && n) {
      if (t instanceof Ai) {
        if (t.number) {
          ...
          if (t.number > 999) {
            const l = t.number / 1e3, u = Math.floor(l);
            l > u ? r = `${u}K+` : r = `${l}K`;
          }
          this.badgeContent.textContent = r, xe(this.badge);
        }
      } else if (t instanceof ki)
        this.badgeContent.textContent = t.text, xe(this.badge);
      else if (t instanceof xo) {
        const r = $e.asClassNameArray(t.icon);
        this.badgeContent.classList.add(...r), xe(this.badge);
      } else
        t instanceof Ro && xe(this.badge);
      if (o) {
        const r = o.split(" ");
        this.badge.classList.add(...r), this.badgeDisposable.value = Ue(() => this.badge.classList.remove(...r));
      }
    }
    this.updateTitle();
  }
  ...
  updateHover() {
    this.hoverDisposables.clear(), this.updateTitle(), this.hoverDisposables.add(pe(this.container, me.MOUSE_OVER, () => {
      this.showHoverScheduler.isScheduled() || (Date.now() - It.hoverLeaveTime < 200 ? this.showHover(!0) : this.showHoverScheduler.schedule(this.configurationService.getValue("workbench.hover.delay")));
    }, !0)), this.hoverDisposables.add(pe(this.container, me.MOUSE_LEAVE, (e) => {
      e.target === this.container && (It.hoverLeaveTime = Date.now(), this.hoverService.hideHover(), this.showHoverScheduler.cancel());
    }, !0)), this.hoverDisposables.add(Ue(() => {
...
class Is extends Kt {
  constructor(e) {
    super({
      ...
      classNames: $e.asClassNameArray(h.more)
    }), this.showMenu = e;
  }
  async run() {
    this.showMenu();
...
let Ei = class extends Ee {
  constructor(e, t, o, n, r, l, u, m, f, b, E, v) {
    super(e, { icon: !0, colors: l, hasPopup: !0, hoverOptions: u }, () => !0, f, b, E, v), this.getOverflowingComposites = t, this.getActiveCompositeId = o, this.getBadge = n, this.getCompositeOpenAction = r, this.contextMenuService = m, this.actions = [];
  }
  showMenu() {
  ...
  getActions() {
    return this.getOverflowingComposites().map((e) => {
      ...
      let n;
      return o instanceof Ai ? n = o.number : o instanceof ki && (n = o.text), n ? t.label = i("numberBadge", "{0} ({1})", e.name, n) : t.label = e.name || "", t;
    });
  }
  dispose() {
...
let vi = class He extends Ee {
  constructor(e, t, o, n, r, l, u, m, f, b, E, v, S, I) {
    super(t, e, m.areBadgesEnabled.bind(m), v, S, I, b), this.compositeActivityAction = t, this.toggleCompositePinnedAction = o, this.toggleCompositeBadgeAction = n, this.compositeContextMenuActionsProvider = r, this.contextMenuActionsProvider = l, this.dndHandler = u, this.compositeBar = m, this.contextMenuService = f, He.manageExtensionAction || (He.manageExtensionAction = E.createInstance(Mt));
  }
  render(e) {
    super.render(e), this.updateChecked(), this.updateEnabled(), this._register(pe(this.container, me.CONTEXT_MENU, (o) => {
      Xt.stop(o, !0), this.showContextMenu(e);
    }));
    let t;
    this._register(Bo.INSTANCE.registerDraggable(this.container, () => ({ type: "composite", id: this.activity.id }), {
      onDragOver: (o) => {
        ...
        Oo(o.eventData.dataTransfer, "move", n), t = this.updateFromDragging(e, n, o.eventData);
      },
      onDragLeave: (o) => {
      ...
      onDrop: (o) => {
        Xt.stop(o.eventData, !0), this.dndHandler.drop(o.dragAndDropData, this.activity.id, o.eventData, t), t = this.updateFromDragging(e, !1, o.eventData);
      },
      onDragStart: (o) => {
    ...
    })), [this.badge, this.label].forEach((o) => this._register(new Go(o, () => {
      this.action.checked || this.action.run();
    }))), this.updateStyles();
  }
  updateFromDragging(e, t, o) {
    const n = e.getBoundingClientRect(), r = o.clientX, l = o.clientY, u = n.bottom - n.top, m = n.right - n.left, f = l <= n.top + u * 0.4, b = l > n.bottom - u * 0.4, E = l <= n.top + u * 0.5, v = r <= n.left + m * 0.4, S = r > n.right - m * 0.4, I = r <= n.left + m * 0.5, k = e.classList, A = {
      vertical: k.contains("top") ? "top" : k.contains("bottom") ? "bottom" : void 0,
      horizontal: k.contains("left") ? "left" : k.contains("right") ? "right" : void 0
    }, J = f || E && !A.vertical || !b && A.vertical === "top", _ = b || !E && !A.vertical || !f && A.vertical === "bottom", B = v || I && !A.horizontal || !S && A.horizontal === "left", $ = S || !I && !A.horizontal || !v && A.horizontal === "right";
    if (e.classList.toggle("top", t && J), e.classList.toggle("bottom", t && _), e.classList.toggle("left", t && B), e.classList.toggle("right", t && $), !!t)
      return { verticallyBefore: J, horizontallyBefore: B };
  }
  showContextMenu(e) {
    ...
    o.length && t.push(...o), this.compositeActivityAction.activity.extensionId && (t.push(new Zt()), t.push(He.manageExtensionAction)), this.compositeBar.isPinned(this.activity.id) ? (this.toggleCompositePinnedAction.label = i("hide", "Hide '{0}'", this.activity.name), this.toggleCompositePinnedAction.checked = !1) : this.toggleCompositePinnedAction.label = i("keep", "Keep '{0}'", this.activity.name), this.compositeBar.areBadgesEnabled(this.activity.id) ? this.toggleCompositeBadgeAction.label = i("hideBadge", "Hide Badge") : this.toggleCompositeBadgeAction.label = i("showBadge", "Show Badge");
    const l = this.contextMenuActionsProvider();
    l.length && (t.push(new Zt()), t.push(...l));
    const u = Fo(e), m = {
...
var Ge;
const Pr = y("auxiliarybar-right-layout-icon", h.layoutSidebarRight, i(
  "toggleAuxiliaryIconRight",
  "Icon to toggle the auxiliary bar off in its right position."
)), Dr = y("auxiliarybar-right-off-layout-icon", h.layoutSidebarRightOff, i(
  "toggleAuxiliaryIconRightOn",
  "Icon to toggle the auxiliary bar on in its right position."
)), _r = y("auxiliarybar-left-layout-icon", h.layoutSidebarLeft, i(
  "toggleAuxiliaryIconLeft",
  "Icon to toggle the auxiliary bar in its left position."
)), xr = y("auxiliarybar-left-off-layout-icon", h.layoutSidebarLeftOff, i(
...
class N extends M {
  constructor() {
    super({
      id: N.ID,
      title: { value: N.LABEL, original: "Toggle Secondary Side Bar Visibility" },
      toggled: {
        condition: re,
...
N.ID = "workbench.action.toggleAuxiliaryBar";
N.LABEL = i("toggleAuxiliaryBar", "Toggle Secondary Side Bar Visibility");
a(N);
a((Ge = class At extends M {
  constructor() {
    super({
      id: At.ID,
      title: { value: At.LABEL, original: "Focus into Secondary Side Bar" },
      category: w.View,
      f1: !0
    });
  }
  async run(e) {
    const t = e.get(Ce), o = e.get(T);
...
}, Ge.ID = "workbench.action.focusAuxiliaryBar", Ge.LABEL = i("focusAuxiliaryBar", "Focus into Secondary Side Bar"), Ge));
c.appendMenuItems([
  {
...
K.ID = "workbench.action.togglePanel";
K.LABEL = i("togglePanelVisibility", "Toggle Panel Visibility");
a(K);
a((Fe = class extends M {
  constructor() {
    super({
  ...
  async run(d) {
    const e = d.get(T), t = d.get(Ce);
    e.isVisible("workbench.parts.panel") || e.setPartHidden(!1, "workbench.parts.panel");
    const o = t.getActivePaneComposite(1);
    o == null || o.focus();
  }
}, Fe.ID = "workbench.action.focusPanel", Fe.LABEL = i("focusPanel", "Focus into Panel"), Fe));
const Et = {
...
function vt(d, e, t, o) {
  return Eo(d, e, t, o, Vo.notEqualsTo(Pi(o)));
}
function Ne(d, e, t, o) {
  return Eo(d, e, t, o, fe.notEqualsTo(o));
}
const Fr = [
  vt(Et.LEFT, { value: i("positionPanelLeft", "Move Panel Left"), original: "Move Panel Left" }, i("positionPanelLeftShort", "Left"), 0),
  vt(Et.RIGHT, { value: i("positionPanelRight", "Move Panel Right"), original: "Move Panel Right" }, i("positionPanelRightShort", "Right"), 1),
  vt(Et.BOTTOM, { value: i("positionPanelBottom", "Move Panel To Bottom"), original: "Move Panel To Bottom" }, i("positionPanelBottomShort", "Bottom"), 2)
], Vr = [
  Ne(Ve.LEFT, { value: i("alignPanelLeft", "Set Panel Alignment to Left"), original: "Set Panel Alignment to Left" }, i("alignPanelLeftShort", "Left"), "left"),
  Ne(Ve.RIGHT, { value: i("alignPanelRight", "Set Panel Alignment to Right"), original: "Set Panel Alignment to Right" }, i("alignPanelRightShort", "Right"), "right"),
  Ne(Ve.CENTER, { value: i("alignPanelCenter", "Set Panel Alignment to Center"), original: "Set Panel Alignment to Center" }, i("alignPanelCenterShort", "Center"), "center"),
  Ne(Ve.JUSTIFY, { value: i("alignPanelJustify", "Set Panel Alignment to Justify"), original: "Set Panel Alignment to Justify" }, i("alignPanelJustifyShort", "Justify"), "justify")
];
...
Fr.forEach((d) => {
  const { id: e, title: t, shortLabel: o, value: n, when: r } = d;
  a(class extends M {
    constructor() {
      super({
        id: e,
    ...
    run(l) {
      l.get(T).setPanelPosition(n === void 0 ? 2 : n);
    }
...
Vr.forEach((d) => {
  ...
  a(class extends M {
    ...
    run(l) {
      l.get(T).setPanelAlignment(n === void 0 ? "center" : n);
    }
...
class vo extends M {
  ...
  async run(e, t) {
    const o = e.get(Ce), n = o.getPinnedPaneCompositeIds(1), r = o.getActivePaneComposite(1);
    if (!r)
      return;
    let l;
    for (let u = 0; u < n.length; u++)
      if (n[u] === r.getId()) {
        l = n[(u + n.length + t) % n.length];
        break;
      }
    typeof l == "string" && await o.openPaneComposite(l, 1, !0);
  }
}
a(class extends vo {
  constructor() {
...
a(class extends M {
  ...
  run(d) {
    d.get(T).setPartHidden(!0, "workbench.parts.auxiliarybar");
  }
});
c.appendMenuItems([
  {
...
class st extends M {
  ...
  run(e, ...t) {
    const o = e.get(No), n = e.get(T), r = e.get(Uo), l = o.getViewContainersByLocation(this.source), u = o.getViewContainersByLocation(this.destination);
    if (l.length) {
      const m = r.getVisibleViewContainer(this.source);
      l.forEach((f) => o.moveViewContainerToLocation(f, this.destination)), n.setPartHidden(!1, this.destination === 1 ? "workbench.parts.panel" : "workbench.parts.auxiliarybar"), m && u.length === 0 && r.openViewContainer(m.id, !0);
    }
  }
}
class ct extends st {
...
ct.ID = "workbench.action.movePanelToSidePanel";
class dt extends st {
  constructor() {
    super(1, 2, {
      id: dt.ID,
...
dt.ID = "workbench.action.movePanelToSecondarySideBar";
a(ct);
a(dt);
class lt extends st {
  constructor() {
...
lt.ID = "workbench.action.moveSidePanelToPanel";
class ut extends st {
  constructor() {
    super(2, 1, {
      id: ut.ID,
...
ut.ID = "workbench.action.moveSecondarySideBarToPanel";
a(lt);
a(ut);
const Nr = y("menuBar", h.layoutMenubar, i("menuBarIcon", "Represents the menu bar")), Ur = y("activity-bar-left", h.layoutActivitybarLeft, i("activityBarLeft", "Represents the activity bar in the left position")), Hr = y("activity-bar-right", h.layoutActivitybarRight, i("activityBarRight", "Represents the activity bar in the right position")), Lt = y("panel-left", h.layoutSidebarLeft, i("panelLeft", "Represents a side bar in the left position"));
y("panel-left-off", h.layoutSidebarLeftOff, i("panelLeftOff", "Represents a side bar in the left position toggled off"));
const Tt = y("panel-right", h.layoutSidebarRight, i("panelRight", "Represents side bar in the right position"));
y("panel-right-off", h.layoutSidebarRightOff, i("panelRightOff", "Represents side bar in the right position toggled off"));
const qr = y("panel-bottom", h.layoutPanel, i("panelBottom", "Represents the bottom panel")), zr = y("statusBar", h.layoutStatusbar, i("statusBarIcon", "Represents the status bar")), Kr = y("panel-align-left", h.layoutPanelLeft, i("panelBottomLeft", "Represents the bottom panel alignment set to the left")), Wr = y("panel-align-right", h.layoutPanelRight, i(
  "panelBottomRight",
  "Represents the bottom panel alignment set to the right"
)), jr = y("panel-align-center", h.layoutPanelCenter, i(
  "panelBottomCenter",
  "Represents the bottom panel alignment set to the center"
)), Qr = y("panel-align-justify", h.layoutPanelJustify, i(
  "panelBottomJustify",
  "Represents the bottom panel alignment set to justified"
)), Jr = y("fullscreen", h.screenFull, i("fullScreenIcon", "Represents full screen")), $r = y("centerLayoutIcon", h.layoutCentered, i("centerLayoutIcon", "Represents centered layout mode")), Yr = y("zenMode", h.target, i("zenModeIcon", "Represents zen mode"));
class se extends M {
  constructor() {
    super({
      id: se.ID,
  ...
  run(e) {
    const t = e.get(T), o = e.get(L), r = !t.isVisible("workbench.parts.activitybar");
    o.updateValue(se.activityBarVisibleKey, r);
  }
}
se.ID = "workbench.action.toggleActivityBarVisibility";
se.activityBarVisibleKey = "workbench.activityBar.visible";
const So = "workbench.sideBar.location";
class yo extends M {
  constructor(e, t, o) {
    super({
      id: e,
  ...
  async run(e) {
    const t = e.get(T), o = e.get(L);
    if (t.getSideBarPosition() !== this.position)
      return o.updateValue(So, Pi(this.position));
  }
}
class gt extends yo {
  constructor() {
...
ht.ID = "workbench.action.moveSideBarLeft";
class pt extends M {
  static getLabel(e) {
  ...
  run(e) {
    const t = e.get(T), o = e.get(L), r = t.getSideBarPosition() === 0 ? "right" : "left";
    return o.updateValue(So, r);
  }
}
pt.ID = "workbench.action.toggleSidebarPosition";
pt.LABEL = i("toggleSidebarPosition", "Toggle Primary Side Bar Position");
y("configure-layout-icon", h.layout, i("cofigureLayoutIcon", "Icon represents workbench layout configuration."));
class mt extends M {
  constructor() {
    super({
      id: mt.ID,
...
mt.ID = "workbench.action.toggleSidebarVisibility";
class ce extends M {
  constructor() {
    super({
      id: ce.ID,
  ...
  run(e) {
    const t = e.get(T), o = e.get(L), r = !t.isVisible("workbench.parts.statusbar");
    return o.updateValue(ce.statusbarVisibleKey, r);
  }
}
ce.ID = "workbench.action.toggleStatusbarVisibility";
ce.statusbarVisibleKey = "workbench.statusBar.visible";
class ge extends M {
  constructor() {
    super({
      id: ge.ID,
  ...
  run(e) {
    const t = e.get(L), n = !t.getValue("workbench.editor.showTabs");
    return t.updateValue("workbench.editor.showTabs", n);
  }
}
ge.ID = "workbench.action.toggleTabsVisibility";
a(ge);
Gt.registerCommandAndKeybindingRule({
  id: "workbench.action.exitZenMode",
  weight: 100 - 1e3,
  handler(d) {
    const e = d.get(T), t = d.get(Ft);
    yt.getValue(t) && e.toggleZenMode();
  },
  when: yt,
  primary: Di(9, 9)
});
class Xr extends M {
  resizePart(e, t, o, n) {
    let r;
    if (n === void 0) {
      const l = o.hasFocus("workbench.parts.editor"), u = o.hasFocus("workbench.parts.sidebar"), m = o.hasFocus("workbench.parts.panel"), f = o.hasFocus("workbench.parts.auxiliarybar");
      u ? r = "workbench.parts.sidebar" : m ? r = "workbench.parts.panel" : l ? r = "workbench.parts.editor" : f && (r = "workbench.parts.auxiliarybar");
    } else
      r = n;
    r && o.resizePart(r, e, t);
  }
}
Xr.RESIZE_INCREMENT = 60;
const ne = (d, e, t, o) => ({
  id: d,
  active: e,
  label: t,
  ...
  useButtons: !1
}), Zr = g.and(Ho.toNegated(), g.notEquals("config.window.menuBarVisibility", "hidden"), g.notEquals("config.window.menuBarVisibility", "toggle"), g.notEquals("config.window.menuBarVisibility", "compact")), Wt = [];
(!qo || !zo) && Wt.push(ne("workbench.action.toggleMenuBar", Zr, i("menuBar", "Menu Bar"), Nr));
Wt.push(ne(se.ID, g.equals("config.workbench.activityBar.visible", !0), i("activityBar", "Activity Bar"), { whenA: g.equals("config.workbench.sideBar.location", "left"), iconA: Ur, iconB: Hr }), ne(mt.ID, _i, i("sideBar", "Primary Side Bar"), { whenA: g.equals("config.workbench.sideBar.location", "left"), iconA: Lt, iconB: Tt }), ne(N.ID, re, i("secondarySideBar", "Secondary Side Bar"), { whenA: g.equals("config.workbench.sideBar.location", "left"), iconA: Tt, iconB: Lt }), ne(K.ID, qe, i("panel", "Panel"), qr), ne(ce.ID, g.equals("config.workbench.statusBar.visible", !0), i("statusBar", "Status Bar"), zr));
const es = [
  z(ht.ID, g.equals("config.workbench.sideBar.location", "left"), i("leftSideBar", "Left"), Lt),
  z(gt.ID, g.equals("config.workbench.sideBar.location", "right"), i("rightSideBar", "Right"), Tt)
], ts = [
  z("workbench.action.alignPanelLeft", fe.isEqualTo("left"), i("leftPanel", "Left"), Kr),
  z("workbench.action.alignPanelRight", fe.isEqualTo("right"), i("rightPanel", "Right"), Wr),
  z("workbench.action.alignPanelCenter", fe.isEqualTo("center"), i("centerPanel", "Center"), jr),
  z("workbench.action.alignPanelJustify", fe.isEqualTo("justify"), i("justifyPanel", "Justify"), Qr)
], is = [
  z("workbench.action.toggleFullScreen", Ko, i("fullscreen", "Full Screen"), Jr),
  z("workbench.action.toggleZenMode", yt, i("zenMode", "Zen Mode"), Yr),
  z("workbench.action.toggleCenteredLayout", Wo, i("centeredLayout", "Centered Layout"), $r)
], os = /* @__PURE__ */ new Set();
for (const { active: d } of [...Wt, ...es, ...ts, ...is])
  for (const e of d.keys())
    os.add(e);
let Q = class extends wt {
  constructor(e, t, o, n, r, l, u, m) {
    super(e, t, o, n, r, l, u, m);
  }
  getMetadata() {
    const e = this.getPrimaryEditorPane(), t = this.getSecondaryEditorPane();
    if (e instanceof ae && t instanceof ae)
      return i(
        "metadataDiff",
        "{0} ↔ {1}",
        t.getMetadata(),
...
Ti(ns, {});
const as = new Jo("editorTabFocusMode", !1, !0);
let Pt = class extends Ye {
  constructor(e, t) {
    super(), this._onDidChange = this._register(new St()), this.onDidChange = this._onDidChange.event, this._editorContext = as.bindTo(e), this._terminalContext = $o.bindTo(e);
    const o = t.getValue("editor.tabFocusMode"), n = t.getValue("terminal.integrated.tabFocusMode") ?? o;
    this._editorContext.set(o), this._terminalContext.set(n), V.setTabFocusMode(o, "editorFocus"), V.setTabFocusMode(n, "terminalFocus");
    const r = /* @__PURE__ */ new Set();
    r.add("focusedView"), this._register(e.onDidChangeContext((l) => {
      if (l.affectsSome(r)) {
        const u = e.getContextKeyValue("focusedView") === "terminal", m = u ? "terminalFocus" : "editorFocus";
        if (this._previousViewContext === m)
          return;
        u ? this._editorContext.reset() : this._terminalContext.reset(), this._previousViewContext = m, this._onDidChange.fire();
      }
    })), this._register(t.onDidChangeConfiguration((l) => {
      if (l.affectsConfiguration("editor.tabFocusMode")) {
        const u = t.getValue("editor.tabFocusMode");
        V.setTabFocusMode(u, "editorFocus"), this._editorContext.set(u), t.getValue("terminal.integrated.tabFocusMode") === null && (t.updateValue("terminal.integrated.tabFocusMode", u), V.setTabFocusMode(u, "terminalFocus"), this._terminalContext.set(u)), this._onDidChange.fire();
      } else if (l.affectsConfiguration("terminal.integrated.tabFocusMode")) {
        const u = t.getValue("terminal.integrated.tabFocusMode") ?? t.getValue("editor.tabFocusMode");
        t.updateValue("terminal.integrated.tabFocusMode", u), V.setTabFocusMode(u, "terminalFocus"), this._terminalContext.set(u), this._onDidChange.fire();
      }
    })), V.onDidChangeTabFocus(() => {
      const l = e.getContextKeyValue("focusedView") === "terminal" ? "terminalFocus" : "editorFocus";
      l === "terminalFocus" ? this._terminalContext.set(V.getTabFocusMode(l)) : this._editorContext.set(V.getTabFocusMode(l));
    });
  }
};
Pt = P([
...
class rs {
  ...
  async setEncoding(e, t) {
    await yn.settled([this.primary, this.secondary].map((o) => o.setEncoding(e, t)));
  }
}
class ss {
  constructor(e, t) {
...
function ve(d) {
  if (d instanceof Ze)
    return d;
  if (d instanceof Ut) {
    const t = ve(d.primary), o = ve(d.secondary);
    return t && o ? new rs(t, o) : t;
  }
  const e = d;
  return Sn(e.setEncoding, e.getEncoding) ? e : null;
}
function je(d) {
  if (d instanceof Ze)
    return d;
  if (d instanceof Ut) {
    const t = je(d.primary), o = je(d.secondary);
    return t && o ? new ss(t, o) : t;
  }
  const e = d;
...
let Dt = class extends Ye {
  ...
  async showIndentationPicker() {
    var n;
    const e = j(this.editorService.activeTextEditorControl);
    if (!e)
      return this.quickInputService.pick([{ label: i("noEditor", "No text editor active at this time") }]);
    if ((n = this.editorService.activeEditor) != null && n.hasCapability(2))
    ...
    const t = [
      ...
      id: r.id,
      label: r.label,
      detail: Fi.isDefaultVariant() || r.label === r.alias ? void 0 : r.alias,
      run: () => {
        e.focus(), r.run();
      }
    }));
  ...
  updateElement(e, t, o, n, r) {
    e.value ? e.value.update(t) : e.value = this.statusbarService.addEntry(t, o, n, r);
  }
  updateState(e) {
    const t = this.state.update(e);
    t.hasChanges() && (this.toRender ? this.toRender.combine(t) : (this.toRender = t, this.delayedRender.value = cn(() => {
...
` ? Co : wo : void 0), this.updateLanguageIdElement(this.state.languageId), this.updateMetadataElement(this.state.metadata);
  }
  getSelectionLabel(e) {
    if (!(!e || !e.selections)) {
      if (e.selections.length === 1)
        return e.charactersSelected ? Be(ls, e.selections[0].positionLineNumber, e.selections[0].positionColumn, e.charactersSelected) : Be(us, e.selections[0].positionLineNumber, e.selections[0].positionColumn);
      if (e.charactersSelected)
        return Be(gs, e.selections.length, e.charactersSelected);
      if (e.selections.length > 0)
        return Be(hs, e.selections.length);
    }
  }
  updateStatusBar() {
    const e = this.editorService.activeEditor, t = this.editorService.activeEditorPane, o = t ? ee(j(t.getControl())) : void 0;
    if (this.onColumnSelectionModeChange(o), this.onSelectionChange(o), this.onLanguageChange(o, e), this.onEOLChange(o), this.onEncodingChange(t, o), this.onIndentationChange(o), this.onMetadataChange(t), this.currentProblemStatus.update(o), this.activeEditorListeners.clear(), t && this.activeEditorListeners.add(t.onDidChangeControl(() => {
      ...
      this.activeEditorListeners.add(o.onDidChangeConfiguration((n) => {
        n.hasChanged(20) && this.onColumnSelectionModeChange(o);
      })), this.activeEditorListeners.add(q.defer(o.onDidChangeCursorPosition)(() => {
      ...
      })), this.activeEditorListeners.add(q.accumulate(o.onDidChangeModelContent)((n) => {
        this.onEOLChange(o), this.currentProblemStatus.update(o);
        const r = o.getSelections();
        if (r) {
          for (const l of n)
            for (const u of l.changes)
              if (r.some((m) => Nt.areIntersecting(m, u.range))) {
    ...
    else if (t instanceof ae || t instanceof Q) {
      const n = [];
      if (t instanceof Q) {
        const r = t.getPrimaryEditorPane();
        r instanceof ae && n.push(r);
        const l = t.getSecondaryEditorPane();
        l instanceof ae && n.push(l);
      } else
        n.push(t);
      for (const r of n)
  ...
  onLanguageChange(e, t) {
    ...
    if (e && t && je(t)) {
      ...
      if (n) {
        ...
        o.languageId = ee(this.languageService.getLanguageName(r));
      }
    }
    this.updateState(o);
  }
  ...
  onMetadataChange(e) {
    ...
    (e instanceof ae || e instanceof Q) && (t.metadata = e.getMetadata()), this.updateState(t);
  }
  onColumnSelectionModeChange(e) {
    const t = { type: "columnSelectionMode", columnSelectionMode: !1 };
    e != null && e.getOption(20) && (t.columnSelectionMode = !0), this.updateState(t);
  }
  onSelectionChange(e) {
    ...
    if (e) {
      ...
      if (t.selections.length === 1) {
        const n = e.getPosition(), r = new dn(
  ...
  onEncodingChange(e, t) {
    ...
    if (e && (t != null && t.hasModel())) {
      const n = e.input ? ve(e.input) : null;
      if (n) {
        const r = n.getEncoding(), l = typeof r == "string" ? H[r] : void 0;
        l ? o.encoding = l.labelShort : o.encoding = r;
      }
    }
    this.updateState(o);
  }
  onResourceEncodingChange(e) {
    ...
    if (t) {
      const o = ze.getCanonicalUri(t.input, { supportSideBySide: Ke.PRIMARY });
      if (o && We(o, e)) {
        const n = ee(j(t.getControl()));
        return this.onEncodingChange(t, n);
      }
    }
  }
  onTabFocusModeChange() {
    const e = { type: "tabFocusMode", tabFocusMode: V.getTabFocusMode(this.contextKeyService.getContextKeyValue("focusedView") === "terminal" ? "terminalFocus" : "editorFocus") };
    this.updateState(e);
  }
  isActiveEditor(e) {
    const t = this.editorService.activeEditorPane;
...
let _t = class extends Ye {
  ...
  updateStatus() {
    ...
    if (this.currentMarker = this.getMarker(), this.hasToUpdateStatus(e, this.currentMarker))
      if (this.currentMarker) {
        const t = ln(this.currentMarker.message)[0], o = `${this.getType(this.currentMarker)} ${t}`;
  ...
  hasToUpdateStatus(e, t) {
    return !t || !e ? !0 : ii.makeKey(e) !== ii.makeKey(t);
  }
  getType(e) {
    switch (e.severity) {
      case Z.Error:
  ...
  getMarker() {
    ...
    return t && this.markers.find((o) => Nt.containsPosition(o, t)) || null;
  }
  onMarkerChanged(e) {
    if (!this.editor)
      return;
    const t = this.editor.getModel();
    t && (t && !e.some((o) => We(t.uri, o)) || this.updateMarkers());
  }
  updateMarkers() {
    if (!this.editor)
      return;
    ...
    e && (e ? (this.markers = this.markerService.read({
      resource: e.uri,
      severities: Z.Error | Z.Warning | Z.Info
    }), this.markers.sort(ps)) : this.markers = [], this.updateStatus());
  }
};
_t = P([
  p(0, Gi),
...
function ps(d, e) {
  let t = un(d.resource.toString(), e.resource.toString());
  return t === 0 && (t = Z.compare(d.severity, e.severity)), t === 0 && (t = Nt.compareRangesUsingStarts(d, e)), t;
}
let Qe = class Io extends we {
  constructor(e, t, o) {
    super(Io.ID, i(
...
Qe.ID = "workbench.action.showLanguageExtensions";
Qe = P([
  p(1, Mi),
  p(2, Xo)
], Qe);
class Se extends M {
  ...
  async run(e) {
    var $t;
    const t = e.get(Xe), o = e.get(te), n = e.get(Oi), r = e.get(gn), l = e.get(Vt), u = e.get(hn), m = e.get(Je), f = e.get(L), b = e.get(xi), E = j(o.activeTextEditorControl);
    if (!E) {
      await t.pick([{ label: i("noEditor", "No text editor active at this time") }]);
      return;
    }
    const v = E.getModel(), S = ze.getOriginalUri(o.activeEditor, { supportSideBySide: Ke.PRIMARY });
    let I, k;
    v && (k = v.getLanguageId(), I = ee(n.getLanguageName(k)));
    let A = !!S;
    (S == null ? void 0 : S.scheme) === Ct.untitled && !(($t = l.untitled.get(S)) != null && $t.hasAssociatedFilePath) && (A = !1);
    const _ = n.getSortedRegisteredLanguageNames().map(({ languageName: W, languageId: F }) => {
      const Pe = n.getExtensions(F).join(" ");
      let O;
      return I === W ? O = i("languageDescription", "({0}) - Configured Language", F) : O = i("languageDescriptionConfigured", "({0})", F), {
        label: W,
        meta: Pe,
        iconClasses: oi(F),
        description: O
    ...
    _.unshift({ type: "separator", label: i("languagesPicks", "languages (identifier)") });
    let B, $, U;
    if (A && S) {
      const W = ni(S) || ai(S);
      U = m.createInstance(Qe, W), U.enabled && _.unshift(U), $ = { label: i(
        "configureModeSettings",
        "Configure '{0}' language based settings...",
        I
      ) }, _.unshift($), B = { label: i("configureAssociationsExt", "Configure File Association for '{0}'...", W) }, _.unshift(B);
    }
    const he = {
      label: i("autoDetect", "Auto Detect")
    };
    _.unshift(he);
    const C = await t.pick(_, { placeHolder: i("pickLanguage", "Select Language Mode"), matchOnDescription: !0 });
    if (!C)
      return;
    if (C === U) {
      U.run();
    ...
    if (C === B) {
      S && this.configureFileAssociation(S, n, t, f);
      return;
    }
    if (C === $) {
      u.openUserSettings({ jsonEditor: !0, revealSetting: { key: `[${pn(k)}]`, edit: !0 } });
      return;
    }
    const x = o.activeEditor;
    if (x) {
      const W = je(x);
      if (W) {
        let F, Pe;
        if (C === he) {
          if (v) {
            const O = ze.getOriginalUri(x, { supportSideBySide: Ke.PRIMARY });
            if (O) {
              let Y = ee(n.guessLanguageIdByFilepathOrFirstLine(O, v.getLineContent(1)));
              (!Y || Y === "unknown") && (Pe = await r.detectLanguage(O), Y = Pe), Y && (F = n.createById(Y));
            }
          }
        } else {
          const O = n.getLanguageIdByLanguageName(C.label);
          F = n.createById(O), S && r.detectLanguage(S).then((Y) => {
            const ko = n.getLanguageIdByLanguageName(C.label) || "unknown";
            if (Y === k && k !== ko) {
              const Lo = f.getValue("workbench.editor.preferHistoryBasedLanguageDetection") ? "history" : "classic";
              b.publicLog2(mn, {
                currentLanguageId: I ?? "unknown",
                nextLanguageId: C.label,
                lineCount: (v == null ? void 0 : v.getLineCount()) ?? -1,
                modelPreference: Lo
              });
            }
          });
        }
        if (typeof F < "u" && (W.setLanguageId(F.languageId, Se.ID), (S == null ? void 0 : S.scheme) === Ct.untitled)) {
          const O = f.getValue("workbench.editor.preferHistoryBasedLanguageDetection") ? "history" : "classic";
          b.publicLog2("setUntitledDocumentLanguage", {
            to: F.languageId,
            from: k ?? "none",
            modelPreference: O
          });
  ...
  configureFileAssociation(e, t, o, n) {
    const r = ni(e), l = ai(e), u = t.guessLanguageIdByFilepathOrFirstLine(fn.file(l)), f = t.getSortedRegisteredLanguageNames().map(({ languageName: b, languageId: E }) => ({
      id: E,
      label: b,
      iconClasses: oi(E),
      description: E === u ? i("currentAssociation", "Current Association") : void 0
    }));
    setTimeout(async () => {
      const b = await o.pick(f, { placeHolder: i(
        "pickLanguageToConfigure",
        "Select Language Mode to Associate with '{0}'",
        r || l
      ) });
      if (b) {
        const E = n.inspect(ri);
        let v;
        r && l[0] !== "." ? v = `*${r}` : v = l;
        let S = 2;
        E.workspaceValue && E.workspaceValue[v] && (S = 5);
        const I = bn(S === 5 ? E.workspaceValue : E.userValue) || /* @__PURE__ */ Object.create(null);
        I[v] = b.id, n.updateValue(ri, I, S);
      }
    }, 50);
  }
}
Se.ID = "workbench.action.editor.changeLanguageMode";
class ms extends M {
  constructor() {
    super({
  ...
  async run(e) {
    var f, b;
    const t = e.get(te), o = e.get(Xe), n = j(t.activeTextEditorControl);
    if (!n) {
      await o.pick([{ label: i("noEditor", "No text editor active at this time") }]);
      return;
    }
    if ((f = t.activeEditor) != null && f.hasCapability(2)) {
    ...
    const l = [
      { label: wo, eol: 0 },
      { label: Co, eol: 1 }
    ], u = (r == null ? void 0 : r.getEOL()) === `
` ? 0 : 1, m = await o.pick(l, { placeHolder: i("pickEndOfLine", "Select End of Line Sequence"), activeItem: l[u] });
    if (m) {
      const E = j(t.activeTextEditorControl);
      E != null && E.hasModel() && !((b = t.activeEditor) != null && b.hasCapability(2)) && (r = E.getModel(), r.pushStackElement(), r.pushEOL(m.eol), r.pushStackElement());
    }
    n.focus();
  }
}
class fs extends M {
  ...
  async run(e) {
    const t = e.get(te), o = e.get(Xe), n = e.get(En), r = e.get(Vt), l = e.get(Ri), u = j(t.activeTextEditorControl);
    if (!u) {
      await o.pick([{ label: i("noEditor", "No text editor active at this time") }]);
      return;
    }
    const m = t.activeEditorPane;
    if (!m) {
      await o.pick([{ label: i("noEditor", "No text editor active at this time") }]);
      return;
    }
    ...
    const b = { label: i("saveWithEncoding", "Save with Encoding") }, E = { label: i("reopenWithEncoding", "Reopen with Encoding") };
    if (!Fi.isDefaultVariant()) {
      const C = "Save with Encoding";
      C !== b.label && (b.detail = C);
      const x = "Reopen with Encoding";
      x !== E.label && (E.detail = x);
    }
    let v;
    if (f instanceof Ze ? v = b : m.input.hasCapability(2) ? v = E : v = await o.pick([E, b], { placeHolder: i("pickAction", "Select Action"), matchOnDetail: !0 }), !v)
      return;
    await vn(50);
    const S = ze.getOriginalUri(m.input, { supportSideBySide: Ke.PRIMARY });
    if (!S || !n.hasProvider(S) && S.scheme !== Ct.untitled)
      return;
    let I;
    n.hasProvider(S) && (I = (await r.readStream(S, { autoGuessEncoding: !0 })).encoding);
    const k = v === E, A = l.getValue(ee(S), "files.encoding");
    let J, _;
    const B = Object.keys(H).sort((C, x) => C === A ? -1 : x === A ? 1 : H[C].order - H[x].order).filter((C) => C === I && I !== A ? !1 : !k || !H[C].encodeOnly).map((C, x) => (C === f.getEncoding() ? J = x : H[C].alias === f.getEncoding() && (_ = x), { id: C, label: H[C].labelLong, description: C })), $ = B.slice();
    I && A !== I && H[I] && (B.unshift({ type: "separator" }), B.unshift({ id: I, label: H[I].labelLong, description: i("guessedEncoding", "Guessed from content") }));
    const U = await o.pick(B, {
      placeHolder: k ? i("pickEncodingForReopen", "Select File Encoding to Reopen File") : i("pickEncodingForSave", "Select File Encoding to Save with"),
      activeItem: $[typeof J == "number" ? J : typeof _ == "number" ? _ : -1]
    });
    if (!U || !t.activeEditorPane)
      return;
    const he = ve(t.activeEditorPane.input);
    typeof U.id < "u" && he && await he.setEncoding(U.id, k ? 1 : 0), u.focus();
  }
}
let xt = class extends Ye {
  constructor(e, t, o, n, r, l) {
    super(), this.filesConfigurationService = e, this.hostService = t, this.editorService = o, this.editorGroupService = n, this.workingCopyService = r, this.logService = l, this.pendingAutoSavesAfterDelay = /* @__PURE__ */ new Map(), this.lastActiveEditor = void 0, this.lastActiveGroupId = void 0, this.lastActiveEditorControlDisposable = this._register(new Ot()), this.onAutoSaveConfigurationChange(e.getAutoSaveConfiguration(), !1);
  ...
  scheduleAutoSave(e) {
    ...
    this.pendingAutoSavesAfterDelay.set(e, Ue(() => {
      this.logService.trace("[editor auto save] clearing pending auto save", e.resource.toString(), e.typeId), clearTimeout(t);
    }));
  }
  discardAutoSave(e) {
    An(this.pendingAutoSavesAfterDelay.get(e)), this.pendingAutoSavesAfterDelay.delete(e);
  }
};
xt = P([
  p(0, wn),
...
class jt extends M {
  constructor() {
    super({
      ...
      icon: h.map,
      precondition: Ht.create("diffEditorVersion", 2)
    });
  }
  run(e, ...t) {
    const o = e.get(L), n = !o.getValue("diffEditor.experimental.collapseUnchangedRegions");
...
c.appendMenuItem(s.EditorTitle, {
  command: {
    id: new jt().desc.id,
    title: i("collapseUnchangedRegions", "Collapse Unchanged Regions"),
    icon: h.map
  },
  group: "navigation",
  when: g.and(g.has("config.diffEditor.experimental.collapseUnchangedRegions"), Ht.create("diffEditorVersion", 2))
});
c.appendMenuItem(s.EditorTitle, {
  command: {
    id: new jt().desc.id,
    title: i("showUnchangedRegions", "Show Unchanged Regions"),
    icon: $e.modify(h.map, "disabled")
  },
  group: "navigation",
  when: g.and(g.has("config.diffEditor.experimental.collapseUnchangedRegions").negate(), Ht.create("diffEditorVersion", 2))
});
ie.as(et.EditorPane).registerEditorPane(tt.create(fi, fi.ID, i("textEditor", "Text Editor")), [
  new be(Ze),
  new be(kn)
]);
ie.as(et.EditorPane).registerEditorPane(tt.create(si, si.ID, i("textDiffEditor", "Text Diff Editor")), [
  new be(Vi)
]);
ie.as(et.EditorPane).registerEditorPane(tt.create(Q, Q.ID, i("binaryDiffEditor", "Binary Diff Editor")), [
  new be(Vi)
]);
ie.as(et.EditorPane).registerEditorPane(tt.create(wt, wt.ID, i("sideBySideEditor", "Side by Side Editor")), [
  new be(Ut)
]);
ie.as(Ni.Workbench).registerWorkbenchContribution(xt, 2);
ie.as(Ni.Workbench).registerWorkbenchContribution(Dt, 2);
Ln(bi.ID, bi, 1);
const Qt = ie.as(Tn.Quickaccess), ft = "inEditorsPicker", Mo = g.and(Lr, g.has(ft));
Qt.registerQuickAccessProvider({
  ctor: ci,
  prefix: ci.PREFIX,
  contextKey: ft,
...
a(rr);
a(sr);
const yi = "workbench.action.quickOpenNavigateNextInEditorPicker";
Gt.registerCommandAndKeybindingRule({
  id: yi,
  weight: 200 + 50,
  handler: bo(yi, !0),
...
const wi = "workbench.action.quickOpenNavigatePreviousInEditorPicker";
Gt.registerCommandAndKeybindingRule({
  id: wi,
  weight: 200 + 50,
  handler: bo(wi, !1),
...
cr();
c.appendMenuItem(s.EmptyEditorGroup, { command: { id: eo, title: i("unlockGroupAction", "Unlock Group"), icon: h.lock }, group: "navigation", order: 10, when: it });
c.appendMenuItem(s.EmptyEditorGroup, { command: { id: to, title: i("closeGroupAction", "Close Group"), icon: h.close }, group: "navigation", order: 20 });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: ot, title: i("splitUp", "Split Up") }, group: "2_split", order: 10 });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: Ie, title: i("splitDown", "Split Down") }, group: "2_split", order: 20 });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: nt, title: i("splitLeft", "Split Left") }, group: "2_split", order: 30 });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: Me, title: i("splitRight", "Split Right") }, group: "2_split", order: 40 });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: io, title: i("toggleLockGroup", "Lock Group"), toggled: it }, group: "3_lock", order: 10, when: D });
c.appendMenuItem(s.EmptyEditorGroupContext, { command: { id: to, title: i("close", "Close") }, group: "4_close", order: 10, when: D });
c.appendMenuItem(s.EditorTabsBarContext, { command: { id: ot, title: i("splitUp", "Split Up") }, group: "2_split", order: 10 });
c.appendMenuItem(s.EditorTabsBarContext, { command: { id: Ie, title: i("splitDown", "Split Down") }, group: "2_split", order: 20 });
c.appendMenuItem(s.EditorTabsBarContext, { command: { id: nt, title: i("splitLeft", "Split Left") }, group: "2_split", order: 30 });
c.appendMenuItem(s.EditorTabsBarContext, { command: { id: Me, title: i("splitRight", "Split Right") }, group: "2_split", order: 40 });
c.appendMenuItem(s.EditorTabsBarContext, { command: { id: ge.ID, title: i("toggleTabs", "Enable Tabs"), toggled: g.has("config.workbench.editor.showTabs") }, group: "3_config", order: 10 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: de, title: i("close", "Close") }, group: "1_close", order: 10 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: oo, title: i("closeOthers", "Close Others"), precondition: dr.notEqualsTo("1") }, group: "1_close", order: 20 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: no, title: i("closeRight", "Close to the Right"), precondition: ao.toNegated() }, group: "1_close", order: 30, when: Ae });
c.appendMenuItem(s.EditorTitleContext, { command: { id: zt, title: i("closeAllSaved", "Close Saved") }, group: "1_close", order: 40 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: ke, title: i("closeAll", "Close All") }, group: "1_close", order: 50 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: ro, title: i("reopenWith", "Reopen Editor With...") }, group: "1_open", order: 10, when: so });
c.appendMenuItem(s.EditorTitleContext, { command: { id: co, title: i("keepOpen", "Keep Open"), precondition: lr.toNegated() }, group: "3_preview", order: 10, when: g.has("config.workbench.editor.enablePreview") });
c.appendMenuItem(s.EditorTitleContext, { command: { id: lo, title: i("pin", "Pin") }, group: "3_preview", order: 20, when: le.toNegated() });
c.appendMenuItem(s.EditorTitleContext, { command: { id: at, title: i("unpin", "Unpin") }, group: "3_preview", order: 20, when: le });
c.appendMenuItem(s.EditorTitleContext, { command: { id: ot, title: i("splitUp", "Split Up") }, group: "5_split", order: 10 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: Ie, title: i("splitDown", "Split Down") }, group: "5_split", order: 20 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: nt, title: i("splitLeft", "Split Left") }, group: "5_split", order: 30 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: Me, title: i("splitRight", "Split Right") }, group: "5_split", order: 40 });
c.appendMenuItem(s.EditorTitleContext, { command: { id: uo, title: i("splitInGroup", "Split in Group") }, group: "6_split_in_group", order: 10, when: go });
c.appendMenuItem(s.EditorTitleContext, { command: { id: ho, title: i("joinInGroup", "Join in Group") }, group: "6_split_in_group", order: 10, when: Le });
c.appendMenuItem(s.EditorTitle, { command: { id: ur, title: i("inlineView", "Inline View"), toggled: g.equals("config.diffEditor.renderSideBySide", !1) }, group: "1_diff", order: 10, when: g.has("isInDiffEditor") });
c.appendMenuItem(s.EditorTitle, { command: { id: gr, title: i("showOpenedEditors", "Show Opened Editors") }, group: "3_open", order: 10 });
c.appendMenuItem(s.EditorTitle, { command: { id: ke, title: i("closeAll", "Close All") }, group: "5_close", order: 10 });
c.appendMenuItem(s.EditorTitle, { command: { id: zt, title: i("closeAllSaved", "Close Saved") }, group: "5_close", order: 20 });
c.appendMenuItem(s.EditorTitle, { command: { id: ge.ID, title: i("toggleTabs", "Enable Tabs"), toggled: g.has("config.workbench.editor.showTabs") }, group: "7_settings", order: 5, when: g.has("config.workbench.editor.showTabs").negate() });
c.appendMenuItem(s.EditorTitle, { command: { id: hr, title: i("togglePreviewMode", "Enable Preview Editors"), toggled: g.has("config.workbench.editor.enablePreview") }, group: "7_settings", order: 10 });
c.appendMenuItem(s.EditorTitle, { command: { id: io, title: i("lockGroup", "Lock Group"), toggled: it }, group: "8_lock", order: 10, when: D });
function R(d, e, t, o, n) {
  const r = {
    command: {
      id: d.id,
      title: d.title,
  ...
  o && (r.alt = {
    ...
    title: o.title,
    icon: o.icon
  }), c.appendMenuItem(s.EditorTitle, r);
}
const Jt = 1e5, Te = 1e6;
R({
  id: qt.ID,
  title: i("splitEditorRight", "Split Editor Right"),
  icon: h.splitHorizontal
}, g.not("splitEditorsVertically"), Jt, {
  id: Ie,
  title: i("splitEditorDown", "Split Editor Down"),
  icon: h.splitVertical
});
R({
  id: qt.ID,
  title: i("splitEditorDown", "Split Editor Down"),
  icon: h.splitVertical
}, g.has("splitEditorsVertically"), Jt, {
  id: Me,
  title: i("splitEditorRight", "Split Editor Right"),
  icon: h.splitHorizontal
});
...
R({
  ...
  title: i("close", "Close"),
  icon: h.close
}, g.and(Ae.toNegated(), rt.toNegated(), le.toNegated()), Te, {
  id: ke,
...
R({
  ...
  title: i("close", "Close"),
  icon: h.closeDirty
}, g.and(Ae.toNegated(), rt, le.toNegated()), Te, {
  id: ke,
  title: i("closeAll", "Close All"),
  icon: h.closeAll
});
R({
  ...
  title: i("unpin", "Unpin"),
  icon: h.pinned
}, g.and(Ae.toNegated(), rt.toNegated(), le), Te, {
  id: de,
  title: i("close", "Close"),
  icon: h.close
});
...
const bs = y("diff-editor-previous-change", h.arrowUp, i(
  "previousChangeIcon",
  "Icon for the previous change action in the diff editor."
)), Es = y("diff-editor-next-change", h.arrowDown, i("nextChangeIcon", "Icon for the next change action in the diff editor.")), Ao = y("diff-editor-toggle-whitespace", h.whitespace, i(
  "toggleWhitespace",
...
R({
  ...
  icon: Ao
}, g.and(ue, g.notEquals("config.diffEditor.ignoreTrimWhitespace", !0)), 20);
R({
  id: po,
  title: i("showTrimWhitespace.label", "Show Leading/Trailing Whitespace Differences"),
  icon: $e.modify(Ao, "disabled")
}, g.and(ue, g.notEquals("config.diffEditor.ignoreTrimWhitespace", !1)), 20);
c.appendMenuItem(s.CommandPalette, { command: { id: co, title: { value: i("keepEditor", "Keep Editor"), original: "Keep Editor" }, category: w.View }, when: g.has("config.workbench.editor.enablePreview") });
c.appendMenuItem(s.CommandPalette, { command: { id: lo, title: { value: i("pinEditor", "Pin Editor"), original: "Pin Editor" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: at, title: { value: i("unpinEditor", "Unpin Editor"), original: "Unpin Editor" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: de, title: { value: i("closeEditor", "Close Editor"), original: "Close Editor" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: br, title: { value: i("closePinnedEditor", "Close Pinned Editor"), original: "Close Pinned Editor" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: ke, title: { value: i("closeEditorsInGroup", "Close All Editors in Group"), original: "Close All Editors in Group" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: zt, title: { value: i("closeSavedEditors", "Close Saved Editors in Group"), original: "Close Saved Editors in Group" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: oo, title: { value: i("closeOtherEditors", "Close Other Editors in Group"), original: "Close Other Editors in Group" }, category: w.View } });
c.appendMenuItem(s.CommandPalette, { command: { id: no, title: { value: i("closeRightEditors", "Close Editors to the Right in Group"), original: "Close Editors to the Right in Group" }, category: w.View }, when: ao.toNegated() });
c.appendMenuItem(s.CommandPalette, { command: { id: Er, title: { value: i("closeEditorGroup", "Close Editor Group"), original: "Close Editor Group" }, category: w.View }, when: D });
c.appendMenuItem(s.CommandPalette, { command: { id: ro, title: { value: i("reopenWith", "Reopen Editor With..."), original: "Reopen Editor With..." }, category: w.View }, when: so });
...
let Ci = class extends yr {
  ...
  getActiveCodeEditor() {
    ...
    return gi(t) && Oe(t.activeCodeEditor) ? t.activeCodeEditor : null;
  }
  async doOpenCodeEditorFromDiff(e, t, o) {
    var r;
    const n = this.editorService.activeTextEditorControl;
    if (!o && ui(n) && e.options && e.resource && t === n.getModifiedEditor() && n.getModel() && We(e.resource, (r = n.getModel()) == null ? void 0 : r.modified.uri)) {
      const l = n.getModifiedEditor();
      return mo(e.options, l, 0), l;
    }
    return null;
  }
  async doOpenCodeEditor(e, t, o) {
    var l, u, m, f;
    if (!((u = (l = this.configurationService.getValue().workbench) == null ? void 0 : l.editor) == null ? void 0 : u.enablePreviewFromCodeNavigation) && t && !((m = e.options) != null && m.pinned) && !o && !We((f = t.getModel()) == null ? void 0 : f.uri, e.resource)) {
      for (const b of this.editorService.visibleEditorPanes)
        if (j(b.getControl()) === t) {
          b.group.pinEditor();
          break;
        }
    }
    const r = await this.editorService.openEditor(e, o ? fo : wr);
    if (r) {
      const b = r.getControl();
      if (Oe(b))
        return b;
      if (gi(b) && Oe(b.activeCodeEditor))
...
function Gs(d, e, t) {
  async function o(n, r, l) {
    const u = hi(n) ? r : n.options;
    Cr(r) && (l = r);
    const m = Ir(n) || hi(n) ? n.resource : void 0;
    if (m == null || !d.canHandleResource(m))
      return e(n, r, l);
    let f;
    const b = await d.createModelReference(m);
    if (f = Mr.get(Ar).listCodeEditors().find((v) => v instanceof kr && v.getModel() === b.object.textEditorModel), f == null) {
      const v = await e(n, r, l);
      if (v != null)
        return b.dispose(), v;
      f = await (t == null ? void 0 : t(b, u, l === fo));
    }
    if (f == null) {
      b.dispose();
      return;
    }
    return u != null && mo(u, f, 1), ((u == null ? void 0 : u.preserveFocus) ?? !1) || (f.focus(), f.getContainerDomNode().scrollIntoView()), new vs(f);
  }
  return o;
}
export {
