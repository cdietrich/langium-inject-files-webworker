import { _ as T, a as m, bC as k, nR as v, a1 as L, oc as S, B as t, a3 as $, nL as M, D as I, fi as B, nH as j, nI as A, ic as f, oI as y, e as D, iB as O, nZ as N, k as z } from "./index-6dabdcd0.js";
import { W as V } from "./languageService-e48cc0e5.js";
import { g as q } from "./jsonErrorMessages-8ea797ae.js";
function E(c) {
  if (!Array.isArray(c))
    return !1;
...
let b = class extends I {
  ...
  async _loadConfigurationsForMode(e) {
    const s = this._languageService.getConfigurationFiles(e), r = B(s.map((n) => n.toString()));
...
`))), A(i) !== "object" && (console.error(t(
  ...
  _handleConfig(e, s) {
    ...
    let l;
    if (s.folding) {
      const p = s.folding.markers, P = p && p.start ? this._parseRegex(e, "folding.markers.start", p.start) : void 0, w = p && p.end ? this._parseRegex(e, "folding.markers.end", p.end) : void 0, _ = P && w ? { start: P, end: w } : void 0;
      l = {
...
$.as(O.Workbench).registerWorkbenchContribution(R, 1);
function U() {
  return {
    ...N(),
    [k.toString()]: new z(V)
